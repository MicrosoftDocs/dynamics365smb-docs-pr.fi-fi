...
ms.author: solsen
---
# <a name="run-batch-jobs-and-xmlports"></a><a name="run-batch-jobs-and-xmlports"></a><a name="run-batch-jobs-and-xmlports"></a>Eräajojen ja XMLportien suorittaminen
...
## <a name="to-run-a-batch-job"></a><a name="to-run-a-batch-job"></a><a name="to-run-a-batch-job"></a>Eräajon suorittaminen
