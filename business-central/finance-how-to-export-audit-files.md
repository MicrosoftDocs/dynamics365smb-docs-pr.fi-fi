...
# <a name="audit-file-export" />Tarkistustiedoston vienti
...
## <a name="set-up-audit-file-export" />Määritä tarkistustiedoston vienti
...
## <a name="provide-the-gl-account-mapping-for-audit-file-export" />Määritä tarkistustiedoston viennin KP-tilin yhdistämismääritys
...
## <a name="export-the-audit-file" />Vie tarkistustiedosto
