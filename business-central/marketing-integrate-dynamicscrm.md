...
## <a name="coupling-records" /><a name="coupling-records"></a>Tietueiden yhdistäminen
...
## <a name="fully-synchronizing-records" /><a name="fully-synchronizing-records"></a>Tietueiden täysi synkronointi
...
## <a name="handling-sales-order-data" /><a name="handling-sales-order-data"></a>Myyntitilauksen tietojen käsitteleminen
...
## <a name="handling-sales-quotes-data" /><a name="handling-sales-quotes-data"></a>Myyntitarjouksen tietojen käsitteleminen
...
## <a name="handling-posted-sales-invoices-customer-payments-and-statistics" /><a name="handling-posted-sales-invoices-customer-payments-and-statistics"></a>Kirjattujen myyntilaskujen, asiakkaiden maksujen ja tilastojen käsitteleminen
...
## <a name="handling-sales-prices" /><a name="handling-sales-prices"></a>Myyntihintojen käsitteleminen
> [!NOTE]
