...
ms.author: edupont
---
# <a name="insure-fixed-assets"></a><a name="insure-fixed-assets"></a>Käyttöomaisuuden vakuuttaminen
...
## <a name="to-create-or-modify-an-insurance-card"></a><a name="to-create-or-modify-an-insurance-card"></a>Vakuutuskortin luominen tai muokkaaminen
...
## <a name="to-assign-a-fixed-asset-to-an-insurance-policy-by-posting-from-the-insurance-journal"></a><a name="to-assign-a-fixed-asset-to-an-insurance-policy-by-posting-from-the-insurance-journal"></a>Käyttöomaisuuden liittäminen vakuutussopimukseen vakuutuspäiväkirjasta kirjaamalla
...
## <a name="to-update-the-insurance-value-of-a-fixed-asset"></a><a name="to-update-the-insurance-value-of-a-fixed-asset"></a>Käyttöomaisuuden vakuutusarvon päivittäminen
...
## <a name="to-monitor-insurance-coverage"></a><a name="to-monitor-insurance-coverage"></a>Vakuutuksen kattavuuden valvonta
...
### <a name="overview-of-insurance-policies"></a><a name="overview-of-insurance-policies"></a>Yleiskuva vakuutussopimuksista
...
### <a name="insurance-coverage"></a><a name="insurance-coverage"></a>Vakuutuskattavuus
...
### <a name="overunder-coverage"></a><a name="overunder-coverage"></a>Yli-/alikattavuus
...
### <a name="uninsured-fixed-assets"></a><a name="uninsured-fixed-assets"></a>Vakuuttamaton käyttöomaisuus
...
## <a name="to-view-insurance-coverage-ledger-entries"></a><a name="to-view-insurance-coverage-ledger-entries"></a>Vakuutuksen kattavuustapahtumien katsominen
...
## <a name="to-view-the-total-insurance-value-of-fixed-assets"></a><a name="to-view-the-total-insurance-value-of-fixed-assets"></a>Käyttöomaisuuden kokonaisvakuutusarvon tarkasteleminen
...
## <a name="to-correct-insurance-coverage-entries"></a><a name="to-correct-insurance-coverage-entries"></a>Vakuutuksen kattavuustapahtumien korjaaminen
