...
# <a name="walkthrough-set-up-and-use-the-shopify-connector" />Vaihekuvaus: Shopify-yhdistimen määrittäminen ja käyttäminen
...
## <a name="connect-business-central-to-the-shopify-shop" />Business Centralin yhdistäminen Shopify-kauppaan
...
## <a name="walkthrough-start-selling-products-online" />Vaihekuvaus: Tuotteiden myynnin aloittaminen verkossa
...
#### <a name="prepare-data" />Valmistele tiedot
...
#### <a name="run-the-synchronization" />Suorita synkronointi
