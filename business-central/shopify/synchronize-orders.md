...
Voit tarkastella kaupan valuuttaa [Kaupan tiedot](https://www.shopify.com/admin/settings/general) -asetuksissa Shopify Adminissa. Shopify voidaan määrittää hyväksymään eri valuuttoja, mutta [!INCLUDE[prod_short](../includes/prod_short.md)] -järjestelmään tuodut tilaukset käyttävät kaupan valuuttaa.
