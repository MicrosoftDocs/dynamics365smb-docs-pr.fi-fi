...
# <a name="synchronize-items-and-inventory" />Synkronoi nimikkeet ja varasto
...
## <a name="define-item-synchronizations" />Määritä nimikkeiden synkronointivaltuudet
...
## <a name="import-items-from-shopify" />Tuo nimikkeitä Shopifysta
...
### <a name="effect-of-shopify-product-skus-and-barcodes-on-mapping-and-creating-items-and-variants-in-business-central" />Shopify-tuotteiden SKU:iden ja viivakoodien vaikutus tuotteiden ja varianttien kartoittamiseen ja luomiseen Business Centralissa
...
## <a name="export-items-to-shopify" />Vie nimikkeet Shopifyhin
...
### <a name="fields-mapping-overview" />Kenttien yhdistämisen yleiskatsaus
...
## <a name="run-item-synchronization" />Suorita nimikkeiden synkronointi

Kohteiden synkronointi kokonaan tai osittain voidaan suorittaa monella eri tavalla.

### <a name="initial-sync-of-items-from-business-central-to-shopify" />Nimikkeiden alkusynkronointi Business Centralista Shopifyhin
...
### <a name="sync-products-from-shopify-to-business-central" />Synkronoi tuotteita Shopifysta Business Centraliin
...
### <a name="ad-hoc-updates-of-shopify-products" />Shopify-tuotteiden Ad-Hoc-päivitykset
...
## <a name="sync-item-images" />Synkronoi nimikekuvat
...
### <a name="sync-product-images-from-the-shopify-shop-page" />Synkronoi tuotekuvat Shopify-myymäläsivulla
...
### <a name="sync-product-images-from-the-shopify-products-page" />Synkronoi tuotekuvat Shopify-tuotesivulta

1. Siirry hakuun ![Lamppu, joka avaa Kerro-ominaisuuden.](../media/ui-search/search_small.png "Kerro, mitä haluat tehdä") -kuvake, syötä **Shopify-tuotteet**, valitse sitten vastaava linkki.
2. Valitse **Synkronoi tuotekuvat** -toiminto.

### <a name="image-synchronization-remarks" />Kuvien synkronoinnin huomautukset
...
## <a name="sync-prices-with-shopify" />Synkronoi hintoja Shopifyn kanssa
...
### <a name="sync-prices-from-the-shopify-products-page" />Synkronoi hinnat Shopify-tuotesivulla

1. Siirry hakuun ![Lamppu, joka avaa Kerro-ominaisuuden.](../media/ui-search/search_small.png "Kerro, mitä haluat tehdä") -kuvake, syötä **Shopify-tuotteet**, valitse sitten vastaava linkki.
2. Valitse **Synkronoi tuotteet Shopifyhin** -toiminto.

### <a name="price-calculation-remarks" />Hintalaskennan huomautukset
...
## <a name="sync-inventory-to-shopify" />Synkronoi varasto Shopifyhin
...
### <a name="to-enable-inventory-sync" />Varaston synkronoinnin ottaminen käyttöön
...
### <a name="sync-inventory-from-the-shopify-shop-page" />Synkronoi varasto Shopify-myymäläsivulta

1. Siirry hakuun ![Lamppu, joka avaa Kerro-ominaisuuden.](../media/ui-search/search_small.png "Kerro, mitä haluat tehdä") -kuvakkeeseen, syötä **Shopify-myymälät**, valitse sitten vastaava linkki.
2. Valitse kauppa, jolle haluat synkronoida varaston avataksesi **Shopify-ostoskortti**-sivun.
3. Valitse **Synkronoi varasto** -toiminto.

### <a name="sync-inventory-from-the-shopify-products-page" />Synkronoi varasto Shopify-tuotesivulta
...
### <a name="inventory-remarks" />Varaston huomautukset
...
#### <a name="example-of-calculation-of-projected-available-balance" />Esimerkki oletetun saatavilla olevan saldon laskemisesta
