...
# <a name="faq-for-technical-details" />Teknisten tietojen UKK

Tämä artikkeli vastaa Shopify-yhdistintä koskeviin yleisimpiin kysymyksiin.

## <a name="what-is-shopify" />Shopifyn kuvaus
...
### <a name="capabilities" />Ominaisuudet
...
## <a name="why-did-microsoft-and-shopify-form-this-partnership" />Miksi Microsoft ja Shopify ryhtyivät tähän kumppanuuteen?
...
## <a name="which-microsoft-products-are-the-shopify-connector-available-for" />Mille Microsoft-tuotteille Shopify-yhdistin on saatavilla?
...
## <a name="currently-unsupported-features-however-were-tracking-them-and-may-consider-adding-them" />Seuraavia ominaisuuksia ei tueta tällä hetkellä, mutta pidämme niitä silmällä ja saatamme harkita niiden lisäämistä
...
## <a name="is-the-shopify-connector-extensible" />Voidaanko Shopify-yhdistintä laajentaa?
...
## <a name="is-the-shopify-connector-open-for-contribution" />Voivatko muut osallistua Shopify-yhdistimen työstämiseen?
