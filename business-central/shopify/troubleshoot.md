...
Olet ehkä käyttänyt [upota sovellus](/dynamics365/business-central/dev-itpro/deployment/embed-app-overview) -toimintoa, jossa asiakkaan URL-osoite on muotoa: `https://[application name].bc.dynamics.com`. Shopify-yhdistin ei toimi upotettavien sovellusten yhteydessä. Lue lisää kohdasta [Minkä Microsoft-tuotteiden kanssa Shopify-yhdistin toimii?](shopify-faq.md#which-microsoft-products-work-with-the-shopify-connector).
