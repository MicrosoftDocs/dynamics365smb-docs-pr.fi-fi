...
# <a name="get-started-with-the-shopify-connector" />Shopifyn yhdistimen käytön aloittaminen
...
## <a name="prerequisites-for-shopify" />Vaatimukset Shopifylle
...
## <a name="prerequisites-for-business-central" />Business Centralin edellytykset
...
## <a name="install-the-dynamics-365-business-central-app-to-your-shopify-online-store" />Asenna Dynamics 365 Business Central -sovellus Shopify-verkkokauppaasi
...
## <a name="connect-business-central-to-the-shopify-online-store" />Business Centralin yhdistäminen Shopify-verkkokauppaan
...
## <a name="testing-strategies" />Testistrategiat
...
### <a name="shopify-sandbox-and-business-central-sandbox" />Shopify-eristysympäristö ja Business Central -eristysympäristö
...
### <a name="shopify-sandbox-and-business-central-production" />Shopify-eristysympäristö ja Business Central -tuotanto
...
### <a name="shopify-production-and-business-central-sandbox" />Shopify-tuotanto ja Business Central -eristysympäristö
...
## <a name="see-related-microsoft-trainingtrainingpathsuse-shopify-connector-dynamics-365-business-central" />Lue aiheeseen liittyen [Microsoftin koulutukset](/training/paths/use-shopify-connector-dynamics-365-business-central/)
