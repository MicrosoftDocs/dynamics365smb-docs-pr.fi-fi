...
# <a name="synchronize-customers" />Asiakkaiden synkronointi
...
## <a name="important-settings-when-importing-customers-from-shopify" />Tärkeät asetukset tuotaessa asiakkaita Shopifysta
...
### <a name="customer-template-per-country" />Asiakasmalli maata kohti
...
## <a name="export-customers-to-shopify" />Vie asiakastiedot Shopifyhin
...
### <a name="populate-customer-information-in-shopify" />Asiakastietojen täyttäminen Shopifyssa
...
## <a name="sync-customers" />Synkronoi asiakkaat
