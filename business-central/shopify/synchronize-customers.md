---
title: Asiakkaiden ja yritysten synkronointi
...
Shopify mahdollistaa yritystenvälisen (B2B) ja kuluttajakaupan (DTC) liiketoiminnan suorittamisen samassa paikassa Shopifyn tehokkaan ja vaivattoman keskitetyn ympäristön avulla. Shopify-yhdistin toimii myös erilaisissa sähköisissä kaupankäynneissä.
...
Asiakkaan vienti [!INCLUDE[prod_short](../includes/prod_short.md)]ista Shopifyhyn vaihtelee sen mukaan, mitä halutaan tehdä:
