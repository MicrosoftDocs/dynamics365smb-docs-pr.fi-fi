...
# <a name="create-and-set-up-a-shopify-account" />Shopify-tilin luominen ja määrittäminen
...
## <a name="trial-end-user" />Kokeiluversio (loppukäyttäjä)
...
## <a name="development-store" />Testikauppa
