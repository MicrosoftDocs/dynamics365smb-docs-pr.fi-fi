...
# <a name="set-up-taxes-for-the-shopify-connection" />Määritä Shopify-yhteyden verot
...
## <a name="if-you-sell-domestically" />Jos myyt kotimaassa
...
## <a name="if-you-sell-internationally" />Jos myyt ulkomailla
...
## <a name="dynamic-tax-inclusive-pricing" />Dynaaminen verot sisältävä hinnoittelu
...
## <a name="if-you-sell-to-eu-customers" />Jos myyt EU-asiakkaille
...
### <a name="collect-vat-set-to-one-stop-shop-registration" />ALV-joukon nouto yhden luukun rekisteröinnistä
...
### <a name="collect-vat-set-to-micro-business-exemption" />ALV:n kerääminen mikroyritysten vapautuksesta
...
## <a name="importing-shopify-orders-sold-to-international-customers" />Kansainvälisille asiakkaille myytyjen Shopify-tilausten tuominen
...
## <a name="other-tax-remarks" />Muut verohuomautukset
