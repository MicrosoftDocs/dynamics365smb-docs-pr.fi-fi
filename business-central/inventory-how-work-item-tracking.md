...
**Nimikkeen seurantarivit** -sivun yläosassa olevassa määräkentissä näkyy rivillä määritettävien nimikkeen seurantanumeroiden määrät ja summat. Määrien tulee vastata asiakirjariveillä olevia määriä, mikä näkyy *0* :lla **Määrittelemättömät-kentissä** .
...
Jos käsittelet **Nimikkeen seurantarivit** -sivua pitkään tai jos käsiteltävän nimikkeen kanssa on paljon aktiviteetteja, voit valita Päivitä saatavuus **-** toiminnon. Lisäksi nimikkeen saatavuus tarkistetaan automaattisesti uudelleen, kun suljet sivun ja vahvistat näin, että saatavuusongelmia ei ole.
...
3.  **Valitse Nimikkeen kortti**  sivulla **Aiheeseen liittyvä** toiminto, valitse **Aiheeseen liittyvä** toiminto, valitse Tapahtumat-toiminto **ja** valitse **sitten Tapahtumakirjaukset**.
...
> [!NOTE]
> [!INCLUDE [prod_short](includes/prod_short.md)] vahvistaa, että kullakin rivillä on yksilöivä sarja-, erä- ja/tai pakettinumeroiden yhdistelmä. Jos haluat jakaa erän, paketin tai erän ja paketin useisiin eriin tai paketteihin, sinun täytyy käyttää useita kirjauskansiorivejä.

1. Valitse ![Lamppu, joka avaa Kerro, mitä haluat tehdä -ominaisuuden](media/ui-search/search_small.png "Kerro, mitä haluat tehdä") -kuvaketta, syötä **Nimikkeen uudelleenluokituspäiväkirjat** ja valitse sitten liittyvä linkki.  
...
4. Sarjanrot-kohdassa **tai** **Eränumerot.** -kentästä, valitse nykyinen sarja- tai eränumero.  
