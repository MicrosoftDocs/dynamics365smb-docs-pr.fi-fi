...
---
# <a name="set-up-jobs-prices-and-job-posting-groups" />Projektien, hintojen ja projektin kirjausryhmien määrittäminen
...
## <a name="to-set-general-information-for-jobs" />Projektien yleistietojen määrittäminen
...
### <a name="to-set-up-job-usage-tracking" />Projektin käytön seurannan määrittäminen
...
## <a name="to-set-up-prices-for-resources-items-and-general-ledger-accounts-for-jobs" />Hintojen määrittäminen töiden nimikkeille, resursseille ja KP-tileille
...
## <a name="to-set-up-job-posting-groups" />Projektin kirjausryhmien määrittäminen
