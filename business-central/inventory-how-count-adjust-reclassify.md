...
---
# <a name="count-adjust-and-reclassify-inventory-using-journals" />Varaston laskeminen, muuttaminen ja uudelleenluokitus käyttämällä päiväkirjoja
...
## <a name="to-count-physical-inventory" />Inventaarion suorittaminen
...
### <a name="to-calculate-expected-inventory-in-basic-warehouse-configurations" />Oletetun varaston laskeminen varastoinnin perusmäärityksissä
...
### <a name="to-print-the-report-to-be-used-when-counting" />Laskennassa käytettävän raportin tulostaminen
...
### <a name="to-enter-and-post-the-actual-counted-inventory-in-basic-warehouse-configurations" />Todellisen lasketun varaston antaminen ja kirjaaminen fyysisen varastoinnin perusmäärityksissä
...
### <a name="to-calculate-the-expected-inventory-in-advanced-warehouse-configurations" />Oletetun varaston laskeminen laajennetuissa varastomäärityksissä
...
### <a name="to-enter-and-post-the-actual-counted-inventory-in-advanced-warehouse-configurations" />Todellisen lasketun varaston antaminen ja kirjaaminen laajennetuissa varastomäärityksissä
...
## <a name="to-do-cycle-counting" />Inventoinnin suorittaminen
...
### <a name="to-set-up-counting-periods" />Laskentajaksojen määrittäminen
...
### <a name="to-assign-a-counting-period-to-an-item" />Laskentajakson määritteleminen nimikkeelle
...
### <a name="to-start-a-count-based-on-counting-periods-in-basic-warehouse-configurations" />Laskennan käynnistäminen laskentakauden perusteella fyysisen varastoinnin perusmäärityksissä
...
### <a name="to-start-a-count-based-on-counting-periods-in-advanced-warehouse-configurations" />Laskennan käynnistäminen laskentakauden perusteella laajennetuissa varastomäärityksissä
...
## <a name="to-adjust-the-quantity-of-one-item" />Yhden nimikkeen määrän muuttaminen
...
### <a name="to-adjust-the-quantities-of-multiple-items-in-basic-warehouse-configurations" />Useiden nimikkeiden määrän muuttaminen fyysisen varastoinnin perusmäärityksissä
...
### <a name="to-adjust-bin-quantities-in-advanced-warehouse-configurations" />Varastopaikkamäärien muuttaminen laajennetuissa varastomäärityksissä
...
## <a name="to-synchronize-the-adjusted-warehouse-entries-with-the-related-item-ledger-entries" />Muutettujen fyysisen varastoinnin tapahtumien ja liittyvien nimiketapahtumien synkronointi
