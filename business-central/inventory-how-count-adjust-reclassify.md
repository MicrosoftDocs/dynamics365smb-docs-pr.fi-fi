...
---
# <a name="count-adjust-and-reclassify-inventory-using-journals"></a><a name="count-adjust-and-reclassify-inventory-using-journals"></a>Varaston laskeminen, muuttaminen ja uudelleenluokitus käyttämällä päiväkirjoja
...
## <a name="to-count-physical-inventory"></a><a name="to-count-physical-inventory"></a>Inventaarion suorittaminen
...
### <a name="to-calculate-expected-inventory-in-basic-warehouse-configurations"></a><a name="to-calculate-expected-inventory-in-basic-warehouse-configurations"></a>Oletetun varaston laskeminen varastoinnin perusmäärityksissä
...
### <a name="to-print-the-report-to-be-used-when-counting"></a><a name="to-print-the-report-to-be-used-when-counting"></a>Laskennassa käytettävän raportin tulostaminen
...
### <a name="to-enter-and-post-the-actual-counted-inventory-in-basic-warehouse-configurations"></a><a name="to-enter-and-post-the-actual-counted-inventory-in-basic-warehouse-configurations"></a>Todellisen lasketun varaston antaminen ja kirjaaminen fyysisen varastoinnin perusmäärityksissä
...
### <a name="to-calculate-the-expected-inventory-in-advanced-warehouse-configurations"></a><a name="to-calculate-the-expected-inventory-in-advanced-warehouse-configurations"></a>Oletetun varaston laskeminen laajennetuissa varastomäärityksissä
...
### <a name="to-enter-and-post-the-actual-counted-inventory-in-advanced-warehouse-configurations"></a><a name="to-enter-and-post-the-actual-counted-inventory-in-advanced-warehouse-configurations"></a>Todellisen lasketun varaston antaminen ja kirjaaminen laajennetuissa varastomäärityksissä
...
## <a name="to-do-cycle-counting"></a><a name="to-do-cycle-counting"></a>Inventoinnin suorittaminen
...
### <a name="to-set-up-counting-periods"></a><a name="to-set-up-counting-periods"></a>Laskentajaksojen määrittäminen
...
### <a name="to-assign-a-counting-period-to-an-item"></a><a name="to-assign-a-counting-period-to-an-item"></a>Laskentajakson määritteleminen nimikkeelle
...
### <a name="to-start-a-count-based-on-counting-periods-in-basic-warehouse-configurations"></a><a name="to-start-a-count-based-on-counting-periods-in-basic-warehouse-configurations"></a>Laskennan käynnistäminen laskentakauden perusteella fyysisen varastoinnin perusmäärityksissä
...
### <a name="to-start-a-count-based-on-counting-periods-in-advanced-warehouse-configurations"></a><a name="to-start-a-count-based-on-counting-periods-in-advanced-warehouse-configurations"></a>Laskennan käynnistäminen laskentakauden perusteella laajennetuissa varastomäärityksissä
...
## <a name="to-adjust-the-quantity-of-one-item"></a><a name="to-adjust-the-quantity-of-one-item"></a>Yhden nimikkeen määrän muuttaminen
...
### <a name="to-adjust-the-quantities-of-multiple-items-in-basic-warehouse-configurations"></a><a name="to-adjust-the-quantities-of-multiple-items-in-basic-warehouse-configurations"></a>Useiden nimikkeiden määrän muuttaminen fyysisen varastoinnin perusmäärityksissä
...
### <a name="to-adjust-bin-quantities-in-advanced-warehouse-configurations"></a><a name="to-adjust-bin-quantities-in-advanced-warehouse-configurations"></a>Varastopaikkamäärien muuttaminen laajennetuissa varastomäärityksissä
...
## <a name="to-synchronize-the-adjusted-warehouse-entries-with-the-related-item-ledger-entries"></a><a name="to-synchronize-the-adjusted-warehouse-entries-with-the-related-item-ledger-entries"></a>Muutettujen fyysisen varastoinnin tapahtumien ja liittyvien nimiketapahtumien synkronointi
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Lue aiheeseen liittyen [Microsoftin koulutukset](/training/modules/adjust-inventory/)
