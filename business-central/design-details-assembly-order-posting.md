...
ms.author: edupont
---
# <a name="design-details-assembly-order-posting"></a><a name="design-details-assembly-order-posting"></a><a name="design-details-assembly-order-posting"></a>Rakennetiedot: kokoonpanotilauksen kirjaus
...
## <a name="posting-sequence"></a><a name="posting-sequence"></a><a name="posting-sequence"></a>Järjestyksen kirjaaminen
...
## <a name="cost-adjustment"></a><a name="cost-adjustment"></a><a name="cost-adjustment"></a>Kustannusten muuttaminen
...
### <a name="performing-the-adjustment"></a><a name="performing-the-adjustment"></a><a name="performing-the-adjustment"></a>Muutoksen suorittaminen
...
## <a name="assemble-to-order"></a><a name="assemble-to-order"></a><a name="assemble-to-order"></a>Kokoonpano tilausta varten
...
### <a name="posting-dates"></a><a name="posting-dates"></a><a name="posting-dates"></a>Kirjauspäivämäärät
