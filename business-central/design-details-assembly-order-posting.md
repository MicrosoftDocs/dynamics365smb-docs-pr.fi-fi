...
ms.author: edupont
---
# <a name="design-details-assembly-order-posting"></a><a name="design-details-assembly-order-posting"></a>Rakennetiedot: kokoonpanotilauksen kirjaus
...
## <a name="posting-sequence"></a><a name="posting-sequence"></a>Järjestyksen kirjaaminen
...
## <a name="cost-adjustment"></a><a name="cost-adjustment"></a>Kustannusten muuttaminen
...
### <a name="performing-the-adjustment"></a><a name="performing-the-adjustment"></a>Muutoksen suorittaminen
...
### <a name="posting-dates"></a><a name="posting-dates"></a>Kirjauspäivämäärät
