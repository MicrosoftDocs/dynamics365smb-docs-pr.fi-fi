...
### <a name="what-is-expected-of-users-while-using-e-documents-matching-assistance"></a>Mitä käyttäjien odotetaan tekevän sähköisten asiakirjojen kohdistusapuria käytettäessä?
...
### <a name="what-is-expected-of-administrators-and-users-when-operating-e-documents-matching-assistance"></a>Mitä järjestelmänvalvojilta ja käyttäjiltä odotetaan sähköisten asiakirjojen kohdistusapuria käytettäessä?
