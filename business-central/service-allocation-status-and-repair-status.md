...
ms.author: bholtorf
---
# <a name="allocation-status-and-repair-status-of-service-items" />Huoltonimikkeen kohdistuksen tila ja korjauksen tila
...
## <a name="changing-repair-status" />Korjauksen tilan muuttaminen
...
## <a name="converting-service-quotes-to-service-orders" />Huoltotarjousten muuntaminen huoltotilauksiksi
...
## <a name="canceling-allocations" />Kohdistusten peruuttaminen
...
## <a name="reallocating-an-active-allocation-entry" />Aktiivisen kohdistustapahtuma uudelleenkohdistaminen
...
## <a name="reallocating-a-service-item" />Huoltonimikkeen uudelleenkohdistaminen
