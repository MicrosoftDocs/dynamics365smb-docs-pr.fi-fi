...
ms.author: edupont
---
# <a name="work-with-blanket-sales-orders-or-blanket-purchase-orders" />Puiteostotilausten tai ostotilausten käsitteleminen
...
## <a name="to-create-a-blanket-sales-order" />Uuden puitemyyntitilauksen luominen
...
## <a name="to-create-a-sales-order-from-a-blanket-sales-order" />Myyntitilauksen luominen puitemyyntitilauksesta
...
## <a name="to-view-the-status-of-a-blanket-sales-order" />Puitemyyntitilauksen tilan katsominen
...
## <a name="to-view-unposted-and-posted-blanket-sales-order-lines" />Kirjaamattomien ja kirjattujen puitemyyntitilausrivien näyttäminen
