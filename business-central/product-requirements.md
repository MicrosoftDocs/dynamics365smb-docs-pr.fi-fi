...
ms.author: jswymer
---
# <a name="minimum-requirements-for-using-business-central" />Business Central -sovelluksen käytön vähimmäisvaatimukset
...
## <a name="mobile-devices" />Mobiililaitteet
...
## <a name="use-business-central-on-premises" />Käytä Business Central on-premises -versiota
