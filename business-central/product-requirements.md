...
ms.author: jswymer
---
# <a name="minimum-requirements-for-using-business-central"></a><a name="minimum-requirements-for-using-business-central"></a>Business Central -sovelluksen käytön vähimmäisvaatimukset
...
## <a name="browsers"></a><a name="browsers"></a>Selaimet
...
## <a name="mobile-devices"></a><a name="mobile-devices"></a>Mobiililaitteet
...
## <a name="using-the-business-central-administration-center"></a><a name="using-the-business-central-administration-center"></a><a name="TAC"></a> Business Centralin hallintakeskuksen käyttäminen
...
## <a name="use-business-central-on-premises"></a><a name="use-business-central-on-premises"></a>Käytä Business Central on-premises -versiota
