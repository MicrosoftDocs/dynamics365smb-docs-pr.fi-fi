...
ms.author: edupont
---
# <a name="flush-components-according-to-operation-output" />Komponenttien materiaalinotto toiminnan tuotoksen mukaan
...
## <a name="automatic-consumption-posting-flushing-methods" />Kulutuksen automaattisen kirjaamisen (materiaalinotto) menetelmät
...
### <a name="automatic-reporting---forward-flush-the-entire-order" />Automaattinen raportointi - koko tilauksen Eteenpäin-materiaalinotto
...
### <a name="automatic-reporting---forward-flushing-by-operation" />Automaattinen raportointi - operaatiokohtainen Eteenpäin-materiaalinotto
...
### <a name="automatic-reporting---back-flushing-by-operation" />Automaattinen raportointi - operaatiokohtainen Taaksepäin-materiaalinotto
...
### <a name="automatic-reporting---back-flushing-the-entire-order" />Automaattinen raportointi - koko tilauksen Taaksepäin-materiaalinotto
...
## <a name="to-flush-components-according-to-operation-output" />Voit tyhjentää osat toiminnon tuotoksen mukaan
...
## <a name="flushing-methods" />Materiaalinottotavat
