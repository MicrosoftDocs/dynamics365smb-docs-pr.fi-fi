...
# <a name="searching-for-customers-vendors-and-other-contacts-from-microsoft-teams" />Asiakkaiden, toimittajien ja muiden yhteyshenkilöiden hakeminen Microsoft Teamsista
...
## <a name="look-up-contacts-from-the-command-box" />Yhteyshenkilöiden haku komentoruudussa
...
## <a name="look-up-contacts-from-the-message-compose-box" />Yhteyshenkilöiden haku viestiruudussa
...
### <a name="heres-another-way" />Vaihtoehtoinen tapa
...
## <a name="viewing-contact-card-details" />Yhteyshenkilökortin tietojen näyttäminen
