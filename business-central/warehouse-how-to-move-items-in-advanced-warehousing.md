...
3. Lisää käyttäjätunnus tarvittaessa hyllytyksen käsittelyn alussa.  
  ...
  > [!NOTE]  
  > Rivit on lajiteltu valittujen kriteereiden nousevassa järjestyksessä. Jos järjestelet asiakirjan mukaan, lajittelu tehdään ensin asiakirjatyypin mukaan **F. varastoinnin aktiviteetin lähdeasiakirja** -luetteloinnin perusteella. Jos järjestelet määränpään mukaan, lajittelu tehdään kohdetyypin mukaan **F. varastoinnin kohdetyyppi** -kentän perusteella.
