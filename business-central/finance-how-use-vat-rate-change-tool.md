...
# <a name="managing-vat-rate-changes"></a><a name="managing-vat-rate-changes"></a>ALV-prosenttimuutosten hallinta
...
## <a name="changing-vat-rates"></a><a name="changing-vat-rates"></a>ALV-prosenttien muuttaminen
...
## <a name="the-vat-rate-change-tool"></a><a name="the-vat-rate-change-tool"></a>ALV-prosentin muutostyökalua
...
## <a name="understanding-the-vat-rate-conversion-process-and-limitations"></a><a name="understanding-the-vat-rate-conversion-process-and-limitations"></a>Tietoja ALV-prosentin muuntoprosessista ja sen rajoituksista
...
### <a name="to-prepare-vat-rate-change-conversions"></a><a name="to-prepare-vat-rate-change-conversions"></a>Suorita ALV-kurssimuutoksen muunnokset
...
### <a name="to-set-up-the-vat-rate-change-tool"></a><a name="to-set-up-the-vat-rate-change-tool"></a>Määritä ALV-prosentin muutostyökalu
...
### <a name="to-set-up-product-posting-group-conversion"></a><a name="to-set-up-product-posting-group-conversion"></a>Määritä tuotteiden ALV-kirjausryhmien muunnos
...
### <a name="to-perform-vat-rate-change-conversion"></a><a name="to-perform-vat-rate-change-conversion"></a>Suorita ALV-kurssimuutoksen muunnos
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Lue aiheeseen liittyen [Microsoftin koulutukset](/training/modules/rate-change-dynamics-365-business-central/)
