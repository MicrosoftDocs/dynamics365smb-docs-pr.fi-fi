...
- Toinen tapa on käyttää **Business Centralin Tietosuojailmoitusten tila** -sivua ja suostua **Kaikkien käyttäjien Käyttöön. OpenAI**  Lisätietoja on kohdassa [käyttöehtojen hyväksyminen](enable-ai.md#consent-to-or-reject-preview-and-privacy-terms-and-conditions-for-all-users).
