...
## <a name="scheduling-synchronization-between-d365fin-and-crm_md"></a>Synkronoinnin aikatauluttaminen [!INCLUDE[d365fin](includes/d365fin_md.md)] :n ja [!INCLUDE[crm_md](includes/crm_md.md)]:n välillä
