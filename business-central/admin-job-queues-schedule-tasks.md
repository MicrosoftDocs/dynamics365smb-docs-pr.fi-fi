...
---
# <a name="use-job-queues-to-schedule-tasks" />Käytä työjonoja ajoitustehtäviin
...
## <a name="monitor-status-or-errors-in-the-job-queue" />Työjonon tilan tai virheiden seuraaminen
...
### <a name="to-view-status-for-any-job" />Minkä tahansa työn tilan näyttäminen
...
## <a name="view-scheduled-tasks" />Näytä ajoitetut tehtävät
...
## <a name="the-my-job-queue-part" />Oma työjono -osa
...
### <a name="to-view-an-error-from-the-my-job-queue-part" />Tarkastele virhettä oma työjono -osasta

1. Valitse tapahtumassa, jonka tila on **Virhe**, **Näytä virhe** -toiminto.
2. Tarkastele virhesanomaa ja korjaa ongelma.

## <a name="examples-of-what-you-can-schedule-using-job-queue-entries" />Esimerkkejä siitä, mitä voit ajoittaa työjonotapahtumien avulla

### <a name="schedule-reports" />Ajoita raportteja
...
### <a name="schedule-synchronization-between-includeprodshortincludesprodshortmd-and-includeprodshortincludescdslongmdmd" />Synkronoinnin aikatauluttaminen [!INCLUDE[prod_short](includes/prod_short.md)]in ja [!INCLUDE[prod_short](includes/cds_long_md.md)]n välillä
...
### <a name="schedule-when-to-post-sales-and-purchase-orders" />Ajoita milloin myynti- ja ostotilaukset kirjataan
...
## <a name="handle-job-queue-entry-issues" />Käsittele työjonotapahtumien ongelmat
...
## <a name="monitor-the-job-queue-with-telemetry" />Työjonon valvominen telemetrian avulla
