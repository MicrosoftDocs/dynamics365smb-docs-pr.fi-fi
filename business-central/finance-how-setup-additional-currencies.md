...
## <a name="displaying-reports-and-amounts-in-acy"></a>Raporttien ja summien näyttäminen lisäraportointivaluuttana
...
## <a name="setting-up-an-acy"></a>Lisäraportointivaluutan määrittäminen
...
### <a name="to-activate-the-acy"></a>Lisäraportointivaluutan aktivoiminen
1. Valitse ![Lamppu, joka avaa Kerro-ominaisuuden.](media/ui-search/search_small.png "Kerro, mitä haluat tehdä") -kuvake, syötä **Pääkirjanpidon asetukset** ja valitse sitten vastaava linkki.  
