...
ms.author: edupont
---
# <a name="dispose-of-or-retire-fixed-assets"></a><a name="dispose-of-or-retire-fixed-assets"></a>Käyttöomaisuuden käytöstä poistaminen
...
## <a name="to-post-a-disposal-from-the-fixed-asset-gl-journal"></a><a name="to-post-a-disposal-from-the-fixed-asset-gl-journal"></a>Luovutuksen kirjaaminen käyttöomaisuuden KP-päiväkirjasta
...
## <a name="to-view-disposal-ledger-entries"></a><a name="to-view-disposal-ledger-entries"></a>Luovutustapahtumien katsominen
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Lue aiheeseen liittyen [Microsoftin koulutukset](/training/modules/dispose-fixed-assets/)
