...
# <a name="set-up-fixed-assets-with-user-defined-depreciation-methods" />Käyttöomaisuuden määrittäminen käyttäjän määrittämien poistomenetelmien avulla
...
## <a name="to-assign-a-depreciation-book-to-a-fixed-asset-with-a-user-defined-depreciation-method" />Poistokirjan liittäminen käyttöomaisuuserään käyttäjän määrittämällä poistomenetelmällä
...
## <a name="to-set-up-user-defined-depreciation-methods" />Käyttäjäkohtaisten poistomenetelmien määrittäminen
...
### <a name="depreciation-based-on-number-of-units" />Yksiköiden lukumäärään perustuvat poistot
...
### <a name="example---user-defined-depreciation" />Esimerkki - käyttäjän määrittämä poisto
