...
## <a name="what-data-is-migrated" />Mitkä tiedot siirretään?

Seuraavat kunkin objektit tiedot siirretään:

### <a name="customers" />Asiakkaat
...
### <a name="chart-of-accounts" />Tilikartta
...
## <a name="file-size-requirements" />Tiedoston kokovaatimukset
...
## <a name="to-migrate-data" />Tietojen siirtäminen
...
## <a name="viewing-the-status-of-the-migration" />Siirron tilan tarkasteleminen
...
## <a name="how-to-avoid-double-posting" />Miten voit välttää kaksinkertaisen kirjauksen
...
## <a name="correcting-errors" />Virheiden korjaaminen
...
## <a name="verifying-data-after-migrating" />Tietojen tarkistaminen siirron jälkeen
...
## <a name="stopping-data-migration" />Tietojen siirron pysäyttäminen
