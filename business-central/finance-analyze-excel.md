...
ms.author: edupont
---
# <a name="analyzing-financial-statements-in-microsoft-excel"></a><a name="analyzing-financial-statements-in-microsoft-excel"></a>Rahoituslaskelmien analysointi Microsoft Excelissä
...
## <a name="getting-the-overview-and-the-details-in-excel"></a><a name="getting-the-overview-and-the-details-in-excel"></a>Yleiskuvan ja yksityiskohtien tarkastelu Excelissä
...
### <a name="understanding-the-excel-templates"></a><a name="understanding-the-excel-templates"></a>Excel-mallien ymmärtäminen
...
## <a name="the--excel-add-in"></a><a name="the--excel-add-in"></a>[!INCLUDE [prod_short](includes/prod_short.md)]in Excel-apuohjelma
