...
ms.author: edupont
---
# <a name="acquire-fixed-assets" />Hankittu käyttöomaisuus
...
## <a name="to-create-a-fixed-asset-and-acquire-it-automatically" />Käyttöomaisuuden luominen ja hankinta automaattisesti
...
## <a name="to-set-up-a-component-list-for-a-main-asset" />Komponenttiluetteloiden määrittäminen pääkäyttöomaisuuserälle
...
## <a name="to-post-a-fixed-asset-acquisition-manually-with-the-fixed-asset-gl-journal" />Käyttöomaisuuden hankinnan kirjaaminen manuaalisesti käyttöomaisuuden KP-päiväkirjan kanssa
...
## <a name="to-cancel-an-acquisition-cost-posting-for-one-fixed-asset" />Yhden käyttöomaisuuserän hankintamenon kirjauksen peruuttaminen
...
## <a name="to-post-the-salvage-value-together-with-the-acquisition-cost" />Jäännösarvon kirjaaminen yhdessä hankintamenon kanssa
...
## <a name="see-related-microsoft-trainingtrainingmodulespurchase-fixed-assets" />Lue aiheeseen liittyen [Microsoftin koulutukset](/training/modules/purchase-fixed-assets/)
