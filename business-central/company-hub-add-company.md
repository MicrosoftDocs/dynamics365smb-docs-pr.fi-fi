...
ms.author: edupont
---
# <a name="add-companies-to-your-company-hub" />Yritysten lisääminen yritystoimintoon
...
## <a name="environment-links" />Ympäristölinkit
...
## <a name="load-companies" />Lataa yritykset
