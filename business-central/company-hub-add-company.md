...
ms.author: edupont
---
# <a name="add-companies-to-your-company-hub"></a><a name="add-companies-to-your-company-hub"></a><a name="add-companies-to-your-company-hub"></a>Yritysten lisääminen yritystoimintoon
...
## <a name="environment-links"></a><a name="environment-links"></a><a name="environment-links"></a>Ympäristölinkit
...
## <a name="load-companies"></a><a name="load-companies"></a><a name="load-companies"></a>Lataa yritykset
