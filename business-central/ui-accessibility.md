...
ms.author: jswymer
---
# <a name="accessibility-and-keyboard-shortcuts"></a><a name="accessibility-and-keyboard-shortcuts"></a>Helppokäyttötoiminnot ja pikanäppäimet
...
## <a name="navigation"></a><a name="navigation"></a><a name="Navigation"></a> Siirtyminen
...
## <a name="headings-in-content"></a><a name="headings-in-content"></a><a name="Headings"></a>Sisällön otsikot
...
## <a name="image-and-links"></a><a name="image-and-links"></a><a name="Images"></a> Kuva ja linkit
...
## <a name="assistive-technologies"></a><a name="assistive-technologies"></a><a name="AssistiveTech"></a> Käyttöä tukevat tekniikat
...
## <a name="zoom"></a><a name="zoom"></a><a name="zoom"></a>Zoomaa
...
## <a name="tooltips"></a><a name="tooltips"></a>Työkaluvihjeet
...
#### <a name="accessing-tooltips"></a><a name="accessing-tooltips"></a>Työkaluvihjeiden käyttäminen
...
## <a name="for-more-accessibility-information"></a><a name="for-more-accessibility-information"></a>Lisätietoja helppokäyttötoiminnoista
