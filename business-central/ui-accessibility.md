...
ms.author: jswymer
---
# <a name="accessibility-and-keyboard-shortcuts" />Helppokäyttötoiminnot ja pikanäppäimet
...
## <a name="tooltips" />Työkaluvihjeet
...
#### <a name="accessing-tooltips" />Työkaluvihjeiden käyttäminen
...
## <a name="for-more-accessibility-information" />Lisätietoja helppokäyttötoiminnoista
