...
ms.author: edupont
---
# <a name="reconcile-customer-payments-with-the-cash-receipt-journal-or-from-customer-ledger-entries" />Asiakkaan maksujen täsmäyttäminen kassapäiväkirjan avulla tai asiakastapahtumista
...
## <a name="to-fill-and-post-a-cash-receipt-journal" />Kassapäiväkirjan täyttäminen ja kirjaaminen
...
## <a name="to-apply-a-payment-to-a-single-customer-ledger-entry" />Maksun kohdistaminen yhteen asiakastapahtumaan:
1. Valitse ![Lamppu, joka avaa Kerro-ominaisuuden.](media/ui-search/search_small.png "Kerro, mitä haluat tehdä") -kuvake, syötä **Kassapäiväkirja** ja valitse sitten vastaava linkki.
2. Valitse **Muokkaa päiväkirjaa** -toiminto.
...
## <a name="to-apply-a-payment-to-multiple-customer-ledger-entries" />Maksun kohdistaminen useaan asiakastapahtumaan:
1. Valitse ![Lamppu, joka avaa Kerro-ominaisuuden.](media/ui-search/search_small.png "Kerro, mitä haluat tehdä") -kuvake, syötä **Kassapäiväkirja** ja valitse sitten vastaava linkki.
2. Valitse **Muokkaa päiväkirjaa** -toiminto.
3. Syötä ensimmäiselle päiväkirjariville asianmukaiset tiedot kohdistettavasta tapahtumasta.
4. Syötä **Asiakirjatyyppi**-kenttään **Maksu**.
...
## <a name="to-apply-a-credit-memo-to-a-single-customer-ledger-entry" />Hyvityslaskun kohdistaminen yhteen asiakastapahtumaan:
...
## <a name="to-apply-a-credit-memo-to-multiple-customer-ledger-entries" />Hyvityslaskun kohdistaminen useaan asiakastapahtumaan:
1. Valitse ![Lamppu, joka avaa Kerro-ominaisuuden.](media/ui-search/search_small.png "Kerro, mitä haluat tehdä") -kuvake, syötä **Myyntihyvityslaskut** ja valitse sitten vastaava linkki.
2. Avaa haluamasi myyntihyvityslasku.
...
## <a name="to-apply-posted-customer-ledger-entries" />Kirjattujen asiakastapahtumien kohdistaminen:
...
## <a name="to-apply-customer-ledger-entries-in-different-currencies-to-one-another" />Erivaluuttaisten asiakastapahtumien kohdistaminen toisiinsa:
...
## <a name="to-correct-an-application-of-customer-entries" />Asiakkaan tapahtumien kohdistuksen korjaaminen
