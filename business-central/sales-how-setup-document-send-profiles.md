...
## <a name="to-set-up-a-document-sending-profile" />Asiakirjan lähetysprofiilin määrittäminen
...
## <a name="to-specify-a-sending-profile-on-a-customer-card" />Lähetysprofiilin määrittäminen asiakaskortilla
