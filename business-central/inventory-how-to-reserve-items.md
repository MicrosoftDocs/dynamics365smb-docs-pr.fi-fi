...
ms.author: edupont
---
# <a name="reserve-items" />Nimikkeiden varaaminen
...
## <a name="reserve-items-for-sales" />Varaa nimikkeitä myyntiä varten
...
## <a name="reserve-an-item-for-a-production-order-line" />Varaa nimikkeitä tuotantotilauksen rivejä varten
...
## <a name="reserve-items-for-production-order-components" />Varaa nimikkeitä tuotantotilauksen komponentteja varten
...
## <a name="change-a-reservation" />Muuta varausta
...
## <a name="cancel-a-reservation" />Peruuta varaus
...
## <a name="reserve-a-specific-serial-or-lot-number" />Varaa tietty sarja- tai eränumero
...
## <a name="see-related-microsoft-trainingtrainingmodulesmanage-outbound-serial-lot-numbers" />Lue aiheeseen liittyen [Microsoftin koulutukset](/training/modules/manage-outbound-serial-lot-numbers/)
