...
3. Valitse **Varattu varastosta** -kentässä jokin seuraavista vaihtoehdoista:
    
   |Kenttä  |Kuvaus  |
   |---------|---------|
   |Tyhjä     | Avointa määrää ei ole varattu lainkaan, tai se on varattu muista lähdeasiakirjoista, kuten ostotilauksista.        |
   |Täysi    |  Avoin määrä on varattu kokonaan saatavilla olevasta varastosta.       |
   |Osittainen     | Avoin määrä on varattu osittain saatavilla olevasta varastosta.        |

4. Täytä tarvittavat kentät. [!INCLUDE [tooltip-inline-tip_md](includes/tooltip-inline-tip_md.md)]
5. Valinnainen: Voit kohdistaa nimikkeet heti valitsemalla **Kohdista**-toiminnon.
6. Valitse jokaiselle vaiheelle jokin menettelytapa **Kohdistustapa**-sivulla
...
7. Jos haluat varata kaikki rivit, joilla **Hyväksy** on otettu käyttöön, valitse **Tee varaus** -toiminto.
