...
## <a name="change-the-user-setup"></a><a name="change-the-user-setup"></a><a name="change-the-user-setup"></a>Käyttäjäasetusten muuttaminen
...
### <a name="overview-of-involved-posting-date-setup"></a><a name="overview-of-involved-posting-date-setup"></a><a name="overview-of-involved-posting-date-setup"></a>Asiaankuuluvan kirjauspäivämäärän asetuksen yleiskuvaus
...
#### <a name="user-setup"></a><a name="user-setup"></a><a name="user-setup"></a>Käyttäjäasetukset
