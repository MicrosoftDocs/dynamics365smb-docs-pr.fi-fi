...
ms.author: edupont
---
# <a name="work-with-assembly-boms" />Kokoonpanon tuoterakenteiden käyttäminen
...
## <a name="to-create-an-assembly-bom" />Luo kokoonpanon tuoterakenne
...
## <a name="to-edit-assembly-boms" />Kokoonpanon tuoterakenteiden muokkaaminen
...
## <a name="to-view-components-and-resources-indented-according-to-the-bom-structure" />Kokoonpanonimikkeen osien ja resurssien näyttäminen tuoterakenteen perusteella sisennettyinä
...
## <a name="to-replace-the-assembly-item-with-its-components-on-document-lines" />Kokoonpanon korvaaminen sen osilla asiakirjariveillä
...
## <a name="to-calculate-the-standard-cost-of-an-assembly-item" />Kokoonpanonimikkeen vakiokustannusten laskeminen
...
## <a name="see-related-microsoft-trainingtrainingmodulesset-up-assembly-items-dynamics-365-business-central" />Lue aiheeseen liittyen [Microsoftin koulutukset](/training/modules/set-up-assembly-items-dynamics-365-business-central/).
