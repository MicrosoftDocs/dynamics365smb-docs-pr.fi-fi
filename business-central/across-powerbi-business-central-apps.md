...
### <a name="you-dont-have-a-power-bi-account" />Power BI -tiliä ei ole
...
### <a name="message-there-are-no-enabled-reports-choose-select-report-to-see-a-list-of-reports-that-you-can-display" />Sanoma: Käyttöönotettuja raportteja ei ole. Valitsemalla Valitse raportti saat näkyviin luettelon raporteista, joita voit tarkastella.
...
### <a name="parameter-validation-failed-please-make-sure-all-parameters-are-valid" />Parametrin tarkistus epäonnistui. Varmista, että kaikki parametrit ovat sallittuja.
...
### <a name="cant-sign-in" />Sisäänkirjautuminen ei onnistu
...
### <a name="message-your-data-source-cant-be-refreshed-because-the-credentials-are-invalid-please-update-your-credentials-and-try-again" />Sanoma: Tietolähdettäsi ei voi päivittää, koska tunnistetiedot ovat virheelliset. Päivitä tunnistetietosi ja yritä uudelleen.
...
### <a name="incorrect-company-name" />Virheellinen yrityksen nimi
...
### <a name="the-key-didnt-match-any-rows-in-the-table" />Avain ei vastannut mitään taulukon riviä
...
### <a name="historical-data-appears-to-be-missing" />Historiatietoja näyttää puuttuvan
...
### <a name="i-only-see-data-for-a-single-company" />Vain yhden yrityksen tiedot näkyvät
...
### <a name="what-now" />Mitä seuraavaksi?
