...
ms.author: jswymer
---
# <a name="use-the--apps-in-power-bi"></a><a name="use-the--apps-in-power-bi"></a><a name="use-the--apps-in-power-bi"></a>[!INCLUDE [prod_short](includes/prod_short.md)] -sovellusten käyttäminen Power BI:ssa
...
## <a name="get-ready"></a><a name="get-ready"></a><a name="get-ready"></a>Valmistelut
...
## <a name="install-a--app-in-power-bi"></a><a name="install-a--app-in-power-bi"></a><a name="install-a--app-in-power-bi"></a>[!INCLUDE[prod_short](includes/prod_short.md)] -asentaminen Power BI:ssa
...
## <a name="connect-the--app-to-your-data"></a><a name="connect-the--app-to-your-data"></a><a name="connect-the--app-to-your-data"></a>[!INCLUDE[prod_short](includes/prod_short.md)] -sovelluksen yhdistäminen tietoihin
...
## <a name="fixing-problems"></a><a name="fixing-problems"></a><a name="fixing-problems"></a>Ongelmien korjaaminen
...
### <a name="you-dont-have-a-power-bi-account"></a><a name="you-dont-have-a-power-bi-account"></a><a name="you-dont-have-a-power-bi-account"></a>Power BI -tiliä ei ole
...
### <a name="message-there-are-no-enabled-reports-choose-select-report-to-see-a-list-of-reports-that-you-can-display"></a><a name="message-there-are-no-enabled-reports-choose-select-report-to-see-a-list-of-reports-that-you-can-display"></a><a name="message-there-are-no-enabled-reports-choose-select-report-to-see-a-list-of-reports-that-you-can-display"></a>Sanoma: Käyttöönotettuja raportteja ei ole. Valitsemalla Valitse raportti saat näkyviin luettelon raporteista, joita voit tarkastella.
...
### <a name="you-need-a-power-bi-pro-license-to-install-the--app-in-power-bi"></a><a name="you-need-a-power-bi-pro-license-to-install-the--app-in-power-bi"></a><a name="you-need-a-power-bi-pro-license-to-install-the--app-in-power-bi"></a>[!INCLUDE[prod_short](includes/prod_short.md)] -sovelluksen asentaminen Power BI:ihin edellyttää Power BI Pro -käyttöoikeutta.
...
### <a name="cant-sign-in"></a><a name="cant-sign-in"></a><a name="cant-sign-in"></a>Sisäänkirjautuminen ei onnistu
...
### <a name="incorrect-company-name"></a><a name="incorrect-company-name"></a><a name="incorrect-company-name"></a>Virheellinen yrityksen nimi
...
### <a name="the-key-didnt-match-any-rows-in-the-table"></a><a name="the-key-didnt-match-any-rows-in-the-table"></a><a name="the-key-didnt-match-any-rows-in-the-table"></a>Avain ei vastannut mitään taulukon riviä
...
### <a name="historical-data-appears-to-be-missing"></a><a name="historical-data-appears-to-be-missing"></a><a name="historical-data-appears-to-be-missing"></a>Historiatietoja näyttää puuttuvan
...
### <a name="i-only-see-data-for-a-single-company"></a><a name="i-only-see-data-for-a-single-company"></a><a name="i-only-see-data-for-a-single-company"></a>Vain yhden yrityksen tiedot näkyvät
...
### <a name="what-now"></a><a name="what-now"></a><a name="what-now"></a>Mitä seuraavaksi?
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Lue aiheeseen liittyen [Microsoftin koulutukset](/training/modules/configure-powerbi-excel-dynamics-365-business-central/index)
