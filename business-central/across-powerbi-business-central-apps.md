...
## <a name="install-a-prod_short-app-in-power-bi"></a>[!INCLUDE[prod_short](includes/prod_short.md)] -asentaminen Power BI:ssa
...
## <a name="connect-the-prod_short-app-to-your-data"></a>[!INCLUDE[prod_short](includes/prod_short.md)] -sovelluksen yhdistäminen tietoihin
...
### <a name="you-need-a-power-bi-pro-license-to-install-the-prod_short-app-in-power-bi"></a>[!INCLUDE[prod_short](includes/prod_short.md)] -sovelluksen asentaminen Power BI:ihin edellyttää Power BI Pro -käyttöoikeutta.
