...
ms.author: edupont
---
# <a name="setting-up-purchasing"></a><a name="setting-up-purchasing"></a>Ostojen määrittäminen
...
## <a name="purchases-and-payables-setup"></a><a name="purchases-and-payables-setup"></a>Ostojen ja ostovelkojen asetukset
...
### <a name="general-settings"></a><a name="general-settings"></a>Yleiset asetukset
...
### <a name="number-series-settings"></a><a name="number-series-settings"></a>Numerosarjojen asetukset
...
## <a name="exact-cost-reversing"></a><a name="exact-cost-reversing"></a>Todellisten kustannusten peruuttaminen
...
## <a name="more-purchasing-setups"></a><a name="more-purchasing-setups"></a>Lisää ostojen asetuksia
...
## <a name="see-related-training-at-microsoft-learn"></a><a name="see-related-training-at-microsoft-learn"></a>Lisätietoja aiheeseen liittyvistä kursseista on [Microsoft Learnissa](/learn/paths/trade-get-started-dynamics-365-business-central/).
