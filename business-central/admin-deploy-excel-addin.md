...
ms.author: jswymer
---
# <a name="get-the-business-central-add-in-for-excel" />Business Central -apuohjelman hankkiminen Exceliin
...
### <a name="about-the-add-in" />Tietoja apuohjelmasta
...
### <a name="about-deployment-as-an-admin" />Tietoja käyttöönotosta ylläpitäjänä
...
### <a name="a-nameswitchaswitching-from-individual-acquisition-to-centralized-deployment-or-the-other-way-around" /><a name="switch"></a>Siirtyminen yksittäisestä hankinnasta keskitettyyn käyttöönottoon tai toisin päin
...
## <a name="preparation-on-premises-only" />Valmistelu (vain on-premises)
...
## <a name="deploy-the-add-in-by-using-centralized-deployment" />Apuohjelman käyttöönottaminen keskitetyn käyttöönoton avulla
...
### <a name="before-you-begin" />Alkutoimet
...
### <a name="set-up-centralized-deployment-of-the-add-in" />Määritä apuohjelman keskitetty käyttöönotto
...
## <a name="a-nameinstallaindividual-acquisition-install-the-add-in-manually-for-your-own-use" /><a name="install"></a>Yksittäinen hankinta: Asenna apuohjelma manuaalisesti omaan käyttöön
...
### <a name="configure-the-business-central-connection" />Business Central -yhteyden määrittäminen
...
## <a name="prepare-devices-and-network-for-the-excel-add-in" />Valmistele laitteet ja verkko Excel-apuohjelmaa varten
