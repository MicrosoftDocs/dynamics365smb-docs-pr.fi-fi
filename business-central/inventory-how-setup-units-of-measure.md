...
ms.author: edupont
---
# <a name="set-up-units-of-measure" />Mittayksikön määrittäminen
...
## <a name="to-set-up-units-of-measure" />Mittayksikön määrittäminen
...
## <a name="to-set-up-multiple-item-units-of-measure" />Useiden nimikkeiden mittayksikön määrittäminen
...
## <a name="to-set-up-unit-of-measure-translations" />Mittayksikön käännösten määrittäminen
...
## <a name="to-enter-a-default-unit-of-measure-code-for-sales-and-purchasing-transactions" />Oletusmittayksikön koodien määrittäminen myynti- ja ostotapahtumille
