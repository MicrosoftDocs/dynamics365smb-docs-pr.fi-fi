...
ms.author: edupont
---
# <a name="register-employees" />Työntekijöiden rekisteröiminen
...
## <a name="adding-new-employees" />Uusien työntekijöiden lisääminen
...
## <a name="to-set-up-an-employee" />Työntekijän määrittäminen
...
## <a name="to-insert-a-picture-of-an-employee" />Työntekijän kuvan lisääminen
...
## <a name="to-register-various-information-about-an-employee" />Työntekijää koskevien erilaisten tietojen rekisteröiminen
