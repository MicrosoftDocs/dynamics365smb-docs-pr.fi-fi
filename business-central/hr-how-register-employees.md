...
ms.author: edupont
---
# <a name="register-employees"></a><a name="register-employees"></a>Työntekijöiden rekisteröiminen
...
## <a name="adding-new-employees"></a><a name="adding-new-employees"></a>Uusien työntekijöiden lisääminen
...
## <a name="to-set-up-an-employee"></a><a name="to-set-up-an-employee"></a>Työntekijän määrittäminen
...
## <a name="to-insert-a-picture-of-an-employee"></a><a name="to-insert-a-picture-of-an-employee"></a>Työntekijän kuvan lisääminen
...
## <a name="to-register-various-information-about-an-employee"></a><a name="to-register-various-information-about-an-employee"></a>Työntekijää koskevien erilaisten tietojen rekisteröiminen
