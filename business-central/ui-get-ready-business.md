...
ms.author: edupont
---
# <a name="get-ready-for-doing-business"></a><a name="get-ready-for-doing-business"></a><a name="get-ready-for-doing-business"></a>Valmistautuminen liiketoimintaan
...
## <a name="teaching-tips-and-tours"></a><a name="teaching-tips-and-tours"></a><a name="teaching-tips-and-tours"></a>Opastusvihjeet ja esittelyt
...
## <a name="role-specific-home-pages"></a><a name="role-specific-home-pages"></a><a name="role-specific-home-pages"></a>Roolikohtaiset aloitussivut
...
## <a name="company-information"></a><a name="company-information"></a><a name="company-information"></a>Yrityksen tiedot
...
## <a name="adding-users-and-permissions"></a><a name="adding-users-and-permissions"></a><a name="adding-users-and-permissions"></a>Käyttäjien ja käyttöoikeuksien lisääminen
...
## <a name="product-help"></a><a name="product-help"></a><a name="product-help"></a>Tuotteen ohje

[!INCLUDE [ua-get-help](includes/ua-get-help.md)] Lisätietoja on kohdassa [Ohje- ja tukiresurssit](product-help-and-support.md).  

### <a name="set-up-your-company-in-"></a><a name="set-up-your-company-in-"></a><a name="set-up-your-company-in-"></a>Määritä oma yritys [!INCLUDE[prod_short](includes/prod_short.md)] -ratkaisussa
...
[Microsoftin koulutus](/training/dynamics365/business-central?WT.mc_id=dyn365bc_landingpage-docs)  
