...
---
# <a name="create-production-orders-from-sales-orders" />Tuotantotilausten luominen myyntitilauksista

Voit luoda tuotettujen nimikkeiden tuotantotilaukset suodaan myyntitilauksista.  

## <a name="to-create-a-production-order-from-a-sales-order" />Tuotantotilausten luominen myyntitilauksista
...
## <a name="order-type" />Tilaustyyppi
