...
ms.author: edupont
---
# <a name="walkthrough-calculating-work-in-process-for-a-job" />Vaihekuvaus: Projektin keskeneräisen työn laskeminen
...
## <a name="calculating-wip" />Keskeneräisen työn laskeminen
...
### <a name="to-calculate-wip" />Keskeneräisen työn laskeminen
...
### <a name="to-review-wip-warnings" />Tarkastele KET-varoituksia
...
### <a name="to-recalculate-wip" />Keskeneräisen työn uudelleenlaskeminen
...
## <a name="posting-wip-to-general-ledger" />Keskeneräisen työn kirjaaminen pääkirjanpitoon

 Kun Marianne on laskenut tämän projektin keskeneräisen työn, hän voi kirjata sen pääkirjanpitoon.  

### <a name="to-post-wip-to-general-ledger" />KET-arvon kirjaaminen pääkirjanpitoon
...
## <a name="reversing-a-wip-posting" />KET-kirjauksen peruuttaminen
...
### <a name="to-reverse-a-wip-posting" />KET-kirjauksen peruuttaminen
...
## <a name="see-related-microsoft-trainingtrainingpathscalculate-post-job-wip" />Lue aiheeseen liittyen [Microsoftin koulutukset](/training/paths/calculate-post-job-wip/)
