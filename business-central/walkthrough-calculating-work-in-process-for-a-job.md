...
ms.author: edupont
---
# <a name="walkthrough-calculating-work-in-process-for-a-job"></a><a name="walkthrough-calculating-work-in-process-for-a-job"></a><a name="walkthrough-calculating-work-in-process-for-a-job"></a>Vaihekuvaus: Projektin keskeneräisen työn laskeminen
...
## <a name="calculating-wip"></a><a name="calculating-wip"></a><a name="calculating-wip"></a>Keskeneräisen työn laskeminen
...
### <a name="to-calculate-wip"></a><a name="to-calculate-wip"></a><a name="to-calculate-wip"></a>Keskeneräisen työn laskeminen
...
### <a name="to-review-wip-warnings"></a><a name="to-review-wip-warnings"></a><a name="to-review-wip-warnings"></a>Tarkastele KET-varoituksia
...
### <a name="to-recalculate-wip"></a><a name="to-recalculate-wip"></a><a name="to-recalculate-wip"></a>Keskeneräisen työn uudelleenlaskeminen
...
## <a name="posting-wip-to-general-ledger"></a><a name="posting-wip-to-general-ledger"></a><a name="posting-wip-to-general-ledger"></a>Keskeneräisen työn kirjaaminen pääkirjanpitoon

 Kun Marianne on laskenut tämän projektin keskeneräisen työn, hän voi kirjata sen pääkirjanpitoon.  

### <a name="to-post-wip-to-general-ledger"></a><a name="to-post-wip-to-general-ledger"></a><a name="to-post-wip-to-general-ledger"></a>KET-arvon kirjaaminen pääkirjanpitoon
...
## <a name="reversing-a-wip-posting"></a><a name="reversing-a-wip-posting"></a><a name="reversing-a-wip-posting"></a>KET-kirjauksen peruuttaminen
...
### <a name="to-reverse-a-wip-posting"></a><a name="to-reverse-a-wip-posting"></a><a name="to-reverse-a-wip-posting"></a>KET-kirjauksen peruuttaminen
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Lue aiheeseen liittyen [Microsoftin koulutukset](/training/paths/calculate-post-job-wip/)
