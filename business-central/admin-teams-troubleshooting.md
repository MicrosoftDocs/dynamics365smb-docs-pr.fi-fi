...
# <a name="troubleshooting-microsoft-teams-integration-with-include-prodshortincludesprodshortmd" />[!INCLUDE [prod_short](includes/prod_short.md)] ja Microsoft Teamsin integroinnin vianmääritys
...
## <a name="the-sign-in-link-doesnt-work" />Sisäänkirjautumislinkki ei toimi
...
## <a name="the-settings-page-is-empty" />Asetukset-sivu on tyhjä
...
## <a name="i-changed-company-but-it-didnt-seem-to-work" />Yrityksen vaihtaminen ei näytä onnistuneen
...
## <a name="something-went-wrong-error-when-searching-for-contacts" />Tapahtui virhe -ilmoitus yhteyshenkilöitä haettaessa
...
## <a name="cannot-find-the-contactcontact-summary-api-error-when-searching-for-contacts" />Yhteyshenkilön tai yhteyshenkilön yhteenvedon ohjelmointirajapintaa ei löydy -virhe, kun yhteyshenkilöitä haetaan
...
## <a name="none-of-my-links-expand-into-a-card" />Yksikään linkkini ei laajennu kortiksi
...
## <a name="my-link-sometimes-doesnt-expand-into-a-card" />Linkki ei aina laajennu kortiksi
...
## <a name="the-details-window-opens-but-shows-an-error-before-details-are-shown" />Tiedot-ikkuna aukeaa, mutta näyttöön tulee virhe, ennen kuin tiedot näkyvät
...
## <a name="im-having-problems-with-the-camera-or-location-in-teams" />Minulla on ongelmia kameran tai sijainnin kanssa Teamsissa
...
## <a name="teams-displays-mixed-languages-for-my-cards-and-card-details" />Teams näyttää useita kieliä korteissani ja korttien tiedoissa
...
## <a name="i-edited-a-field-in-the-details-window-but-my-change-wasnt-saved" />Muokkasin tietoikkunan kenttä, mutta muutosta ei tallennettu
...
## <a name="a-new-tile-appeared-in-the-app-launcher-how-do-i-remove-it" />Uusi ruutu ilmestyi sovelluksen käynnistimeen. Miten poistan sen?
...
## <a name="duplicate-text-in-the-share-to-teams-window" />Monista teksti Jaa Teamsiin -ikkunassa
...
## <a name="unable-to-sign-into-the-share-to-teams-window" />Jaa Teamsiin -ikkunaan ei voi kirjautua.
...
## <a name="my-cards-no-longer-have-a-popout-button" />Kortteissani ei ole enää ponnahduspainiketta
...
## <a name="cant-pin-a-card-to-tab" />Kortin kiinnittäminen välilehteen ei onnistu
...
## <a name="someone-added-a-tab-but-the-tab-doesnt-show-up-for-me" />Joku lisäsi välilehden, mutta välilehti ei näy minulle
...
## <a name="others-see-different-sorting-or-column-layout-than-what-the-tab-author-sees" />Toiset näkevät eri lajittelu- tai sarakeasettelun kuin välilehden tekijä näkee
