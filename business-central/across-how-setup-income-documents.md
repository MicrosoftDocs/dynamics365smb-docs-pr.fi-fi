...
ms.author: edupont
---
# <a name="set-up-incoming-documents"></a><a name="set-up-incoming-documents"></a>Määritä saapuvat asiakirjat
...
## <a name="to-set-up-the-incoming-documents-feature"></a><a name="to-set-up-the-incoming-documents-feature"></a>Saapuvat asiakirjat -ominaisuuden määrittäminen
...
## <a name="to-set-up-approvers-of-incoming-document-records"></a><a name="to-set-up-approvers-of-incoming-document-records"></a>Saapuvien asiakirjatietueiden hyväksyjien määrittäminen
...
## <a name="to-set-up-an-ocr-service"></a><a name="to-set-up-an-ocr-service"></a>OCR-palvelun määrittäminen
