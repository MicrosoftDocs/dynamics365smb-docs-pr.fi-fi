...
ms.author: edupont
---
# <a name="set-up-incoming-documents" />Määritä saapuvat asiakirjat
...
## <a name="to-set-up-the-incoming-documents-feature" />Saapuvat asiakirjat -ominaisuuden määrittäminen
...
## <a name="to-set-up-approvers-of-incoming-document-records" />Saapuvien asiakirjatietueiden hyväksyjien määrittäminen
...
## <a name="to-set-up-an-ocr-service" />OCR-palvelun määrittäminen
