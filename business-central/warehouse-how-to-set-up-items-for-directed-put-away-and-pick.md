...
ms.author: bholtorf
---
# <a name="set-up-items-and-locations-for-directed-put-away-and-pick" />Nimikkeiden ja sijaintien määrittäminen ohjattua hyllytystä ja poimintaa varten
...
## <a name="to-set-up-an-item-for-directed-put-away-and-pick" />Nimikkeen määritys ohjattua hyllytystä ja poimintaa varten
...
## <a name="to-start-using-directed-put-away-and-pick" />Ohjatun hyllytyksen ja poiminnan käytön aloittaminen
...
## <a name="to-set-up-a-zone-in-your-warehouse" />Alueen määrittäminen fyysiseen varastoon
