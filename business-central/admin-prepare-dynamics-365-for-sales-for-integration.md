...
## <a name="integrating-through-dataverse" />Integroiminen Dataverse -palvelun avulla
...
### <a name="connection-settings-in-the-setup-guide" />Yhteysasetukset asennusoppaassa
...
### <a name="standard-sales-entity-mapping-for-synchronization" />Synkronoinnin Myynti-entiteetin yhdistämismääritys
...
## <a name="synchronizing-items-and-resources-with-products-with-different-units-of-measure" />Nimikkeiden ja resurssien synkronointi eri mittayksiköitä käyttävien tuotteiden kanssa
...
### <a name="mapping-items-and-resources-to-products" />Nimikkeiden ja resurssien yhdistäminen tuotteisiin
...
### <a name="synchronization-jobs-for-a-sales-integration" />Myynnin integroinnin synkronointityöt
...
### <a name="default-synchronization-job-queue-entries" />Oletusarvoiset synkronoinnin työjonotapahtumat
