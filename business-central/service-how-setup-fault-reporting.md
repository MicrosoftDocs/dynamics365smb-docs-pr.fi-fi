...
# <a name="set-up-fault-reporting" />Vian raportoinnin määrittäminen
...
## <a name="to-specify-the-overall-level-of-fault-reporting" />Vian raportoinnin yleisen tason määrittäminen
...
## <a name="to-create-fault-and-resolution-code-relationships" />Vika- ja ratkaisukoodien suhteiden luominen
