...
# <a name="set-up-fault-reporting"></a><a name="set-up-fault-reporting"></a>Vian raportoinnin määrittäminen
...
## <a name="to-specify-the-overall-level-of-fault-reporting"></a><a name="to-specify-the-overall-level-of-fault-reporting"></a>Vian raportoinnin yleisen tason määrittäminen
...
## <a name="to-create-fault-and-resolution-code-relationships"></a><a name="to-create-fault-and-resolution-code-relationships"></a>Vika- ja ratkaisukoodien suhteiden luominen
