...
ms.author: edupont
---
# <a name="create-contacts" />Kontaktien luominen
...
## <a name="to-create-a-contact-manually" />Kontaktin luominen manuaalisesti
...
## <a name="to-create-a-contact-from-a-customer-vendor-or-bank-account" />Kontaktin luominen asiakkaana, toimittajana tai pankkitilinä.
...
## <a name="to-create-a-customer-vendor-employee-or-bank-account-from-a-contact" />Asiakkaan, toimittajan, työntekijän tai pankkitilin luominen yhteyshenkilöstä
...
## <a name="to-link-a-contact-to-an-existing-customer-vendor-employee-or-bank-account" />Kontaktin linkittäminen olemassa olevaan asiakkaaseen, toimittajaan, työntekijään tai pankkitiliin
...
## <a name="to-remove-a-link-between-a-contact-and-an-existing-customer-vendor-employee-or-bank-account" />Kontaktin linkin poistaminen olemassa olevasta asiakkaasta, toimittajasta, työntekijästä tai pankkitilistä
...
## <a name="synchronizing-contacts-with-customers-vendors-employees-and-bank-accounts" />Kontaktien synkronoiminen asiakkaiden, toimittajien, työntekijöiden ja pankkitilien kanssa
...
## <a name="to-view-which-customer-vendor-employee-or-bank-account-a-contact-is-related-to" />Tarkistetaan, mihin asiakkaaseen, toimittajaan, työntekijään tai pankkitiliin yhteyshenkilö liittyy
