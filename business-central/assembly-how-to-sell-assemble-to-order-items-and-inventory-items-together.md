...
---
# <a name="sell-assemble-to-order-items-and-inventory-items-together" />Kokoonpano tilausta varten -nimikkeiden ja varastonimikkeiden myyminen yhdessä
...
## <a name="to-sell-assemble-to-order-items-and-inventory-items-together" />Myy kokoonpano tilausta varten -nimikkeitä ja varastonimikkeitä yhdessä
