...
ms.author: edupont
---
# <a name="design-details-posting-date-on-adjustment-value-entry"></a><a name="design-details-posting-date-on-adjustment-value-entry"></a>Rakennetiedot: Muutoksen arvotapahtuman kirjauspäivämäärä
...
## <a name="how-posting-dates-are-assigned"></a><a name="how-posting-dates-are-assigned"></a>Miten kirjauspäivämäärät määritellään
...
#### <a name="item-ledger-entry"></a><a name="item-ledger-entry"></a>Nimiketapahtuma
...
#### <a name="inventory-periods"></a><a name="inventory-periods"></a>Varastokaudet
...
#### <a name="general-ledger-setup"></a><a name="general-ledger-setup"></a>Pääkirjanpidon asetukset
...
## <a name="common-problems-with-the-adjust-cost---item-entries-batch-job"></a><a name="common-problems-with-the-adjust-cost---item-entries-batch-job"></a>Yleisiä ongelmia Muuta kustannuksia - Nimiketapahtumat -eräajossa

On olemassa kaksi skenaariota, joita tuki tiimi kohtaa niin usein, että niillä on omat ongelmanratkaisuartikkelinsa.

### <a name="error-message-posting-date-is-not-within-your-range-of-allowed-posting-dates"></a><a name="error-message-posting-date-is-not-within-your-range-of-allowed-posting-dates"></a>Virhesanoma: "Kirjauspäivämäärä ei kuulu sallittujen kirjauspäivämäärien alueeseen..."
