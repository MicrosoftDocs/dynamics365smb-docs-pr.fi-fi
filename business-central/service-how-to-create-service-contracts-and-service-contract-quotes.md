...
ms.author: bholtorf
---
# <a name="work-with-service-contracts-and-service-contract-quotes" />Huoltosopimusten ja huoltosopimustarjousten käyttäminen
...
## <a name="to-create-a-service-contract-or-service-contract-quote" />Huoltosopimuksen tai -sopimustarjouksen luominen
...
## <a name="to-convert-a-service-contract-quote-to-service-contract" />Huoltosopimustarjousten muuntaminen huoltosopimuksiksi
...
## <a name="to-create-contract-service-credit-memos" />Huoltosopimuksen hyvityslaskujen luominen
...
## <a name="updating-and-evaluating-contracts" />Sopimusten päivittäminen ja arvioiminen
...
## <a name="to-add-a-contract-line-to-a-service-contract-or-contract-quote" />Sopimusrivien lisääminen huoltosopimukseen tai sopimustarjoukseen:
...
## <a name="to-remove-contract-lines" />Sopimusrivien poistaminen
...
## <a name="service-line-cost-and-value" />Huoltorivin kustannus ja arvo
...
## <a name="to-add-a-contract-discount-to-service-contract-quotes" />Sopimusalennusten lisääminen huoltosopimustarjouksiin
...
## <a name="to-change-the-owner-of-a-service-contract" />Huoltosopimusten haltijan vaihtaminen
...
## <a name="to-update-a-service-contract-price" />Päivitä huoltosopimuksen hinnat
...
## <a name="to-post-prepaid-contract-entries" />Ennakkoon maksettujen sopimustapahtumien kirjaaminen
...
## <a name="changing-the-service-contract-status" />Huoltosopimuksen tilan muuttaminen
...
## <a name="to-cancel-a-service-contract" />Sopimuksen peruuttaminen
...
## <a name="filing-a-service-contract-or-contract-quote" />Huoltosopimuksen ja sopimustarjouksen arkistoiminen
