...
ms.author: bholtorf
---
# <a name="work-with-service-contracts-and-service-contract-quotes"></a><a name="work-with-service-contracts-and-service-contract-quotes"></a>Huoltosopimusten ja huoltosopimustarjousten käyttäminen
...
## <a name="to-create-a-service-contract-or-service-contract-quote"></a><a name="to-create-a-service-contract-or-service-contract-quote"></a>Huoltosopimuksen tai -sopimustarjouksen luominen
...
## <a name="to-convert-a-service-contract-quote-to-service-contract"></a><a name="to-convert-a-service-contract-quote-to-service-contract"></a>Huoltosopimustarjousten muuntaminen huoltosopimuksiksi
...
## <a name="to-create-contract-service-credit-memos"></a><a name="to-create-contract-service-credit-memos"></a>Huoltosopimuksen hyvityslaskujen luominen
...
## <a name="updating-and-evaluating-contracts"></a><a name="updating-and-evaluating-contracts"></a>Sopimusten päivittäminen ja arvioiminen
...
## <a name="to-add-a-contract-line-to-a-service-contract-or-contract-quote"></a><a name="to-add-a-contract-line-to-a-service-contract-or-contract-quote"></a>Sopimusrivien lisääminen huoltosopimukseen tai sopimustarjoukseen:
...
## <a name="to-remove-contract-lines"></a><a name="to-remove-contract-lines"></a>Sopimusrivien poistaminen
...
## <a name="service-line-cost-and-value"></a><a name="service-line-cost-and-value"></a>Huoltorivin kustannus ja arvo
...
## <a name="to-add-a-contract-discount-to-service-contract-quotes"></a><a name="to-add-a-contract-discount-to-service-contract-quotes"></a>Sopimusalennusten lisääminen huoltosopimustarjouksiin
...
## <a name="to-change-the-owner-of-a-service-contract"></a><a name="to-change-the-owner-of-a-service-contract"></a>Huoltosopimusten haltijan vaihtaminen
...
## <a name="to-update-a-service-contract-price"></a><a name="to-update-a-service-contract-price"></a>Päivitä huoltosopimuksen hinnat
...
## <a name="to-post-prepaid-contract-entries"></a><a name="to-post-prepaid-contract-entries"></a>Ennakkoon maksettujen sopimustapahtumien kirjaaminen
...
## <a name="changing-the-service-contract-status"></a><a name="changing-the-service-contract-status"></a>Huoltosopimuksen tilan muuttaminen
...
## <a name="to-cancel-a-service-contract"></a><a name="to-cancel-a-service-contract"></a>Sopimuksen peruuttaminen
...
## <a name="filing-a-service-contract-or-contract-quote"></a><a name="filing-a-service-contract-or-contract-quote"></a>Huoltosopimuksen ja sopimustarjouksen arkistoiminen
