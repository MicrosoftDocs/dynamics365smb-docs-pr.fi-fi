...
ms.author: edupont
---
# <a name="create-a-demand-forecast"></a><a name="create-a-demand-forecast"></a><a name="create-a-demand-forecast"></a>Kysyntäennusteen luominen
...
## <a name="sales-forecasts-and-production-forecasts"></a><a name="sales-forecasts-and-production-forecasts"></a><a name="sales-forecasts-and-production-forecasts"></a>Myyntiennusteet ja tuotantoennusteet
...
## <a name="component-forecast"></a><a name="component-forecast"></a><a name="component-forecast"></a>Komponenttiennuste
...
## <a name="forecasting-periods"></a><a name="forecasting-periods"></a><a name="forecasting-periods"></a>Ennustejaksot
...
## <a name="forecast-by-locations"></a><a name="forecast-by-locations"></a><a name="forecast-by-locations"></a>Ennusteet sijainnin mukaan
...
### <a name="use-forecast-by-locations"></a><a name="use-forecast-by-locations"></a><a name="use-forecast-by-locations"></a>Käytä ennusteita sijaintien mukaan
...
### <a name="do-not-use-forecast-by-locations"></a><a name="do-not-use-forecast-by-locations"></a><a name="do-not-use-forecast-by-locations"></a>Älä käytä ennusteita sijaintien mukaan
...
## <a name="to-create-a-demand-forecast"></a><a name="to-create-a-demand-forecast"></a><a name="to-create-a-demand-forecast"></a>Kysyntäennusteen luominen
