...
# <a name="the-data-archive-extension"></a><a name="the-data-archive-extension"></a>Tietoarkisto-laajennus
...
## <a name="start-archiving-data"></a><a name="start-archiving-data"></a>Tietojen arkistoinnin aloittaminen
...
## <a name="storage-considerations"></a><a name="storage-considerations"></a>Huomioitavaa tallennuksesta
