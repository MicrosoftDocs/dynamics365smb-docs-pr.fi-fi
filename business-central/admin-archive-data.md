...
# <a name="the-data-archive-extension" />Tietoarkisto-laajennus
...
## <a name="start-archiving-data" />Tietojen arkistoinnin aloittaminen
...
## <a name="storage-considerations" />Huomioitavaa tallennuksesta
