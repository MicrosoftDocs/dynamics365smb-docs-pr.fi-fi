...
ms.author: jswymer
---
# <a name="change-basic-settings" />Perusasetusten muuttaminen
...
### <a name="change-the-role" />Roolin vaihtaminen
...
### <a name="work-date-indication" />Käsittelypäivämäärän ilmaiseminen
...
## <a name="notifications" />Ilmoitukset
...
## <a name="teaching-tips" />Opetusvinkkejä
