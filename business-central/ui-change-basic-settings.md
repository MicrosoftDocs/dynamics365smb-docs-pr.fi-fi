...
ms.author: jswymer
---
# <a name="change-basic-settings"></a><a name="change-basic-settings"></a>Perusasetusten muuttaminen
...
## <a name="role"></a><a name="role"></a><a name="role-center"></a>Rooli
...
### <a name="change-the-role"></a><a name="change-the-role"></a>Roolin vaihtaminen
...
## <a name="company"></a><a name="company"></a><a name="company"></a>Oma yritys
...
## <a name="work-date"></a><a name="work-date"></a><a name="work-date"></a>Käsittelypäivämäärä
...
### <a name="work-date-indication"></a><a name="work-date-indication"></a>Käsittelypäivämäärän ilmaiseminen
...
## <a name="region"></a><a name="region"></a><a name="region"></a> Alue
...
## <a name="language"></a><a name="language"></a><a name="language"></a> Kieli
...
## <a name="time-zone"></a><a name="time-zone"></a>Aikavyöhyke
...
## <a name="notifications"></a><a name="notifications"></a>Ilmoitukset
...
## <a name="teaching-tips"></a><a name="teaching-tips"></a>Opetusvinkkejä
