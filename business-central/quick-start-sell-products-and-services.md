...
# <a name="sales-quick-start" />Myynnin pika-aloitus
...
## <a name="set-up-items-to-sell" />Myytävien nimikkeiden määrittäminen
...
### <a name="set-up-a-new-item" />Määritä uusi nimike
...
## <a name="set-up-customers" />Asiakkaiden määrittäminen
...
### <a name="set-up-a-new-customer" />Uuden asiakkaan määrittäminen
...
## <a name="create-a-sales-order" />Luo myyntitilaus
...
### <a name="to-create-a-sales-order" />Myyntitilauksen luominen
...
## <a name="create-a-sales-invoice" />Luo myyntilasku
...
### <a name="to-create-and-post-a-sales-invoice" />Luo ja kirjaa myyntilasku seuraavasti
