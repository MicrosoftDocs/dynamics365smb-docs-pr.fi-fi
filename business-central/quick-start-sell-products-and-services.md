...
# <a name="sales-quick-start"></a><a name="sales-quick-start"></a>Myynnin pika-aloitus
...
## <a name="set-up-items-to-sell"></a><a name="set-up-items-to-sell"></a>Myytävien nimikkeiden määrittäminen
...
### <a name="set-up-a-new-item"></a><a name="set-up-a-new-item"></a>Määritä uusi nimike
...
## <a name="set-up-customers"></a><a name="set-up-customers"></a>Asiakkaiden määrittäminen
...
### <a name="set-up-a-new-customer"></a><a name="set-up-a-new-customer"></a>Uuden asiakkaan määrittäminen
...
### <a name="to-create-a-sales-order"></a><a name="to-create-a-sales-order"></a>Myyntitilauksen luominen
...
## <a name="create-a-sales-invoice"></a><a name="create-a-sales-invoice"></a>Luo myyntilasku
...
### <a name="to-create-and-post-a-sales-invoice"></a><a name="to-create-and-post-a-sales-invoice"></a>Luo ja kirjaa myyntilasku seuraavasti
