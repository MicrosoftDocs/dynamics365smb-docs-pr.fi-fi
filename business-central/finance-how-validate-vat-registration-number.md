...
# <a name="validate-vat-registration-numbers" />ALV-rekisterinumeroiden vahvistaminen
...
## <a name="configure-the-service-to-verify-vat-registration-numbers-automatically" />Määritä palvelu tarkistamaan ALV-rekisterinumerot automaattisesti
...
## <a name="validation-templates" />Tarkistusmallit
