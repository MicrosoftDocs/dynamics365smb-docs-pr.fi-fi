...
---
# <a name="set-up-posting-groups"></a>Kirjausryhmien määrittäminen
...
Käytä **Yleiset kirjausasetukset** -sivun **Estetty**-kenttää, jos haluat estää käyttäjiä vahingossa käyttämästä asetuksia, jotka eivät enää ole merkityksellisiä uusissa kirjauksissa. 

## <a name="access-all-fields-and-accounts-when-you-set-up-a-posting-group"></a>Kaikkien kenttien ja tilien käyttäminen kirjausryhmän määrittämisen yhteydessä

Kirjausryhmät voivat olla monimutkaisia määrittää. Koska kaikkia tilityyppejä ei käytetä usein, [!INCLUDE [prod_short](includes/prod_short.md)] ei näytä niitä riveillä sarakkeina. Lisäksi oikeiden tilien valinnan helpottamiseksi [!INCLUDE [prod_short](includes/prod_short.md)] suodattaa tilit, jotka voit valita kenttähauissa. 

Jos haluat käyttää kaikkia riveillä ja kentissä olevia tilejä, on olemassa pari asetusta, joista voi olla apua:

* Jos haluat näyttää kaikki tilit sarakkeina riveillä, ota **Näytä kaikki tilit** -vaihto käyttöön.
* Voit käyttää kaikkia kentän hakujen tilejä valitsemalla yksittäisillä riveillä **Näytä kaikki tilit haussa** -valintaruutu.

> [!NOTE]
> **Näytä kaikki tilit** -vaihto ei ehkä näytä toimivan **Yleiset kirjausasetukset** -sivulla. Tämä johtuu siitä, että [!INCLUDE [prod_short](includes/prod_short.md)] näyttää aina kaikki tilit sivun riveillä sarakkeina.
