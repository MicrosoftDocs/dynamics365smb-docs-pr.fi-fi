...
ms.author: bholtorf
---
# <a name="set-up-posting-groups"></a><a name="set-up-posting-groups"></a>Määritä kirjanpidon kirjausryhmät
...
## <a name="general-posting-groups"></a><a name="general-posting-groups"></a>Yleiset kirjausryhmät
...
## <a name="specific-posting-groups"></a><a name="specific-posting-groups"></a>Erityiset kirjausryhmät
...
### <a name="allowing-substitute-customer-or-vendor-posting-groups-on-documents"></a><a name="allowing-substitute-customer-or-vendor-posting-groups-on-documents"></a>Korvaavien asiakkaan tai toimittajan kirjausryhmien salliminen asiakirjoille
...
## <a name="tax-posting-groups"></a><a name="tax-posting-groups"></a>Verokirjausryhmä
...
## <a name="example-of-linking-posting-groups"></a><a name="example-of-linking-posting-groups"></a>Esimerkki kirjausryhmien linkittämisestä
...
## <a name="copying-posting-setup-lines"></a><a name="copying-posting-setup-lines"></a>Kirjausasetusrivien kopioiminen
...
## <a name="set-up-posting-groups-on-the-go"></a><a name="set-up-posting-groups-on-the-go"></a>Kirjausryhmien määrittäminen liikkeellä ollessa
...
## <a name="troubleshooting-posting-group-errors"></a><a name="troubleshooting-posting-group-errors"></a>Kirjausryhmän virheiden vianetsintä
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Lue aiheeseen liittyen [Microsoftin koulutukset](/training/modules/posting-groups-dynamics-365-business-central/)
