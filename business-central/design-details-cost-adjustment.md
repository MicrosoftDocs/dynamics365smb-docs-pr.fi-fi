...
ms.author: edupont
---
# <a name="design-details-cost-adjustment"></a><a name="design-details-cost-adjustment"></a>Rakennetiedot: kustannuksen muutos
...
## <a name="detecting-the-adjustment"></a><a name="detecting-the-adjustment"></a>Muutoksen havaitseminen
...
### <a name="item-application-entry"></a><a name="item-application-entry"></a>Nimikkeen kohdistustapahtuma
...
### <a name="average-cost-adjustment-entry-point"></a><a name="average-cost-adjustment-entry-point"></a>Keskimääräinen kustannusten oikaisun tulopaikka
...
### <a name="order-level"></a><a name="order-level"></a>Tilauksen taso
...
## <a name="manual-versus-automatic-cost-adjustment"></a><a name="manual-versus-automatic-cost-adjustment"></a>Manuaalinen kustannusten muuttaminen verrattuna automaattiseen kustannusten muuttamiseen
...
## <a name="adjust-cost---item-entries-batch-job"></a><a name="adjust-cost---item-entries-batch-job"></a>Muuta kustann. - Nimiketapaht. -eräajo
...
#### <a name="relation-entries-in-the-gl--item-ledger-relation-table-1"></a><a name="relation-entries-in-the-gl--item-ledger-relation-table-1"></a>Liittyvät kirjaukset G/L – nimikkeen pääkirjan suhdetaulukko (1)
...
#### <a name="general-ledger-entries-1"></a><a name="general-ledger-entries-1"></a>Pääkirjanpidon tapahtumat (1)
...
#### <a name="relation-entries-in-the-gl--item-ledger-relation-table-2"></a><a name="relation-entries-in-the-gl--item-ledger-relation-table-2"></a>Liittyvät kirjaukset G/L – nimikkeen pääkirjan suhdetaulukko (2)
...
#### <a name="general-ledger-entries-2"></a><a name="general-ledger-entries-2"></a>Pääkirjanpidon tapahtumat (2)
...
## <a name="automatic-cost-adjustment"></a><a name="automatic-cost-adjustment"></a>Automaattinen kustannusten muuttaminen
