...
5.  **Lisää Maksurekisteröintitiedot-sivun**  **Maksualennus-pikavälilehden** Maksualennuspvm-kenttään **päivämäärä**, joka on myöhempi kuin päivämäärä **, Maksurekisteröinnin asetukset -** sivun Vastaanottopvm **.-kenttään** .  
