...
ms.author: bholtorf
---
# <a name="upgrading-an-integration-with-dynamics-365-sales" />Integroinnin päivittäminen Dynamics 365 Salesissa
...
## <a name="to-upgrade-your-connection-to-use-dataverse" />Yhteyden päivittäminen niin, että se käyttää Dataverse -sovellusta
