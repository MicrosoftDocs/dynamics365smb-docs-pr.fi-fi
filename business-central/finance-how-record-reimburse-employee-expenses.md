...
ms.author: edupont
---
# <a name="record-and-reimburse-employees-expenses" />Työntekijöiden kulujen kirjaaminen ja hyvittäminen
...
## <a name="to-record-an-employees-expense" />Työntekijän kulun kirjaaminen
...
## <a name="to-reimburse-an-employee" />Hyvityksen tekeminen työntekijälle
...
## <a name="to-reconcile-reimbursements-with-employee-ledger-entries" />Hyvitysten täsmäyttäminen työntekijätapahtumien kanssa
