...
ms.author: edupont
---
# <a name="record-and-reimburse-employees-expenses"></a><a name="record-and-reimburse-employees-expenses"></a>Työntekijöiden kulujen kirjaaminen ja hyvittäminen
...
## <a name="to-record-an-employees-expense"></a><a name="to-record-an-employees-expense"></a>Työntekijän kulun kirjaaminen
...
## <a name="to-reimburse-an-employee"></a><a name="to-reimburse-an-employee"></a>Hyvityksen tekeminen työntekijälle
...
## <a name="to-reconcile-reimbursements-with-employee-ledger-entries"></a><a name="to-reconcile-reimbursements-with-employee-ledger-entries"></a>Hyvitysten täsmäyttäminen työntekijätapahtumien kanssa
