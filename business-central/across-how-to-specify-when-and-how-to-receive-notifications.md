...
Työnkuluissa, jotka edellyttävät, että joku hyväksyy muutokset, on määritettävä hyväksynnän käyttäjät, jotka hyväksyvät tai hylkäävät muutokset. Voit esimerkiksi haluta jonkun hyväksyvän uudet tietueet. Tärkeä osa hyväksynnän käyttäjäasetuksia on määrittää, miten ja milloin käyttäjälle ilmoitetaan muutoksesta. Voit esimerkiksi määrittää, että hyväksynnän käyttäjä saa välittömästi sähköpostiviestin, kun joku luo uuden asiakkaan. Voit myös aikatauluttaa toimitettavat ilmoitukset esimerkiksi viikko- tai kuukausiperusteisesti.
...
> [!NOTE]
> Voidaksesi käyttää sähköpostia ilmoitusmenetelmänä, sinun on määritettävä sähköposti sekä lähettäjälle että vastaanottajalle [!INCLUDE [prod_short](includes/prod_short.md)] -ratkaisussa. Lisätietoja kohdassa [Sähköpostin määrittäminen](admin-how-setup-email.md).
...
3. Täytä **Työnkulun ilmoitusasetukset** -sivun kentät seuraavassa taulukossa kuvatulla tavalla.  
   ...
   Määritit, miten käyttäjä saa ilmoituksia. Määritä seuraavaksi, milloin käyttäjä saa ilmoituksia.  
