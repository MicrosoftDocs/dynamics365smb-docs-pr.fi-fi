...
ms.author: bholtorf
---
# <a name="service-price-management"></a><a name="service-price-management"></a><a name="service-price-management"></a>huoltohallinnan asetukset
...
## <a name="service-price-adjustment-groups"></a><a name="service-price-adjustment-groups"></a><a name="service-price-adjustment-groups"></a>Huoltohintamuutoksen ryhmät
...
## <a name="service-price-groups"></a><a name="service-price-groups"></a><a name="service-price-groups"></a>Huoltohintaryhmät
...
## <a name="service-pricing"></a><a name="service-pricing"></a><a name="service-pricing"></a>Huoltohinnoittelu
...
## <a name="service-price-adjustment"></a><a name="service-price-adjustment"></a><a name="service-price-adjustment"></a>huoltohintojen oikaisu
