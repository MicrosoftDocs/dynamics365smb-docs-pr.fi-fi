...
# <a name="set-up-fixed-asset-depreciation"></a><a name="set-up-fixed-asset-depreciation"></a>Käyttöomaisuuden poiston määrittäminen
...
## <a name="to-create-a-depreciation-book"></a><a name="to-create-a-depreciation-book"></a>Poistokirjan luominen
...
## <a name="to-assign-a-depreciation-book-to-a-fixed-asset"></a><a name="to-assign-a-depreciation-book-to-a-fixed-asset"></a>Poistokirjan liittäminen käyttöomaisuuteen
...
## <a name="to-assign-a-depreciation-book-to-multiple-fixed-assets-with-a-batch-job"></a><a name="to-assign-a-depreciation-book-to-multiple-fixed-assets-with-a-batch-job"></a>Poistokirjan liittäminen useisiin käyttöomaisuuseriin eräajon avulla
...
## <a name="to-set-up-depreciation-posting-types"></a><a name="to-set-up-depreciation-posting-types"></a>Poiston kirjaustyyppien määrittäminen
...
## <a name="to-set-up-default-templates-and-batches-for-fixed-asset-depreciation"></a><a name="to-set-up-default-templates-and-batches-for-fixed-asset-depreciation"></a>Käyttöomaisuuden poiston oletusmallien ja -erien määrittäminen
...
## <a name="fiscal-year-365-days-field-depreciation"></a><a name="fiscal-year-365-days-field-depreciation"></a>Tilikausi 365 päivää -kentän poisto
