...
ms.author: edupont
---
# <a name="depreciate-or-amortize-fixed-assets" />Käyttöomaisuuden poisto tai kuolettaminen
...
## <a name="to-calculate-depreciation-automatically" />Poistojen laskeminen automaattisesti
...
## <a name="to-post-depreciation-manually-from-the-fixed-asset-gl-journal" />Poistojen kirjaaminen manuaalisesti käyttöomaisuuden KP-päiväkirjasta
...
## <a name="to-manage-the-ending-book-value" />Loppukirjanpitoarvon hallinta
...
## <a name="to-calculate-allocations-in-the-fixed-asset-gl-journal" />Käyttöomaisuuden KO-päiväkirjan kohdistusten laskeminen
...
## <a name="use-duplication-lists-to-prepare-to-post-to-multiple-depreciation-books" />Valmistele useiden poistokirjojen kirjaaminen monistusluetteloiden avulla
...
## <a name="to-post-entries-to-different-depreciation-books" />Tapahtumien kirjaaminen eri poistokirjoihin
...
## <a name="to-copy-fixed-asset-ledger-entries-between-depreciation-books" />Käyttöomaisuustapahtumien kopioiminen poistokirjojen välillä
