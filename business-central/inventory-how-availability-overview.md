...
ms.author: edupont
---
# <a name="view-the-availability-of-items"></a><a name="view-the-availability-of-items"></a><a name="view-the-availability-of-items"></a>Nimikkeiden saatavuuden tarkasteleminen
...
## <a name="to-view-the-availability-of-an-item-according-to-when-it-will-be-received-or-shipped"></a><a name="to-view-the-availability-of-an-item-according-to-when-it-will-be-received-or-shipped"></a><a name="to-view-the-availability-of-an-item-according-to-when-it-will-be-received-or-shipped"></a>Voit tarkastella nimikkeen saatavuutta sen vastaanotto- tai toimituspäivän mukaan.
...
## <a name="to-view-the-availability-of-an-item-in-different-periods"></a><a name="to-view-the-availability-of-an-item-in-different-periods"></a><a name="to-view-the-availability-of-an-item-in-different-periods"></a>Nimikkeen saatavuuden tarkastelu eri jaksoissa
...
## <a name="to-view-the-availability-of-an-item-at-the-locations-where-it-is-stored"></a><a name="to-view-the-availability-of-an-item-at-the-locations-where-it-is-stored"></a><a name="to-view-the-availability-of-an-item-at-the-locations-where-it-is-stored"></a>Nimikkeen saatavuuden tarkastelu kaikissa sen varastointipaikoissa
...
## <a name="to-view-the-availability-of-all-items-by-the-location-where-they-are-stored"></a><a name="to-view-the-availability-of-all-items-by-the-location-where-they-are-stored"></a><a name="to-view-the-availability-of-all-items-by-the-location-where-they-are-stored"></a>Kaikkien nimikkeiden saatavuuden tarkastelu kaikissa niiden varastointipaikoissa
...
## <a name="to-view-the-availability-of-an-item-by-its-use-in-assembly-or-production-boms"></a><a name="to-view-the-availability-of-an-item-by-its-use-in-assembly-or-production-boms"></a><a name="to-view-the-availability-of-an-item-by-its-use-in-assembly-or-production-boms"></a>Nimikkeen saatavuuden tarkastelu sen mukaan, miten sitä käytetään kokoonpanon tai tuotannon tuoterakenteessa
...
### <a name="to-view-the-availability-of-an-item-according-to-demand-for-its-parent"></a><a name="to-view-the-availability-of-an-item-according-to-demand-for-its-parent"></a><a name="to-view-the-availability-of-an-item-according-to-demand-for-its-parent"></a>Nimikkeen saatavuuden tarkasteleminen pääkohteen kysynnän mukaan
...
## <a name="to-view-the-availability-of-an-item-by-its-units-of-measure"></a><a name="to-view-the-availability-of-an-item-by-its-units-of-measure"></a><a name="to-view-the-availability-of-an-item-by-its-units-of-measure"></a>Nimikkeen saatavuuden näyttäminen mittayksiköinä
...
## <a name="to-view-the-availability-of-an-item-by-its-variants"></a><a name="to-view-the-availability-of-an-item-by-its-variants"></a><a name="to-view-the-availability-of-an-item-by-its-variants"></a>Nimikkeen saatavuuden näyttäminen sen varianttien mukaan
...
## <a name="assembly-availability-page"></a><a name="assembly-availability-page"></a><a name="assembly-availability-page"></a>Kokoonpanon saatavuus -sivu
