...
ms.author: edupont
---
# <a name="view-the-availability-of-items" />Nimikkeiden saatavuuden tarkasteleminen
...
## <a name="to-view-the-availability-of-an-item-according-to-when-it-will-be-received-or-shipped" />Voit tarkastella nimikkeen saatavuutta sen vastaanotto- tai toimituspäivän mukaan.
...
## <a name="to-view-the-availability-of-an-item-in-different-periods" />Nimikkeen saatavuuden tarkastelu eri jaksoissa
...
## <a name="to-view-the-availability-of-an-item-at-the-locations-where-it-is-stored" />Nimikkeen saatavuuden tarkastelu kaikissa sen varastointipaikoissa
...
## <a name="to-view-the-availability-of-all-items-by-the-location-where-they-are-stored" />Kaikkien nimikkeiden saatavuuden tarkastelu kaikissa niiden varastointipaikoissa
...
## <a name="to-view-the-availability-of-an-item-by-its-use-in-assembly-or-production-boms" />Nimikkeen saatavuuden tarkastelu sen mukaan, miten sitä käytetään kokoonpanon tai tuotannon tuoterakenteessa
...
### <a name="to-view-the-availability-of-an-item-according-to-demand-for-its-parent" />Nimikkeen saatavuuden tarkasteleminen pääkohteen kysynnän mukaan
...
## <a name="to-view-the-availability-of-an-item-by-its-units-of-measure" />Nimikkeen saatavuuden näyttäminen mittayksiköinä
...
## <a name="to-view-the-availability-of-an-item-by-its-variants" />Nimikkeen saatavuuden näyttäminen sen varianttien mukaan
...
## <a name="assembly-availability-page" />Kokoonpanon saatavuus -sivu
