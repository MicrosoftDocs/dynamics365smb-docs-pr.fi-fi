...
ms.author: edupont
---
# <a name="set-up-electronic-document-sending-and-receiving"></a><a name="set-up-electronic-document-sending-and-receiving"></a>Sähköisten asiakirjojen vastaanottamisen ja lähettämisen määrittäminen
...
### <a name="to-set-up-the-company-for-electronic-document-sending-and-receiving"></a><a name="to-set-up-the-company-for-electronic-document-sending-and-receiving"></a>Yrityksen valmistelu sähköisten asiakirjojen lähettämistä ja vastaanottamista varten
...
### <a name="to-set-up-vat-posting-for-electronic-document-sending-and-receiving"></a><a name="to-set-up-vat-posting-for-electronic-document-sending-and-receiving"></a>ALV-kirjausten määrittäminen sähköisten asiakirjojen lähettämistä ja vastaanottamista varten
...
### <a name="to-set-up-countriesregions-for-electronic-document-sending-and-receiving"></a><a name="to-set-up-countriesregions-for-electronic-document-sending-and-receiving"></a>Maa-/alueasetuksien määrittäminen asiakirjojen sähköistä lähettämistä ja vastaanottamista varten
...
### <a name="to-set-up-items-for-electronic-document-sending-and-receiving"></a><a name="to-set-up-items-for-electronic-document-sending-and-receiving"></a>Kohteiden määrittäminen sähköisten asiakirjojen lähettämistä ja vastaanottamista varten
...
### <a name="to-set-up-units-of-measure-for-electronic-document-sending-and-receiving"></a><a name="to-set-up-units-of-measure-for-electronic-document-sending-and-receiving"></a>Mittayksikköjen määrittäminen asiakirjojen sähköistä lähettämistä ja vastaanottamista varten
...
### <a name="to-set-up-customers-for-electronic-document-sending"></a><a name="to-set-up-customers-for-electronic-document-sending"></a>Asiakkaiden määrittäminen sähköisten asiakirjojen lähettämistä ja vastaanottamista varten
...
### <a name="to-select-the-peppol-electronic-document-format-for-electronic-document-sending"></a><a name="to-select-the-peppol-electronic-document-format-for-electronic-document-sending"></a>PEPPOL-formaatin valitseminen asiakirjojen lähettämistä varten
...
### <a name="to-set-up-vendors-for-electronic-document-receiving"></a><a name="to-set-up-vendors-for-electronic-document-receiving"></a>Toimittajien määrittäminen sähköisten asiakirjojen vastaanottamista varten
...
### <a name="to-select-the-peppol---invoice-data-exchange-definition-for-electronic-document-receiving"></a><a name="to-select-the-peppol---invoice-data-exchange-definition-for-electronic-document-receiving"></a>PEPPOL – Lasku -tietojenvaihtomäärityksen valitseminen asiakirjojen vastaanottamista varten
...
### <a name="to-set-up-the-gl-account-to-use-on-new-purchase-invoice-lines-for-non-identifiable-items-and-non-items"></a><a name="to-set-up-the-gl-account-to-use-on-new-purchase-invoice-lines-for-non-identifiable-items-and-non-items"></a>Kirjanpitotilin määrittäminen käyttämään uusia ostolaskun rivejä tunnistamattomille kohteille ja ei-kohteille
