...
ms.author: edupont
---
# <a name="troubleshooting-self-service-sign-up" />Itsepalvelun rekisteröitymisen vianmääritys
...
## <a name="what-email-address-can-i-use-with-business-central" />Mitä sähköpostiosoitetta voin käyttää Business Central -sovelluksen kanssa?
...
## <a name="regional-availability" />Aluekohtainen saatavuus
