...
ms.author: edupont
---
# <a name="process-purchase-returns-or-cancellations" />Ostopalautusten tai peruutusten käsittely
...
## <a name="inventory-costing" />Varaston arvostus
...
## <a name="to-create-a-purchase-credit-memo-from-a-posted-purchase-invoice" />Ostohyvityslaskun luominen kirjatusta ostolaskusta
...
## <a name="to-create-a-purchase-credit-memo-by-copying-a-posted-purchase-invoice" />Uuden ostohyvityslaskun luominen kopioimalla kirjattu ostolaskun
...
## <a name="to-create-a-purchase-return-order-based-on-one-or-more-posted-purchase-documents" />Ostopalautustilauksen luominen vähintään yhden kirjatun ostoasiakirjan perusteella
...
## <a name="to-create-a-replacement-purchase-order-from-a-purchase-return-order" />Korvaavan ostotilauksen luominen ostopalautustilauksesta
...
## <a name="to-create-a-purchase-allowance" />Ostoalennuksen luominen
...
## <a name="to-combine-return-shipments" />Palautustoimitusten yhdistäminen
...
### <a name="to-remove-open-purchase-return-orders-after-combined-return-shipment-posting" />Poista avoin ostotilaus yhdistetyn palautustoimituksen kirjauksen jälkeen
...
## <a name="see-related-microsoft-training" />Lue aiheeseen liittyen [Microsoftin koulutukset](/training/paths/return-items-dynamics-365-business-central/)
