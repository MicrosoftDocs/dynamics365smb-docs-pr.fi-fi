...
ms.author: edupont
---
# <a name="walkthrough-receiving-and-putting-away-in-advanced-warehouse-configurations" />Vaihekuvaus: Vastaanotto ja hyllytys laajennetuissa varastomäärityksissä
...
## <a name="reviewing-the-white-location-setup" />Tarkistaa VALKOINEN-sijainnin asetuksia

**Sijaintikortti**-sivun asetuksissa määritellään yrityksen varaston työnkulut.  

### <a name="to-review-the-location-setup" />Sijainnin asetusten tarkistaminen
...
## <a name="creating-the-purchase-orders" />Ostotilausten luominen

Ostotilaukset ovat yleisin saapuvien lähdeasiakirjojen tyyppi.  

### <a name="to-create-the-purchase-orders" />Ostotilausten luominen
...
## <a name="putting-the-items-away" />Nimikkeiden hyllyttäminen
...
### <a name="to-put-the-items-away" />Nimikkeiden hyllyttäminen
