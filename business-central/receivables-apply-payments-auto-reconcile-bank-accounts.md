...
# <a name="apply-payments-automatically-and-reconciling-bank-accounts"></a>Maksujen automaattinen kohdistaminen ja pankkitilien täsmäyttäminen
...
Voit tuoda pankin tiliotteet pankkisyötteenä määrittämällä ensin Envestnet Yodlee Bank Feeds -palvelun ja linkittämällä sitten pankkitilit liittyviin verkkopankkitileihin. Lisätietoja [on Kohdassa Envestnet Yodlee -pankkisyöttöpalvelun määrittäminen](bank-how-setup-bank-statement-service.md).  
...
Vaihtoehtoisesti voit käyttää AMC Banking 365 Fundamentals -laajennusta muuntamaan tiliotteen tiedostomuodosta riippumatta tietovirraksi, jonka voit tämän jälkeen tuoda [!INCLUDE[prod_short](includes/prod_short.md)]iin. Lisätietoja on [AMC banking 365 fundamentals -laajennuksessa](ui-extensions-amc-banking.md).  
