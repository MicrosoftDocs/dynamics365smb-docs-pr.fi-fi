...
ms.author: edupont
---
# <a name="post-capacities"></a><a name="post-capacities"></a><a name="post-capacities"></a>Kapasiteettien kirjaaminen
...
## <a name="to-post-capacities"></a><a name="to-post-capacities"></a><a name="to-post-capacities"></a>Kapasiteettien kirjaaminen
...
## <a name="to-view-work-center-ledger-entries"></a><a name="to-view-work-center-ledger-entries"></a><a name="to-view-work-center-ledger-entries"></a>Tuotantosolutapahtumien näyttäminen
