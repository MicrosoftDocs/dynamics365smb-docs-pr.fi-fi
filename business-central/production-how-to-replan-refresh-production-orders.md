...
ms.author: edupont
---
# <a name="replan-or-refresh-production-orders-directly"></a><a name="replan-or-refresh-production-orders-directly"></a>Tuotantotilausten suora uudelleensuunnittelu tai päivittäminen
...
## <a name="to-replan-a-production-order"></a><a name="to-replan-a-production-order"></a>Tuotantotilauksen uudelleensuunnittelu
...
## <a name="to-refresh-a-production-order"></a><a name="to-refresh-a-production-order"></a>Tuotantotilauksen päivittäminen
