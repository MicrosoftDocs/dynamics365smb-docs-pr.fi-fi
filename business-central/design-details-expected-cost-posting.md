...
ms.author: edupont
---
# <a name="design-details-expected-cost-posting" />Rakennetiedot: oletetun kustannuksen kirjaus
...
## <a name="prerequisites-for-posting-expected-costs" />Oletetun kustannuksen kirjaamisen edellytykset
