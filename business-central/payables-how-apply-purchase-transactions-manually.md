...
ms.author: edupont
---
# <a name="reconcile-vendor-payments-with-the-payment-journal-or-from-vendor-ledger-entries" />Toimittajamaksujen täsmäyttäminen maksukirjauskansiolla tai toimittajatapahtumista
...
## <a name="to-apply-a-payment-to-a-single-or-multiple-vendor-ledger-entries" />Maksun kohdistaminen yhteen tai useaan toimittajatapahtumaan
...
## <a name="to-apply-a-credit-memo-to-a-single-or-multiple-vendor-ledger-entries" />Hyvityslaskun kohdistaminen yhteen tai useaan toimittajatapahtumaan
...
## <a name="to-apply-posted-vendor-ledger-entries" />Kirjattujen toimittajatapahtumien kohdistus:
...
## <a name="to-apply-vendor-ledger-entries-in-different-currencies-to-one-another" />Eri valuutoissa olevien toimittajatapahtumien kohdistaminen toisiinsa:
...
## <a name="to-unapply-an-application-of-vendor-entries" />Toimittajan tapahtumien kohdistuksen peruuttaminen
