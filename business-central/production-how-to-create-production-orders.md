...
ms.author: edupont
---
# <a name="create-production-order-headers"></a><a name="create-production-order-headers"></a><a name="create-production-order-headers"></a>Tuotantotilausten otsikoiden luominen
...
## <a name="to-create-a-production-order-header"></a><a name="to-create-a-production-order-header"></a><a name="to-create-a-production-order-header"></a>Tuotantotilausten otsikoiden luominen
