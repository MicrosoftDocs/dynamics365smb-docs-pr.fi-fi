...
ms.author: edupont
---
# <a name="set-up-resources-for-projects" />Projektien resurssien määrittäminen
...
## <a name="to-set-up-a-resource" />Resurssin määrittäminen
...
## <a name="to-set-up-a-resource-group" />Resurssiryhmän määrittäminen
...
## <a name="to-set-capacity-for-a-resource" />Resurssin kapasiteetin määrittäminen
...
## <a name="to-set-up-alternate-resource-costs" />Vaihtoehtoisten resurssikustannusten määrittäminen
...
## <a name="to-set-up-alternate-resource-prices" />Vaihtoehtoisten resurssihintojen määrittäminen
