...
ms.author: edupont
---
# <a name="set-up-resources-for-projects"></a><a name="set-up-resources-for-projects"></a>Projektien resurssien määrittäminen
...
## <a name="to-set-up-a-resource"></a><a name="to-set-up-a-resource"></a>Resurssin määrittäminen
...
## <a name="to-set-up-a-resource-group"></a><a name="to-set-up-a-resource-group"></a>Resurssiryhmän määrittäminen
...
## <a name="to-set-capacity-for-a-resource"></a><a name="to-set-capacity-for-a-resource"></a>Resurssin kapasiteetin määrittäminen
...
## <a name="to-set-up-alternate-resource-costs"></a><a name="to-set-up-alternate-resource-costs"></a>Vaihtoehtoisten resurssikustannusten määrittäminen
...
## <a name="to-set-up-alternate-resource-prices"></a><a name="to-set-up-alternate-resource-prices"></a>Vaihtoehtoisten resurssihintojen määrittäminen
