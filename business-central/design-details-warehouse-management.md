...
# <a name="warehouse-management-overview"></a><a name="warehouse-management-overview"></a><a name="warehouse-management-overview"></a>Varastohallinnan yleiskuvaus
...
## <a name="modeling-the-physical-warehouse"></a><a name="modeling-the-physical-warehouse"></a><a name="modeling-the-physical-warehouse"></a>Fyysisen varaston mallinnus
...
### <a name="locations-and-bins"></a><a name="locations-and-bins"></a><a name="locations-and-bins"></a>Sijainnit ja varastopaikat
...
### <a name="shelves-and-bins"></a><a name="shelves-and-bins"></a><a name="shelves-and-bins"></a>Hyllyt ja varastopaikat
...
## <a name="typical-warehouse-workflow"></a><a name="typical-warehouse-workflow"></a><a name="typical-warehouse-workflow"></a>Tyypillinen fyysisen varastoinnin työnkulku
...
## <a name="terminology-related-to-warehouse-management"></a><a name="terminology-related-to-warehouse-management"></a><a name="terminology-related-to-warehouse-management"></a>Varastoinninhallintaan liittyvät termit

### <a name="complexity-levels"></a><a name="complexity-levels"></a><a name="complexity-levels"></a>Monimutkaisuustasot
...
### <a name="warehouse-flows"></a><a name="warehouse-flows"></a><a name="warehouse-flows"></a>Fyysiset varastointivirrat
...
### <a name="basic-documents"></a><a name="basic-documents"></a><a name="basic-documents"></a>Perusasiakirjat
...
### <a name="advanced-documents"></a><a name="advanced-documents"></a><a name="advanced-documents"></a>Laajennettujen toimintojen asiakirjat
...
### <a name="pages-and-settings"></a><a name="pages-and-settings"></a><a name="pages-and-settings"></a>Sivut ja asetukset

Tässä osassa käsitellään käsitteitä, joihin varastoinnin keskeiset sivut ja asetukset perustuvat.

#### <a name="bins-and-bin-content"></a><a name="bins-and-bin-content"></a><a name="bins-and-bin-content"></a>Varastopaikat ja varastopaikan sisältö
...
#### <a name="bin-type"></a><a name="bin-type"></a><a name="bin-type"></a>Varastopaikan tyyppi
...
#### <a name="bin-ranking"></a><a name="bin-ranking"></a><a name="bin-ranking"></a>Varastopaikan luokittelu
...
#### <a name="bin-setup"></a><a name="bin-setup"></a><a name="bin-setup"></a>Varastopaikan asetus
...
#### <a name="zone"></a><a name="zone"></a><a name="zone"></a>Vyöhyke
...
#### <a name="warehouse-class"></a><a name="warehouse-class"></a><a name="warehouse-class"></a>F. var. luokka
...
#### <a name="location"></a><a name="location"></a><a name="location"></a>Sijainti
...
#### <a name="first-expired-first-out"></a><a name="first-expired-first-out"></a><a name="first-expired-first-out"></a>FEFO (ensin vanhentunut ensimmäisenä ulos)
...
#### <a name="put-away-template"></a><a name="put-away-template"></a><a name="put-away-template"></a>Hyllytysmalli
