...
# <a name="warehouse-management-overview" />Varastohallinnan yleiskuvaus
...
## <a name="modeling-the-physical-warehouse" />Fyysisen varaston mallinnus
...
### <a name="locations-and-bins" />Sijainnit ja varastopaikat
...
### <a name="shelves-and-bins" />Hyllyt ja varastopaikat
...
## <a name="typical-warehouse-workflow" />Tyypillinen fyysisen varastoinnin työnkulku
...
## <a name="terminology-related-to-warehouse-management" />Varastoinninhallintaan liittyvät termit

### <a name="complexity-levels" />Monimutkaisuustasot
...
### <a name="warehouse-flows" />Fyysiset varastointivirrat
...
### <a name="basic-documents" />Perusasiakirjat
...
### <a name="advanced-documents" />Laajennettujen toimintojen asiakirjat
...
### <a name="pages-and-settings" />Sivut ja asetukset

Tässä osassa käsitellään käsitteitä, joihin varastoinnin keskeiset sivut ja asetukset perustuvat.

#### <a name="bins-and-bin-content" />Varastopaikat ja varastopaikan sisältö
...
#### <a name="bin-type" />Varastopaikan tyyppi
...
#### <a name="bin-ranking" />Varastopaikan luokittelu
...
#### <a name="bin-setup" />Varastopaikan asetus
...
#### <a name="warehouse-class" />F. var. luokka
...
#### <a name="first-expired-first-out" />FEFO (ensin vanhentunut ensimmäisenä ulos)
...
#### <a name="put-away-template" />Hyllytysmalli
