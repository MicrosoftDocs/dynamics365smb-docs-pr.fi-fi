...
# <a name="set-up-universal-print-printers" />Yleistulostuksen tulostimien määrittäminen
...
## <a name="set-up-universal-print-and-printers-in-microsoft-azure" />Yleistulostuksen ja tulostimien määrittäminen Microsoft Azuressa
...
## <a name="add-printers-in-business-central-online" />Tulostimien lisääminen Business Central onlinessa
...
## <a name="add-printers-in-business-central-on-premises" />Tulostimien lisääminen paikallisessa Business Centralissa
...
<!-- To Do Adding printers individually lets you duplicate printers with custom , like different paper trays and paper size and orientation.  To add printers individually, you'll need to know printer's share name in Universal Print. -->
### <a name="connect-to-universal-print-for-the-first-time" />Ensimmäinen yhdistäminen yleistulostukseen
...
## <a name="common-problems-and-resolutions" />Yleisiä ongelmia ja niiden ratkaisuja
...
### <a name="you-dont-have-access-to-the-printer-your-printer" />Et voi käyttää tulostinta \<your-printer\>.
...
## <a name="there-was-an-error-fetching-printers-shared-to-you" />Virhe noudettaessa sinulle jaettuja tulostimia.
