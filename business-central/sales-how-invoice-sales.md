...
ms.author: edupont
---
# <a name="invoice-sales" />Myynnin laskutus
...
## <a name="create-sales-invoices" />Luo myyntilaskut
...
### <a name="to-create-a-sales-invoice" />Myyntilaskujen luominen
...
## <a name="registering-payments" />Maksujen rekisteröiminen
...
## <a name="external-document-numbers" />Ulkoisen tiedoston numerot

[!INCLUDE [ext-doc-no-sales](includes/ext-doc-no-sales.md)]

## <a name="see-related-microsoft-training" />Lue aiheeseen liittyen [Microsoftin koulutukset](/training/modules/invoicing-customers-dynamics-365-business-central/index).
