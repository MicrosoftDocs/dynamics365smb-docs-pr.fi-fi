...
# <a name="switching-to-another-company-or-environment"></a><a name="switching-to-another-company-or-environment"></a>Siirtyminen toiseen yritykseen tai ympäristöön
...
## <a name="about-companies-and-environments"></a><a name="about-companies-and-environments"></a>Tietoja yrityksistä ja ympäristöistä
...
## <a name="features-for-switching-company-or-environment"></a><a name="features-for-switching-company-or-environment"></a>Ominaisuudet yrityksen tai ympäristön vaihtamista varten
...
## <a name="use-the-company-switcher"></a><a name="use-the-company-switcher"></a>Käytä yrityksen vaihtajaa
...
## <a name="use-the-app-launcher"></a><a name="use-the-app-launcher"></a>Sovelluksen käynnistyksen käyttäminen
...
-->
## <a name="use-my-settings"></a><a name="use-my-settings"></a>Omien asetusten käyttäminen
...
## <a name="use-company-hub"></a><a name="use-company-hub"></a>Yritystoiminnon käyttäminen
