...
ms.author: edupont
---
# <a name="publish-a-web-service"></a><a name="publish-a-web-service"></a><a name="publish-a-web-service"></a>Verkkopalvelun julkaiseminen
...
## <a name="creating-and-publishing-a-web-service"></a><a name="creating-and-publishing-a-web-service"></a><a name="creating-and-publishing-a-web-service"></a>Verkkopalvelun luominen ja julkaiseminen

Seuraavassa kerrotaan, kuinka voit luoda ja julkaista verkkopalvelun.  

### <a name="to-create-and-publish-a-web-service"></a><a name="to-create-and-publish-a-web-service"></a><a name="to-create-and-publish-a-web-service"></a>Verkkopalvelun luominen ja julkaiseminen
...
### <a name="to-verify-the-availability-of-a-web-service"></a><a name="to-verify-the-availability-of-a-web-service"></a><a name="to-verify-the-availability-of-a-web-service"></a>Verkkopalvelun saatavuuden tarkistaminen
