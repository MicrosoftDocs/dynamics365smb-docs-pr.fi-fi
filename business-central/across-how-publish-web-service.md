...
ms.author: edupont
---
# <a name="publish-a-web-service" />Verkkopalvelun julkaiseminen
...
## <a name="creating-and-publishing-a-web-service" />Verkkopalvelun luominen ja julkaiseminen

Seuraavassa kerrotaan, kuinka voit luoda ja julkaista verkkopalvelun.  

### <a name="to-create-and-publish-a-web-service" />Verkkopalvelun luominen ja julkaiseminen
...
### <a name="to-verify-the-availability-of-a-web-service" />Verkkopalvelun saatavuuden tarkistaminen
