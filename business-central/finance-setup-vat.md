...
# <a name="set-up-calculations-and-posting-methods-for-value-added-tax" />Arvonlisäveron laskemisen ja kirjaustapojen määrittäminen
...
## <a name="set-up-vat-using-the-assisted-setup-guide-recommended" />Käytä ALV:n määrityksessä asetusten ohjattua määritysopasta (suositus)
...
### <a name="check-the-vat-posting-setup" />Tarkista ALV-kirjausasetukset.
...
## <a name="set-up-a-default-vat-date-for-documents-and-journals" />ALV:n oletuspäivämäärän määrittäminen asiakirjoille ja päiväkirjoille
...
### <a name="enabling-or-disabling-the-vat-date-feature" />ALV-päivämääräominaisuuden ottaminen käyttöön tai poistaminen käytöstä
...
### <a name="limiting-periods-for-posting-and-changing-the-vat-date" />Kausien rajoittaminen ALV-päivämäärän kirjaamista ja muuttamista varten
...
#### <a name="to-limit-posting-based-on-vat-return-period" />ALV-palautusjaksoon perustuvan kirjauksen rajoittaminen
...
#### <a name="to-limit-posting-based-on-allow-fromto-period" />Voit rajoittaa kirjauksen, joka perustuu sallimiseen kohteesta/kohteeseen
...
## <a name="set-up-vat-registration-numbers-for-your-country-or-region" />Määritä oman maan tai alueen ALV-rekisteröintinumerot
...
## <a name="set-up-vat-business-posting-groups" />Liiketoiminnan ALV-kirjausryhmien määrittäminen
...
## <a name="set-up-vat-product-posting-groups" />Tuotteen ALV-kirjausryhmien määrittäminen
...
## <a name="combine-vat-posting-groups-in-vat-posting-setups" />ALV-kirjausryhmien yhdistäminen ALV-kirjausasetuksissa
...
## <a name="assign-vat-posting-groups-by-default-to-multiple-entities" />ALV-kirjausryhmien määrittäminen oletusarvoisesti useille objekteille
...
## <a name="assign-vat-posting-groups-to-accounts-customers-vendors-items-and-resources" />Määritä ALV-kirjausryhmät yksittäisille tileille, asiakkaille, toimittajille, nimikkeille ja resursseille

Seuraavissa osissa käsitellään ALV-kirjausryhmien määrittämistä yksittäisille objekteille.

### <a name="to-assign-vat-posting-groups-to-individual-general-ledger-accounts" />ALV-kirjausryhmien määrittäminen yksittäisille pääkirjanpidon tileille
...
### <a name="to-assign-vat-business-posting-groups-to-customers-and-vendors" />Liiketoiminnan ALV-kirjausryhmien määrittäminen asiakkaille ja toimittajille
...
### <a name="to-assign-vat-product-posting-groups-to-individual-items-and-resources" />Tuotteen ALV-kirjausryhmien määritetään yksittäisille nimikkeille ja resursseille
...
## <a name="set-up-clauses-to-explain-vat-exemption-or-non-standard-vat-rates" />Määritä lausekkeet ALV-vapautuksen tai poikkeavien ALV-prosenttien selittämiseksi
...
### <a name="to-set-up-vat-clauses" />ALV-lauseiden määrittäminen
...
### <a name="to-assign-a-vat-clause-to-a-vat-posting-setup" />ALV-lauseen määrittäminen ALV-kirjausryhmään
...
### <a name="to-specify-translations-for-vat-clauses" />ALV-lauseiden käännösten määrittäminen
...
### <a name="to-specify-extended-text-for-vat-clauses" />ALV-lauseiden lisätekstin määrittäminen
...
## <a name="create-a-vat-posting-setup-to-handle-import-vat" />ALV-kirjausten asetukset luominen käsittelemään tuonnin ALV:tä
...
## <a name="use-reverse-charge-vat-for-trade-between-eu-countries-or-regions" />ALV-vastakirjauksen käyttäminen EU-maiden tai -alueiden välisessä kaupassa
...
### <a name="sales-to-eu-countries-or-regions" />Myynti EU-maihin tai -alueille
...
## <a name="vat-rounding-for-documents" />ALV:n pyöristäminen asiakirjoja varten
...
## <a name="set-up-vat-reporting" />Määritä ALV-raportointi
