...
ms.author: edupont
---
# <a name="design-details-production-order-posting"></a><a name="design-details-production-order-posting"></a><a name="design-details-production-order-posting"></a>Rakennetiedot: tuotantotilauksen kirjaus
...
## <a name="posting-structure"></a><a name="posting-structure"></a><a name="posting-structure"></a>Kirjausrakenne
...
## <a name="capacity-posting"></a><a name="capacity-posting"></a><a name="capacity-posting"></a>Kapasiteetin kirjaus
...
## <a name="production-order-costing"></a><a name="production-order-costing"></a><a name="production-order-costing"></a>Tuotantotilauksen arvostus
