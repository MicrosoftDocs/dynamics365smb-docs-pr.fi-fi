...
ms.author: edupont
---
# <a name="design-details-production-order-posting" />Rakennetiedot: tuotantotilauksen kirjaus
...
## <a name="posting-structure" />Kirjausrakenne
...
## <a name="capacity-posting" />Kapasiteetin kirjaus
...
## <a name="production-order-costing" />Tuotantotilauksen arvostus
