...
ms.author: edupont
---
# <a name="export-and-import-approval-workflows" />Hyväksyntätyönkulkujen vienti ja tuonti
...
## <a name="export-a-workflow" />Työnkulun vieminen
...
## <a name="import-a-workflow" />Työnkulun tuominen
