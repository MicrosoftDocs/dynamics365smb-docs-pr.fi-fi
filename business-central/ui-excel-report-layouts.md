...
ms.author: jswymer
---
# <a name="working-with-microsoft-excel-layouts" />Microsoft Excel -asetteluiden käyttäminen
...
## <a name="why-use-excel-layouts" />Miksi kannattaa käyttää Excel-asetteluja?
...
## <a name="understanding-excel-layouts" />Tietoja Excelin asetteluista
