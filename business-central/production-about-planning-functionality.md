...
description: 'Tutustu siihen, miten suunnittelussa käytetään kysyntä- ja tarjontatietoja, ehdottaaksesi, miten tarjonta tasapainotetaan kysyntään vastaamiseksi.'
author: brentholtorf
ms.author: bholtorf
...
- Kysyntä on termi, jota käytetään kaikenlaista bruttotarpeesta, esimerkiksi myyntitilauksesta, huoltotilauksesta, kokoonpano- tai tuotantotilausten osatarpeesta, lähtevästä siirrosta, puitetilauksesta tai ennusteesta. Näiden lisäksi on myös tiettyjä muita teknisiä kysyntätyyppejä. Tällaisia tarpeita ovat esimerkiksi negatiivinen tuotanto- tai ostotilaus, negatiivinen varasto ja ostopalautustilaus.  
