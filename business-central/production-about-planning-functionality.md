...
ms.author: bholtorf
---
# <a name="about-planning-functionality" />Tietoja toimintojen suunnittelusta
...
## <a name="demand-and-supply" />Kysyntä ja tarjonta
...
## <a name="planning-calculation" />Suunnittelulaskenta
...
## <a name="planning-with-manual-transfer-orders" />Suunnittelu manuaalisia siirtotilauksia käyttäen.
...
## <a name="other-important-planning-fields" />Muut tärkeät suunnittelukentät
...
## <a name="planning-worksheets-and-requisition-worksheets" />Suunnittelutyökirjat ja hankintatyökirjat
...
### <a name="requisition-worksheet" />Hankintatyökirja
...
## <a name="see-related-microsoft-training" />Lue aiheeseen liittyen [Microsoftin koulutukset](/training/modules/plan-items-dynamics-365-business-central/)
