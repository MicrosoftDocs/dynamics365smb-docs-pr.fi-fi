...
---
# <a name="reconcile-payments-that-cant-be-applied-automatically"></a>Täsmäytä maksut, joita ei voi kohdistaa automaattisesti
...
## <a name="to-reconcile-payments-that-cant-be-applied-automatically"></a>Sellaisten maksujen täsmäyttäminen, joita ei voi kohdistaa automaattisesti
