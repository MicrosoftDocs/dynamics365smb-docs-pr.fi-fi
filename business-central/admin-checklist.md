...
ms.author: edupont
---
# <a name="onboard-users-with-checklists"></a><a name="onboard-users-with-checklists"></a>Käyttäjien perehdyttäminen tarkistusluetteloiden avulla
...
## <a name="to-add-an-item-to-the-checklist"></a><a name="to-add-an-item-to-the-checklist"></a>Nimikkeen lisääminen tarkistusluetteloon
