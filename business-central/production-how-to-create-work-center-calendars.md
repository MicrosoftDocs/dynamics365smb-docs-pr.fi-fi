...
ms.author: edupont
---
# <a name="set-up-shop-calendars"></a><a name="set-up-shop-calendars"></a><a name="set-up-shop-calendars"></a>Tuotantokalentereiden määrittäminen
...
## <a name="to-create-work-shifts"></a><a name="to-create-work-shifts"></a><a name="to-create-work-shifts"></a>Työvuorojen luominen
...
## <a name="to-set-up-a-shop-calendar"></a><a name="to-set-up-a-shop-calendar"></a><a name="to-set-up-a-shop-calendar"></a>Tuotantokalenterin määrittäminen
...
## <a name="to-calculate-a-work-center-calendar"></a><a name="to-calculate-a-work-center-calendar"></a><a name="to-calculate-a-work-center-calendar"></a>Tuotantosolun kalenterin laskeminen
...
## <a name="to-record-work-center-absence"></a><a name="to-record-work-center-absence"></a><a name="to-record-work-center-absence"></a>Tuotantosolun poissaolojen tallentaminen
