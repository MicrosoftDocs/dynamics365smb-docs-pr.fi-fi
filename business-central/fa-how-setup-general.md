...
## Käyttöomaisuustoiminnan yleisen toiminnan määrittäminen
...
## Käyttöomaisuuden luokka- ja alaluokkakoodien määrittäminen
...
### Käyttöomaisuuden alaluokkakoodit
...
## Resurssien rekisteröinnin aloittaminen
...
## Käyttöomaisuuden sijaintikoodien määrittäminen (valinnainen)
...
## Käyttöomaisuuden kohdistustunnusten määrittäminen (valinnainen)
...
## Käyttöomaisuuden päiväkirjaerien määrittäminen (valinnainen)
...
## Käyttöomaisuuden uudelleenluokituspäiväkirjamallien määrittäminen (valinnainen)
...
## Käyttöomaisuuden uudelleenluokituspäiväkirjaerien määrittäminen (valinnainen)
