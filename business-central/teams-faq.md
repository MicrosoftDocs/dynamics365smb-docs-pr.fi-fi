...
### <a name="what-is-the-minimum-version-of--for-contact-search"></a>Mikä on yhteyshenkilöhaussa käytettävä [!INCLUDE [prod_short.md](includes/prod_short.md)]in vähimmäisversio?
