...
# <a name="set-up-contact-sync-with-outlook-for-business-central-on-premises"></a><a name="set-up-contact-sync-with-outlook-for-business-central-on-premises"></a>Määritä yhteyshenkilön synkronointi paikalliselle Outlook for Business Centralille
...
## <a name="introduction"></a><a name="introduction"></a>Esittely
...
## <a name="set-up-contact-sync"></a><a name="set-up-contact-sync"></a>Kontaktin synkronoinnin määritys
