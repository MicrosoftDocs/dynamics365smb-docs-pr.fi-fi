...
ms.author: andreipa
---
# <a name="work-with-recurring-revenue-in-"></a><a name="work-with-recurring-revenue-in-"></a><a name="work-with-recurring-revenue-in-"></a>Toistuvan tuoton käsitteleminen kohteessa [!INCLUDE[prod_short](includes/prod_short.md)]
...
## <a name="register-revenue-with-a-recurring-general-journal"></a><a name="register-revenue-with-a-recurring-general-journal"></a><a name="register-revenue-with-a-recurring-general-journal"></a>Rekisteröi tuotot toistuvassa yleisessä päiväkirjassa
...
### <a name="why-use-this-option"></a><a name="why-use-this-option"></a><a name="why-use-this-option"></a>Miksi käyttää tätä asetusta
...
## <a name="create-multiple-invoices-based-on-a-recurring-job-journal"></a><a name="create-multiple-invoices-based-on-a-recurring-job-journal"></a><a name="create-multiple-invoices-based-on-a-recurring-job-journal"></a>Luo useita laskuja toistuvan projektipäiväkirjan perusteella
...
### <a name="why-use-this-option-1"></a><a name="why-use-this-option-1"></a><a name="why-use-this-option-1"></a>Miksi käyttää tätä asetusta
...
## <a name="create-multiple-invoices-based-on-recurring-sales-lines"></a><a name="create-multiple-invoices-based-on-recurring-sales-lines"></a><a name="create-multiple-invoices-based-on-recurring-sales-lines"></a>Luo useita laskuja toistuvien myyntirivien perusteella
...
### <a name="why-use-this-option-2"></a><a name="why-use-this-option-2"></a><a name="why-use-this-option-2"></a>Miksi käyttää tätä asetusta
...
## <a name="recurring-invoices-with-service-contract"></a><a name="recurring-invoices-with-service-contract"></a><a name="recurring-invoices-with-service-contract"></a>Toistuvat laskut ja huoltosopimus
...
### <a name="why-use-this-option-3"></a><a name="why-use-this-option-3"></a><a name="why-use-this-option-3"></a>Miksi käyttää tätä asetusta
...
## <a name="related-features"></a><a name="related-features"></a><a name="related-features"></a>Aiheeseen liittyvät ominaisuudet
[!INCLUDE[prod_short](includes/prod_short.md)] -ohjelmassa on useita toisiinsa liittyviä toimintoja.

### <a name="blanket-sales-orders"></a><a name="blanket-sales-orders"></a><a name="blanket-sales-orders"></a>Puitemyyntitilaukset
...
#### <a name="why-use-this-option-4"></a><a name="why-use-this-option-4"></a><a name="why-use-this-option-4"></a>Miksi käyttää tätä asetusta
...
### <a name="recurring-orders-norway"></a><a name="recurring-orders-norway"></a><a name="recurring-orders-norway"></a>Toistuvat tilaukset (Norja)
...
#### <a name="why-use-this-option-5"></a><a name="why-use-this-option-5"></a><a name="why-use-this-option-5"></a>Miksi käyttää tätä asetusta
...
### <a name="recurring-revenue-and-subscription-billing-by-other-providers"></a><a name="recurring-revenue-and-subscription-billing-by-other-providers"></a><a name="recurring-revenue-and-subscription-billing-by-other-providers"></a>Muiden palveluntarjoajien toistuva tuotto- ja tilauslaskutus
