...
## <a name="register-revenue-with-a-recurring-general-journal" />Rekisteröi tuotot toistuvassa yleisessä päiväkirjassa
...
## <a name="create-multiple-invoices-based-on-a-recurring-job-journal" />Luo useita laskuja toistuvan projektipäiväkirjan perusteella
...
## <a name="create-multiple-invoices-based-on-recurring-sales-lines" />Luo useita laskuja toistuvien myyntirivien perusteella
...
## <a name="recurring-invoices-with-service-contract" />Toistuvat laskut ja huoltosopimus
...
## <a name="related-features" />Aiheeseen liittyvät ominaisuudet
[!INCLUDE[prod_short](includes/prod_short.md)] -ohjelmassa on useita toisiinsa liittyviä toimintoja.

### <a name="blanket-sales-orders" />Puitemyyntitilaukset
...
### <a name="recurring-orders-norway" />Toistuvat tilaukset (Norja)
...
### <a name="recurring-revenue-and-subscription-billing-by-other-providers" />Muiden palveluntarjoajien toistuva tuotto- ja tilauslaskutus
