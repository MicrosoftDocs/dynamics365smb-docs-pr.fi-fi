...
ms.author: jswymer
---
# <a name="entering-data" />Tietojen antaminen
...
## <a name="work-with-editable-fields" />Muokattavien kenttien käsitteleminen
...
### <a name="modifying-a-field-value" />Kentän arvon muokkaaminen
...
### <a name="how-quick-entry-works" />Pikatapahtuman toimintaperiaate
...
#### <a name="tips-and-tricks" />Vihjeet ja vinkit
...
### <a name="to-change-quick-entry-fields" />Pikatapahtumakenttien muuttaminen
...
## <a name="mandatory-fields" />Pakolliset kentät
...
## <a name="finding-data-as-you-type" />Tietojen etsiminen kirjoitettaessa
...
## <a name="copying-and-pasting-faq-fields-and-lines" />Kenttien ja rivien kopioimisen ja liittämisen usein kysytyt kysymykset
...
## <a name="filtering-line-items" />Rivinimikkeiden suodattaminen
...
### <a name="switching-the-focus-on-and-off" />Kohdituksen Kytkeminen Päälle ja Pois
...
## <a name="multitasking-across-multiple-pages" />Monen tehtävän suorittaminen yhtä aikaa useilla sivuilla
...
## <a name="entering-quantities-by-calculation" />Määrien antaminen laskutoimituksia käyttämällä
...
## <a name="entering-negative-numbers" />Negatiivisten lukujen syöttäminen
...
## <a name="entering-dates-and-times" />Päivämäärien ja aikojen syöttäminen
...
### <a name="entering-dates" />Päivämäärien syöttäminen
...
## <a name="entering-times" />Aikojen syöttäminen
...
## <a name="entering-combined-datetimes" />Yhdistettyjen päivämäärien ja aikojen syöttäminen

[!INCLUDE [datetimes](includes/datetimes.md)]

## <a name="entering-duration" />Keston syöttäminen
