...
---
# <a name="flows-for-production-assembly-and-jobs" />Tuotanto-, kokoonpano- ja projektityönkulut
...
## <a name="overview-of-different-configuration-options" />Erilaisten määritysvaihtoehtojen yleiskatsaus
...
### <a name="inbound-flow-put-away" />Saapuva virta (hyllytys)
...
### <a name="outbound-flow-pick" />Lähtevä virta (poiminta)
...
## <a name="warehouses-without-dedicated-warehouse-activity" />Fyysiset varastot, joissa ei ole erillistä varastotoimintoa
...
## <a name="basic-warehouse-configuration" />Fyysisen varastoinnin perusmääritykset
...
### <a name="flows-to-and-from-production-in-a-basic-warehouse-configuration" />Fyysisen varastoinnin perusmääritysten tuotannon tulevat ja lähtevät työnkulut
...
### <a name="flows-to-and-from-assembly-in-a-basic-warehouse-configuration" />Fyysisen varastoinnin perusmääritysten kokoonpanoon tulevat lähtevät työnkulut
...
### <a name="flows-for-project-management-in-a-basic-warehouse-configuration" />Fyysisen varaston perusmääritysten projektinhallinnan työnkulut
...
### <a name="flows-to-and-from-production-in-advanced-warehouse-configurations" />Fyysisen varastoinnin laajennettujen määritysten tuotannon tulevat ja lähtevät työnkulut
...
### <a name="flows-to-and-from-assembly-in-advanced-warehouse-configurations" />Fyysisen varastoinnin laajennettujen määritysten kokoonpanon tulevat ja lähtevät työnkulut
...
### <a name="flows-to-project-management-in-advanced-warehouse-configurations" />Fyysisen varaston laajennettujen määritysten projektinhallinnan työnkulut
