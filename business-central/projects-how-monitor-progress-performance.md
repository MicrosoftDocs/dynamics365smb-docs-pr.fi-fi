...
---
# <a name="monitor-job-progress-and-performance" />Projektin edistymisen ja suorituskyvyn valvonta
...
## <a name="create-a-job-wip-method" />Projektin KET-menetelmän luominen
...
## <a name="define-a-wip-method-for-a-job" />KET-menetelmän määrittäminen projektille
...
### <a name="define-a-wip-method-for-a-job-task" />KET-menetelmän määrittäminen projektitehtävälle
...
## <a name="calculate-wip" />Laske KET
...
## <a name="calculate-and-post-job-completion-entries" />Projektin valmistumistapahtumien laskeminen ja kirjaaminen
...
## <a name="view-job-ledger-entries" />Projektin kirjanpitotapahtumien tarkasteleminen
