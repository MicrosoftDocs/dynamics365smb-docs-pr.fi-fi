...
## <a name="define-a-wip-method-for-a-project"></a>KET-menetelmän määrittäminen projektille
...
## <a name="view-project-ledger-entries"></a>Projektin kirjanpitotapahtumien tarkasteleminen
