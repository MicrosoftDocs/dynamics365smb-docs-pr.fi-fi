...
---
# <a name="monitor-job-progress-and-performance"></a><a name="monitor-job-progress-and-performance"></a><a name="monitor-job-progress-and-performance"></a>Projektin edistymisen ja suorituskyvyn valvonta
...
## <a name="create-a-job-wip-method"></a><a name="create-a-job-wip-method"></a><a name="create-a-job-wip-method"></a>Projektin KET-menetelmän luominen
...
## <a name="define-a-wip-method-for-a-job"></a><a name="define-a-wip-method-for-a-job"></a><a name="define-a-wip-method-for-a-job"></a>KET-menetelmän määrittäminen projektille
...
### <a name="define-a-wip-method-for-a-job-task"></a><a name="define-a-wip-method-for-a-job-task"></a><a name="define-a-wip-method-for-a-job-task"></a>KET-menetelmän määrittäminen projektitehtävälle
...
## <a name="calculate-wip"></a><a name="calculate-wip"></a><a name="calculate-wip"></a>Laske KET
...
## <a name="post-wip"></a><a name="post-wip"></a><a name="post-wip"></a>Kirjaa KET
...
## <a name="calculate-and-post-job-completion-entries"></a><a name="calculate-and-post-job-completion-entries"></a><a name="calculate-and-post-job-completion-entries"></a>Projektin valmistumistapahtumien laskeminen ja kirjaaminen
...
## <a name="view-job-ledger-entries"></a><a name="view-job-ledger-entries"></a><a name="view-job-ledger-entries"></a>Projektin kirjanpitotapahtumien tarkasteleminen
...
## <a name="find-related-microsoft-training"></a><a name="find-related-microsoft-training"></a><a name="find-related-microsoft-training"></a>Etsi aiheeseen liittyvät [Microsoftin koulutukset](/training/paths/calculate-post-job-wip/)
