...
ms.author: jswymer
---
# <a name="closing-income-statement-accounts" />Tuloslaskelmatilien sulkeminen
...
## <a name="to-run-the-close-income-statement-batch-job" />Sulje tuloslaskelma -eräajon ajaminen
...
## <a name="about-the-close-income-statement-batch-job" />Tietoja Sulje tuloslaskelma -eräajosta
