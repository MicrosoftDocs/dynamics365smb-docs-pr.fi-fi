...
ms.author: edupont
---
# <a name="add-extended-text" />Lisätekstin lisääminen
...
## <a name="to-define-extended-text-for-an-description" />Kuvauksen lisätekstin määrittäminen
...
## <a name="to-add-an-extended-item-text-on-a-sales-order-line" />Laajennetun nimiketekstin lisääminen myyntitilausriville
