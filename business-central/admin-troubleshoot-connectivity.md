...
ROBOTS: NOINDEX
---
# <a name="troubleshoot-connectivity-for-business-central" />Business Central -yhteyden vianmääritys
...
## <a name="start-the-connectivity-check" />Aloita yhteyden tarkistus
...
## <a name="basic-internet-connectivity" />Perusyhteys internetiin
...
## <a name="cdn-content-delivery-network-resources-loading" />CDN (content delivery network) -resurssien lataaminen
...
## <a name="user-authentication" />Käyttäjän todennus
...
## <a name="business-central-environments-discovery" />Business Central -ympäristöjen etsiminen
...
## <a name="application-service-connectivity" />Sovelluspalvelun yhteys
...
## <a name="web-server-connectivity" />Verkkopalvelimen yhteys
...
## <a name="service-health-status" />Palvelun kunnon tila
