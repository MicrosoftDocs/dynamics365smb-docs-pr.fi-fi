...
---
# <a name="analyze-data-with-statistical-accounts" />Analysoi tietoja tilastotilien avulla
...
## <a name="set-up-a-statistical-account" />Tilastollisen tilin määrittäminen
...
## <a name="post-amounts-to-a-statistical-account" />Kirjaa määrät tilastolliseen tiliin
...
## <a name="verify-statistical-account-amounts" />Tarkista tilastollisen tilin summat
...
## <a name="include-the-statistical-account-in-a-financial-report" />Sisällytä tilastotili talousraporttiin
