...
ms.author: bholtorf
---
# <a name="set-up-a-loaner-program"></a><a name="set-up-a-loaner-program"></a>Lainatavaraohjelman määrittäminen
...
## <a name="to-set-up-a-loaner"></a><a name="to-set-up-a-loaner"></a>Lainatavaran määrittäminen
