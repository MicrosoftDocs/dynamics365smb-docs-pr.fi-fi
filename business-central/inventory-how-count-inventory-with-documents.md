...
ms.author: edupont
---
# <a name="count-and-adjust-inventory-using-documents" />Varastojen laskenta ja muutos asiakirjoja käyttämällä
...
## <a name="to-create-a-physical-inventory-order" />Inventointitilauksen luominen
...
## <a name="to-create-a-physical-inventory-recording" />Inventointitallennuksen luominen
...
## <a name="to-finish-a-physical-inventory-recording" />Inventointitallennuksen valmistuminen
...
## <a name="to-complete-a-physical-inventory-order" />Inventointitilauksen viimeisteleminen
...
### <a name="to-find-duplicate-physical-inventory-order-lines" />Inventointitilausrivien kaksoiskappaleiden löytäminen
...
### <a name="to-post-a-physical-inventory-order" />Inventointitilauksen kirjaaminen
...
### <a name="to-view-posted-physical-inventory-orders" />Kirjattujen inventointitilausten tarkasteleminen
...
## <a name="handling-item-tracking-when-counting-inventory" />Nimikeseurannan käsittely varastoa laskettaessa
...
### <a name="example---prepare-a-physical-inventory-recording-for-an-item-tracked-item" />Esimerkki – nimekeseuratun nimikkeen inventointitallennuksen valmistelu
...
### <a name="example---record-and-post-counted-lot-number-differences" />Esimerkki – laskettujen eränumeroerojen tallentaminen ja kirjaaminen
...
## <a name="inventory-documents" />Varastoasiakirjat
...
### <a name="to-set-up-numbering-for-inventory-documents" />Varastoasiakirjojen numeroinnin määrittäminen
...
### <a name="to-create-and-post-an-inventory-document" />Varastoasiakirjan luominen ja kirjaaminen
...
## <a name="printing-inventory-documents" />Varastoasiakirjojen tulostaminen
