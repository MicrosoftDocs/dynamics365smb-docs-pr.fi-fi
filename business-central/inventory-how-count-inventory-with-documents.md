...
ms.author: edupont
---
# <a name="count-and-adjust-inventory-using-documents"></a><a name="count-and-adjust-inventory-using-documents"></a><a name="count-and-adjust-inventory-using-documents"></a>Varastojen laskenta ja muutos asiakirjoja käyttämällä
...
## <a name="to-create-a-physical-inventory-order"></a><a name="to-create-a-physical-inventory-order"></a><a name="to-create-a-physical-inventory-order"></a>Inventointitilauksen luominen
...
## <a name="to-create-a-physical-inventory-recording"></a><a name="to-create-a-physical-inventory-recording"></a><a name="to-create-a-physical-inventory-recording"></a>Inventointitallennuksen luominen
...
## <a name="to-finish-a-physical-inventory-recording"></a><a name="to-finish-a-physical-inventory-recording"></a><a name="to-finish-a-physical-inventory-recording"></a>Inventointitallennuksen valmistuminen
...
## <a name="to-complete-a-physical-inventory-order"></a><a name="to-complete-a-physical-inventory-order"></a><a name="to-complete-a-physical-inventory-order"></a>Inventointitilauksen viimeisteleminen
...
### <a name="to-find-duplicate-physical-inventory-order-lines"></a><a name="to-find-duplicate-physical-inventory-order-lines"></a><a name="to-find-duplicate-physical-inventory-order-lines"></a>Inventointitilausrivien kaksoiskappaleiden löytäminen
...
### <a name="to-post-a-physical-inventory-order"></a><a name="to-post-a-physical-inventory-order"></a><a name="to-post-a-physical-inventory-order"></a>Inventointitilauksen kirjaaminen
...
### <a name="to-view-posted-physical-inventory-orders"></a><a name="to-view-posted-physical-inventory-orders"></a><a name="to-view-posted-physical-inventory-orders"></a>Kirjattujen inventointitilausten tarkasteleminen
...
## <a name="handling-item-tracking-when-counting-inventory"></a><a name="handling-item-tracking-when-counting-inventory"></a><a name="handling-item-tracking-when-counting-inventory"></a>Nimikeseurannan käsittely varastoa laskettaessa
...
### <a name="example---record-and-post-counted-lot-number-differences"></a><a name="example---record-and-post-counted-lot-number-differences"></a><a name="example---record-and-post-counted-lot-number-differences"></a>Esimerkki – laskettujen eränumeroerojen tallentaminen ja kirjaaminen
...
## <a name="inventory-documents"></a><a name="inventory-documents"></a><a name="inventory-documents"></a>Varastoasiakirjat
...
### <a name="to-set-up-numbering-for-inventory-documents"></a><a name="to-set-up-numbering-for-inventory-documents"></a><a name="to-set-up-numbering-for-inventory-documents"></a>Varastoasiakirjojen numeroinnin määrittäminen
...
### <a name="to-create-and-post-an-inventory-document"></a><a name="to-create-and-post-an-inventory-document"></a><a name="to-create-and-post-an-inventory-document"></a>Varastoasiakirjan luominen ja kirjaaminen
...
## <a name="printing-inventory-documents"></a><a name="printing-inventory-documents"></a><a name="printing-inventory-documents"></a>Varastoasiakirjojen tulostaminen
