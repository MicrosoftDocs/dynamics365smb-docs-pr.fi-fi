...
ms.author: edupont
---
# <a name="work-with-production-families" />Tuotantoperheiden käsitteleminen
...
## <a name="to-set-up-a-production-family" />Tuotantoperheen määrittäminen
...
## <a name="to-produce-based-on-a-production-family" />Tuotanto tuoteperheen perusteella
