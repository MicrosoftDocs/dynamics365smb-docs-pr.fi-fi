---
title: Hyväksyntätyönkulkujen ottaminen käyttöön
...
ms.author: edupont
---
# <a name="enable-approval-workflows"></a><a name="enable-approval-workflows"></a><a name="enable-approval-workflows"></a>Hyväksymistyönkulkujen ottaminen käyttöön
...
## <a name="enable-a-workflow"></a><a name="enable-a-workflow"></a><a name="enable-a-workflow"></a>Työnkulun ottaminen käyttöön
