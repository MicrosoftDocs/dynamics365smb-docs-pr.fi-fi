...
ms.author: edupont
---
# <a name="design-details-known-item-application-issue" />Rakennetiedot: Nimikkeen kohdistuksen tunnettu ongelma
...
## <a name="symptoms-of-the-issue" />Ongelman oireet
...
## <a name="basics-of-item-application" />Nimikkeen kohdistuksen perusteet
...
### <a name="quantity-application" />Määrän kohdistus
...
### <a name="cost-application" />Kustannusten kohdistus
...
## <a name="illustration-of-a-basic-cost-flow" />Peruskustannusvirran kuva
...
## <a name="reasons-for-the-issue" />Ongelman syyt
...
## <a name="identifying-the-issue" />Ongelman tunnistaminen
...
## <a name="workaround-for-the-issue" />Ongelman ratkaisu
