...
ms.author: edupont
---
# <a name="design-details-known-item-application-issue"></a><a name="design-details-known-item-application-issue"></a>Rakennetiedot: Nimikkeen kohdistuksen tunnettu ongelma
...
## <a name="symptoms-of-the-issue"></a><a name="symptoms-of-the-issue"></a>Ongelman oireet
...
## <a name="basics-of-item-application"></a><a name="basics-of-item-application"></a>Nimikkeen kohdistuksen perusteet
...
### <a name="quantity-application"></a><a name="quantity-application"></a>Määrän kohdistus
...
### <a name="cost-application"></a><a name="cost-application"></a>Kustannusten kohdistus
...
## <a name="illustration-of-a-basic-cost-flow"></a><a name="illustration-of-a-basic-cost-flow"></a>Peruskustannusvirran kuva
...
## <a name="reasons-for-the-issue"></a><a name="reasons-for-the-issue"></a>Ongelman syyt
...
## <a name="identifying-the-issue"></a><a name="identifying-the-issue"></a>Ongelman tunnistaminen
...
## <a name="workaround-for-the-issue"></a><a name="workaround-for-the-issue"></a>Ongelman ratkaisu
