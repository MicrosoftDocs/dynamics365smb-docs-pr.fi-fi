---
title: 'Pakettien myynti, kokoaminen ja toimitus'
description: Just-in-time -varastoinnin tukemiseksi kokoonpanotilaukset voidaan luoda ja linkittää automaattisesti heti kun myyntitilausrivi on luotu.
author: SorenGP
ms.topic: conceptual
ms.devlang: na
ms.tgt_pltfrm: na
...
ms.author: edupont
---
# <a name="walkthrough-selling-assembling-and-shipping-kits"></a><a name="walkthrough-selling-assembling-and-shipping-kits"></a><a name="walkthrough-selling-assembling-and-shipping-kits"></a>Vaihekuvaus: pakettien myynti, kokoaminen ja toimitus
...
### <a name="setting-up-assembly-items"></a><a name="setting-up-assembly-items"></a><a name="setting-up-assembly-items"></a>Kokoonpanon nimikkeiden määrittäminen
...
### <a name="selling-customized-assembly-items"></a><a name="selling-customized-assembly-items"></a><a name="selling-customized-assembly-items"></a>Mukautetun kokoonpanon nimikkeiden myynti
...
### <a name="planning-for-assembly-items"></a><a name="planning-for-assembly-items"></a><a name="planning-for-assembly-items"></a>Kokoonpanon nimikkeiden suunnittelu
...
### <a name="assembling-items"></a><a name="assembling-items"></a><a name="assembling-items"></a>Nimikkeiden kokoonpano
...
### <a name="shipping-assembly-items-from-stock-and-assembled-to-order"></a><a name="shipping-assembly-items-from-stock-and-assembled-to-order"></a><a name="shipping-assembly-items-from-stock-and-assembled-to-order"></a>Toimitetaan kokoonpanon nimikkeet varastosta ja kokoonpano tilausta varten
...
## <a name="prepare-sample-data"></a><a name="prepare-sample-data"></a><a name="prepare-sample-data"></a>Esimerkkitietojen valmisteleminen
...
5.  Valitse ![Lamppu, joka avaa Kerro-ominaisuuden.](media/ui-search/search_small.png "Kerro, mitä haluat tehdä") -kuvake, syötä **Nimikepäiväkirjat** ja valitse sitten vastaava linkki. **Nimikepäiväkirja**-sivu avautuu.  
...
### <a name="creating-the-assembly-items"></a><a name="creating-the-assembly-items"></a><a name="creating-the-assembly-items"></a>Kokoonpanon nimikkeiden luominen
...
### <a name="selling-the-assembly-items"></a><a name="selling-the-assembly-items"></a><a name="selling-the-assembly-items"></a>Kokoonpanon nimikkeiden myynti
...
### <a name="planning-for-the-unavailable-ats-items"></a><a name="planning-for-the-unavailable-ats-items"></a><a name="planning-for-the-unavailable-ats-items"></a>Ei käytettävissä olevien ATS-nimikkeiden suunnittelu
...
### <a name="assembling-and-shipping-the-first-ato-quantity"></a><a name="assembling-and-shipping-the-first-ato-quantity"></a><a name="assembling-and-shipping-the-first-ato-quantity"></a>Ensimmäisen ATO-määrän kokoaminen ja toimitus
...
4.  Valitse ![Lamppu, joka avaa Kerro-ominaisuuden.](media/ui-search/search_small.png "Kerro, mitä haluat tehdä") -kuvake, syötä **Poiminnat** ja valitse sitten vastaava linkki.  
...
### <a name="assembling-and-recording-the-second-ato-quantity"></a><a name="assembling-and-recording-the-second-ato-quantity"></a><a name="assembling-and-recording-the-second-ato-quantity"></a>Toisen ATO-määrän kokoonpano ja tallentaminen
...
### <a name="assembling-the-ats-quantity"></a><a name="assembling-the-ats-quantity"></a><a name="assembling-the-ats-quantity"></a>ATS-määrän kokoonpano
...
5.  Valitse ![Lamppu, joka avaa Kerro-ominaisuuden.](media/ui-search/search_small.png "Kerro, mitä haluat tehdä") -kuvake, syötä **Poiminnat** ja valitse sitten vastaava linkki.  
...
10. Valitse ![Lamppu, joka avaa Kerro-ominaisuuden.](media/ui-search/search_small.png "Kerro, mitä haluat tehdä") -kuvake, syötä **Myyntitilaukset** ja valitse sitten vastaava linkki.  
