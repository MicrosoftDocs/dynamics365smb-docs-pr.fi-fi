...
ms.author: edupont
---
# <a name="walkthrough-selling-assembling-and-shipping-kits"></a><a name="walkthrough-selling-assembling-and-shipping-kits"></a>Vaihekuvaus: pakettien myynti, kokoaminen ja toimitus
...
### <a name="setting-up-assembly-items"></a><a name="setting-up-assembly-items"></a>Kokoonpanon nimikkeiden määrittäminen
...
### <a name="selling-customized-assembly-items"></a><a name="selling-customized-assembly-items"></a>Mukautetun kokoonpanon nimikkeiden myynti
...
### <a name="planning-for-assembly-items"></a><a name="planning-for-assembly-items"></a>Kokoonpanon nimikkeiden suunnittelu
...
### <a name="assembling-items"></a><a name="assembling-items"></a>Nimikkeiden kokoonpano
...
### <a name="shipping-assembly-items-from-stock-and-assembled-to-order"></a><a name="shipping-assembly-items-from-stock-and-assembled-to-order"></a>Toimitetaan kokoonpanon nimikkeet varastosta ja kokoonpano tilausta varten
...
## <a name="prepare-sample-data"></a><a name="prepare-sample-data"></a>Esimerkkitietojen valmisteleminen
...
### <a name="creating-the-assembly-items"></a><a name="creating-the-assembly-items"></a>Kokoonpanon nimikkeiden luominen
...
### <a name="selling-the-assembly-items"></a><a name="selling-the-assembly-items"></a>Kokoonpanon nimikkeiden myynti
...
### <a name="planning-for-the-unavailable-ats-items"></a><a name="planning-for-the-unavailable-ats-items"></a>Ei käytettävissä olevien ATS-nimikkeiden suunnittelu
...
### <a name="assembling-and-shipping-the-first-ato-quantity"></a><a name="assembling-and-shipping-the-first-ato-quantity"></a>Ensimmäisen ATO-määrän kokoaminen ja toimitus
...
### <a name="assembling-and-recording-the-second-ato-quantity"></a><a name="assembling-and-recording-the-second-ato-quantity"></a>Toisen ATO-määrän kokoonpano ja tallentaminen
...
### <a name="assembling-the-ats-quantity"></a><a name="assembling-the-ats-quantity"></a>ATS-määrän kokoonpano
...
### <a name="shipping-the-remaining-items-partly-from-stock-and-partly-assembled-to-the-order"></a><a name="shipping-the-remaining-items-partly-from-stock-and-partly-assembled-to-the-order"></a>Toimitetaan jäljellä olevat nimikkeet osittain varastosta ja osittain kootaan tilausta varten
