...
ms.author: edupont
---
# <a name="walkthrough-selling-assembling-and-shipping-kits" />Vaihekuvaus: pakettien myynti, kokoaminen ja toimitus
...
### <a name="setting-up-assembly-items" />Kokoonpanon nimikkeiden määrittäminen
...
### <a name="selling-customized-assembly-items" />Mukautetun kokoonpanon nimikkeiden myynti
...
### <a name="planning-for-assembly-items" />Kokoonpanon nimikkeiden suunnittelu
...
### <a name="assembling-items" />Nimikkeiden kokoonpano
...
### <a name="shipping-assembly-items-from-stock-and-assembled-to-order" />Toimitetaan kokoonpanon nimikkeet varastosta ja kokoonpano tilausta varten
...
## <a name="prepare-sample-data" />Esimerkkitietojen valmisteleminen
...
### <a name="creating-the-assembly-items" />Kokoonpanon nimikkeiden luominen
...
### <a name="selling-the-assembly-items" />Kokoonpanon nimikkeiden myynti
...
### <a name="planning-for-the-unavailable-ats-items" />Ei käytettävissä olevien ATS-nimikkeiden suunnittelu
...
### <a name="assembling-and-shipping-the-first-ato-quantity" />Ensimmäisen ATO-määrän kokoaminen ja toimitus
...
### <a name="assembling-and-recording-the-second-ato-quantity" />Toisen ATO-määrän kokoonpano ja tallentaminen
...
### <a name="assembling-the-ats-quantity" />ATS-määrän kokoonpano
...
### <a name="shipping-the-remaining-items-partly-from-stock-and-partly-assembled-to-the-order" />Toimitetaan jäljellä olevat nimikkeet osittain varastosta ja osittain kootaan tilausta varten
