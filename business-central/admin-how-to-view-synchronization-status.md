...
# <a name="view-the-status-of-synchronization-jobs" />Synkronointitöiden tilan näyttäminen
...
## <a name="to-view-and-resolve-synchronization-errors-for-coupled-records" />Yhdistettyjen tietueiden synkronointivirheiden tarkasteleminen ja ratkaiseminen
...
## <a name="to-view-the-synchronization-log-for-a-specific-manually-synchronized-record" />Tietyn (manuaalisesti synkronoidun) tietueen synkronointilokin näyttäminen
...
## <a name="remove-couplings-between-records" />Liitosten poistaminen tietueiden väliltä
