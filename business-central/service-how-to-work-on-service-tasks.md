...
ms.author: edupont
---
# <a name="work-on-service-tasks" />Huoltotehtävien käyttäminen
...
## <a name="to-work-on-a-service-task" />Huoltotehtävien parissa työskenteleminen
...
## <a name="to-register-service-operations" />Huoltotoimintojen rekisteröiminen
...
## <a name="to-register-spare-parts" />Varaosien rekisteröiminen
...
## <a name="to-register-spare-parts-from-a-service-order" />Rekisteröi varaosat huoltotilauksesta
...
## <a name="to-replace-a-service-item-or-a-service-item-component" />Huoltonimikkeen tai huoltonimikkeen komponentin korvaaminen
...
## <a name="to-change-the-response-time-for-a-service-item-line" />Huoltonimikerivin vastausajan muuttaminen
...
## <a name="to-register-faultresolution-codes" />Vika-/ratkaisukoodien rekisteröiminen
