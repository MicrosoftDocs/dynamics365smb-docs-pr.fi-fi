...
# <a name="responding-to-requests-about-users-personal-data" />Käyttäjien henkilökohtaisia tietoja koskeviin pyyntöihin vastaaminen
...
## <a name="types-of-requests" />Pyyntöjen tyypit
...
## <a name="restrict-data-processing-for-a-data-subject" />Tietojen kohteen tietojen käsittelyn rajoittaminen
...
## <a name="handling-data-subject-requests-when-using-a-trial-version" />Tietojen kohteen pyyntöjen käsittely kokeiluversiota käytettäessä
...
## <a name="exporting-data-from-tables-not-classified-by-data-subject" />Tietojen vieminen taulukoista, joita ei ole luokiteltu tietojen aiheen mukaan
...
## <a name="handling-data-about-minors" />Alaikäisiä koskevien tietojen käsitteleminen
