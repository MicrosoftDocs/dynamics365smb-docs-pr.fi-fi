...
ms.author: edupont
---
# <a name="approval-workflow-notifications"></a><a name="approval-workflow-notifications"></a><a name="approval-workflow-notifications"></a>Hyväksyntätyönkulkuilmoitukset
...
## <a name="set-up-notifications"></a><a name="set-up-notifications"></a><a name="set-up-notifications"></a>Ilmoitusten määrittäminen
