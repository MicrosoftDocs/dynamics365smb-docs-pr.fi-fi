...
ms.author: edupont
---
# <a name="manage-employee-absence" />Työntekijöiden poissaolojen hallinta
...
## <a name="to-register-employee-absence" />Työntekijöiden poissaolojen rekisteröinti:
...
## <a name="to-view-an-individual-employees-absence" />Tarkastele yksittäisen työntekijän poissaoloja
...
## <a name="to-view-an-employees-absence-by-categories" />Tarkastele työntekijän poissaoloja luokittain
1. Valitse oikeassa yläkulmassa oleva **Etsi sivu tai raportti** -kuvake, syötä **Työntekijät** ja valitse sitten aiheeseen liittyvä linkki.
...
## <a name="to-view-all-employee-absences-by-category" />Tarkastele kaikkien työntekijöiden poissaoloja luokittain
1. Valitse oikeassa yläkulmassa oleva **Etsi sivu tai raportti** -kuvake, syötä **Poissaolon rekisteröinti** ja valitse sitten aiheeseen liittyvä linkki.
...
## <a name="to-view-all-employee-absences-by-period" />Tarkastele kaikkien työntekijöiden poissaoloja kausittain
1. Valitse oikeassa yläkulmassa oleva **Etsi sivu tai raportti** -kuvake, syötä **Poissaolon rekisteröinti** ja valitse sitten aiheeseen liittyvä linkki.
