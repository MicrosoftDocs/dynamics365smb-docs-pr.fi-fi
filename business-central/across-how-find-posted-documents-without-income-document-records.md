...
ms.author: edupont
---
# <a name="find-posted-documents-without-incoming-document-records" />Sellaisten kirjattujen asiakirjojen etsiminen, joilla ei ole saapuvia asiakirjatietueita
...
## <a name="to-find-posted-documents-without-incoming-document-records" />Sellaisten kirjattujen asiakirjojen etsiminen, joilla ei ole saapuvia asiakirjatietueita
...
## <a name="to-connect-found-documents-to-existing-incoming-document-records" />Löydettyjen asiakirjojen yhdistäminen olemassa oleviin saapuviin asiakirjatietueisiin
