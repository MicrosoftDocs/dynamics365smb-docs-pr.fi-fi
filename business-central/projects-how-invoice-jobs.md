...
ms.author: edupont
---
# <a name="invoice-jobs"></a><a name="invoice-jobs"></a>Projektien laskuttaminen
...
## <a name="to-create-multiple-job-sales-invoices"></a><a name="to-create-multiple-job-sales-invoices"></a>Voit luoda monta projektin myyntilaskua
...
## <a name="to-create-and-post-job-sales-invoice-from-job-planning-lines"></a><a name="to-create-and-post-job-sales-invoice-from-job-planning-lines"></a>Projektin myyntilaskun luominen ja kirjaaminen projektin suunnitteluriveistä
