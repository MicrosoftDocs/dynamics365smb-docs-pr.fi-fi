...
### <a name="filter-criteria-and-operators"></a><a name="FilterCriteria"> </a>Suodatusehdot ja operaattorit
...
## <a name="see-related-training-at-microsoft-learn"></a>Lisätietoja aiheeseen liittyvistä kursseista on [Microsoft Learnissa](/learn/modules/search-filter-sort-data-dynamics-365-business-central/)
