...
ms.author: bholtorf
---
# <a name="enable-automatic-breaking-bulk-with-directed-put-away-and-pick" />Irtotavaran ohjatulla hyllytyksellä ja poiminnalla tapahtuvan automaattisen erottelun ottaminen käyttöön
...
## <a name="breakbulk-in-picks" />Erotteleminen poiminnoissa
...
## <a name="breakbulk-in-put-aways" />Erottelu hyllytyksissä
...
## <a name="breakbulk-in-movements" />Erottelu varastosiirroissa
