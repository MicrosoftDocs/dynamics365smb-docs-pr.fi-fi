---
title: 'Nimikkeiden poiminta tai siirtäminen tuotantoa, aAssemblya tai perusvarastoinnin määritysten projekteja varten'
...
Aktivoi seuraavat asetukset lähtevälle virralle (poiminnalle) **perusvarastointimäärityksessä sijainnin Sijainti-kortti**  sivulla:

* Tuotanto, valitse **Tuotannon kulutus f. var. -kentässä Varaston poiminta** /siirto **. Käsittely-kenttä** .
* Kokoonpano, valitse Asm-kentässä **Varaston** siirto **. Kulutus F. var. Käsittely-kenttä** .
* Projektinhallinta, valitse **Projektin kulutus f. var. -kentässä Varaston** poiminta **. Käsittely-kenttä** .
...
Varastopaikkoja käyttävien sijaintien osalta voit laajentaa työnkulun projektiin Varastosiirto-asiakirjoilla **·** .
...
|Projektit | Muuta projektin tilaksi **Avoin** tai luo heti projekti, jonka tila on Avoin.|  
