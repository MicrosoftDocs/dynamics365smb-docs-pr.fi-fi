...
---
# <a name="pick-for-production-assembly-or-jobs-in-basic-warehouse-configurations" />Tuotanto-, kokoonpano- ja projektipoiminta perusvarastointimäärityksissä
...
## <a name="inventory-picks" />Varaston poiminnat
...
## <a name="inventory-movements" />Varastosiirrot
...
### <a name="project-management" />Projektinhallinta
...
## <a name="pick-or-move-for-production-assembly-and-jobs-in-a-basic-warehouse-configuration" />Tuotantoon, kokoonpanoon ja projekteihin poimiminen tai siirtäminen fyysisen varastoinnin perusmäärityksissä
...
### <a name="to-create-an-inventory-pick-from-the-source-document" />Varastopoiminnan lähdeasiakirjasta luominen
...
### <a name="to-create-an-inventory-movement-from-the-source-document" />Varaston siirron luominen lähdeasiakirjasta
...
### <a name="to-create-multiple-inventory-picks-or-movements-with-a-batch-job" />Useiden varaston poimintojen tai siirtojen luominen eräajon avulla
...
### <a name="to-create-inventory-picks-or-movements-in-two-steps" />Varaston poimintojen tai siirtojen luominen kahdessa vaiheessa
...
## <a name="to-record-the-inventory-pick" />Varaston poiminnan kirjaaminen
...
## <a name="to-record-the-inventory-movement" />Varastosiirron kirjaaminen
...
## <a name="flushing-production-components-in-a-basic-warehouse-configuration" />Tuotannon komponenttien materiaaliotot fyysisen varastoinnin perusmäärityksissä
