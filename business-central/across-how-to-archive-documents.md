...
---
# <a name="archive-documents" />Asiakirjojen arkistointi
...
## <a name="to-set-up-automatic-document-archiving" />Asiakirjojen automaattisen arkistoinnin määrittäminen
...
## <a name="to-manually-archive-a-sales-order" />Myyntitilauksen arkistointi manuaalisesti
...
## <a name="to-restore-a-non-posted-sales-order-from-the-archive" />Kirjaamattomien myyntitilausten palauttaminen arkistosta
...
## <a name="to-delete-archived-sales-orders" />Arkistoitujen myyntitilausten poistaminen
