...
# <a name="add-business-central-tab-in-microsoft-teams" />Business Central -välilehden lisääminen Microsoft Teamsiin
...
## <a name="about-business-central-tabs" />Tietoja Business Centralin välilehdistä
...
## <a name="add-tab-using-recommended-content" />Lisää välilehti käyttäen suositeltua sisältöä
...
## <a name="add-tab-using-a-page-link" />Lisää välilehti käyttämällä sivun linkkiä
...
## <a name="add-tab-by-pinning-card-details" />Lisää välilehti kiinnittämällä kortin tiedot
...
## <a name="change-a-tab-and-its-content" />Välilehden ja sen sisällön muuttaminen
