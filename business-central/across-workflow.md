...
---
# <a name="workflows-in-business-central"></a>Dynamics 365 Business Centralin työnkulut
...
[!INCLUDE [prod_short](includes/prod_short.md)] -ohjelman oletusversio tukee tämän tyyppisiä työnkulkuja:
...
Esimerkkejä hyväksymistyönkulkutapahtumista ovat myynti- tai ostotilausten/tarjousten/laskujen luominen, hintojen muutokset sekä myyjän tai asiakkaan muokkaukset, jne.
