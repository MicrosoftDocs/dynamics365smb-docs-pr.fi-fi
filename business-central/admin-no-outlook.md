...
ms.author: edupont
---
# <a name="use-business-central-without-outlook"></a><a name="use-business-central-without-outlook"></a>Business Central -sovelluksen käyttäminen ilman Outlookia
...
## <a name="sending-email"></a><a name="sending-email"></a>Sähköpostin lähettäminen
