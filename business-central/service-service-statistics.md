...
# <a name="viewing-service-statistics" />Huoltotilastojen tarkasteleminen
...
## <a name="viewing-statistics-for-service-orders" />Huoltotilauksen tilastojen tarkasteleminen
...
### <a name="view-totals-for-a-service-order" />Huoltotilauksen kokonaissummien tarkasteleminen
...
### <a name="view-shipping-information" />Toimitustietojen tarkasteleminen
...
### <a name="view-order-details" />Tilaustietojen tarkasteleminen
...
### <a name="analyze-service-order-lines" />Huoltotilausrivien analysointi
...
### <a name="view-customer-information" />Asiakastietojen tarkasteleminen
...
## <a name="viewing-service-item-statistics" />Huoltonimikkeen tilastojen tarkasteleminen
...
## <a name="use-trendscapes" />Trendscape-näkymien käyttäminen
...
## <a name="viewing-gains-and-losses-on-contracts" />Sopimusten voittojen ja tappioiden tarkasteleminen
...
## <a name="viewing-statistics-for-posted-service-documents" />Kirjattujen huoltoasiakirjojen tilastojen tarkasteleminen
...
### <a name="posted-service-shipment-statistics" />Kirjatun huoltotoimituksen tilastot
...
### <a name="posted-service-invoice-statistics" />Kirjatun huoltolaskun tilastot
...
### <a name="posted-service-credit-memo-statistics" />Kirjattujen huollon hyvityslaskujen tilastot
