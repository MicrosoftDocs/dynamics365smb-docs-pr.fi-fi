...
# <a name="viewing-service-statistics"></a><a name="viewing-service-statistics"></a><a name="viewing-service-statistics"></a>Huoltotilastojen tarkasteleminen
...
## <a name="viewing-statistics-for-service-orders"></a><a name="viewing-statistics-for-service-orders"></a><a name="viewing-statistics-for-service-orders"></a>Huoltotilauksen tilastojen tarkasteleminen
...
### <a name="view-totals-for-a-service-order"></a><a name="view-totals-for-a-service-order"></a><a name="view-totals-for-a-service-order"></a>Huoltotilauksen kokonaissummien tarkasteleminen
...
### <a name="view-shipping-information"></a><a name="view-shipping-information"></a><a name="view-shipping-information"></a>Toimitustietojen tarkasteleminen
...
### <a name="view-order-details"></a><a name="view-order-details"></a><a name="view-order-details"></a>Tilaustietojen tarkasteleminen
...
### <a name="analyze-service-order-lines"></a><a name="analyze-service-order-lines"></a><a name="analyze-service-order-lines"></a>Huoltotilausrivien analysointi
...
### <a name="view-customer-information"></a><a name="view-customer-information"></a><a name="view-customer-information"></a>Asiakastietojen tarkasteleminen
...
## <a name="viewing-service-item-statistics"></a><a name="viewing-service-item-statistics"></a><a name="viewing-service-item-statistics"></a>Huoltonimikkeen tilastojen tarkasteleminen
...
## <a name="use-trendscapes"></a><a name="use-trendscapes"></a><a name="use-trendscapes"></a>Trendscape-näkymien käyttäminen
...
## <a name="viewing-gains-and-losses-on-contracts"></a><a name="viewing-gains-and-losses-on-contracts"></a><a name="viewing-gains-and-losses-on-contracts"></a>Sopimusten voittojen ja tappioiden tarkasteleminen
...
## <a name="viewing-statistics-for-posted-service-documents"></a><a name="viewing-statistics-for-posted-service-documents"></a><a name="viewing-statistics-for-posted-service-documents"></a>Kirjattujen huoltoasiakirjojen tilastojen tarkasteleminen
...
### <a name="posted-service-shipment-statistics"></a><a name="posted-service-shipment-statistics"></a><a name="posted-service-shipment-statistics"></a>Kirjatun huoltotoimituksen tilastot
...
### <a name="posted-service-invoice-statistics"></a><a name="posted-service-invoice-statistics"></a><a name="posted-service-invoice-statistics"></a>Kirjatun huoltolaskun tilastot
...
### <a name="posted-service-credit-memo-statistics"></a><a name="posted-service-credit-memo-statistics"></a><a name="posted-service-credit-memo-statistics"></a>Kirjattujen huollon hyvityslaskujen tilastot
