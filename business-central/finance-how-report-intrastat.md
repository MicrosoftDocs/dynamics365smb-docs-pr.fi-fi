...
ms.author: altotovi
---
# <a name="work-with-intrastat-reporting"></a><a name="work-with-intrastat-reporting"></a>Intrastat-raportoinnin käyttäminen
...
## <a name="fill-in-the-intrastat-report"></a><a name="fill-in-the-intrastat-report"></a>Täytä Intrastat-raportti
...
## <a name="modify-the-intrastat-report"></a><a name="modify-the-intrastat-report"></a>Muokkaa Intrastat-raporttia
...
## <a name="validate-intrastat-lines"></a><a name="validate-intrastat-lines"></a>Tarkista Intrastat-rivit
...
## <a name="recalculating-weight-or-supplementary-unit-of-measure"></a><a name="recalculating-weight-or-supplementary-unit-of-measure"></a>Painon tai täydentävän mittayksikön uudelleenlaskenta
...
## <a name="intrastat-rules"></a><a name="intrastat-rules"></a>Intrastat-säännöt
...
### <a name="fixed-assets-reporting"></a><a name="fixed-assets-reporting"></a>Käyttöomaisuuden raportit
...
### <a name="intrastat-report-statuses"></a><a name="intrastat-report-statuses"></a>Intrastat-raportin tilat
