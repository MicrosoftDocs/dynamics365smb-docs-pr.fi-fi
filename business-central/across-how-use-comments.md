...
ms.author: edupont
---
# <a name="add-comments-to-cards-and-documents" />Kommenttien lisääminen kortteihin ja asiakirjoihin
...
## <a name="to-add-a-comments-to-an-item-card" />Kommenttien lisääminen nimikkeen korttiin
