...
# <a name="review-amounts-in-general-ledger-accounts"></a><a name="review-amounts-in-general-ledger-accounts"></a>Summien tarkistaminen kirjanpitotileillä
...
## <a name="set-up-accounts-for-reviews"></a><a name="set-up-accounts-for-reviews"></a>Määritä tilit tarkistusta varten
...
## <a name="mark-entries-as-reviewed"></a><a name="mark-entries-as-reviewed"></a>Merkitse tapahtumat tarkistetuiksi
...
## <a name="review-accounts-that-have-old-entries"></a><a name="review-accounts-that-have-old-entries"></a>Tarkista tilit, joilla on vanhoja tapahtumia
...
## <a name="filter-entries"></a><a name="filter-entries"></a>Suodata tapahtumat
...
## <a name="analyze-entries"></a><a name="analyze-entries"></a>Analysoi tapahtumia
