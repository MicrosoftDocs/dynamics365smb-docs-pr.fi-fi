---
title: Kirjanpitotilien tarkistaminen
...
# <a name="review-amounts-in-general-ledger-accounts"></a>Kirjanpitotilien summien tarkistaminen
...
> [!TIP]
> Nopea tapa valita useita merkintöjä on pitää Ctrl- tai vaihto-näppäimiä painettuna, kun valitset tapahtumat. *Ctrl-näppäinyhdistelmällä* voit valita tietyt tapahtumat, ja *Shift* valitsee kaikki tapahtumat ensimmäisen ja viimeisen valitsemasi merkinnän välillä.
