...
Kokeilujaksoa voi kuitenkin jatkaa itse vain kerran. Et siis voi jatkaa sitä itse kahdesti. Jos olet jo jatkanut kokeilujaksoa itse, Microsoft-kumppani voi jatkaa sitä uudelleen puolestasi, mikä on myös kertaluonteinen asia. Jos sinulla ei vielä ole kumppania, katso [Miten löydän jälleenmyyjäkumppanin?](/dynamics365/business-central/across-faq#how-do-i-find-a-reselling-partner).  
...
Jos ensimmäinen 30 päivän kokeilujaksosi on vanhentunut, voit jatkaa sitä itse. Sinun tarvitsee vain kirjautua esittely-yritykseen ja käynnistää **kokeilujakson jatkamisen** opas ilmoituksesta.  

Kun olet luonut oman yrityksen, kirjaudu ulos ja kirjaudu sitten uudelleen sisään kyseisen yrityksen tunnistetiedoilla.  

Jos organisaatiollasi on jälleenmyyntisuhde kumppanin kanssa, tämä voi kirjautua sisään sovellukseen [!INCLUDE[prod_short](includes/prod_short.md)] delegoituna järjestelmänvalvojana ja suorittaa saman **kokeilujakson jatkamisen** oppaan. Lisätietoja on kohdassa [Kokeiluversioiden jatkaminen (järjestelmänvalvojana)](/dynamics365/business-central/dev-itpro/administration/tenant-administration#extending-trials).  

Kuitenkin, kun tämä toinen jatkoaika, joka antaa organisaatiolle jopa 90 päivää koeaikaa, on ohi, sinun täytyy joko tilata [!INCLUDE[prod_short](includes/prod_short.md)] tai lopettaa sen käyttö. Jos päätät, että et jatka, sinun kannattaa viedä tärkeät yrityksesi tiedot.
