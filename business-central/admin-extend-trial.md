...
# <a name="need-more-time-to-decide-whether-to-subscribe" />Tarvitsetko lisää aikaa, ennen kuin päätät tilauksen tekemisestä?
...
## <a name="to-extend-your-trial-period" />Kokeilujakson laajentaminen
...
## <a name="what-happens-if-my-trial-period-is-expired" />Mitä tapahtuu, jos kokeilujakso päättyy?
