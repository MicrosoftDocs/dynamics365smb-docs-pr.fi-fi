...
# <a name="need-more-time-to-decide-whether-to-subscribe"></a><a name="need-more-time-to-decide-whether-to-subscribe"></a>Tarvitsetko lisää aikaa, ennen kuin päätät tilauksen tekemisestä?
...
## <a name="to-extend-your-trial-period"></a><a name="to-extend-your-trial-period"></a>Kokeilujakson laajentaminen
...
## <a name="what-happens-if-my-trial-period-is-expired"></a><a name="what-happens-if-my-trial-period-is-expired"></a>Mitä tapahtuu, jos kokeilujakso päättyy?
