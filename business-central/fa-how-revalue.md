...
## <a name="to-post-other-acquisition-costs"></a>Lisähankintakustannusten kirjaaminen
...
### <a name="example---posting-other-acquisition-costs"></a>Esimerkki - Lisähankintamenojen kirjaaminen
