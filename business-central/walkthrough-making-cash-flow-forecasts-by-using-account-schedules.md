...
ms.author: edupont
---
# <a name="walkthrough-making-cash-flow-forecasts-using-financial-reports"></a><a name="walkthrough-making-cash-flow-forecasts-using-financial-reports"></a><a name="walkthrough-making-cash-flow-forecasts-using-financial-reports"></a>Vaihekuvaus: Kassavirtaennusteiden tekeminen talousraporttien avulla
...
## <a name="setting-up-a-new-financial-report-name"></a><a name="setting-up-a-new-financial-report-name"></a><a name="setting-up-a-new-financial-report-name"></a>Uuden talousraportin nimen määrittäminen
...
### <a name="set-up-a-new-financial-report-name"></a><a name="set-up-a-new-financial-report-name"></a><a name="set-up-a-new-financial-report-name"></a>Uuden talousraportin nimen määrittäminen
...
## <a name="setting-up-row-definition-lines"></a><a name="setting-up-row-definition-lines"></a><a name="setting-up-row-definition-lines"></a>Rivimäärityksen rivien määrittäminen
...
### <a name="set-up-row-definition-lines"></a><a name="set-up-row-definition-lines"></a><a name="set-up-row-definition-lines"></a>Rivimäärityksen rivien määrittäminen
...
## <a name="setting-up-a-new-column-definition"></a><a name="setting-up-a-new-column-definition"></a><a name="setting-up-a-new-column-definition"></a>Uuden sarakemäärityksen määrittäminen
...
### <a name="set-up-a-new-column-definition"></a><a name="set-up-a-new-column-definition"></a><a name="set-up-a-new-column-definition"></a>Uuden sarakemäärityksen määrittäminen
...
## <a name="assigning-the-column-definition-to-the-financial-report-name"></a><a name="assigning-the-column-definition-to-the-financial-report-name"></a><a name="assigning-the-column-definition-to-the-financial-report-name"></a>Sarakemäärityksen liittäminen talousraportin nimeen

Ken on nyt valmis määrittämään sarakemäärityksen talousraportin nimeen.  

### <a name="assign-the-column-definition-to-the-financial-report-name"></a><a name="assign-the-column-definition-to-the-financial-report-name"></a><a name="assign-the-column-definition-to-the-financial-report-name"></a>Sarakemäärityksen liittäminen talousraportin nimeen
...
## <a name="view-and-print-the-cash-flow-forecast"></a><a name="view-and-print-the-cash-flow-forecast"></a><a name="view-and-print-the-cash-flow-forecast"></a>Kassavirtaennusteen tarkasteleminen ja tulostaminen
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Lue aiheeseen liittyen [Microsoftin koulutukset](/training/modules/forecast-cash-flow-dynamics-365-business-central/)
