...
ms.author: edupont
---
# <a name="run-full-planning-mps-or-mrp" />Kokonaisvaltaisen suunnittelun, tuotanto-ohjelman tai tarvelaskennan suorittaminen
...
## <a name="methods-for-generating-a-plan" />Suunnitelman luomismenetelmät
...
## <a name="to-calculate-the-planning-worksheet" />Suunnittelutyökirjan laskeminen
...
## <a name="to-perform-action-messages" />Suorita toimenpideviestit
...
## <a name="action-messages" />Toimenpideviestit
