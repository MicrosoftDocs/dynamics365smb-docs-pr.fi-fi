...
ms.author: edupont
---
# <a name="work-with-payment-tolerances-and-payment-discount-tolerances"></a><a name="work-with-payment-tolerances-and-payment-discount-tolerances"></a>Maksutoleranssien ja maksualennustoleranssien käsitteleminen
...
## <a name="applying-payment-tolerance-to-multiple-documents"></a><a name="applying-payment-tolerance-to-multiple-documents"></a>Maksutoleranssien käyttöönotto useissa asiakirjoissa
...
## <a name="to-set-up-tolerances"></a><a name="to-set-up-tolerances"></a>Toleranssien määrittäminen
...
## <a name="to-enable-or-disable-payment-tolerance-warnings"></a><a name="to-enable-or-disable-payment-tolerance-warnings"></a>Maksutoleranssivaroitusten ottaminen käyttöön tai poistaminen käytöstä
...
## <a name="to-block-payment-tolerance-for-customers"></a><a name="to-block-payment-tolerance-for-customers"></a>Maksutoleranssin estäminen asiakkailta
...
## <a name="example-1---tolerance-calculations-for-a-single-document"></a><a name="example-1---tolerance-calculations-for-a-single-document"></a>Esimerkki 1 – Yksittäisen asiakirjan toleranssilaskennat
...
### <a name="payment-range-diagrams"></a><a name="payment-range-diagrams"></a>Maksualuediagrammit

Yo. tapaukseen liittyen maksudiagrammi on seuraavanlainen:  

#### <a name="1-payment-date-011503-scenarios-1-3"></a><a name="1-payment-date-011503-scenarios-1-3"></a>(1) Maksupvm <=15.01.03 (Tapaukset 1-3)
...
#### <a name="2-payment-date-is-between-011603-and-012003-scenarios-4-9"></a><a name="2-payment-date-is-between-011603-and-012003-scenarios-4-9"></a>(2) Maksupvm on välillä 16.1.03 ja 20.1.03 (Tapaukset 4-9)
...
#### <a name="3-payment-date-is-after-012003-scenarios-10-15"></a><a name="3-payment-date-is-after-012003-scenarios-10-15"></a>(3) Maksupvm 20.01.2003 jälkeen (Tapaukset 10-15)
...
## <a name="example-2---tolerance-calculations-for-multiple-documents"></a><a name="example-2---tolerance-calculations-for-multiple-documents"></a>Esimerkki 2 – Useiden asiakirjojen toleranssilaskelmat
...
### <a name="payment-range-diagrams-1"></a><a name="payment-range-diagrams-1"></a>Maksualuediagrammit

Yo. tapaukseen liittyen maksudiagrammi on seuraavanlainen:  

#### <a name="1-payment-date-011503-scenarios-1-3-1"></a><a name="1-payment-date-011503-scenarios-1-3-1"></a>(1) Maksupvm <=15.01.03 (Tapaukset 1–3)
...
#### <a name="2-payment-date-is-between-011603-and-011703-scenarios-4-9"></a><a name="2-payment-date-is-between-011603-and-011703-scenarios-4-9"></a>(2) Maksupvm on välillä 16.1.03 ja 17.01.2003 (Tapaukset 4-9)
...
#### <a name="3-payment-date-is-between-011803-and-012003-scenarios-10-21"></a><a name="3-payment-date-is-between-011803-and-012003-scenarios-10-21"></a>(3) Maksupvm on välillä 18.01.2003 ja 20.1.03 (Tapaukset 10-21)
...
#### <a name="4-payment-date-is-between-012103-and-012203-scenarios-22-27"></a><a name="4-payment-date-is-between-012103-and-012203-scenarios-22-27"></a>(4) Maksupvm on välillä 21.01.2003 ja 22.01.2003 (Tapaukset 22-27)
...
#### <a name="5-payment-date-is-after-012203-scenarios-28-30"></a><a name="5-payment-date-is-after-012203-scenarios-28-30"></a>(5) Maksupvm 22.01.2003 jälkeen (Tapaukset 28-30)
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Lue aiheeseen liittyen [Microsoftin koulutukset](/training/modules/enter-payments-dynamics-365-business-central/)
