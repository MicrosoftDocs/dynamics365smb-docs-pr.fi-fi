...
## <a name="to-set-up-automatic-account-posting-groups"></a><a name="to-set-up-automatic-account-posting-groups"></a><a name="to-set-up-automatic-account-posting-groups"></a><a name="to-set-up-automatic-account-posting-groups"></a>Automaattisten tilin kirjausryhmien määrittäminen
