...
---
# <a name="set-up-bank-reference-files-in-the-finnish-version"></a><a name="set-up-bank-reference-files-in-the-finnish-version"></a><a name="set-up-bank-reference-files-in-the-finnish-version"></a>Pankin viitetiedostojen määrittäminen suomalaisessa versiossa
...
## <a name="to-set-up-a-bank-reference-file"></a><a name="to-set-up-a-bank-reference-file"></a><a name="to-set-up-a-bank-reference-file"></a>Pankin viitetiedoston määrittäminen
