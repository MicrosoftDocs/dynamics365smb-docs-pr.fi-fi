...
ms.date: 04/01/2021
ms.author: edupont
ms.openlocfilehash: 5b8675d9dd392096cc0c1aa72485ea2698247f15
...
---
# <a name="set-up-bank-reference-files-in-the-finnish-version"></a><a name="set-up-bank-reference-files-in-the-finnish-version"></a><a name="set-up-bank-reference-files-in-the-finnish-version"></a><a name="set-up-bank-reference-files-in-the-finnish-version"></a>Pankin viitetiedostojen määrittäminen suomalaisessa versiossa
...
## <a name="to-set-up-a-bank-reference-file"></a><a name="to-set-up-a-bank-reference-file"></a><a name="to-set-up-a-bank-reference-file"></a><a name="to-set-up-a-bank-reference-file"></a>Pankin viitetiedoston määrittäminen
