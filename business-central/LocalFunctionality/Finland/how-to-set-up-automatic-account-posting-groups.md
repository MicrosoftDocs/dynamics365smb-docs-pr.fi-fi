...
---
# <a name="set-up-automatic-account-posting-groups-in-the-finnish-version"></a><a name="set-up-automatic-account-posting-groups-in-the-finnish-version"></a>Automaattisten tilikirjausryhmien määrittäminen suomalaisessa versiossa
