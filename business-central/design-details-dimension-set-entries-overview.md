...
ms.author: edupont
---
# <a name="dimension-set-entries-overview"></a><a name="dimension-set-entries-overview"></a>Dimensioyhdistelmätapahtumien yleiskuva
...
## <a name="dimension-set-entries"></a><a name="dimension-set-entries"></a>Dimensioyhdistelmän tapahtumat
...
## <a name="codeunit-408-dimension-management"></a><a name="codeunit-408-dimension-management"></a>Codeunit 408 -dimension hallinta
...
## <a name="performance-improvement"></a><a name="performance-improvement"></a>Suorituskyvyn parantaminen
