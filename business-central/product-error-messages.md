...
[!INCLUDE [prodshort](includes/prodshort.md)] -ohjelman oletusversio sisältää useimpien kenttien, sarakkeiden ja toimintojen kuvaukset, joita voi käyttää, kun valitset nimen. Yhdessä kuvailevien kuvatekstien ja ohjetekstien kanssa nämä vihjeet tai kuvatekstit ovat nykyinen toteutuksemme *sulautetusta käyttäjätuesta*, joka on tärkeä periaate nykypäivän ohjelmistosuunnittelun maailmassa.  
