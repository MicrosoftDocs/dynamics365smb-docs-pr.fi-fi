...
ms.author: edupont
---
# <a name="set-up-fixed-asset-insurance"></a><a name="set-up-fixed-asset-insurance"></a><a name="set-up-fixed-asset-insurance"></a>Käyttöomaisuuserän määrittäminen
...
## <a name="to-set-up-general-insurance-information"></a><a name="to-set-up-general-insurance-information"></a><a name="to-set-up-general-insurance-information"></a>Yleisten vakuutustietojen määrittäminen
...
## <a name="to-set-up-insurance-types"></a><a name="to-set-up-insurance-types"></a><a name="to-set-up-insurance-types"></a>Vakuutustyyppien määrittäminen
...
## <a name="to-set-up-insurance-cards"></a><a name="to-set-up-insurance-cards"></a><a name="to-set-up-insurance-cards"></a>Vakuutuskorttien määrittäminen
...
## <a name="to-set-up-insurance-journal-templates"></a><a name="to-set-up-insurance-journal-templates"></a><a name="to-set-up-insurance-journal-templates"></a>Vakuutuspäiväkirjamallien määrittäminen
...
## <a name="to-set-up-insurance-journal-batches"></a><a name="to-set-up-insurance-journal-batches"></a><a name="to-set-up-insurance-journal-batches"></a>Vakuutuspäiväkirjaerien määrittäminen
