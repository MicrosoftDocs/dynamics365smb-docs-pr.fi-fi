...
ms.author: edupont
---
# <a name="set-up-fixed-asset-insurance" />Käyttöomaisuuserän määrittäminen
...
## <a name="to-set-up-general-insurance-information" />Yleisten vakuutustietojen määrittäminen
...
## <a name="to-set-up-insurance-types" />Vakuutustyyppien määrittäminen
...
## <a name="to-set-up-insurance-cards" />Vakuutuskorttien määrittäminen
...
## <a name="to-set-up-insurance-journal-templates" />Vakuutuspäiväkirjamallien määrittäminen
...
## <a name="to-set-up-insurance-journal-batches" />Vakuutuspäiväkirjaerien määrittäminen
...
## <a name="see-related-microsoft-training" />Lue aiheeseen liittyen [Microsoftin koulutukset](/training/paths/set-up-fixed-assets-management/)
