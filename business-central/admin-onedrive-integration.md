...
ms.author: jswymer
---
# <a name="managing-onedrive-integration-with-business-central"></a><a name="managing-onedrive-integration-with-business-central"></a><a name="managing-onedrive-integration-with-business-central"></a>OneDriven ja Business Centralin integroinnin hallinta
...
## <a name="configure-onedrive-for-integration-with-business-central"></a><a name="configure-onedrive-for-integration-with-business-central"></a><a name="configure-onedrive-for-integration-with-business-central"></a>Määritä OneDrive:n ja Business Centralin integrointi
...
### <a name="managing-privacy"></a><a name="managing-privacy"></a><a name="managing-privacy"></a>Yksityisyyden hallinta
...
## <a name="configure-business-central"></a><a name="configure-business-central"></a><a name="configure-business-central"></a>Määritä Business Central
...
### <a name="about-multiple-environments"></a><a name="about-multiple-environments"></a><a name="about-multiple-environments"></a>Tietoja useista ympäristöistä
...
### <a name="configure-onedrive-using-onedrive-setup"></a><a name="configure-onedrive-using-onedrive-setup"></a><a name="configure-onedrive-using-onedrive-setup"></a>OneDriven määritys käyttämällä OneDrive-asetuksia
...
### <a name="switching-to-new-onedrive-integration-after-upgrade"></a><a name="switching-to-new-onedrive-integration-after-upgrade"></a><a name="switching-to-new-onedrive-integration-after-upgrade"></a>Siirtyminen uuteen OneDrive-integrointiin päivityksen jälkeen
...
## <a name="restoring-onedrive-and-"></a><a name="restoring-onedrive-and-"></a><a name="restoring-onedrive-and-"></a>OneDriven ja [!INCLUDE[prod_short](includes/prod_short.md)]in palauttaminen
...
## <a name="governance"></a><a name="governance"></a><a name="governance"></a>Hallinto
