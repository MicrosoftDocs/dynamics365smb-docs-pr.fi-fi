...
ms.author: edupont
---
# <a name="service-posting"></a><a name="service-posting"></a>Huollon kirjaus
...
## <a name="ship"></a><a name="ship"></a>Toimitus
...
## <a name="invoice"></a><a name="invoice"></a>Lasku
...
## <a name="ship-and-invoice"></a><a name="ship-and-invoice"></a>Toimitus ja lasku
Toimitus- ja laskutusvaihtoehdon avulla voit luoda sekä palvelutoimituksen että laskun samaan aikaan.  

## <a name="ship-and-consume"></a><a name="ship-and-consume"></a>Toimitus ja kulutus
...
## <a name="to-view-information-about-a-posted-service-document"></a><a name="to-view-information-about-a-posted-service-document"></a>Kirjattujen huoltoasiakirjojen tarkasteleminen
