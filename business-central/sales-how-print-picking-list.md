...
ms.author: edupont
---
# <a name="print-the-picking-list"></a><a name="print-the-picking-list"></a><a name="print-the-picking-list"></a>Tulosta poimintaluettelo
...
## <a name="to-print-a-picking-list-from-a-sales-order"></a><a name="to-print-a-picking-list-from-a-sales-order"></a><a name="to-print-a-picking-list-from-a-sales-order"></a>Varaston poimintaluettelon tulostaminen myyntitilauksesta
