...
ms.author: bholtorf
---
# OneDrive for Business - usein kysytyt kysymykset
...
## Toimiiko tämä kaikkien [!INCLUDE[prod_short](includes/prod_short.md)] -asiakasohjelmien kanssa?
...
## Onko OneDrive sama kuin SharePoint tiedostojen tallentamiseen?
...
## Tukeeko [!INCLUDE[prod_short](includes/prod_short.md)] OneDriven kuluttajaversiota?

Ei. Tämä integrointi on tarkoitettu ainoastaan OneDrive for Businessille, ja se tukee vain työtiliäsi. 

## Tuetaanko kaikkia OneDrive for Business -suunnitelmia?
...
## Missä voin nähdä OneDrive-palvelun kunnon?
...
## Onko OneDrive-integrointi saatavilla [!INCLUDE[prod_short](includes/prod_short.md)] on-premises -versioon?
...
## Olemme muuttaneet yrityksen nimeä. Mitä aiemmille tiedostoilleni tapahtuu?
...
## Kun liität tiedostoja [!INCLUDE[prod_short](includes/prod_short.md)]iin, miten valitsen tiedoston OneDrivesta?
...
## Haluan avata tiedostoja SharePointissa sen sijaan. Miten tämä tehdään?
...
## Miten OneDrive-integrointi kytketään pois päältä?
...
## Pitäisikö minun käyttää SharePoint-yhteyden määritys -sivua yhteyden muodostamiseen SharePointiin?
...
## Mikä [!INCLUDE[prod_short](includes/prod_short.md)]-versio tukee OneDrivea?

Integrointi OneDriven kanssa tuli saataville vuoden 2021 2. julkaisuaallossa.  

## <a name="features"></a>Mihin ominaisuuksiin OneDrive-integrointi vaikuttaa?
...
## Jatkaako Microsoft OneDrive-integraation parantamista?
...
### Business Central ei löydä OneDrivea
...
### Outlookin jakamisessa on ongelmia
...
### Avaa OneDrivessa- ja Jaa-toiminnot puuttuvat
