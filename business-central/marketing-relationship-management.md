...
|Määritä ulkoiset objektit, joiden kanssa sinulla on liikesuhteita. Esimerkiksi asiakkaat, mahdolliset asiakkaat, toimittajat, lakimiehet ja konsultit, jotka ovat joko Henkilö- tai Yritys-tyyppisiä.|[Kontaktien hallinta](marketing-contacts.md)|
...
|Käytät Dynamics 365 Salesia asiakassuhteissa, voit nauttia saumattomasta integraatiosta liidistä tuottoon -prosessissa käyttämällä -ohjelmaa taustatoiminnoissa. Käytä [!INCLUDE [prod_short](includes/prod_short.md)] taustatoimintoja, kuten tilausten käsittelyä, varaston hallintaa ja taloustietojen hoitamista.|[Dynamics 365 Sales -integrointi](marketing-integrate-dynamicscrm.md)|
