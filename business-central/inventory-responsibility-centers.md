...
ms.author: bholtorf
---
# <a name="work-with-responsibility-centers" />Vastuupaikkojen käyttäminen
...
## <a name="to-set-up-a-responsibility-center" />Vastuupaikkojen luominen
...
## <a name="to-assign-responsibility-centers-to-users" />Vastuupaikkojen liittäminen käyttäjiin
