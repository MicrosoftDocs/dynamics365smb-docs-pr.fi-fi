...
ms.author: edupont
---
# <a name="track-relations-between-demand-and-supply"></a><a name="track-relations-between-demand-and-supply"></a><a name="track-relations-between-demand-and-supply"></a>Kysynnän ja tarjonnan välisten suhteiden seuraaminen
...
## <a name="to-track-linked-items"></a><a name="to-track-linked-items"></a><a name="to-track-linked-items"></a>Linkitettyjen kohteiden seuraaminen
...
## <a name="untracked-planning-elements"></a><a name="untracked-planning-elements"></a><a name="untracked-planning-elements"></a>Ei-seuratut suunnitteluelementit
