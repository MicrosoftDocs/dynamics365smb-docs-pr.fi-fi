...
# <a name="work-with-calendar-dates-and-times"></a><a name="work-with-calendar-dates-and-times"></a>Kalenterin päivämäärien ja aikojen käsitteleminen
...
## <a name="check-your-region-and-language-settings"></a><a name="check-your-region-and-language-settings"></a>Alueen ja kielen asetusten tarkistaminen
...
### <a name="picking-dates-from-the-calendar"></a><a name="picking-dates-from-the-calendar"></a>Päivämäärien valitseminen kalenterista
...
### <a name="day-week-year-pattern"></a><a name="day-week-year-pattern"></a>Päivä\-viikko\-vuosi-malli
...
### <a name="digit-patterns"></a><a name="digit-patterns"></a>Numeromallit
...
### <a name="today"></a><a name="today"></a>Tänään
...
### <a name="period"></a><a name="period"></a>Jakso
...
### <a name="closing-date"></a><a name="closing-date"></a>Sulkemispvm
...
## <a name="setting-ranges"></a><a name="setting-ranges"></a><a name="BKMK_SettingDateRanges"></a> Alueiden asettaminen
...
## <a name="use-date-formulas"></a><a name="use-date-formulas"></a>Päivämääräkaavojen käyttäminen
...
## <a name="entering-combined-dates-and-times"></a><a name="entering-combined-dates-and-times"></a>Yhdistettyjen päivämäärien ja aikojen syöttäminen
