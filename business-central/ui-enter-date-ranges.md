...
# <a name="work-with-calendar-dates-and-times" />Kalenterin päivämäärien ja aikojen käsitteleminen
...
## <a name="check-your-region-and-language-settings" />Alueen ja kielen asetusten tarkistaminen
...
### <a name="picking-dates-from-the-calendar" />Päivämäärien valitseminen kalenterista
...
### <a name="day-week-year-pattern" />Päivä\-viikko\-vuosi-malli
...
### <a name="digit-patterns" />Numeromallit
...
### <a name="closing-date" />Sulkemispvm
...
## <a name="a-namebkmksettingdaterangesa-setting-ranges" /><a name="BKMK_SettingDateRanges"></a> Alueiden asettaminen
...
## <a name="use-date-formulas" />Päivämääräkaavojen käyttäminen
...
## <a name="entering-combined-dates-and-times" />Yhdistettyjen päivämäärien ja aikojen syöttäminen
