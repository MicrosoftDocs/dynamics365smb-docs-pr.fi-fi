...
ms.author: jswymer
---
# <a name="run-and-print-reports" />Suorita ja tulosta raportteja
...
## <a name="specifying-the-data-to-include-in-a-report" />Raportteihin sisällytettävien tietojen määrittäminen
...
## <a name="previewing-a-report" />Raportin esikatselu
...
### <a name="work-with-the-preview" />Esikatselun käyttäminen
...
## <a name="saving-a-report-to-a-file" />Raportin tallentaminen tiedostoon
...
### <a name="manage-scheduled-recurring-reports" />Aikataulutettujen toistuvien raporttien hallinta
...
### <a name="printing-reports-in-thai" />Raporttien tulostaminen Thain kielelle
...
## <a name="switching-the-report-layout" />Raportin asettelun vaihtaminen
...
## <a name="change-language-and-format-of-numbers-dates-and-times" />Numeroiden, päivämäärien ja kellonaikojen kielen ja muodon muuttaminen
...
## <a name="advanced-options" />Lisäasetukset
