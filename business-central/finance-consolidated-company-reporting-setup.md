...
# <a name="set-up-company-consolidation"></a><a name="set-up-company-consolidation"></a><a name="set-up-company-consolidation"></a>Määritä yrityksen konsolidointi
...
## <a name="simple-consolidation-setup"></a><a name="simple-consolidation-setup"></a><a name="simple-consolidation-setup"></a>Yksinkertaiset konsolidoinnin asetukset
...
## <a name="advanced-consolidation-setup"></a><a name="advanced-consolidation-setup"></a><a name="advanced-consolidation-setup"></a>Konsolidoinnin lisäasetukset
...
### <a name="set-up-the-consolidated-company"></a><a name="set-up-the-consolidated-company"></a><a name="set-up-the-consolidated-company"></a>Määritä konsolidoitu yritys
...
### <a name="add-business-units"></a><a name="add-business-units"></a><a name="add-business-units"></a><a name="busunit"></a>Lisää liiketoimintayksiköt
...
### <a name="prepare-general-ledger-accounts-for-consolidation"></a><a name="prepare-general-ledger-accounts-for-consolidation"></a><a name="prepare-general-ledger-accounts-for-consolidation"></a><a name="glacc"></a>Valmistele kirjanpitotilit konsolidointia varten
...
### <a name="specify-exchange-rates-for-consolidations"></a><a name="specify-exchange-rates-for-consolidations"></a><a name="specify-exchange-rates-for-consolidations"></a><a name="exchrates"></a>Määritä valuutan vaihtokurssit konsolidoiduissa yrityksissä
...
### <a name="include-or-exclude-dimensions"></a><a name="include-or-exclude-dimensions"></a><a name="include-or-exclude-dimensions"></a><a name="dim"></a>Dimensioiden sisällyttäminen tai jättäminen pois
...
### <a name="exclude-a-company-from-consolidation"></a><a name="exclude-a-company-from-consolidation"></a><a name="exclude-a-company-from-consolidation"></a><a name="exclude"></a>Jätä yritys konsolidoinnin ulkopuolelle
...
### <a name="include-a-partially-owned-company-in-consolidation"></a><a name="include-a-partially-owned-company-in-consolidation"></a><a name="include-a-partially-owned-company-in-consolidation"></a><a name="include"></a>Sisällytä osittain omistettu yritys konsolidointiin
