...
description: Tutustu nimikkeiden vastaanottoon fyysisellä varastolla ja rekisteröi ja vastaa ne saapuviin lähdeasiakirjoihin.
author: brentholtorf
ms.topic: conceptual
ms.devlang: al
...
Saapuvien tilausten vastaanotossa on periaatteessa kaksi toimintaa:

* Nimikkeiden vastaanottaminen vastaanottolaiturilla, nimikkeiden tunnistaminen, niiden täsmäyttäminen lähdeasiakirjaan ja vastaanotetun määrän kirjaaminen.
...
|**Tehtävä**|**Katso**|  
|------------|-------------|  
|Vastaanota nimikkeitä fyysisen varastoinnin sijainneissa, joissa on fyysisen varastoinnin vastaanotto, kokonaan tai osittain automatisoitua fyysisen varastoinnin käsittelyä varten.|[Nimikkeiden vastaanottaminen](warehouse-how-receive-items.md)|
