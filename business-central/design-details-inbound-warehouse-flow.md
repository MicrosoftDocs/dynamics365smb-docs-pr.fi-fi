...
ms.author: bholtorf
---
# <a name="design-details-inbound-warehouse-flow"></a><a name="design-details-inbound-warehouse-flow"></a>Rakennetiedot: saapuvan fyysisen varastoinnin virta
...
## <a name="no-dedicated-warehouse-activity"></a><a name="no-dedicated-warehouse-activity"></a>Ei määritettyä varastotoimintoa
...
## <a name="basic-warehouse-configurations"></a><a name="basic-warehouse-configurations"></a>Fyysisen varastoinnin perusmääritykset
...
### <a name="1-release-a-source-document-to-create-a-request-for-an-inventory-put-away"></a><a name="1-release-a-source-document-to-create-a-request-for-an-inventory-put-away"></a>1: Varaston hyllytyspyynnön luominen vapauttamalla lähdeasiakirja
...
### <a name="2-create-an-inventory-put-away"></a><a name="2-create-an-inventory-put-away"></a>2: Varaston hyllytyksen luominen
...
### <a name="3-post-an-inventory-put-away"></a><a name="3-post-an-inventory-put-away"></a>3: Varaston hyllytyksen kirjaaminen
...
### <a name="1-release-the-source-document"></a><a name="1-release-the-source-document"></a>1: Lähdeasiakirjan vapauttaminen
...
### <a name="2-create-a-warehouse-receipt"></a><a name="2-create-a-warehouse-receipt"></a>2: Fyysisen varastoinnin vastaanoton luominen
...
### <a name="3-post-the-warehouse-receipt"></a><a name="3-post-the-warehouse-receipt"></a>3: Fyysisen varastoinnin vastaanoton kirjaaminen
...
### <a name="4-optional-generate-put-away-worksheet-lines"></a><a name="4-optional-generate-put-away-worksheet-lines"></a>4: (Valinnainen) Hyllytystyökirjan rivien luominen
...
### <a name="5-create-a-warehouse-put-away-document"></a><a name="5-create-a-warehouse-put-away-document"></a>5: Fyysisen varastoinnin hyllytysasiakirjan luominen
...
### <a name="6-register-a-warehouse-put-away"></a><a name="6-register-a-warehouse-put-away"></a>6: Fyysisten varaston hyllytyksen rekisteröinti
...
## <a name="related-tasks"></a><a name="related-tasks"></a>Liittyvät tehtävät
