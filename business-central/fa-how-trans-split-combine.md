...
ms.author: edupont
---
# <a name="transfer-split-or-combine-fixed-assets" />Käyttöomaisuuserien siirtäminen, jakaminen tai yhdistäminen
...
## <a name="to-transfer-a-fixed-asset-to-a-different-department" />Käyttöomaisuuden siirtäminen toiselle osastolle
...
## <a name="to-split-a-fixed-asset-into-three-fixed-assets" />Käyttöomaisuuden jakaminen kolmeen käyttöomaisuuserään
...
## <a name="to-combine-two-fixed-assets-into-one" />Kahden käyttöomaisuuserän yhdistäminen yhdeksi eräksi
...
## <a name="to-view-changed-depreciation-book-values-due-to-fixed-asset-reclassification" />Muutetun poistokirjan arvojen tarkasteleminen käyttöomaisuuden uudelleenluokittelun vuoksi
