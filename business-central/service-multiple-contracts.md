...
ms.author: edupont
---
# <a name="multiple-contracts" />Useita sopimuksia
...
## <a name="creating-multiple-contracts-per-service-item" />Usean sopimuksen luominen huoltonimikkeelle
...
## <a name="copying-documents" />Asiakirjojen kopioiminen
...
## <a name="creating-service-orders-for-multiple-contracts" />Huoltotilausten luominen usealle sopimukselle
