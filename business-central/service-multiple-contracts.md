...
ms.author: edupont
---
# <a name="multiple-contracts"></a><a name="multiple-contracts"></a>Useita sopimuksia
...
## <a name="creating-multiple-contracts-per-service-item"></a><a name="creating-multiple-contracts-per-service-item"></a>Usean sopimuksen luominen huoltonimikkeelle
...
## <a name="copying-documents"></a><a name="copying-documents"></a>Asiakirjojen kopioiminen
...
## <a name="creating-service-orders-for-multiple-contracts"></a><a name="creating-service-orders-for-multiple-contracts"></a>Huoltotilausten luominen usealle sopimukselle
