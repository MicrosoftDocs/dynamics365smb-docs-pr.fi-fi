...
ms.author: jswymer
---
# <a name="set-up-opportunity-sales-cycles-and-cycle-stages" />Mahdollisuuden myyntisyklien ja syklin vaiheiden määrittäminen
...
## <a name="to-set-up-opportunity-sales-cycle-codes" />Mahdollisuuden myyntisyklin koodien määrittäminen
...
## <a name="to-define-opportunity-sales-cycle-stages" />Mahdollisuuden myyntisyklin vaiheiden määrittäminen
...
## <a name="to-assign-stage-cycles-to-opportunities" />Syklin vaiheiden määrittäminen mahdollisuuksille
...
## <a name="to-set-up-activities-with-tasks" />Tehtäviä sisältävien toimintojen määrittäminen
...
## <a name="to-assign-tasks-or-activities-of-tasks-to-opportunities" />Tehtävien tai tehtävätoimintojen määrittäminen mahdollisuuksiin
