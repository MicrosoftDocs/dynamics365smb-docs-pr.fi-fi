...
ms.author: edupont
---
# <a name="defining-and-allocating-costs"></a><a name="defining-and-allocating-costs"></a>Kustannusten määrittäminen ja kohdistaminen
...
## <a name="setting-up-allocation-source-and-targets"></a><a name="setting-up-allocation-source-and-targets"></a>Kohdistuksen lähteen ja sen tavoitteiden määrittäminen
...
### <a name="to-set-up-cost-allocations"></a><a name="to-set-up-cost-allocations"></a>Määritä kustannusten kohdistamiset
...
## <a name="setting-filters-for-dynamic-allocation-bases"></a><a name="setting-filters-for-dynamic-allocation-bases"></a>Suodattimien määrittäminen dynaamisen kohdistuksen perusteille.
...
### <a name="setting-filters"></a><a name="setting-filters"></a>Asetetaan suodattimia
...
## <a name="scenario-1-defining-static-allocations-based-on-allocation-ratio"></a><a name="scenario-1-defining-static-allocations-based-on-allocation-ratio"></a>Skenaario 1: Kohdistamissuhteeseen perustuvan staattisen kohdistamisen määrittäminen
...
### <a name="to-define-the-allocation-source-prod-cost-center-on-the-general-fasttab"></a><a name="to-define-the-allocation-source-prod-cost-center-on-the-general-fasttab"></a>Määritä varauksen lähde TUOT kustannuspaikka yleisessä pikavälilehdessä
...
### <a name="to-define-the-allocation-target-cost-objects-on-the-lines-fasttab"></a><a name="to-define-the-allocation-target-cost-objects-on-the-lines-fasttab"></a>Määritä kodhistuskohteen kustannus-objektit Rivit-pikavälilehdellä
...
## <a name="scenario-2-defining-dynamic-allocations-based-on-items-sold"></a><a name="scenario-2-defining-dynamic-allocations-based-on-items-sold"></a>Skenaario 2: Dynaamisten kohdistamisten määrittäminen myytyjen nimikkeiden perusteella
...
### <a name="to-define-dynamic-allocations-based-on-items-sold-in-the-previous-year"></a><a name="to-define-dynamic-allocations-based-on-items-sold-in-the-previous-year"></a>Märitä edellisvuonna myyytihin nimikkeisiin perustuvat dynaamiset kohdistukset
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Lue aiheeseen liittyen [Microsoftin koulutukset](/training/modules/allocate-costs-dynamics-365-business-central/)
