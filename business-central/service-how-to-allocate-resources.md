...
## Huoltotilausten tai -tarjousten yleistilanteen katsominen  
...
## Resurssin kohdistaminen resurssin tai resurssiryhmän saatavuuden avulla    
1. Valitse ![Lamppu, joka avaa Kerro-ominaisuuden.](media/ui-search/search_small.png "Kerro, mitä haluat tehdä") -kuvake, syötä **Lähetystaulukko** ja valitse sitten vastaava linkki.  
...
## Resurssien kohdistaminen huoltotilausta käyttämällä:  
...
## Huoltotilauksen resurssien uudelleenkohdistaminen  
...
## Resurssien kohdistaminen lähetystaulukkoa käyttämällä  
...
## Resurssituntien rekisteröiminen  
...
## Resurssien kohdistaminen kaikkiin tilauksen huoltonimikkeisiin
