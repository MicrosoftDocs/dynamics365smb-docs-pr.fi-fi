...
ms.author: edupont
---
# <a name="set-up-contacts"></a><a name="set-up-contacts"></a>Kontaktien määrittäminen
...
## <a name="to-assign-industry-groups-to-a-contact"></a><a name="to-assign-industry-groups-to-a-contact"></a>Toimialaryhmien määrittäminen kontaktille
...
## <a name="to-assign-mailing-groups-to-a-contact"></a><a name="to-assign-mailing-groups-to-a-contact"></a>Postitusryhmien määrittäminen kontaktiin
...
## <a name="to-define-a-contacts-alternate-address"></a><a name="to-define-a-contacts-alternate-address"></a>Kontaktin vaihtoehtoisen osoitteen määrittäminen
...
## <a name="to-assign-job-responsibilities-to-a-contact"></a><a name="to-assign-job-responsibilities-to-a-contact"></a>Vastuualueiden liittäminen kontakteihin:
...
## <a name="to-assign-organizational-levels-to-a-contact"></a><a name="to-assign-organizational-levels-to-a-contact"></a>Organisaatiotasojen määrittäminen kontaktille
...
## <a name="to-assign-web-sources-to-a-contact"></a><a name="to-assign-web-sources-to-a-contact"></a>Verkkolähteiden määrittäminen kontaktille
...
## <a name="to-assign-business-relations-to-a-contact"></a><a name="to-assign-business-relations-to-a-contact"></a>Liikesuhteiden määrittäminen kontaktille
...
## <a name="automatically-copying-specific-information-from-contact-companies-to-contact-persons"></a><a name="automatically-copying-specific-information-from-contact-companies-to-contact-persons"></a>Tiettyjen tietojen kopioiminen automaattisesti kontaktiyrityksistä kontaktihenkilöille
...
## <a name="use-predefined-defaults-on-new-contacts"></a><a name="use-predefined-defaults-on-new-contacts"></a>Ennalta määritettyjen oletusarvojen käyttäminen uusissa kontakteissa
...
## <a name="synchronizing-contacts-with-customers-vendors-and-bank-accounts"></a><a name="synchronizing-contacts-with-customers-vendors-and-bank-accounts"></a>Kontaktien synkronoiminen asiakkaiden, toimittajien ja pankkitilien kanssa
...
## <a name="searching-for-duplicate-contacts"></a><a name="searching-for-duplicate-contacts"></a>Kontaktien kaksoiskappaleiden hakeminen
