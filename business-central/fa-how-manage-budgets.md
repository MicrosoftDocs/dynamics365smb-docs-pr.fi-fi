...
ms.author: edupont
---
# <a name="manage-budgets-for-fixed-assets" />Käyttöomaisuuden budjettien hallinta
...
## <a name="to-budget-the-acquisition-cost-of-a-fixed-asset" />Käyttöomaisuuden hankintamenon budjetointi
...
## <a name="to-budget-the-disposal-of-a-fixed-asset" />Käyttöomaisuuden luovutuksen budjetointi
...
## <a name="to-view-projected-disposal-values" />Suunniteltujen luovutusarvojen katsominen
...
## <a name="to-budget-depreciation" />Poistojen budjetointi
