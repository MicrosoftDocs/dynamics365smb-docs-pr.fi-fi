...
ms.author: bholtorf
---
# <a name="connect-to-microsoft-dataverse" />Yhteyden muodostaminen Microsoft Dataverseen
...
## <a name="set-up-a-connection-to-includecdslongmdincludescdslongmdmd" />Määritä yhteys tuotteeseen [!INCLUDE[cds_long_md](includes/cds_long_md.md)]
...
### <a name="to-use-the-dataverse-connection-setup-assisted-setup-guide" />Dataverse -yhteyden määrityksen asetusten ohjatun määritysoppaan käyttäminen
...
### <a name="to-create-or-maintain-the-connection-manually" />Yhteyden luominen tai ylläpitäminen manuaalisesti
...
## <a name="customize-the-match-based-coupling" />Vastaavuuteen perustuvan yhdistämisen mukauttaminen
...
### <a name="view-the-results-of-the-coupling-job" />Yhdistämistyön tulosten tarkasteleminen
...
## <a name="upgrade-connections-from-business-central-online-to-use-certificate-based-authentication" />Päivitä yhteydet Business Central Onlinesta käyttääksesi varmennepohjaista todennusta
...
### <a name="to-upgrade-your-business-central-online-connection-to-use-certificate-based-authentication" />Business Central online -yhteyden päivittäminen käyttämään varmennepohjaista todennusta
...
## <a name="connecting-on-premises-versions" />Paikallisten versioiden yhdistäminen
...
### <a name="to-register-an-application-in-azure-ad-for-connecting-from-business-central-to-dataverse" />Sovelluksen rekisteröiminen Azure AD:ssä muodostamaan yhteys Business Centralista Dataverseen
...
### <a name="to-disconnect-from-includecdslongmdincludescdslongmdmd" />[!INCLUDE[cds_long_md](includes/cds_long_md.md)] -yhteyden katkaiseminen
