...
## <a name="set-up-test-and-enable-a-connection-to-includecrm_mdincludescrm_mdmd"></a>[!INCLUDE[crm_md](includes/crm_md.md)] -yhteyden määrittäminen, testaaminen ja käyttöönotto  
