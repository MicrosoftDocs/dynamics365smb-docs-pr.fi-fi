...
## <a name="link-your-business-central-and-dataverse-environments"></a>Business Central- ja Dataverse-ympäristöjen linkittäminen
...
## <a name="allow-for-different-currencies"></a>Eri valuuttojen salliminen
...
### <a name="to-register-an-application-in-microsoft-entra-id-for-connecting-from-business-central-to-dataverse"></a>Sovelluksen rekisteröiminen Microsoft Entra ID:ssä muodostamaan yhteys Business Centralista Dataverseen
