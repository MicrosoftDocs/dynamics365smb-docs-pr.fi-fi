...
ms.author: bholtorf
---
# <a name="create-production-boms"></a><a name="create-production-boms"></a>Tuotannon tuoterakenteiden luominen
...
## <a name="to-create-a-production-bom"></a><a name="to-create-a-production-bom"></a>Tuotannon tuoterakenteen luominen
...
## <a name="to-create-a-new-version-of-a-production-bom"></a><a name="to-create-a-new-version-of-a-production-bom"></a>Tuotannon tuoterakenteiden uusien versioiden luominen
...
## <a name="quantity-calculation-formula-on-production-boms"></a><a name="quantity-calculation-formula-on-production-boms"></a>Tuotannon tuoterakenteiden määrän laskentakaava
