...
ms.author: edupont
---
# <a name="calculate-order-promising-dates" />Toimituksen lupaamisen päivämäärien laskeminen
...
## <a name="about-order-promising" />Tietoja toimituksen lupaamisesta
...
### <a name="available-to-promise" />Luvattavissa
...
### <a name="capable-to-promise" />Mahdollinen luvattavaksi
...
## <a name="to-set-up-order-promising" />Toimituksen lupaamisen määrittäminen
...
### <a name="inbound-and-outbound-warehouse-handling-times-in-order-promising" />Saapuvan ja lähtevän fyysisen varastoinnin käsittelyajat toimituksen lupaamisen aikana
...
#### <a name="to-enter-default-inbound-and-outbound-warehouse-handling-times-for-sales-and-purchase-documents" />Saapuvien ja lähtevien varastointien oletuskäsittelyaikojen syöttäminen myynti- ja ostoasiakirjoihin
...
#### <a name="to-enter-inbound-and-outbound-warehouse-handling-times-on-locations" />Saapuvan ja lähtevän fyysisen varastoinnin käsittelyaikojen syöttäminen sijainteihin
...
## <a name="to-make-an-item-critical" />Nimikkeen määritteleminen kriittiseksi
...
## <a name="to-calculate-an-order-promising-date" />Toimituksen lupaamisen päivämäärän laskeminen
...
## <a name="see-related-microsoft-training" />Lue aiheeseen liittyen [Microsoftin koulutukset](/training/modules/promising-sales-order-delivery-dynamics-365-business-central/)
