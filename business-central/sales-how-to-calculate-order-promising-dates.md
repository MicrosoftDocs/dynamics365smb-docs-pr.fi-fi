...
ms.author: edupont
---
# <a name="calculate-order-promising-dates"></a><a name="calculate-order-promising-dates"></a>Toimituksen lupaamisen päivämäärien laskeminen
...
## <a name="about-order-promising"></a><a name="about-order-promising"></a>Tietoja toimituksen lupaamisesta
...
### <a name="available-to-promise"></a><a name="available-to-promise"></a>Luvattavissa
...
### <a name="capable-to-promise"></a><a name="capable-to-promise"></a>Mahdollinen luvattavaksi
...
### <a name="calculations"></a><a name="calculations"></a>Laskelmat
...
## <a name="to-set-up-order-promising"></a><a name="to-set-up-order-promising"></a>Toimituksen lupaamisen määrittäminen
...
### <a name="inbound-and-outbound-warehouse-handling-times-in-order-promising"></a><a name="inbound-and-outbound-warehouse-handling-times-in-order-promising"></a>Saapuvan ja lähtevän fyysisen varastoinnin käsittelyajat toimituksen lupaamisen aikana
...
#### <a name="to-enter-inbound-and-outbound-warehouse-handling-times-on-locations"></a><a name="to-enter-inbound-and-outbound-warehouse-handling-times-on-locations"></a>Saapuvan ja lähtevän fyysisen varastoinnin käsittelyaikojen syöttäminen sijainteihin
...
## <a name="to-make-an-item-critical"></a><a name="to-make-an-item-critical"></a>Nimikkeen määritteleminen kriittiseksi
...
## <a name="to-calculate-an-order-promising-date"></a><a name="to-calculate-an-order-promising-date"></a>Toimituksen lupaamisen päivämäärän laskeminen
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Lue aiheeseen liittyen [Microsoftin koulutukset](/training/modules/promising-sales-order-delivery-dynamics-365-business-central/)
