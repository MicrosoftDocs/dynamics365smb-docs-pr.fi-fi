...
ms.author: bholtorf
---
# <a name="register-new-vendors"></a><a name="register-new-vendors"></a>Uusien toimittajien rekisteröiminen
...
## <a name="adding-new-vendors"></a><a name="adding-new-vendors"></a>Uusien toimittajien lisääminen
...
### <a name="to-create-a-new-vendor"></a><a name="to-create-a-new-vendor"></a>Uuden toimittajan luominen
...
### <a name="deleting-and-editing-vendor-information"></a><a name="deleting-and-editing-vendor-information"></a>Toimittajan tietojen poistaminen ja muokkaaminen
...
## <a name="to-save-the-vendor-card-as-a-template"></a><a name="to-save-the-vendor-card-as-a-template"></a>Toimittajan kortin tallentaminen mallina
