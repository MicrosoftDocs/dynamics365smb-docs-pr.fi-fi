...
ms.author: edupont
---
# <a name="use-item-charges-to-account-for-additional-trade-costs" />Kaupan lisäkustannusten huomiointi nimikekulujen avulla
...
## <a name="to-set-up-item-charge-numbers" />Nimikekulunumeroiden määrittäminen
...
## <a name="to-assign-an-item-charge-directly-to-the-purchase-invoice-for-the-item" />Nimikekulun määrittäminen suoraan nimikkeen ostolaskuun
...
## <a name="to-assign-an-item-charge-from-a-separate-invoice-to-the-purchase-invoice-for-the-item" />Nimikekulun määrittäminen erillisestä laskusta nimikkeen ostolaskuun
...
## <a name="handle-item-charges-for-partial-receipts" />Osittaisten vastaanottojen nimikekulujen käsitteleminen
...
## <a name="see-related-microsoft-trainingtrainingmodulespost-purchase-item-charges-dynamics-365-business-central" />Lue aiheeseen liittyen [Microsoftin koulutukset](/training/modules/post-purchase-item-charges-dynamics-365-business-central/)
