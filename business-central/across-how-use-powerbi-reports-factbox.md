...
ms.author: jswymer
---
# <a name="creating-power-bi-reports-for-displaying-list-data-in-" />[!INCLUDE[prod_short](includes/prod_short.md)]in luettelotiedot näyttävien Power BI -raporttien luominen
