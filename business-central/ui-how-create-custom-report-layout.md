...
ms.author: edupont
---
# <a name="legacy-create-and-modify-custom-report-layouts" />(Vanha) Raporttien mukautettujen asettelujen luominen ja muokkaaminen
...
## <a name="create-a-custom-layout" />Mukautetun asettelun luominen
...
## <a name="a-namemodifycustomlayoutamodifying-a-custom-layout" /><a name="ModifyCustomLayout"></a>Mukautetun asettelun muokkaaminen
...
### <a name="modify-a-custom-layout" />Mukautetun asettelun muokkaaminen
