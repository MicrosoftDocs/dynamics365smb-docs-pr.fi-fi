...
---
# <a name="auditing-changes-in-business-central"></a><a name="auditing-changes-in-business-central"></a>Business Centralin tilintarkastuksen muutokset
...
## <a name="about-the-change-log"></a><a name="about-the-change-log"></a>Muutoslokista
...
### <a name="work-with-the-change-log"></a><a name="work-with-the-change-log"></a>Muutoslokin käyttäminen
...
## <a name="about-activity-logs"></a><a name="about-activity-logs"></a>Tietoja tapahtumalokeista
...
### <a name="work-with-activity-logs"></a><a name="work-with-activity-logs"></a>Toimintalokien käyttäminen
...
## <a name="monitoring-sensitive-fields"></a><a name="monitoring-sensitive-fields"></a>Arkaluonteisten kenttien valvonta
...
### <a name="setting-up-field-monitoring"></a><a name="setting-up-field-monitoring"></a>Kentän valvonnan asetusten määrittäminen
...
### <a name="work-with-field-monitoring"></a><a name="work-with-field-monitoring"></a>Kentän seurannan käsitteleminen
...
### <a name="viewing-field-monitoring-telemetry"></a><a name="viewing-field-monitoring-telemetry"></a>Kentän seurannan telemetrian tarkastelu
...
## <a name="defining-retention-policies"></a><a name="defining-retention-policies"></a>Säilytyskäytäntöjen määrittäminen
