...
ms.author: jswymer
---
# <a name="create-interactions-on-contacts-and-segments" />Vuorovaikutusten luominen kontakteille ja segmenteille
...
## <a name="to-create-an-interaction" />Integroinnin luominen
...
## <a name="to-finish-and-delete-postponed-interactions" />Lykättyjen vuorovaikutusten lopettaminen ja poistaminen
1. Avaa kontakti-, myyjä- tai vuorovaikutuslokitapahtuma.
2. Valitse **Lykätyt vuorovaikutukset**.
3. Valitse lopetettava vuorovaikutus ja valitse sitten **Jatka**-toiminto.

## <a name="to-create-an-interaction-on-a-segment" />Vuorovaikutusten luominen segmentille
