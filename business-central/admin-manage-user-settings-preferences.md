...
ms.author: soalex
---
# <a name="manage-user-settings-and-preferences"></a><a name="manage-user-settings-and-preferences"></a>Käyttäjäasetusten ja asetusten hallinta
...
## <a name="types-of-user-settings"></a><a name="types-of-user-settings"></a>Käyttäjäasetusten tyypit
...
## <a name="overview-of-all-user-specific-changes"></a><a name="overview-of-all-user-specific-changes"></a>Kaikkien käyttäjäkohtaisten muutosten yleiskuvaus
...
## <a name="to-review-or-delete-user-personalizations"></a><a name="to-review-or-delete-user-personalizations"></a>Käyttäjän mukautusten tarkasteleminen ja poistaminen
