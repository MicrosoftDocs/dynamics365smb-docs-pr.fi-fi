...
ms.author: soalex
---
# <a name="manage-user-settings-and-preferences" />Käyttäjäasetusten ja asetusten hallinta
...
## <a name="types-of-user-settings" />Käyttäjäasetusten tyypit
...
## <a name="overview-of-all-user-specific-changes" />Kaikkien käyttäjäkohtaisten muutosten yleiskuvaus
...
## <a name="to-review-or-delete-user-personalizations" />Käyttäjän mukautusten tarkasteleminen ja poistaminen
