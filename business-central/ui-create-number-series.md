...
ms.author: edupont
---
# <a name="create-number-series" />Numerosarjojen luominen
...
## <a name="gaps-in-number-series" />Numerosarjojen aukot
...
## <a name="behavior-of-the-no-field-on-documents-and-cards" />Nro-kentän toiminta asiakirjoissa ja korteissa
...
## <a name="to-create-a-new-number-series" />Uuden numerosarjan luominen
...
## <a name="to-create-relationships-between-number-series" />Numerosarjojen suhteiden luonti
...
## <a name="to-set-up-where-a-number-series-is-used" />Numerosarjan käyttökohteen määrittäminen
...
## <a name="see-related-microsoft-training" />Lue aiheeseen liittyen [Microsoftin koulutukset](/training/modules/number-series-trail-codes-dynamics-365-business-central/index)
