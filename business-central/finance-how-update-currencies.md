...
Vaihtokurssit ovat työkalu, jonka avulla lasketaan kunkin valuuttatapahtuman arvo paikallisessa valuutassa (PVA).  **Valuutan vaihtokurssit -** sivulla on seuraavat kentät:
...
Voit pitää valuutan vaihtokurssit ajan tasalla ulkoisen palvelun avulla.
...
4. Yhdistä kentät XML-tiedostosta lähdekentän valuutan vaihtokurssitaulukkoon.
5. Käytä kaikkia tarvittavia muunnossääntöjä.
6. Valitse **Käytössä**-tilanvaihtonäppäin ottaaksesi palvelun käyttöön.
...
Ajoittain on korjattava virheitä maksutapahtumissa, jotka liittyvät ulkomaan valuuttojen voittojen ja tappioiden muuttamiseen. Voit peruuttaa maksutapahtuman kohdistuksen **ja peruuttaa sen käyttämällä Peruuta tapahtuma -** toimintoa **Pankkitilitapahtumat**-, **Asiakastapahtumat**- ja **Toimittajatapahtumat-sivuilla** .
...
[Valuutat kohteessa Business Central](finance-currencies.md)    
