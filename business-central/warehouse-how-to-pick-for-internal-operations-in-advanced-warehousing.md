...
ms.author: bholtorf
---
# <a name="pick-for-production-assembly-or-jobs-in-advanced-warehouse-configurations" />Tuotanto-, kokoonpano- ja projektipoiminta laajennetuissa varastointimäärityksissä
...
## <a name="to-create-pick-documents-in-bulk-with-the-pick-worksheet" />Poiminta-asiakirjojen joukkoluonti poimintatyökirjan avulla
...
## <a name="to-pick-items-for-a-productions-order-assembly-order-job" />Tuotantotilauksen, kokoonpanotilauksen, projektin nimikkeiden poimiminen
...
## <a name="flushing-production-components-in-a-advanced-warehouse-configuration" />Tuotannon komponenttien materiaaliotto laajennetussa fyysisen varaston määrityksessä
