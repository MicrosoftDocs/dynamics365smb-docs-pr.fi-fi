...
ms.author: edupont
---
# <a name="delete-approval-workflows"></a><a name="delete-approval-workflows"></a>Hyväksymistyönkulkujen poistaminen
...
## <a name="delete-a-workflow"></a><a name="delete-a-workflow"></a>Työnkulun poistaminen
