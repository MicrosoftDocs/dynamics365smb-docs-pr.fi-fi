...
ms.author: edupont
---
# <a name="define-user-tasks" />Käyttäjätehtävien määrittäminen
...
## <a name="managing-user-tasks" />Käyttäjätehtävien hallinta
...
### <a name="picking-up-user-tasks" />Käyttäjätehtävien poimiminen
...
### <a name="deleting-user-tasks" />Käyttäjätehtävien poistaminen
