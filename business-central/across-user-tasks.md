...
ms.author: edupont
---
# <a name="define-user-tasks"></a><a name="define-user-tasks"></a>Käyttäjätehtävien määrittäminen
...
## <a name="managing-user-tasks"></a><a name="managing-user-tasks"></a>Käyttäjätehtävien hallinta
...
### <a name="picking-up-user-tasks"></a><a name="picking-up-user-tasks"></a>Käyttäjätehtävien poimiminen
...
### <a name="deleting-user-tasks"></a><a name="deleting-user-tasks"></a>Käyttäjätehtävien poistaminen
