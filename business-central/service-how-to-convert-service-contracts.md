...
ms.author: edupont
---
# <a name="convert-service-contracts-that-include-vat-amounts" />ALV-summia sisältävien huoltosopimusten muuntaminen
...
### <a name="to-correct-an-invoice-for-a-prepaid-service-contract" />Korjaa ennakkoon maksetun huoltosopimuksen lasku
...
### <a name="to-create-a-credit-memo-for-vat-difference" />Luo ALV-erotuksen hyvityslasku
...
### <a name="to-create-contract-expiration-dates-in-contract-lines" />Luo sopimuksen vanhentumispäivämäärät sopimusriveille
...
### <a name="to-create-a-new-credit-memo" />Luo uusi hyvityslasku.
