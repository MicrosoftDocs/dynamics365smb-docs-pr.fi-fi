...
ms.author: edupont
---
# <a name="enable-customer-payments-through-payment-services" />Asiakasmaksujen ottaminen käyttöön maksupalvelujen kautta
...
## <a name="to-enable-a-payment-service-in-includeprodshortincludesprodshortmd" />Maksupalvelun ottaminen käyttöön [!INCLUDE[prod_short](includes/prod_short.md)]issa
...
## <a name="to-select-a-payment-service-on-a-sales-invoice" />Maksupalvelun valitseminen myyntilaskussa
