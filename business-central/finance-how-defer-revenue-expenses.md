...
ms.author: edupont
---
# <a name="defer-revenues-and-expenses" />Tuottojen ja kulujen siirtäminen
...
## <a name="to-set-up-a-gl-account-for-deferral" />KP-tilin määrittäminen siirtoa varten
...
## <a name="to-set-up-a-deferral-template" />Siirtomallin määrittäminen
...
## <a name="to-assign-a-deferral-template-to-an-item" />Siirtomallin määrittäminen nimikkeelle
...
## <a name="to-change-a-deferral-schedule-from-a-sales-invoice" />Siirtomallin muuttaminen myyntilaskusta
...
## <a name="to-preview-how-deferred-revenues-or-expenses-will-be-posted-to-the-general-ledger" />Siirrettyjen tuottojen tai kulujen kirjanpitoon kirjaamisen tarkasteleminen
...
## <a name="to-review-posted-deferrals-in-the-sales-deferral-summary-report" />Kirjattujen siirtojen tarkasteleminen Myynnin siirron yhteenveto -raportissa
...
## <a name="to-specify-a-period-in-which-to-allow-deferral-posting" />Kauden määrittäminen lykkäyksen kirjauksen sallimiseksi
