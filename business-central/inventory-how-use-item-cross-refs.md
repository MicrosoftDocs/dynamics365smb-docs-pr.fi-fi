...
ms.author: edupont
---
# <a name="use-item-references"></a><a name="use-item-references"></a>Käytä nimikeviittauksia
...
## <a name="to-start-using-item-references"></a><a name="to-start-using-item-references"></a>Voit alkaa käyttää nimikeviitteitä seuraavasti
...
## <a name="to-set-up-an-item-reference"></a><a name="to-set-up-an-item-reference"></a>Nimikeviittauksen määrittäminen
...
## <a name="to-enter-a-vendors-item-description-on-a-document"></a><a name="to-enter-a-vendors-item-description-on-a-document"></a>Toimittajan nimikekuvauksen antaminen asiakirjassa
