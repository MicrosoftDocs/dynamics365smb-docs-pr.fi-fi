...
ms.author: edupont
---
# <a name="use-item-references" />Käytä nimikeviittauksia
...
## <a name="to-start-using-item-references" />Voit alkaa käyttää nimikeviitteitä seuraavasti
...
## <a name="to-set-up-an-item-reference" />Nimikeviittauksen määrittäminen
...
## <a name="to-enter-a-vendors-item-description-on-a-document" />Toimittajan nimikekuvauksen antaminen asiakirjassa
