---
title: Varaston arvostuksen ja arvostuksen määrittäminen
...
|Varmistaminen, että oletetut kustannukset kirjataan pääkirjanpitoon, jotta väliaikaisilla KP-tileillä näkyy arvio erääntyneistä summista ja kaupattavien nimikkeiden kustannuksista ennen niiden laskutusta.|**Varastonhallinnan asetukset** -sivun **Oletettu kust. kirjaus KP:toon** -kenttä|  
...
[Asetusten parhaat käytännöt: Arvostusmenetelmä](setup-best-practices-costing-method.md)    
[Suunnittelun yksityiskohdat: Varaston arvostus](design-details-inventory-costing.md)    
[Suunnittelun yksityiskohdat: Nimikkeiden arvostusmenetelmän muuttaminen](design-details-changing-costing-methods.md)    
[Business Centralin käsitteleminen](ui-work-product.md)    
[Rahoitus](finance.md)    
