...
ms.author: jswymer
---
# <a name="close-accounting-periods"></a><a name="close-accounting-periods"></a>Kirjanpitojakson päättäminen

Kun tilikausi on ohi, sinun täytyy päättää tilikauteen sisältyvät kirjanpitojaksot.

## <a name="to-close-accounting-periods"></a><a name="to-close-accounting-periods"></a>Kirjanpitojakson päättäminen
