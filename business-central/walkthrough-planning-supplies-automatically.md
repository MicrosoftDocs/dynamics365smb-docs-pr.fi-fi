...
ms.author: edupont
---
# <a name="walkthrough-planning-supplies-automatically" />Vaihekuvaus: Toimitusten automaattinen suunnittelu
...
### <a name="to-create-stockkeeping-units" />Varastointiyksikän luominen
...
### <a name="to-change-selected-planning-parameters" />Vaihda valitut suunnitteluparametrit
...
## <a name="creating-a-regenerative-supply-plan" />Toimituksen uudelleensuunnittelun luominen
...
### <a name="to-create-the-sales-order" />Myyntitilauksen luominen
...
### <a name="to-create-a-regenerative-plan-to-fulfill-demand-at-location-east" />Uudelleensuunnittelun luominen ITÄ-sijainnin kysynnän täyttämiseksi
...
### <a name="to-calculate-mrp-to-include-underlying-component-needs" />Laske tarvelaskenta sisällyttäen pohjana olevat osat
...
## <a name="analyzing-the-planning-result" />Suunnittelun tulosten analysoiminen
...
### <a name="to-check-the-planning-parameter" />Tarkista suunnitteluparametri
...
### <a name="to-view-more-order-tracking-entries" />Tarkastele lisää tilauksen seurantatapahtumia
...
## <a name="carrying-out-action-messages" />Toimenpideviestien toteuttaminen
 Seuraavaksi Karl muuntaa ehdotetut suunnittelurivit toimitustilauksiksi **Toteuta toim.pideviesti** -toiminnolla.  

### <a name="to-automatically-create-the-suggested-supply-orders" />Ehdotettujen toimitustilausten luominen automaattisesti
...
## <a name="creating-a-net-change-plan" />Nettomuutossuunnitelman luominen
...
### <a name="to-create-the-new-sales-demand-and-replan-accordingly" />Myynnin kysynnän luominen ja uudelleensuunnittelu
...
## <a name="analyzing-the-changed-planning-result" />Muutetun suunnittelun tulosten analysoiminen
...
### <a name="to-view-an-existing-order" />Olemassa olevan tilauksen tarkasteleminen
