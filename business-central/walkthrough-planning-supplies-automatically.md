...
ms.author: edupont
---
# <a name="walkthrough-planning-supplies-automatically"></a><a name="walkthrough-planning-supplies-automatically"></a><a name="walkthrough-planning-supplies-automatically"></a>Vaihekuvaus: Toimitusten automaattinen suunnittelu
...
### <a name="to-create-stockkeeping-units"></a><a name="to-create-stockkeeping-units"></a><a name="to-create-stockkeeping-units"></a>Varastointiyksikän luominen
...
### <a name="to-change-selected-planning-parameters"></a><a name="to-change-selected-planning-parameters"></a><a name="to-change-selected-planning-parameters"></a>Vaihda valitut suunnitteluparametrit
...
## <a name="creating-a-regenerative-supply-plan"></a><a name="creating-a-regenerative-supply-plan"></a><a name="creating-a-regenerative-supply-plan"></a>Toimituksen uudelleensuunnittelun luominen
...
### <a name="to-create-the-sales-order"></a><a name="to-create-the-sales-order"></a><a name="to-create-the-sales-order"></a>Myyntitilauksen luominen
...
### <a name="to-create-a-regenerative-plan-to-fulfill-demand-at-location-east"></a><a name="to-create-a-regenerative-plan-to-fulfill-demand-at-location-east"></a><a name="to-create-a-regenerative-plan-to-fulfill-demand-at-location-east"></a>Uudelleensuunnittelun luominen ITÄ-sijainnin kysynnän täyttämiseksi
...
### <a name="to-calculate-mrp-to-include-underlying-component-needs"></a><a name="to-calculate-mrp-to-include-underlying-component-needs"></a><a name="to-calculate-mrp-to-include-underlying-component-needs"></a>Laske tarvelaskenta sisällyttäen pohjana olevat osat
...
## <a name="analyzing-the-planning-result"></a><a name="analyzing-the-planning-result"></a><a name="analyzing-the-planning-result"></a>Suunnittelun tulosten analysoiminen
...
### <a name="to-view-order-tracking-entries-for-item-1300"></a><a name="to-view-order-tracking-entries-for-item-1300"></a><a name="to-view-order-tracking-entries-for-item-1300"></a>Tarkastele kohteen 1300 tilauksen merkintää
...
### <a name="to-check-the-planning-parameter"></a><a name="to-check-the-planning-parameter"></a><a name="to-check-the-planning-parameter"></a>Tarkista suunnitteluparametri
...
### <a name="to-view-more-order-tracking-entries"></a><a name="to-view-more-order-tracking-entries"></a><a name="to-view-more-order-tracking-entries"></a>Tarkastele lisää tilauksen seurantatapahtumia
...
## <a name="carrying-out-action-messages"></a><a name="carrying-out-action-messages"></a><a name="carrying-out-action-messages"></a>Toimenpideviestien toteuttaminen
 Seuraavaksi Karl muuntaa ehdotetut suunnittelurivit toimitustilauksiksi **Toteuta toim.pideviesti** -toiminnolla.  

### <a name="to-automatically-create-the-suggested-supply-orders"></a><a name="to-automatically-create-the-suggested-supply-orders"></a><a name="to-automatically-create-the-suggested-supply-orders"></a>Ehdotettujen toimitustilausten luominen automaattisesti
...
## <a name="creating-a-net-change-plan"></a><a name="creating-a-net-change-plan"></a><a name="creating-a-net-change-plan"></a>Nettomuutossuunnitelman luominen
...
### <a name="to-create-the-new-sales-demand-and-replan-accordingly"></a><a name="to-create-the-new-sales-demand-and-replan-accordingly"></a><a name="to-create-the-new-sales-demand-and-replan-accordingly"></a>Myynnin kysynnän luominen ja uudelleensuunnittelu
...
## <a name="analyzing-the-changed-planning-result"></a><a name="analyzing-the-changed-planning-result"></a><a name="analyzing-the-changed-planning-result"></a>Muutetun suunnittelun tulosten analysoiminen
...
### <a name="to-view-order-tracking-entries-for-item-1250"></a><a name="to-view-order-tracking-entries-for-item-1250"></a><a name="to-view-order-tracking-entries-for-item-1250"></a>Tarkastele kohteen 1250 tilauksen merkintää
...
### <a name="to-view-an-existing-order"></a><a name="to-view-an-existing-order"></a><a name="to-view-an-existing-order"></a>Olemassa olevan tilauksen tarkasteleminen
