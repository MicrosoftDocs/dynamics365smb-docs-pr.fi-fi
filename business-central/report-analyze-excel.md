...
ms.author: jswymer
---
# <a name="analyzing-report-data-with-excel-and-xml" />Raporttitietojen analysointi Excelillä ja XML:llä
...
## <a name="more-about-excel-data-only" />Lisätietoja Excelistä (vain tiedot)
...
## <a name="for-administrators" />Järjestelmänvalvojille
...
## <a name="for-developers-and-advanced-users" />Kehittäjille ja kokeneille käyttäjille
