...
> [!NOTE]
> Järjestelmänvalvojat voivat tehdä samat asettelumuutokset kuin käyttäjät mukauttamalla profiilin (roolin), joka voidaan liittää useisiin käyttäjiin. Saat lisätietoja roolien sivuista valitsemalla [Roolien sivujen mukauttaminen](ui-personalization-manage.md)<br /><br />
...
## <a name="video-and-training"></a>Video ja koulutus

Seuraava video näyttää joitakin tapoja, joilla voit mukauttaa roolikeskuksesi.

> [!Video https://www.microsoft.com/en-us/videoplayer/embed/RE4ArUB?rel=0]

Online-koulutusta varten on kohdassa [Microsoftin Dynamics 365 Business Central käyttöliittymän mukauttaminen](/training/modules/personalize-ui-dynamics-365-business-central/).
...
### <a name="add-a-field-so-its-visible-on-the-page"></a>Kentän lisääminen siten, että se näkyy sivulla
