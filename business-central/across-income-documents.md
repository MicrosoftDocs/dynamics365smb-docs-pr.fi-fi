...
ms.author: edupont
---
# <a name="incoming-documents"></a><a name="incoming-documents"></a><a name="incoming-documents"></a>Saapuvat asiakirjat
...
## <a name="usage-scenario"></a><a name="usage-scenario"></a><a name="usage-scenario"></a>Käyttöskenaario
...
## <a name="incoming-document-features"></a><a name="incoming-document-features"></a><a name="incoming-document-features"></a>Saapuvan asiakirjan ominaisuudet
