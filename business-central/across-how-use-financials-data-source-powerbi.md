...
# <a name="building-power-bi-reports-to-display--data"></a><a name="building-power-bi-reports-to-display--data"></a>Power BI -raporttien luominen näyttämään [!INCLUDE [prod_long](includes/prod_long.md)] -tietoja
...
## <a name="add--as-a-data-source-in-power-bi-desktop"></a><a name="add--as-a-data-source-in-power-bi-desktop"></a><a name="getdata"></a>[!INCLUDE[prod_short](includes/prod_short.md)]in lisääminen Power BI Desktopin tietolähteeksi
...
## <a name="creating-accessible-reports"></a><a name="creating-accessible-reports"></a>Helppokäyttötoimintoja sisältävien raporttien luominen
...
## <a name="creating-reports-to-display-data-associated-with-a-list"></a><a name="creating-reports-to-display-data-associated-with-a-list"></a>Raporttien luominen näyttämään luetteloon liitetyt tiedot
...
## <a name="using-the--report-theme-optional"></a><a name="using-the--report-theme-optional"></a><a name="theme"></a>[!INCLUDE [prod_short](includes/prod_short.md)] -raportin teeman käyttäminen (valinnainen)
...
### <a name="download-the-theme"></a><a name="download-the-theme"></a>Teeman lataaminen
...
### <a name="import-the-theme-on-a-report"></a><a name="import-the-theme-on-a-report"></a>Teeman tuominen raporttiin
...
## <a name="publish-reports"></a><a name="publish-reports"></a>Raporttien julkaiseminen
...
## <a name="distribute-or-share-a-report"></a><a name="distribute-or-share-a-report"></a>Raportin jakaminen tai jakelu
...
### <a name="cannot-insert-a-record-current-connection-intent-is-read-only-error-connecting-to-custom-api-page"></a><a name="cannot-insert-a-record-current-connection-intent-is-read-only-error-connecting-to-custom-api-page"></a>"Tietuetta ei voi lisätä. Nykyinen yhteystarkoitus on vain luku.". virhe muodostettaessa yhteyttä mukautettuun ohjelmointirajapintasivuun
