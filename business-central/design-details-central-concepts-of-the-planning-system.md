...
---
# <a name="design-details-central-concepts-of-the-planning-system" />Rakennetiedot: suunnittelujärjestelmän keskeiset käsitteet
...
## <a name="planning-parameters" />Suunnittelun parametrit
...
## <a name="planning-starting-date" />Suunnittelun aloituspäivämäärä
...
## <a name="dynamic-order-tracking-pegging" />Dynaaminen tilausseuranta (tarvekohdistus)
...
### <a name="dynamic-order-tracking-versus-the-planning-system" />Dynaaminen tilausseuranta verrattuna suunnittelujärjestelmään
...
## <a name="sequence-and-priority-in-planning" />Suunnittelun järjestys ja ensisijaisuus
...
### <a name="item-priority--low-level-code" />Nimikkeen prioriteetti/alatason koodi
...
#### <a name="optimizing-performance-for-low-level-calculations" />Suorituskyvyn optimoiminen matalan tason laskelmissa
...
### <a name="locations--transfer-level-priority" />Sijainnit/siirtotason prioriteetti
...
### <a name="order-priority" />Tilauksen prioriteetti
...
## <a name="demand-forecasts-and-blanket-orders" />Kysyntäennusteet ja puitetilaukset
...
## <a name="planning-assignment" />Suunnittelun tehtävä
...
## <a name="item-dimensions" />Nimikedimensiot
...
## <a name="item-attributes" />Nimikkeen määritteet
...
### <a name="specific-attributes" />Tietyt attribuutit
...
### <a name="non-specific-attributes" />Epäspesifiset määritteet
...
## <a name="order-to-order-links" />Tilausten väliset linkit
...
## <a name="planning-flexibility" />Suunnittelun joustavuus
...
## <a name="order-planning" />Tilauksen suunnittelu
...
## <a name="finite-loading" />Äärellinen kuormitus
