...
---
# <a name="design-details-central-concepts-of-the-planning-system"></a><a name="design-details-central-concepts-of-the-planning-system"></a>Rakennetiedot: suunnittelujärjestelmän keskeiset käsitteet
...
## <a name="planning-starting-date"></a><a name="planning-starting-date"></a>Suunnittelun aloituspäivämäärä
...
## <a name="dynamic-order-tracking-pegging"></a><a name="dynamic-order-tracking-pegging"></a>Dynaaminen tilausseuranta (tarvekohdistus)
...
### <a name="dynamic-order-tracking-versus-the-planning-system"></a><a name="dynamic-order-tracking-versus-the-planning-system"></a>Dynaaminen tilausseuranta verrattuna suunnittelujärjestelmään
...
## <a name="sequence-and-priority-in-planning"></a><a name="sequence-and-priority-in-planning"></a>Suunnittelun järjestys ja ensisijaisuus
...
### <a name="item-priority--low-level-code"></a><a name="item-priority--low-level-code"></a>Nimikkeen prioriteetti/alatason koodi
...
#### <a name="optimizing-performance-for-low-level-calculations"></a><a name="optimizing-performance-for-low-level-calculations"></a>Suorituskyvyn optimoiminen matalan tason laskelmissa
...
### <a name="locations--transfer-level-priority"></a><a name="locations--transfer-level-priority"></a>Sijainnit/siirtotason prioriteetti
...
### <a name="order-priority"></a><a name="order-priority"></a>Tilauksen prioriteetti
...
## <a name="demand-forecasts-and-blanket-orders"></a><a name="demand-forecasts-and-blanket-orders"></a>Kysyntäennusteet ja puitetilaukset
...
## <a name="planning-assignment"></a><a name="planning-assignment"></a>Suunnittelun tehtävä
...
## <a name="item-dimensions"></a><a name="item-dimensions"></a>Nimikedimensiot
...
## <a name="item-attributes"></a><a name="item-attributes"></a>Nimikkeen määritteet
...
### <a name="specific-attributes"></a><a name="specific-attributes"></a>Tietyt attribuutit
...
### <a name="non-specific-attributes"></a><a name="non-specific-attributes"></a>Epäspesifiset määritteet
...
## <a name="order-to-order-links"></a><a name="order-to-order-links"></a>Tilausten väliset linkit
...
## <a name="reservations"></a><a name="reservations"></a>Varaukset
...
## <a name="warnings"></a><a name="warnings"></a>Varoitukset
...
### <a name="emergency"></a><a name="emergency"></a>Hätä
...
## <a name="error-logs"></a><a name="error-logs"></a>Virhelokit
...
## <a name="order-planning"></a><a name="order-planning"></a>Tilauksen suunnittelu
...
## <a name="finite-loading"></a><a name="finite-loading"></a>Äärellinen kuormitus
