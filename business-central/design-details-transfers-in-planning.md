...
---
# <a name="design-details-transfers-in-planning" />Rakennetiedot: siirrot suunnittelussa
...
## <a name="why-is-a-transfer-a-special-case" />Siirron erikoisasema
...
## <a name="transfers-are-dependent-demand" />Siirrot ovat riippuvaisia kysynnästä
...
## <a name="planning-sequence" />Suunnittelujärjestys
...
## <a name="transfer-level-code" />Siirtotason koodi
...
## <a name="planning-transfers-without-sku" />Siirtojen suunnittelu ilman varastointiyksiköitä
...
## <a name="changing-quantity-with-reservations" />Varauksia sisältävän määrän muuttaminen
...
## <a name="changing-quantity-in-a-transfer-chain" />Määrän muuttaminen siirtoketjussa
...
## <a name="lead-time-calculation" />Toimitusajan laskenta
...
## <a name="safety-lead-time" />Toimitusajan varmistus
...
## <a name="reschedule" />Aikataul. uud.
...
## <a name="serial-and-lot-numbers-in-transfer-chains" />Sarja- ja eränumerot siirtoketjuissa
