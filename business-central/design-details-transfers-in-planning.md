...
![Esimerkki siirtoprosessista](media/nav_app_supply_planning_7_transfers1.png "Esimerkki siirtoprosessista")  
...
![Esimerkki yksinkertaisesta siirtoprosessista](media/nav_app_supply_planning_7_transfers4.png "Esimerkki yksinkertaisesta siirtoprosessista")  
...
![Tarjonnan suunnittelu ja siirrot](media/nav_app_supply_planning_7_transfers5.png "Tarjonnan suunnittelu ja siirrot")  
...
![Siirron suunnittelun 1 määrän muuttaminen](media/nav_app_supply_planning_7_transfers9.png "Siirron suunnittelun 1 määrän muuttaminen")  

Nyt suunnittelija VAALEANPUNAISESSA sijainnissa luo varauksen ostoon.  

![Siirron suunnittelun 2 määrän muuttaminen](media/nav_app_supply_planning_7_transfers10.png "Siirron suunnittelun 2 määrän muuttaminen")  
...
![Siirron suunnittelun 3 määrän muuttaminen](media/nav_app_supply_planning_7_transfers11.png "Siirron suunnittelun 3 määrän muuttaminen")  
...
![Siirron suunnittelun 4 määrän muuttaminen](media/nav_app_supply_planning_7_transfers12.png "Siirron suunnittelun 4 määrän muuttaminen")  
...
![Siirron suunnittelun keskiset päivämäärät ja ajat](media/nav_app_supply_planning_7_transfers13.png "Siirron suunnittelun keskiset päivämäärät ja ajat")  
...
![Siirron suunnittelun eräpäivän muuttaminen](media/nav_app_supply_planning_7_transfers15.png "Siirron suunnittelun eräpäivän muuttaminen")  
...
![Siirron suunnittelun tilausten väliset linkit](media/nav_app_supply_planning_7_transfers16.png "Siirron suunnittelun tilausten väliset linkit")  
