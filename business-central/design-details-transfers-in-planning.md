...
---
# <a name="design-details-transfers-in-planning"></a><a name="design-details-transfers-in-planning"></a><a name="design-details-transfers-in-planning"></a>Rakennetiedot: siirrot suunnittelussa
...
## <a name="why-is-a-transfer-a-special-case"></a><a name="why-is-a-transfer-a-special-case"></a><a name="why-is-a-transfer-a-special-case"></a>Siirron erikoisasema
...
## <a name="transfers-are-dependent-demand"></a><a name="transfers-are-dependent-demand"></a><a name="transfers-are-dependent-demand"></a>Siirrot ovat riippuvaisia kysynnästä
...
## <a name="planning-sequence"></a><a name="planning-sequence"></a><a name="planning-sequence"></a>Suunnittelujärjestys
...
## <a name="transfer-level-code"></a><a name="transfer-level-code"></a><a name="transfer-level-code"></a>Siirtotason koodi
...
## <a name="planning-transfers-without-sku"></a><a name="planning-transfers-without-sku"></a><a name="planning-transfers-without-sku"></a>Siirtojen suunnittelu ilman varastointiyksiköitä
...
## <a name="changing-quantity-with-reservations"></a><a name="changing-quantity-with-reservations"></a><a name="changing-quantity-with-reservations"></a>Varauksia sisältävän määrän muuttaminen
...
## <a name="changing-quantity-in-a-transfer-chain"></a><a name="changing-quantity-in-a-transfer-chain"></a><a name="changing-quantity-in-a-transfer-chain"></a>Määrän muuttaminen siirtoketjussa
...
## <a name="lead-time-calculation"></a><a name="lead-time-calculation"></a><a name="lead-time-calculation"></a>Toimitusajan laskenta
...
## <a name="safety-lead-time"></a><a name="safety-lead-time"></a><a name="safety-lead-time"></a>Toimitusajan varmistus
...
## <a name="reschedule"></a><a name="reschedule"></a><a name="reschedule"></a>Aikataul. uud.
...
## <a name="serial-and-lot-numbers-in-transfer-chains"></a><a name="serial-and-lot-numbers-in-transfer-chains"></a><a name="serial-and-lot-numbers-in-transfer-chains"></a>Sarja- ja eränumerot siirtoketjuissa
