...
# <a name="set-up-service-contracts" />Huoltosopimusten määrittäminen
...
## <a name="to-set-up-a-service-contract-group" />Huoltosopimusryhmien määrittäminen
...
## <a name="to-set-up-a-service-contract-account-group" />Huoltosopimusten tiliryhmien määrittäminen
...
## <a name="to-set-up-a-contract-template" />Sopimusmallien määrittäminen
...
## <a name="to-set-up-a-customer-template" />Asiakasmallien määrittäminen
