...
ms.author: edupont
---
# <a name="overview-of-tasks-to-set-up-"></a><a name="overview-of-tasks-to-set-up-"></a><a name="overview-of-tasks-to-set-up-"></a>[!INCLUDE[prod_short](includes/prod_short.md)]in määritystehtävien yleiskatsaus
...
Joidenkin alueiden edellytyksenä on, että käyttäjä on [!INCLUDE[prod_short](includes/prod_short.md)]-tilauksen järjestelmänvalvoja. Lisätietoja on kohdassa [Hallinta](admin-setup-and-administration.md).  
...
## <a name="set-up-apps"></a><a name="set-up-apps"></a><a name="set-up-apps"></a>Sovellusten määrittäminen
