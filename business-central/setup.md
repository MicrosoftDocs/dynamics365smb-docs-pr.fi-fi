...
ms.author: edupont
---
# <a name="overview-of-tasks-to-set-up-"></a><a name="overview-of-tasks-to-set-up-"></a>[!INCLUDE[prod_short](includes/prod_short.md)]in määritystehtävien yleiskatsaus
...
## <a name="set-up-apps"></a><a name="set-up-apps"></a>Sovellusten määrittäminen
