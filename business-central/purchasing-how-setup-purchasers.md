...
ms.author: edupont
---
# <a name="set-up-purchasers" />Ostajien määrittäminen
...
## <a name="to-set-up-purchasers" />Ostajien määrittäminen
...
## <a name="to-assign-purchasers-to-vendors" />Ostajien määrittäminen toimittajiin
