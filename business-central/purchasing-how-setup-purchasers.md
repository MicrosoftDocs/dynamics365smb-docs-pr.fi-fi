...
ms.author: edupont
---
# <a name="set-up-purchasers"></a><a name="set-up-purchasers"></a><a name="set-up-purchasers"></a>Ostajien määrittäminen
...
## <a name="to-set-up-purchasers"></a><a name="to-set-up-purchasers"></a><a name="to-set-up-purchasers"></a>Ostajien määrittäminen
...
## <a name="to-assign-purchasers-to-vendors"></a><a name="to-assign-purchasers-to-vendors"></a><a name="to-assign-purchasers-to-vendors"></a>Ostajien määrittäminen toimittajiin
