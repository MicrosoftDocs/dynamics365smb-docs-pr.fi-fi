...
ms.author: edupont
---
# <a name="walkthrough-conducting-a-sales-campaign" />Vaihekuvaus: Myyntikampanjan suorittaminen
...
## <a name="setting-up-a-campaign" />Kampanjan määrittäminen
...
### <a name="to-set-up-a-campaign" />Kampanjan määrittäminen
...
## <a name="selecting-the-target-audience" />Kohderyhmän valitseminen
...
### <a name="to-create-a-segment-with-the-relevant-contacts" />Asianmukaiset kontaktit sisältävän segmentin luominen
...
### <a name="to-save-your-segmentation-criteria" />Segmentointikriteerien tallentaminen
...
## <a name="mining-the-data" />Tietojen louhinta
...
### <a name="to-remove-contacts-from-the-segment" />Kontaktien poistaminen segmentistä
...
### <a name="to-bring-back-the-removed-contacts" />Poistettujen yhteystietojen palauttaminen
...
## <a name="linking-a-segment-to-a-campaign" />Segmentin yhdistäminen kampanjaan
...
### <a name="to-link-a-segment-to-the-campaign" />Segmentin yhdistäminen kampanjaan
...
## <a name="sending-letters-and-email-messages-to-contacts" />Kirjeet ja sähköpostiviestit lähetetään yhteystiedoille
...
### <a name="to-use-a-segment-to-send-a-letter-to-a-contact" />Lähetä kirje yhteyshenkilölle segmentin avulla
...
### <a name="to-send-an-email-message-to-a-contact" />Lähetä sähköpostiviesti yhteyshenkilölle
...
## <a name="registering-campaign-responses" />Kampanjareaktioiden rekisteröiminen
...
### <a name="to-register-campaign-responses" />Kampanjareaktioiden rekisteröiminen
