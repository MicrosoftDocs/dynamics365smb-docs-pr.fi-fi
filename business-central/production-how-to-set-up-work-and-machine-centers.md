...
ms.author: edupont
---
# <a name="set-up-work-centers-and-machine-centers" />Tuotantosolujen ja kuormituskeskusten määrittäminen
...
## <a name="to-set-up-a-work-center" />Tuotantosolun määrittäminen
...
## <a name="considerations-about-capacity" />Huomioitavaa kapasiteetista
...
### <a name="setup-time" />Määritysaika
...
### <a name="work-center-processing-multiple-orders-simultaneously" />Tuotantosolu käsittelee samanaikaisesti useita tilauksia
...
### <a name="efficient-resource-can-dedicate-only-part-of-their-work-date-to-productive-work" />Tehokas resurssi voi varata vain osan työpäivästä tuottavaan työhön
...
### <a name="consolidated-calendar" />Yhdistetty kalenteriin
...
### <a name="example---different-machine-centers-assigned-to-a-work-center" />Esimerkki - Tuotantosoluun liitetyt erilaiset kuormitusryhmät
...
## <a name="to-set-up-a-capacity-constrained-machine-or-work-center" />Kapasiteettirajoitetun kuormitusryhmän tai tuotantosolun määrittäminen
