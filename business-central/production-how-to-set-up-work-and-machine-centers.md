...
ms.author: edupont
---
# <a name="set-up-work-centers-and-machine-centers"></a><a name="set-up-work-centers-and-machine-centers"></a>Tuotantosolujen ja kuormituskeskusten määrittäminen
...
## <a name="to-set-up-a-work-center"></a><a name="to-set-up-a-work-center"></a>Tuotantosolun määrittäminen
...
## <a name="considerations-about-capacity"></a><a name="considerations-about-capacity"></a>Huomioitavaa kapasiteetista
...
### <a name="run-time"></a><a name="run-time"></a>Ajoaika
...
### <a name="setup-time"></a><a name="setup-time"></a>Määritysaika
...
### <a name="work-center-processing-multiple-orders-simultaneously"></a><a name="work-center-processing-multiple-orders-simultaneously"></a>Tuotantosolu käsittelee samanaikaisesti useita tilauksia
...
### <a name="efficient-resource-can-dedicate-only-part-of-their-work-date-to-productive-work"></a><a name="efficient-resource-can-dedicate-only-part-of-their-work-date-to-productive-work"></a>Tehokas resurssi voi varata vain osan työpäivästä tuottavaan työhön
...
### <a name="consolidated-calendar"></a><a name="consolidated-calendar"></a>Yhdistetty kalenteriin
...
### <a name="example---different-machine-centers-assigned-to-a-work-center"></a><a name="example---different-machine-centers-assigned-to-a-work-center"></a>Esimerkki - Tuotantosoluun liitetyt erilaiset kuormitusryhmät
...
## <a name="to-set-up-a-capacity-constrained-machine-or-work-center"></a><a name="to-set-up-a-capacity-constrained-machine-or-work-center"></a>Kapasiteettirajoitetun kuormitusryhmän tai tuotantosolun määrittäminen
