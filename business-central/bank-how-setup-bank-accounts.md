...
## <a name="to-set-up-bank-accounts" />Pankkitilien määrittäminen
...
## <a name="to-enter-an-opening-balance" />Alkusaldon syöttäminen
...
## <a name="to-set-up-your-bank-account-for-import-or-export-of-bank-files" />Pankkitilin määrittäminen pankkitiedostojen tuontia tai vientiä varten
...
## <a name="to-set-up-vendor-bank-accounts-for-export-of-bank-files" />Toimittajan pankkitilien määrittäminen pankkitiedostojen vientiä varten
...
## <a name="changing-your-bank-account" />Pankkitilin vaihtaminen
...
## <a name="see-related-microsoft-trainingtrainingmodulescash-management-dynamics-365-business-central" />Lue aiheeseen liittyen [Microsoftin koulutukset](/training/modules/cash-management-dynamics-365-business-central/)
