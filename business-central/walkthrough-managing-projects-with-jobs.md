...
## <a name="setting-up-a-job-1"></a>Projektin määrittäminen
...
## <a name="see-related-microsoft-training"></a>Lue aiheeseen liittyen [Microsoftin koulutukset](/training/paths/create-jobs/)
