...
---
# <a name="walkthrough-managing-projects"></a>Vaihekuvaus: Projektinhallinta Projektit-sovellusalueen avulla
...
### <a name="to-create-a-project-journal-batch"></a>Luo uusi päiväkirjan erä.
...
### <a name="to-add-project-tasks"></a>Työtehtävien lisääminen
...
### <a name="to-copy-a-project"></a>Projektin kopioiminen
