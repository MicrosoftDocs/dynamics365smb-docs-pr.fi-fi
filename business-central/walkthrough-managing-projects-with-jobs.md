...
ms.author: edupont
---
# <a name="walkthrough-managing-projects-with-jobs"></a><a name="walkthrough-managing-projects-with-jobs"></a><a name="walkthrough-managing-projects-with-jobs"></a>Vaihekuvaus: Projektinhallinta Projektit-sovellusalueen avulla
...
### <a name="setting-up-a-job"></a><a name="setting-up-a-job"></a><a name="setting-up-a-job"></a>Projektin määrittäminen
...
### <a name="handling-fixed-prices"></a><a name="handling-fixed-prices"></a><a name="handling-fixed-prices"></a>Kiinteiden hintojen käsitteleminen
...
### <a name="copying-a-job"></a><a name="copying-a-job"></a><a name="copying-a-job"></a>Projektin kopioiminen
...
### <a name="making-payment-by-installment"></a><a name="making-payment-by-installment"></a><a name="making-payment-by-installment"></a>Maksujen suorittaminen osamaksuina
...
## <a name="preparing-sample-data"></a><a name="preparing-sample-data"></a><a name="preparing-sample-data"></a>Esimerkkitietojen valmisteleminen

 Valmistaudu tähän vaihekuvaukseen lisäämällä Tricia uutena resurssina.  

### <a name="to-prepare-the-sample-data"></a><a name="to-prepare-the-sample-data"></a><a name="to-prepare-the-sample-data"></a>Esimerkkitietojen valmisteleminen
...
### <a name="to-create-a-job-journal-batch"></a><a name="to-create-a-job-journal-batch"></a><a name="to-create-a-job-journal-batch"></a>Luo uusi päiväkirjan erä.
...
## <a name="setting-up-a-job-1"></a><a name="setting-up-a-job-1"></a><a name="setting-up-a-job-1"></a>Projektin määrittäminen
...
### <a name="to-set-up-a-job"></a><a name="to-set-up-a-job"></a><a name="to-set-up-a-job"></a>Projektin määrittäminen
...
### <a name="to-customize-pricing"></a><a name="to-customize-pricing"></a><a name="to-customize-pricing"></a>Mukauta hinnoittelu
...
### <a name="to-add-job-tasks"></a><a name="to-add-job-tasks"></a><a name="to-add-job-tasks"></a>Työtehtävien lisääminen
...
### <a name="to-create-planning-lines"></a><a name="to-create-planning-lines"></a><a name="to-create-planning-lines"></a>Luo suunnittelurivit
...
## <a name="calculating-remaining-usage"></a><a name="calculating-remaining-usage"></a><a name="calculating-remaining-usage"></a>Jäljellä olevan käytön laskeminen
...
### <a name="to-calculate-remaining-usage"></a><a name="to-calculate-remaining-usage"></a><a name="to-calculate-remaining-usage"></a>Jäljellä olevan käytön laskeminen
...
## <a name="creating-and-posting-a-job-sales-invoice"></a><a name="creating-and-posting-a-job-sales-invoice"></a><a name="creating-and-posting-a-job-sales-invoice"></a>Projektin myyntilaskun luominen ja kirjaaminen
...
### <a name="to-create-a-job-sales-invoice"></a><a name="to-create-a-job-sales-invoice"></a><a name="to-create-a-job-sales-invoice"></a>Projektin myyntilaskun luominen
...
### <a name="to-post-a-new-sales-invoice"></a><a name="to-post-a-new-sales-invoice"></a><a name="to-post-a-new-sales-invoice"></a>Uuden myyntilaskun kirjaaminen
...
### <a name="to-view-the-posted-invoice"></a><a name="to-view-the-posted-invoice"></a><a name="to-view-the-posted-invoice"></a>Kirjatun laskun tarkasteleminen
...
### <a name="to-open-the-statistics-page"></a><a name="to-open-the-statistics-page"></a><a name="to-open-the-statistics-page"></a>Tilastot-sivun avaaminen
...
## <a name="handling-fixed-prices-1"></a><a name="handling-fixed-prices-1"></a><a name="handling-fixed-prices-1"></a>Kiinteiden hintojen käsitteleminen
...
### <a name="to-manage-fixed-pricing-in-jobs"></a><a name="to-manage-fixed-pricing-in-jobs"></a><a name="to-manage-fixed-pricing-in-jobs"></a>Kiinteän hinnoittelun hallinta projekteissa
...
### <a name="to-enter-hours-in-the-job-journal"></a><a name="to-enter-hours-in-the-job-journal"></a><a name="to-enter-hours-in-the-job-journal"></a>Tuntien lisääminen projektipäiväkirjaan
...
## <a name="copying-jobs"></a><a name="copying-jobs"></a><a name="copying-jobs"></a>Projektien kopioiminen
...
### <a name="to-copy-a-job"></a><a name="to-copy-a-job"></a><a name="to-copy-a-job"></a>Projektin kopioiminen
...
## <a name="making-payments-by-installments"></a><a name="making-payments-by-installments"></a><a name="making-payments-by-installments"></a>Maksujen suorittaminen osamaksuina
...
### <a name="to-set-up-a-new-account"></a><a name="to-set-up-a-new-account"></a><a name="to-set-up-a-new-account"></a>Uuden tilin luominen
...
### <a name="to-make-a-payment-by-installment"></a><a name="to-make-a-payment-by-installment"></a><a name="to-make-a-payment-by-installment"></a>Osamaksujen käyttäminen
...
### <a name="to-create-an-invoice"></a><a name="to-create-an-invoice"></a><a name="to-create-an-invoice"></a>Luo lasku
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Lue aiheeseen liittyen [Microsoftin koulutukset](/training/paths/create-jobs/)
