...
ms.author: edupont
---
# <a name="walkthrough-managing-projects-with-jobs" />Vaihekuvaus: Projektinhallinta Projektit-sovellusalueen avulla
...
### <a name="copying-a-job" />Projektin kopioiminen
...
### <a name="making-payment-by-installment" />Maksujen suorittaminen osamaksuina
...
## <a name="preparing-sample-data" />Esimerkkitietojen valmisteleminen

 Valmistaudu tähän vaihekuvaukseen lisäämällä Tricia uutena resurssina.  

### <a name="to-prepare-the-sample-data" />Esimerkkitietojen valmisteleminen
...
### <a name="to-create-a-job-journal-batch" />Luo uusi päiväkirjan erä.
...
### <a name="to-set-up-a-job" />Projektin määrittäminen
...
### <a name="to-customize-pricing" />Mukauta hinnoittelu
...
### <a name="to-add-job-tasks" />Työtehtävien lisääminen
...
### <a name="to-create-planning-lines" />Luo suunnittelurivit
...
## <a name="calculating-remaining-usage" />Jäljellä olevan käytön laskeminen
...
### <a name="to-calculate-remaining-usage" />Jäljellä olevan käytön laskeminen
...
## <a name="creating-and-posting-a-job-sales-invoice" />Projektin myyntilaskun luominen ja kirjaaminen
...
### <a name="to-create-a-job-sales-invoice" />Projektin myyntilaskun luominen
...
### <a name="to-post-a-new-sales-invoice" />Uuden myyntilaskun kirjaaminen
...
### <a name="to-view-the-posted-invoice" />Kirjatun laskun tarkasteleminen
...
### <a name="to-open-the-statistics-page" />Tilastot-sivun avaaminen
...
### <a name="to-manage-fixed-pricing-in-jobs" />Kiinteän hinnoittelun hallinta projekteissa
...
### <a name="to-enter-hours-in-the-job-journal" />Tuntien lisääminen projektipäiväkirjaan
...
## <a name="copying-jobs" />Projektien kopioiminen
...
### <a name="to-copy-a-job" />Projektin kopioiminen
...
## <a name="making-payments-by-installments" />Maksujen suorittaminen osamaksuina
...
### <a name="to-set-up-a-new-account" />Uuden tilin luominen
...
### <a name="to-make-a-payment-by-installment" />Osamaksujen käyttäminen
...
### <a name="to-create-an-invoice" />Luo lasku
