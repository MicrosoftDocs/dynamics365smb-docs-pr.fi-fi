...
# <a name="manually-synchronize-table-mappings" />Taulukon yhdistämismääritysten manuaalinen synkronointi
...
## <a name="run-a-full-synchronization" />Täyden synkronoinnin suorittaminen
...
### <a name="to-run-a-full-synchronization" />Täyden synkronoinnin suorittaminen
...
## <a name="synchronizing-all-modified-records" />Kaikkien muokattujen tietueiden synkronointi
...
### <a name="to-synchronize-data-for-all-tables" />Kaikki taulukoiden tietojen synkronointi
...
## <a name="synchronize-individual-table-mappings" />Yksittäisen taulukon yhdistämismääritysten synkronointi
...
### <a name="to-synchronize-records-of-an-integration-table-mapping" />Integrointitaulukon yhdistämismäärityksen tietueiden synkronointi
