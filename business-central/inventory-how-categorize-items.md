...
ms.author: edupont
---
# <a name="categorize-items"></a><a name="categorize-items"></a><a name="categorize-items"></a>Nimikkeiden luokitteleminen
...
## <a name="to-create-an-item-category"></a><a name="to-create-an-item-category"></a><a name="to-create-an-item-category"></a>Nimikeluokan luominen
...
## <a name="to-assign-an-item-category-to-an-item"></a><a name="to-assign-an-item-category-to-an-item"></a><a name="to-assign-an-item-category-to-an-item"></a>Nimikeluokan määrittäminen nimikkeeseen
