...
ms.author: edupont
---
# <a name="quote-an-assemble-to-order-sale"></a><a name="quote-an-assemble-to-order-sale"></a><a name="quote-an-assemble-to-order-sale"></a>Kokoonpano tilausta varten -myynnin tarjous
...
## <a name="to-create-a-sales-quote-for-an-assemble-to-order-item"></a><a name="to-create-a-sales-quote-for-an-assemble-to-order-item"></a><a name="to-create-a-sales-quote-for-an-assemble-to-order-item"></a>Luo myyntitarjous kokoonpano tilausta varten -nimikkeelle
