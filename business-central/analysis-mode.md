...
4. Kun haluat keskeyttää analyysitilan, valitse **Jätä analyysitila** ![Näyttää analyysitilan sammutuspainikkeen](media/analysis-mode-exit-icon.png) -painike.
   ...
   Lisäämäsi analyysivälilehdet säilyvät, kunnes poistat ne. Jos palaat analysointitilaan uudelleen, näet ne juuri sellaisina kuin ne jätit.
...
**Sarakkeet**-ruutu on toinen kahdesta ruudusta, jotka toimivat yhdessä määrittääkseen analyysin. Toinen alue on **Analyysisuodattimet**-ruutu. **Sarakkeet**-ruutua käytetään tietojen yhteenvetoon. **Sarakkeet**-ruudun avulla voit määrittää, mitkä sarakkeet sisällytetään analyysiin.
...
Jos haluat siirtää kentän yhdeltä alueelta toiselle, valitse sieppauskuvake ![Näyttää painikkeen, jolla kenttään tartutaan analyysitilassa](media/column-grab-icon.png) luettelon sarakkeen viereen ja vedä se alueelle. Et voi siirtää kenttää alueelle, jossa sitä ei sallita.
...
Jos analysoitava tietojoukko ylittää 100 000 riviä, ehdotamme, että syötät analyysitilan, joka on optimoitu suurille tietojoukoille. Tällä hetkellä on olemassa kaksi rajoitusta, jos siirryt tähän tilaan: 
...
1. Vastaanottajat voivat valita linkin ja avata sivun tai kyselyn analyysin [!INCLUDE [prod_short](includes/prod_short.md)] -ohjelmassa. Ohjelma pyytää heitä määrittämään uuden analyysivälilehden nimen, joka luodaan.  
...
### Tapauskohtainen data-analyysin esimerkit toiminta-alueittain
...
- Analyysitilan näkymässä on enintään 100 000 riviä. Jos ylität tämän, saat viestin, jossa se kerrotaan. Voit kiertää tämän rajoituksen määrittämällä sivun suodattimet ennen analysointitilaan siirtymistä, jos mahdollista. Haluat esimerkiksi analysoida tiettyä asiakasryhmää tai haluat tietoja vain kuluvasta vuodesta. Voit myös valita ennalta määritetyn näkymän, jos se toimii analyyseissä.
