...
---
# <a name="analyze-list-data-using-data-analysis-mode" />Luettelotietojen analysoiminen analysointitilan avulla
...
## <a name="prerequisite" />Vaatimukset
...
## <a name="work-with-data-analysis-mode" />Tietojen analysointitilan käsitteleminen
...
## <a name="limitations" />Rajoitukset
