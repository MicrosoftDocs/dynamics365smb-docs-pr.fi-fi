...
2. Valitse sivun yläosan toimintopalkissa **Syötä analyysitila** ![Näyttää analyysitilan käyttöönoton painikkeen](media/analysis-mode-icon.png) -painike.
   ...
   [![Näyttää yhteenvedon tietojen analysointitilassa olevasta sivusta](media/analysis-mode-overview-3.png)](media/analysis-mode-overview-3.png#lightbox)
...
![Näyttää sarakeruudun yleiskuvan tietojen analysointitilassa](media/analysis-mode-columns-3.png)
