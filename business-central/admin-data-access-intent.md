...
ms.author: jswymer
---
# <a name="managing-database-access-intent"></a><a name="managing-database-access-intent"></a><a name="managing-database-access-intent"></a>Tietokannan käyttötarkoituksen hallinta
...
## <a name="to-change-the-database-access-intent"></a><a name="to-change-the-database-access-intent"></a><a name="to-change-the-database-access-intent"></a>Tietokannan käyttötarkoituksen muuttaminen
