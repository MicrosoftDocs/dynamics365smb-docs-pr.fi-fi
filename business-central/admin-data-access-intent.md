...
ms.author: jswymer
---
# <a name="managing-database-access-intent"></a><a name="managing-database-access-intent"></a>Tietokannan käyttötarkoituksen hallinta
...
## <a name="to-change-the-database-access-intent"></a><a name="to-change-the-database-access-intent"></a>Tietokannan käyttötarkoituksen muuttaminen
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Lue aiheeseen liittyen [Microsoftin koulutukset](/training/paths/deploy-configure-dynamics-365-business-central/)
