...
ms.author: jswymer
---
# <a name="managing-database-access-intent" />Tietokannan käyttötarkoituksen hallinta
...
## <a name="to-change-the-database-access-intent" />Tietokannan käyttötarkoituksen muuttaminen
...
## <a name="see-related-microsoft-training" />Lue aiheeseen liittyen [Microsoftin koulutukset](/training/paths/deploy-configure-dynamics-365-business-central/)
