...
ms.author: edupont
---
# <a name="adjust-item-costs" />Nimikekustannusten muuttaminen
...
## <a name="to-adjust-item-costs-manually" />Nimikekustannusten muokkaaminen manuaalisesti
...
## <a name="to-make-general-changes-in-the-direct-unit-cost" />Yleisten muutosten tekeminen välittömään yksikkökustannukseen
...
## <a name="understanding-unit-cost-calculation" />Tietoja yksikkökustannuksen laskennasta
...
## <a name="unit-cost-calculation-for-purchases" />Ostojen yksikkökustannuksen laskenta
...
### <a name="costing-method-fifo-lifo-specific-or-average" />Kustannusmenetelmät FIFO, LIFO, Spesifi tai Keskimäärä
...
## <a name="unit-cost-calculation-for-sales" />Myyntien yksikkökustannuksen laskenta
