...
ms.author: edupont
---
# <a name="adjust-item-costs"></a><a name="adjust-item-costs"></a>Nimikekustannusten muuttaminen
...
## <a name="to-adjust-item-costs-manually"></a><a name="to-adjust-item-costs-manually"></a>Nimikekustannusten muokkaaminen manuaalisesti
...
## <a name="to-make-general-changes-in-the-direct-unit-cost"></a><a name="to-make-general-changes-in-the-direct-unit-cost"></a>Yleisten muutosten tekeminen välittömään yksikkökustannukseen
...
## <a name="understanding-unit-cost-calculation"></a><a name="understanding-unit-cost-calculation"></a>Tietoja yksikkökustannuksen laskennasta
...
## <a name="unit-cost-calculation-for-purchases"></a><a name="unit-cost-calculation-for-purchases"></a>Ostojen yksikkökustannuksen laskenta
...
### <a name="costing-method-fifo-lifo-specific-or-average"></a><a name="costing-method-fifo-lifo-specific-or-average"></a>Kustannusmenetelmät FIFO, LIFO, Spesifi tai Keskimäärä
...
### <a name="costing-method-standard"></a><a name="costing-method-standard"></a>Arvostusmenetelmä Vakio
...
### <a name="all-costing-methods"></a><a name="all-costing-methods"></a>Kaikki arvostusmenetelmät
...
## <a name="unit-cost-calculation-for-sales"></a><a name="unit-cost-calculation-for-sales"></a>Myyntien yksikkökustannuksen laskenta
