...
ms.author: edupont
---
# <a name="manage-storage-by-deleting-documents-or-compressing-data" />Hallitse tallennustilaa poistamalla asiakirjoja tai pakkaamalla tietoja.
...
## <a name="delete-documents" />Asiakirjojen poistaminen
...
## <a name="compress-data-with-date-compression" />Pakkaa tiedot päivämäärätiivistyksen avulla
...
## <a name="posting-compressed-entries" />Tiivistettyjen tapahtumien kirjaaminen
...
### <a name="to-run-a-date-compression" />Suorita Pvmtiivistys
