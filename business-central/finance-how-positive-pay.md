...
## <a name="to-view-exported-positive-pay-records"></a>Vietyjen Positive Pay -tietueiden näyttäminen
...
## <a name="to-reexport-positive-pay-files"></a>Positive Pay -tiedostojen uudelleenvienti
