...
ms.author: edupont
---
# <a name="export-a-positive-pay-file"></a><a name="export-a-positive-pay-file"></a><a name="export-a-positive-pay-file"></a>Positive Pay -tiedoston vienti
...
## <a name="to-set-up-a-bank-account-for-positive-pay"></a><a name="to-set-up-a-bank-account-for-positive-pay"></a><a name="to-set-up-a-bank-account-for-positive-pay"></a>Positive Pay -pankkitilin määrittäminen
...
## <a name="to-export-a-positive-pay-file"></a><a name="to-export-a-positive-pay-file"></a><a name="to-export-a-positive-pay-file"></a>Positive Pay -tiedoston vienti
1. Valitse ![Lamppu, joka avaa Kerro-ominaisuuden.](media/ui-search/search_small.png "Kerro, mitä haluat tehdä") -kuvake, syötä **Pankkitilit** ja valitse sitten vastaava linkki.
