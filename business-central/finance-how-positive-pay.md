...
ms.author: edupont
---
# <a name="export-a-positive-pay-file" />Positive Pay -tiedoston vienti
...
## <a name="to-set-up-a-bank-account-for-positive-pay" />Positive Pay -pankkitilin määrittäminen
...
## <a name="to-export-a-positive-pay-file" />Positive Pay -tiedoston vienti
1. Valitse ![Lamppu, joka avaa Kerro-ominaisuuden.](media/ui-search/search_small.png "Kerro, mitä haluat tehdä") -kuvake, syötä **Pankkitilit** ja valitse sitten vastaava linkki.
