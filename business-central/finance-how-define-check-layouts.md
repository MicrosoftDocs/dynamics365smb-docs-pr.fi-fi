...
ms.author: edupont
---
# <a name="select-a-check-layout" />Sekin asettelun valitseminen
...
## <a name="to-select-a-check-layout" />Sekin asettelun valitseminen
...
## <a name="use-micr-and-security-fonts" />MICR- ja suojausfonttien käyttäminen
...
### <a name="secure-font-specifications" />Suojattujen fonttien määritykset
