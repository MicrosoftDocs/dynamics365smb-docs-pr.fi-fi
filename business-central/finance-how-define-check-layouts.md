...
ms.author: edupont
---
# <a name="select-a-check-layout"></a><a name="select-a-check-layout"></a><a name="select-a-check-layout"></a>Sekin asettelun valitseminen
...
## <a name="to-select-a-check-layout"></a><a name="to-select-a-check-layout"></a><a name="to-select-a-check-layout"></a>Sekin asettelun valitseminen
...
## <a name="use-micr-and-security-fonts"></a><a name="use-micr-and-security-fonts"></a><a name="use-micr-and-security-fonts"></a>MICR- ja suojausfonttien käyttäminen
...
### <a name="micr-e-13b-specifications"></a><a name="micr-e-13b-specifications"></a><a name="micr-e-13b-specifications"></a>MICR E-13B -määritykset
...
### <a name="delimiter-characters"></a><a name="delimiter-characters"></a><a name="delimiter-characters"></a>Erottimen merkit
...
### <a name="micr-cmc-7-specifications"></a><a name="micr-cmc-7-specifications"></a><a name="micr-cmc-7-specifications"></a>MICR CMC-7 -määritykset
...
### <a name="delimiter-characters-1"></a><a name="delimiter-characters-1"></a><a name="delimiter-characters-1"></a>Erottimen merkit
...
### <a name="secure-font-specifications"></a><a name="secure-font-specifications"></a><a name="secure-font-specifications"></a>Suojattujen fonttien määritykset
