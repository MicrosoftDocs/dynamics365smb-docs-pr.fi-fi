...
# <a name="business-central-for-multi-site-and-international-organizations" />Business Central kansainvälisille organisaatioille ja organisaatioille, joilla on useita toimipaikkoja
...
## <a name="integrating-the-headquarter-company-and-the-sites" />Pääkonttorin yrityksen ja toimipaikkojen integroiminen
...
## <a name="meet-the-needs-of-domestic-and-international-sites" />Kansallisten ja kansainvälisten toimipaikkojen tarpeiden täyttäminen
...
## <a name="consolidate-financial-data" />Taloustietojen konsolidointi
...
## <a name="share-business-insight-with-integrated-analytics" />Liiketoimintatietojen jakaminen integroitujen analyysien kanssa
...
## <a name="exchange-data-using-apis-and-xmlports" />Tietojen vaihtaminen ohjelmointirajapintojen ja XMLport-objektien avulla
...
## <a name="promote-an-efficient-intercompany-supply-chain" />Konsernin tehokkaan toimitusketjun määrittäminen
...
## <a name="respond-quickly-to-new-business-conditions" />Nopea reagoiminen liiketoiminnan uusiin olosuhteisiin
