...
description: 'Rajoittaaksesi tietueen käyttöä, voit sisällyttää kaksi työnkulun vastausta työnkulkuun, joka määrittää tietueen käyttöä.'
author: brentholtorf
ms.author: bholtorf
