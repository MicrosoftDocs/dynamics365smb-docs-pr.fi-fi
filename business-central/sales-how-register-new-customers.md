...
ms.author: edupont
---
# <a name="register-new-customers"></a><a name="register-new-customers"></a><a name="register-new-customers"></a>Uusien asiakkaiden rekisteröinti
...
## <a name="adding-new-customers"></a><a name="adding-new-customers"></a><a name="adding-new-customers"></a>Uusien asiakkaiden lisääminen
...
### <a name="to-create-a-new-customer-card"></a><a name="to-create-a-new-customer-card"></a><a name="to-create-a-new-customer-card"></a>Uuden asiakkaan kortin luominen
...
### <a name="to-save-the-customer-card-as-a-template"></a><a name="to-save-the-customer-card-as-a-template"></a><a name="to-save-the-customer-card-as-a-template"></a>Asiakkaan kortin tallentaminen mallina
...
## <a name="deleting-customer-cards"></a><a name="deleting-customer-cards"></a><a name="deleting-customer-cards"></a>Asiakaskorttien poistaminen
...
## <a name="managing-credit-limits"></a><a name="managing-credit-limits"></a><a name="managing-credit-limits"></a>Luottorajojen hallinta
...
### <a name="to-specify-credit-limit-warnings"></a><a name="to-specify-credit-limit-warnings"></a><a name="to-specify-credit-limit-warnings"></a>Luottorajavaroitusten määrittäminen
