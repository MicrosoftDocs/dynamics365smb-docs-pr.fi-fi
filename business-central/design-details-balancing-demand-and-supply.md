...
---
# Rakennetiedot: kysynnän ja tarjonnan täsmäytys
...
## Suunnittelun aloituspäivämäärää edeltävien tilausten käsitteleminen
...
### Sarja- ja eränumeroita sekä tilausten välisiä linkkejä ei koske poisjättäminen edeltävältä jaksolta  
...
### Sarja- ja eränumerot ladataan erittelytason mukaan  
...
### Tilausten välisiä linkkejä ei katkaista koskaan
...
### Komponenttitarve ladataan tuotantotilausten muutosten mukaan
...
### Myyntitilaukset vähentävät ennustettua kysyntää
...
### Myyntitilaukset vähentävät puitetilauksen kysyntää
...
### Kysynnän ja tarjonnan tilaan liittyvä prioriteetti  
...
## Tarjonnan ja kysynnän täsmäyttäminen
...
### Tarjoustapahtumien toimenpiteitä koskevat säännöt
...
### Tarjonnan määrän määrittäminen  
...
### Tilauksen seurantalinkit suunnittelun aikana  
...
## Kysynnän ja tarjonnan täsmäytyksen sulkeminen
...
### Suunnittelurivin luominen (ehdotettu toimenpide)  
