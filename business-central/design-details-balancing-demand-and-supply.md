...
---
# <a name="design-details-balancing-supply-and-demand" />Rakennetiedot: kysynnän ja tarjonnan täsmäytys
...
## <a name="supply-and-demand" />Kysyntä ja tarjonta
...
## <a name="the-concept-of-balancing-in-brief" />Täsmäytyskäsite lyhyesti
...
## <a name="process-orders-before-the-planning-start-date" />Suunnittelun aloituspäivämäärää edeltävien tilausten käsitteleminen
...
### <a name="serial-and-lot-numbers-and-order-to-order-links-are-exempt-from-the-previous-period" />Sarja- ja eränumeroita sekä tilausten välisiä linkkejä ei koske poisjättäminen edeltävältä jaksolta
...
## <a name="load-inventory-profiles" />Varastoprofiilien lataaminen
...
### <a name="item-dimensions-are-separated" />Nimikedimensiot erotetaan
...
### <a name="serial-and-lot-numbers-are-loaded-by-specification-level" />Sarja- ja eränumerot ladataan erittelytason mukaan
...
### <a name="order-to-order-links-are-never-broken" />Tilausten välisiä linkkejä ei katkaista koskaan
...
### <a name="component-need-is-loaded-according-to-production-order-changes" />Komponenttitarve ladataan tuotantotilausten muutosten mukaan
...
### <a name="consume-safety-stock" />Varmuusvaraston käyttäminen
...
### <a name="forecast-demand-is-reduced-by-sales-orders" />Myyntitilaukset vähentävät ennustettua kysyntää
...
### <a name="blanket-order-demand-is-reduced-by-sales-orders" />Myyntitilaukset vähentävät puitetilauksen kysyntää
...
## <a name="prioritize-orders" />Tilausten priorisointi
...
### <a name="priorities-on-the-demand-side" />Kysyntäpuolen prioriteetit
...
### <a name="priorities-on-the-supply-side" />Tarjontapuolen prioriteetit
...
### <a name="priority-related-to-the-state-of-supply-and-demand" />Kysynnän ja tarjonnan tilaan liittyvä prioriteetti
...
## <a name="balancing-supply-with-demand" />Tarjonnan ja kysynnän täsmäyttäminen
...
### <a name="rules-for-actions-for-supply-events" />Tarjoustapahtumien toimenpiteitä koskevat säännöt
...
### <a name="determine-the-supply-quantity" />Tarjonnan määrän määrittäminen
...
### <a name="order-tracking-links-during-planning" />Tilauksen seurantalinkit suunnittelun aikana
...
## <a name="close-balanced-supply-and-demand" />Kysynnän ja tarjonnan täsmäytyksen sulkeminen
...
### <a name="create-the-planning-line-suggested-action" />Suunnittelurivin luominen (ehdotettu toimenpide)
