...
---
# <a name="design-details-balancing-supply-and-demand"></a><a name="design-details-balancing-supply-and-demand"></a>Rakennetiedot: kysynnän ja tarjonnan täsmäytys
...
## <a name="supply-and-demand"></a><a name="supply-and-demand"></a>Kysyntä ja tarjonta
...
## <a name="the-concept-of-balancing-in-brief"></a><a name="the-concept-of-balancing-in-brief"></a>Täsmäytyskäsite lyhyesti
...
## <a name="process-orders-before-the-planning-start-date"></a><a name="process-orders-before-the-planning-start-date"></a>Suunnittelun aloituspäivämäärää edeltävien tilausten käsitteleminen
...
### <a name="serial-and-lot-numbers-and-order-to-order-links-are-exempt-from-the-previous-period"></a><a name="serial-and-lot-numbers-and-order-to-order-links-are-exempt-from-the-previous-period"></a>Sarja- ja eränumeroita sekä tilausten välisiä linkkejä ei koske poisjättäminen edeltävältä jaksolta
...
## <a name="load-inventory-profiles"></a><a name="load-inventory-profiles"></a>Varastoprofiilien lataaminen
...
### <a name="item-dimensions-are-separated"></a><a name="item-dimensions-are-separated"></a>Nimikedimensiot erotetaan
...
### <a name="serial-and-lot-numbers-are-loaded-by-specification-level"></a><a name="serial-and-lot-numbers-are-loaded-by-specification-level"></a>Sarja- ja eränumerot ladataan erittelytason mukaan
...
### <a name="order-to-order-links-are-never-broken"></a><a name="order-to-order-links-are-never-broken"></a>Tilausten välisiä linkkejä ei katkaista koskaan
...
### <a name="component-need-is-loaded-according-to-production-order-changes"></a><a name="component-need-is-loaded-according-to-production-order-changes"></a>Komponenttitarve ladataan tuotantotilausten muutosten mukaan
...
### <a name="consume-safety-stock"></a><a name="consume-safety-stock"></a>Varmuusvaraston käyttäminen
...
### <a name="forecast-demand-is-reduced-by-sales-orders"></a><a name="forecast-demand-is-reduced-by-sales-orders"></a>Myyntitilaukset vähentävät ennustettua kysyntää
...
### <a name="blanket-order-demand-is-reduced-by-sales-orders"></a><a name="blanket-order-demand-is-reduced-by-sales-orders"></a>Myyntitilaukset vähentävät puitetilauksen kysyntää
...
## <a name="prioritize-orders"></a><a name="prioritize-orders"></a>Tilausten priorisointi
...
### <a name="priorities-on-the-demand-side"></a><a name="priorities-on-the-demand-side"></a>Kysyntäpuolen prioriteetit
...
### <a name="priorities-on-the-supply-side"></a><a name="priorities-on-the-supply-side"></a>Tarjontapuolen prioriteetit
...
### <a name="priority-related-to-the-state-of-supply-and-demand"></a><a name="priority-related-to-the-state-of-supply-and-demand"></a>Kysynnän ja tarjonnan tilaan liittyvä prioriteetti
...
## <a name="balancing-supply-with-demand"></a><a name="balancing-supply-with-demand"></a>Tarjonnan ja kysynnän täsmäyttäminen
...
### <a name="rules-for-actions-for-supply-events"></a><a name="rules-for-actions-for-supply-events"></a>Tarjoustapahtumien toimenpiteitä koskevat säännöt
...
### <a name="determine-the-supply-quantity"></a><a name="determine-the-supply-quantity"></a>Tarjonnan määrän määrittäminen
...
### <a name="order-tracking-links-during-planning"></a><a name="order-tracking-links-during-planning"></a>Tilauksen seurantalinkit suunnittelun aikana
...
## <a name="close-balanced-supply-and-demand"></a><a name="close-balanced-supply-and-demand"></a>Kysynnän ja tarjonnan täsmäytyksen sulkeminen
...
### <a name="create-the-planning-line-suggested-action"></a><a name="create-the-planning-line-suggested-action"></a>Suunnittelurivin luominen (ehdotettu toimenpide)
