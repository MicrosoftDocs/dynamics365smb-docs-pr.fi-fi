...
# <a name="introduction-to-contoso-coffee-demo-data" />Johdatus Contoso Coffee -demotietoihin
...
## <a name="set-up-contoso-coffee-data" />Contoso Coffee -tietojen määrittäminen
...
## <a name="manufacturing-scenarios" />Tuotantoskenaariot
...
## <a name="warehousing-scenarios" />Varastointiskenaariot
