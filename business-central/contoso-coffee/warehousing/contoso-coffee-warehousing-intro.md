...
# <a name="introduction-to-contoso-coffee-warehousing" />Contoso Coffeen fyysisen varastoinnin esittely
...
## <a name="set-up-contoso-coffee-warehousing-data" />Contoso Coffeen varastointitietojen määrittäminen
