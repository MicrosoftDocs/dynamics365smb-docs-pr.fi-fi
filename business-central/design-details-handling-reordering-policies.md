...
---
# <a name="design-details-handling-reordering-policies" />Rakennetiedot: uusintatilauskäytäntöjen käsittely
...
## <a name="the-role-of-the-reorder-point" />Uusintatilauspisteen tehtävä
...
## <a name="monitoring-the-projected-inventory-level-and-the-reorder-point" />Suunnitellun varastomäärän ja uusintatilauspisteen seuranta
...
### <a name="projected-inventory" />Suunniteltu varasto
...
### <a name="projected-available-inventory" />Oletettu saatavilla oleva varasto
...
### <a name="determining-the-projected-inventory-level" />Suunnittelun varastomäärän määrittäminen
...
## <a name="the-role-of-the-time-bucket" />Aikavälin tehtävä
...
## <a name="stay-below-the-overflow-level" />Sallitun ylityksen alapuolella pysyminen
...
### <a name="calculating-the-overflow-level" />Sallitun ylityksen laskeminen

Sallittu ylitys lasketaan eri tavoin uusintatilauskäytännön mukaan.  

#### <a name="maximum-qty" />Enimmäismäärä
...
#### <a name="fixed-reorder-qty" />Kiinteä uusintatil. määrä
...
#### <a name="order-multiple" />Tilauskerrannainen
...
### <a name="creating-the-planning-line-with-an-overflow-warning" />Ylitysvaroituksen sisältävän suunnittelurivin luominen
...
#### <a name="calculating-the-planning-line-quantity" />Suunnittelurivin määrän laskeminen
...
#### <a name="defining-the-action-message-type" />Toimenpidesanoman tyypin määrittäminen
...
#### <a name="composing-the-warning-message" />Varoitussanoman luominen
...
### <a name="example-scenario" />Esimerkkiskenaario
...
#### <a name="item-setup" />Nimikkeen asetus
...
#### <a name="situation-before-sales-decrease" />Tilanne ennen myynnin vähenemistä
...
#### <a name="situation-after-sales-decrease" />Tilanne myynnin vähenemisen jälkeen
...
#### <a name="resulting-planning-lines" />Tuloksena olevat suunnittelurivit
...
## <a name="handling-projected-negative-inventory" />Suunnitellun negatiivisen varaston käsittely
...
## <a name="reordering-policies" />Uusintatilauskäytännöt
...
### <a name="fixed-reorder-quantity" />Kiinteä uusintatilausmäärä
...
#### <a name="calculated-per-time-bucket" />Laskettu aikavälikohtaisesti
...
#### <a name="creates-only-necessary-supply" />Vain tarvittavan tarjonnan luonti
...
#### <a name="combines-with-order-modifiers" />Yhdistää tilausmääritteiden kanssa
...
#### <a name="combines-with-calendars" />Yhdistäminen kalentereihin
...
#### <a name="shouldnt-be-used-with-forecasts" />Ei tule käyttää ennusteen kanssa
...
#### <a name="must-not-be-used-with-reservations" />Ei tule käyttää varausten kanssa
...
### <a name="maximum-quantity" />Enimmäismäärä
...
#### <a name="calculate-per-time-bucket" />Laskettu aikavälikohtaisesti
...
#### <a name="combine-with-order-modifiers" />Yhdistäminen tilausmääritteiden kanssa
...
### <a name="combine-with-calendars" />Yhdistäminen kalentereihin

Ennen kuin suunnittelujärjestelmä ehdottaa uusintatilauspistettä vastaavaa uutta toimitustilausta, se tarkistaa, onko tilaus aikataulutettu muulle kuin työpäivälle. Se käyttää kalenteria, joka määritetään **Yritystiedot**- ja **Sijaintikortti**-sivujen **Peruskalenterin koodi** -kentässä.  

Jos aikataulutettu päivämäärä ei ole työpäivä, suunnittelujärjestelmä siirtää tilauksen seuraavaan työpäivään. Päivämäärän siirtäminen voi johtaa tilaukseen, joka täyttää uusintatilauspisteen mutta ei täytä tiettyä kysyntää. Suunnittelujärjestelmä luo ylimääräisen tarjonnan vastaamaan epätasapainoiseen kysyntään.

### <a name="order" />Järjestys
...
#### <a name="order-to-order-links-and-past-due-dates" />Tilausten väliset linkit ja erääntyneet määräpäivät
