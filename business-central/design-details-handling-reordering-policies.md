...
Erä-erästä-käytäntö muistuttaa osittain tilauskäytäntöä. Se voi hyväksyä määriä varastossa, minkä lisäksi se niputtaa kysynnän ja tarjonnan määritetyllä aikavälillä.
