...
ms.author: edupont
---
# <a name="make-check-payments" />Sekkimaksujen suorittaminen
...
## <a name="to-pay-a-vendor-invoice-with-a-computer-check" />Maksaaksesi toimittajalaskun tietokonesekillä
...
## <a name="to-cancel-printed-checks-that-are-not-posted" />Kirjaamattomien ja tulostettujen sekkien peruuttaminen
...
## <a name="to-void-checks" />Sekkien mitätöiminen
...
## <a name="to-view-a-summary-of-posted-checks" />Voit tarkastella kirjattujen sekkien yhteenvetoa
...
## <a name="see-related-microsoft-trainingtrainingmodulesuse-checks-dynamics-365-business-central" />Lue aiheeseen liittyen [Microsoftin koulutukset](/training/modules/use-checks-dynamics-365-business-central/)
