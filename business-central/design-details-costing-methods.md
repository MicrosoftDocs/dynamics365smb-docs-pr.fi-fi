...
ms.author: bholtorf
---
# <a name="design-details-costing-methods"></a><a name="design-details-costing-methods"></a><a name="design-details-costing-methods"></a>Rakennetiedot: arvostusmenetelmät
...
### <a name="effect-of-costing-methods-on-valuing-inventory-increases"></a><a name="effect-of-costing-methods-on-valuing-inventory-increases"></a><a name="effect-of-costing-methods-on-valuing-inventory-increases"></a>Arvostusmenetelmien vaikutus arvostetussa varastossa kasvaa
...
#### <a name="standard"></a><a name="standard"></a><a name="standard"></a>Vakio

**Vakio**-arvostusmenetelmää käyttävien nimikkeiden kohdalla varastoarvon nousut arvostetaan nimikkeen nykyisellä vakiokustannuksella.  

### <a name="effect-of-costing-methods-on-valuing-inventory-decreases"></a><a name="effect-of-costing-methods-on-valuing-inventory-decreases"></a><a name="effect-of-costing-methods-on-valuing-inventory-decreases"></a>Arvostusmenetelmien vaikutus arvostetussa varastossa laskee
