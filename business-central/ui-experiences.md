...
ms.author: edupont
---
# <a name="change-which-features-are-displayed"></a><a name="change-which-features-are-displayed"></a><a name="change-which-features-are-displayed"></a>Näytettävien ominaisuuksien muuttaminen
...
## <a name="enabling-premium-features-after-upgrading-a-plan"></a><a name="enabling-premium-features-after-upgrading-a-plan"></a><a name="enabling-premium-features-after-upgrading-a-plan"></a>Premium-ominaisuuksien käyttöönotto suunnitelman päivittämisen jälkeen
...
### <a name="to-update-plan-changes-in-users-groups"></a><a name="to-update-plan-changes-in-users-groups"></a><a name="to-update-plan-changes-in-users-groups"></a>Suunnitelman muutoksien päivittäminen käyttäjäryhmissä
...
### <a name="to-select-the-premium-experience"></a><a name="to-select-the-premium-experience"></a><a name="to-select-the-premium-experience"></a>Premium-käyttäjäkokemuksen valinta
...
## <a name="help-assumes-premium-experience"></a><a name="help-assumes-premium-experience"></a><a name="help-assumes-premium-experience"></a>Ohje käsittelee Premium-käyttäjäkokemusta
