...
---
# <a name="work-with-general-journals"></a><a name="work-with-general-journals"></a>Yleisten päiväkirjojen käyttäminen
...
## <a name="use-journal-templates-and-batches"></a><a name="use-journal-templates-and-batches"></a>Päiväkirjan mallien ja erien käyttäminen
...
### <a name="validating-general-journal-batches"></a><a name="validating-general-journal-batches"></a>Yleisen päiväkirjan erien arvioiminen
...
## <a name="understanding-main-accounts-and-balancing-accounts"></a><a name="understanding-main-accounts-and-balancing-accounts"></a>Tietoja päätileistä ja vastatileistä
...
## <a name="work-with-recurring-journals"></a><a name="work-with-recurring-journals"></a>Toistuvien tapahtumien päiväkirjojen käyttäminen
...
### <a name="recurring-method-field"></a><a name="recurring-method-field"></a>Toistotapa-kenttä
...
### <a name="recurring-frequency-field"></a><a name="recurring-frequency-field"></a>Toistotiheys-kenttä
...
### <a name="expiration-date-field"></a><a name="expiration-date-field"></a>Vanhentumispäivämäärä -kenttä
...
### <a name="allocating-recurring-journal-amounts-to-several-accounts"></a><a name="allocating-recurring-journal-amounts-to-several-accounts"></a>Toistuvien tapahtumien päiväkirjan summien kohdistaminen useisiin tileihin
...
#### <a name="example-allocating-rent-payments-to-different-departments"></a><a name="example-allocating-rent-payments-to-different-departments"></a>Esimerkki: Vuokramaksujen kohdistaminen eri osastoihin
...
### <a name="calculate-the-reversal-date"></a><a name="calculate-the-reversal-date"></a>Peruutuspäivämäärän laskenta
...
## <a name="work-with-standard-journals"></a><a name="work-with-standard-journals"></a>Vakiopäiväkirjojen käyttäminen
...
### <a name="to-save-a-standard-journal"></a><a name="to-save-a-standard-journal"></a>Tallentaminen vakiopäiväkirjana
...
### <a name="to-reuse-a-standard-journal"></a><a name="to-reuse-a-standard-journal"></a>Vakiopäiväkirjan käyttäminen uudelleen
...
## <a name="to-renumber-document-numbers-in-journals"></a><a name="to-renumber-document-numbers-in-journals"></a>Asiakirjanumeroiden uudelleennumerointi päiväkirjoissa
...
### <a name="to-renumber-documents-in-journals"></a><a name="to-renumber-documents-in-journals"></a>Asiakirjanumeroiden uudelleennumerointi päiväkirjoissa
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Lue aiheeseen liittyen [Microsoftin koulutukset](/training/paths/use-journals-dynamics-365-business-central/)
