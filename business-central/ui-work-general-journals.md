...
---
# <a name="work-with-general-journals" />Yleisten päiväkirjojen käyttäminen
...
## <a name="use-journal-templates-and-batches" />Päiväkirjan mallien ja erien käyttäminen
...
### <a name="validating-general-journal-batches" />Yleisen päiväkirjan erien arvioiminen
...
## <a name="understanding-main-accounts-and-balancing-accounts" />Tietoja päätileistä ja vastatileistä
...
## <a name="work-with-recurring-journals" />Toistuvien tapahtumien päiväkirjojen käyttäminen
...
### <a name="recurring-method-field" />Toistotapa-kenttä
...
### <a name="recurring-frequency-field" />Toistotiheys-kenttä
...
### <a name="expiration-date-field" />Vanhentumispäivämäärä -kenttä
...
### <a name="allocating-recurring-journal-amounts-to-several-accounts" />Toistuvien tapahtumien päiväkirjan summien kohdistaminen useisiin tileihin
...
#### <a name="example-allocating-rent-payments-to-different-departments" />Esimerkki: Vuokramaksujen kohdistaminen eri osastoihin
...
### <a name="calculate-the-reversal-date" />Peruutuspäivämäärän laskenta
...
## <a name="work-with-standard-journals" />Vakiopäiväkirjojen käyttäminen
...
### <a name="to-save-a-standard-journal" />Tallentaminen vakiopäiväkirjana
...
### <a name="to-reuse-a-standard-journal" />Vakiopäiväkirjan käyttäminen uudelleen
...
## <a name="to-renumber-document-numbers-in-journals" />Asiakirjanumeroiden uudelleennumerointi päiväkirjoissa
...
### <a name="to-renumber-documents-in-journals" />Asiakirjanumeroiden uudelleennumerointi päiväkirjoissa
...
## <a name="see-related-microsoft-training" />Lue aiheeseen liittyen [Microsoftin koulutukset](/training/paths/use-journals-dynamics-365-business-central/)
