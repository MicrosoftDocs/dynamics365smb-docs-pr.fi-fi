...
Useimmat päiväkirjat perustuvat yleiseen päiväkirjaan, ja voit käsitellä kaikki tapahtumat **Yleiset päiväkirjat** -sivulla. Lue lisätietoja kohdasta [Tapahtumien kirjaaminen suoraan pääkirjanpitoon](finance-how-post-transactions-directly.md).  
...
Voit kirjata esimerkiksi työntekijöiden kuluja hyvityksiin. Lue lisätietoja kohdasta [Työntekijöiden kulujen kirjaaminen ja hyvittäminen](finance-how-record-reimburse-employee-expenses.md).
 ...
 [!INCLUDE [prod_short](includes/prod_short.md)] Se tarjoaa kuitenkin myös päiväkirjoja, jotka on optimoitu tietyntyyppisille kauppatapahtumille, kuten *maksupäiväkirjalle* maksujen rekisteröintiä varten. Lisätietoja on kohdassa [Maksujen ja hyvitysten tallentaminen maksupäiväkirjaan](payables-how-post-payments-refunds.md).  
...
## <a name="add-context-to-general-journal-transactions"></a>Lisää konteksti yleisen päiväkirjan transaktioihin
...
Yleisen päiväkirjan malleja on useita. Jokaisella päiväkirjan mallilla on oma sivunsa, jolla on tiettyjä toimintoja ja näitä toimintoja varten tarvittavat kentät. Tällaisia kenttiä ovat esimerkiksi **Maksutäsmäytyspäiväkirjat-sivu**, joka käsittelee pankkimaksut, sekä **Maksupäiväkirjat-sivu**, joka maksaa toimittajille tai korvaa työntekijöille. Lisätietoja on kohdissa [Maksujen suorittaminen](payables-make-payments.md) ja [Asiakkaan maksujen täsmäyttäminen kassapäiväkirjan avulla tai asiakastapahtumista](receivables-how-apply-sales-transactions-manually.md).
...
Voit ottaa taustatarkistuksen käyttöön, mikä auttaa estämään viiveet kirjauksessa. Merkki ilmoittaa sinulle, kun käsittelemäsi talouspäiväkirjassa oleva virhe estää sinua kirjaamasta päiväkirjaa. Yleisen päiväkirjan **erät** -sivulla voit valita **Taustavirhetarkistus**, jos haluat [!INCLUDE[prod_short](includes/prod_short.md)] tarkistaa viivästyspäiväkirjat, kuten yleiset päiväkirjat tai maksupäiväkirjat, samalla kun käsittelet niitä.

Kun oikeellisuustarkistus otetaan käyttöön, **Asiakirjan tarkistuksen** tai **päiväkirjan tarkistuksen** -tietoruuduissa näkyvät tämän rivin ja koko erän seurantakohteet. Vahvistus tehdään silloin, kun lataat rahoituspäiväkirjan erän ja kun valitset toisen päiväkirjarivin. Tietoruudun **Virheet yhteensä** -ruudussa näkyy [!INCLUDE[prod_short](includes/prod_short.md)]in löytämien virheiden kokonaismäärä, ja valitsemalla se voidaan avata virheiden yleiskatsaus.
...
## <a name="understanding-main-accounts-and-balancing-accounts"></a>Tietoja päätileistä ja vastatileistä
...
| Vastaanottaja | Katso |
| --- | --- |
|K Kiinteä|Päiväkirjarivillä oleva summa säilyy kirjauksen jälkeen. Rivit, joiden summat ovat nolla, säilyvät kirjauskansiossa, mutta niitä ei kirjata. Summan voi päivittää myöhemmässä ajossa.  |
|M Muuttuja|Päiväkirjarivillä oleva summa poistetaan kirjauksen jälkeen.|
...
Jos päiväkirjan rivi tulee kirjata joka kuukausi, syötä **1 K**. Jokaisen kirjauksen jälkeen **Kirjauspvm.**-kentässä oleva päivämäärä päivitetään seuraavan kuukauden samaan päivään.
...
Jos kenttä on tyhjä, rivi kirjataan joka kerta, kunnes poistat sen kirjauskansiosta.
...
Toistuvien yleisten **päiväkirjojen** sivulla voit valita **Kohdistukset-toiminnon** määrittääksesi, miten toistuvien kirjausten päiväkirjan rivillä olevia summia kohdistetaan useille tileille ja dimensioille. Kohdistus toimii toistuvien tapahtumien päiväkirjan rivin vastatilin rivinä.
...
### <a name="calculate-the-reversal-date"></a>Peruutuspäivämäärän laskenta
...
Asiakirjan numeroinneissa täytyy ottaa huomioon niihin liittyvät kohdistukset, kuten maksun kohdistus, joka on tehty asiakirjasta päiväkirjan rivillä toimittajan tiliin. Niinpä kyseisten tapahtumien **Kohdistetaan tunnisteeseen**- ja **Kohdistetaan asiakirjaan nro** -kentät voidaan päivittää.

### <a name="to-renumber-documents-in-journals"></a>Asiakirjanumeroiden uudelleennumerointi päiväkirjoissa

Seuraava menettely perustuu **Yleiset päiväkirjat** -sivulle, mutta se koskee kaikkia muita yleiseen päiväkirjaan perustuvia päiväkirjoja, kuten **Maksupäiväkirjat-sivua** .
