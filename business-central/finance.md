...
# <a name="financial-management"></a>Varainhoito
...
Seuraavissa osissa kuvataan tehtäväsarja ja linkit tehtäviä kuvaaviin artikkeleihin.  
...
| Vastaanottaja... | Katso |
| --- | --- |
| Lisää dimensioita, kun haluat saada käyttöön monipuolisempia liiketoimintatietoja. |[Dimensioiden käsitteleminen](finance-dimensions.md) |
...
| Liitä liittyvien nimikkeiden lisäkustannukset, kuten rahti- ja fyysisen käsittelyn kulut, joita joudut maksamaan kaupan yhteydessä. Näin kustannus vaikuttaa varaston arvostukseen. |[Kaupan lisäkustannusten huomioiminen nimikekulujen avulla](payables-how-assign-item-charges.md) |
...
| Vastaanottaja... | Katso |
| --- | --- |
| Tutustu rahoitustietojen analysointimahdollisuuksiin. | [Talousanalytiikan yleiskatsaus](bi.md) |
| Määritä taloushallinnon raportointi liiketoimintayksiköiden tai yritysten välillä. | [Taloushallinnon raportoinnin käsitteleminen liiketoimintayksiköiden tai yritysten välillä](finance-consolidated-company-reporting.md) |
| Määritä ja käytä taloushallinnon raportointia lausuntojen ja yleiskatsausten laatimiseen. | [Taloushallinnon raportoinnin valmisteleminen](bi-how-work-account-schedule.md) |
| Tee rahoitustietojen ad-hoc-analyysi suoraan luettelosivuilla ja kyselyissä. | [Taloustietojen tapauskohtainen analyysi](ad-hoc-analysis-finance.md) |
| Tilikartan taloustietojen analysoiminen. | [Tilikartan taloustietojen analysoiminen](finance-general-ledger.md) |
| Todellisten summien analysointi budjetoituihin summiin nähden | [Todellisten summien analysoiminen budjetoituihin summiin verraten](bi-how-analyze-actual-versus-budget.md) |
| Kassavirran analysoiminen. | [Kassavirran analysoiminen](finance-analyze-cash-flow.md) |
| Tutustu valmiisiin keskeisiin talousraportteihin. | [Valmiit keskeiset talousraportit](finance-reports.md) |
| Tutustu käyttöomaisuuden valmiisiin avainraportteihin. | [Valmiit käyttöomaisuusraportit](fa-reports.md) |
...
[Ostomoduulin käyttäminen](purchasing-manage-purchasing.md)  
