...
# <a name="manage-work-across-multiple-companies-in-the-company-hub"></a><a name="manage-work-across-multiple-companies-in-the-company-hub"></a>Työnhallinta useiden yritysten välillä yritystoiminnossa
...
## <a name="company-hub-home-page"></a><a name="company-hub-home-page"></a>Yritystoiminnon kotisivu
...
## <a name="assigned-tasks"></a><a name="assigned-tasks"></a>Määritetyt tehtävät
...
### <a name="my-user-tasks"></a><a name="my-user-tasks"></a>Omat käyttäjätehtävät
...
## <a name="access-the-company-hub"></a><a name="access-the-company-hub"></a>Yritystoiminnon käyttö
...
## <a name="set-up-the-company-hub"></a><a name="set-up-the-company-hub"></a>Määritä yritystoiminto
