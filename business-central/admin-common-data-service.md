...
# <a name="integrating-with-microsoft-dataverse"></a><a name="integrating-with-microsoft-dataverse"></a>Integrointi Microsoft Dataversein kanssa
...
## <a name="getting-started-with-"></a><a name="getting-started-with-"></a>[!INCLUDE[prod_short](includes/cds_long_md.md)]in käytön aloittaminen
...
## <a name="bi-directional-or-uni-directional-data-synchronization"></a><a name="bi-directional-or-uni-directional-data-synchronization"></a>Kaksisuuntainen tai yksisuuntainen tietojen synkronointi
...
## <a name="standard-and-custom-entities"></a><a name="standard-and-custom-entities"></a>Vakioentiteetit ja mukautetut entiteetit
...
## <a name="about-the-business-central-base-integration-solution"></a><a name="about-the-business-central-base-integration-solution"></a>Tietoja Business Central -perusintegrointiratkaisusta
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Lue aiheeseen liittyen [Microsoftin koulutukset](/training/modules/use-model-driven-apps-common-data-service/)
