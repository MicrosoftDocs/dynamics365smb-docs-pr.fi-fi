...
ms.author: edupont
---
# <a name="design-details-reconciliation-with-the-general-ledger" />Rakennetiedot: täsmäytys pääkirjanpidon kanssa
...
## <a name="post-inventory-cost-to-gl-batch-job" />Kirjaa varaston kust. KP:oon -eräajo
...
## <a name="automatic-cost-posting" />Automaattinen kustann. kirjaus
...
## <a name="account-types" />Tilityypit
