...
---
# Anna [!INCLUDE[prod_short](includes/prod_short.md)] ehdottaa arvoja
...
## **Ehdota vastasummaa** -valintaruutu **Yleisen päiväkirjan erät** -sivulla
...
### **Summa**-kentän täyttäminen automaattisesti yleisen päiväkirjan rivien täsmäyttämistä varten
...
## **Täytä vastaanottopäivämäärä automaattisesti** -kenttä **Maksurekisteröinti**-sivulla
...
### **Maksurekisteröinti**-sivun **Täytä vastaanottopäivämäärä automaattisesti** -kentän automaattinen täyttäminen
