...
ms.author: edupont
---
# <a name="general-journal-post-line-overview" />Yleisen päiväkirjan kirjausrivin yleiskuva
...
## <a name="old-architecture" />Vanha arkkitehtuuri
...
### <a name="new-architecture" />Uusi arkkitehtuuri
