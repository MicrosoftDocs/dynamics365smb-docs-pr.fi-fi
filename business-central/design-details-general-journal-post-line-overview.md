...
ms.author: edupont
---
# <a name="general-journal-post-line-overview"></a><a name="general-journal-post-line-overview"></a>Yleisen päiväkirjan kirjausrivin yleiskuva
...
## <a name="old-architecture"></a><a name="old-architecture"></a>Vanha arkkitehtuuri
...
### <a name="new-architecture"></a><a name="new-architecture"></a>Uusi arkkitehtuuri
