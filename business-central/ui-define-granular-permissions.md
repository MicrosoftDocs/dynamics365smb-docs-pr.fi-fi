...
# <a name="assign-permissions-to-users-and-groups" />Määritä käyttöoikeudet käyttäjille ja ryhmille
...
## <a name="to-create-a-permission-set" />Käyttöoikeuksien joukon luominen
...
### <a name="example---indirect-permission" />Esimerkki - epäsuora käyttöoikeus
...
### <a name="to-add-other-permission-sets" />Toisen käyttöoikeuksien joukon lisääminen
...
## <a name="to-copy-a-permission-set" />Käyttöoikeuksien joukon kopioiminen
...
## <a name="to-create-or-modify-permissions-by-recording-your-actions" />Käyttöoikeuksien luominen tai muokkaaminen toimia tallentamalla
...
### <a name="to-export-and-import-a-permission-set" />Käyttöoikeusjoukon vieminen ja tuominen
...
## <a name="to-remove-obsolete-permissions-from-all-permission-sets" />Voit poistaa vanhentuneet käyttöoikeudet kaikista käyttöoikeuksien joukoista seuraavasti.

Valitse **Käyttöoikeuksien joukot** -sivulla **Poista vanhentuneet käyttöoikeudet** -toiminto.

## <a name="to-set-up-time-constraints-for-users" />Määritä käyttäjän aikarajoitukset
...
## <a name="to-manage-permissions-through-user-groups" />Käyttöoikeuksien hallinta käyttäjäryhmien avulla
...
### <a name="to-add-users-to-a-user-group" />Käyttäjien lisääminen käyttäjäryhmään
...
### <a name="to-copy-a-user-group-and-all-its-permission-sets" />Käyttäjäryhmän ja sen kaikkien käyttöoikeuksien joukkojen kopioiminen
...
### <a name="to-assign-permission-sets-to-user-groups" />Käyttöoikeuksien joukkojen määrittäminen käyttäjäryhmille
...
### <a name="to-assign-a-permission-set-on-the-permission-set-by-user-group-page" />Käyttöoikeuksien joukon määrittäminen **Käyttöoikeuksien joukko käyttäjäryhmän mukaan** -sivulla
...
## <a name="to-assign-permission-sets-to-users" />Käyttöoikeusjoukkojen määrittäminen käyttäjälle
...
### <a name="to-assign-a-permission-set-on-a-user-card" />Käyttäjäoikeuksien joukon määrittäminen käyttäjän kortissa
...
### <a name="to-assign-a-permission-set-on-the-permission-set-by-user-page" />Käyttöoikeuksien joukon määrittäminen Käyttöoikeuksien joukko käyttäjän mukaan -sivulla
...
## <a name="to-get-an-overview-of-a-users-permissions" />Yleiskuvan saaminen käyttöoikeuksista
...
### <a name="security-filters-limit-a-users-access-to-specific-records-in-a-table" />Suojaussuodattimet rajoittavat käyttäjän käyttöoikeutta tiettyihin taulukon tietueisiin
...
## <a name="viewing-permission-changes-telemetry" />Käyttöoikeuksien muutosten telemetrian tarkasteleminen
...
## <a name="delegated-admin-users" />Delegoidut järjestelmänvalvojakäyttäjät
