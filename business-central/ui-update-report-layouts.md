...
ms.author: edupont
---
# <a name="legacy-update-custom-report-layouts" />(Vanha) Päivitä mukautetut raporttiasettelut
...
## <a name="to-update-one-or-more-custom-report-layouts" />Vähintään yhden mukautetun raportin asettelun päivittäminen
...
## <a name="to-test-custom-report-layout-updates" />Mukautettujen raporttiasetteluiden päivitysten testaaminen
...
## <a name="a-nameupdatelimitationsa-limitations-of-the-custom-report-layout-update" /><a name="UpdateLimitations"></a> Mukautettujen raporttiasetteluiden päivittämisen rajoitukset
...
## <a name="a-namefixerrorsa-fixing-errors" /><a name="FixErrors"></a> Virheiden korjaaminen
