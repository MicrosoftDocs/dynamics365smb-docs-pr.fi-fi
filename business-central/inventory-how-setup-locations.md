...
ms.author: bholtorf
---
# <a name="set-up-locations"></a><a name="set-up-locations"></a>Sijaintien määrittäminen
...
## <a name="location-cards"></a><a name="location-cards"></a>Sijaintikortit
...
### <a name="to-set-up-a-location"></a><a name="to-set-up-a-location"></a>Sijaintien määrittäminen
...
### <a name="to-create-a-transfer-route"></a><a name="to-create-a-transfer-route"></a>Siirtoreittien luominen
...
## <a name="bins"></a><a name="bins"></a>Varastopaikat
...
## <a name="zones"></a><a name="zones"></a>Alueet
...
## <a name="default-dimensions-for-locations"></a><a name="default-dimensions-for-locations"></a>Sijaintien oletusdimensiot
...
### <a name="example-of-default-dimensions-on-locations"></a><a name="example-of-default-dimensions-on-locations"></a>Esimerkki sijaintien oletusdimensioista
...
## <a name="see-related-training-at-microsoft-learn"></a><a name="see-related-training-at-microsoft-learn"></a>Lisätietoja aiheeseen liittyvistä kursseista on [Microsoft Learnissa](/learn/modules/trade-set-up-dynamics-365-business-central/)
