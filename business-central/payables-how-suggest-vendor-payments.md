...
ms.author: edupont
---
# <a name="suggest-vendor-payments" />Ehdota toimittajamaksuja
...
## <a name="to-use-the-suggest-vendor-payments-function" />Ehdota toimittajamaksuja -toiminnon käyttäminen
...
## <a name="to-insert-the-due-date-as-posting-date-on-payment-journal-lines" />Eräpäivän lisääminen maksupäiväkirjan rivien kirjauspäivämääräksi
...
## <a name="see-related-microsoft-training" />Lue aiheeseen liittyen [Microsoftin koulutukset](/training/modules/suggest-vendor-payments-dynamics-365-business-central/)
