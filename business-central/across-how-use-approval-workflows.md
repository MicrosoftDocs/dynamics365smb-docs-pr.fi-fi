...
ms.author: edupont
---
# <a name="how-to-use-approval-workflows" />Toimintaohje: Hyväksyntätyönkulkujen käyttäminen
...
## <a name="request-a-record-approval" />Tietueen hyväksynnän pyytäminen
...
## <a name="cancel-approval-requests" />Peruuta hyväksymispyyntö
...
## <a name="approve-or-reject-approval-requests" />Hyväksymispyyntöjen hyväksyminen tai hylkääminen
...
## <a name="delegate-approval-requests" />Delegoi hyväksymispyynnöt
...
## <a name="manage-overdue-approval-requests" />Myöhässä olevien hyväksymispyyntöjen hallinta
