...
ms.author: edupont
---
# <a name="how-to-use-approval-workflows"></a><a name="how-to-use-approval-workflows"></a>Toimintaohje: Hyväksyntätyönkulkujen käyttäminen
...
## <a name="request-a-record-approval"></a><a name="request-a-record-approval"></a>Tietueen hyväksynnän pyytäminen
...
## <a name="cancel-approval-requests"></a><a name="cancel-approval-requests"></a>Peruuta hyväksymispyyntö
...
## <a name="approve-or-reject-approval-requests"></a><a name="approve-or-reject-approval-requests"></a>Hyväksymispyyntöjen hyväksyminen tai hylkääminen
...
## <a name="delegate-approval-requests"></a><a name="delegate-approval-requests"></a>Delegoi hyväksymispyynnöt
...
## <a name="manage-overdue-approval-requests"></a><a name="manage-overdue-approval-requests"></a>Myöhässä olevien hyväksymispyyntöjen hallinta
