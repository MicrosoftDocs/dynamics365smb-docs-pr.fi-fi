...
---
# <a name="walkthrough-set-up-and-use-a-purchase-approval-workflow"></a>Vaihekuvaus: Ostojen hyväksyntä -työnkulun määrittäminen ja käyttäminen
...
### <a name="set-up-approval-users"></a>Hyväksyjäkäyttäjien määrittäminen
...
#### <a name="to-set-up-how-and-when-youre-notified"></a>Voit määrittää, miten ja milloin saat ilmoituksen
