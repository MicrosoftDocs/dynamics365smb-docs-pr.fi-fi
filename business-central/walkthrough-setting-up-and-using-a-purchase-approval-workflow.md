...
ms.author: edupont
---
# <a name="walkthrough-setting-up-and-using-a-purchase-approval-workflow"></a><a name="walkthrough-setting-up-and-using-a-purchase-approval-workflow"></a>Vaihekuvaus: Ostojen hyväksyntä -työnkulun määrittäminen ja käyttäminen
...
## <a name="users"></a><a name="users"></a>Käyttäjät
...
### <a name="setting-up-approval-users"></a><a name="setting-up-approval-users"></a>Hyväksyjäkäyttäjien määrittäminen
...
#### <a name="to-set-up-yourself-and-alicia-as-approval-users"></a><a name="to-set-up-yourself-and-alicia-as-approval-users"></a>Määritä itsesi ja Alicia hyväksyjäkäyttäjiksi
...
### <a name="setting-up-notifications"></a><a name="setting-up-notifications"></a>Ilmoitusten määrittäminen
...
#### <a name="to-set-up-how-and-when-you-are-notified"></a><a name="to-set-up-how-and-when-you-are-notified"></a>Voit määrittää, miten ja milloin saat ilmoituksen
...
## <a name="creating-the-approval-workflow"></a><a name="creating-the-approval-workflow"></a>Hyväksymistyönkulun luominen
...
### <a name="to-create-and-enable-a-purchase-order-approval-workflow"></a><a name="to-create-and-enable-a-purchase-order-approval-workflow"></a>Ostotilauksen hyväksymisen työnkulun luominen ja lähettäminen
...
## <a name="use-the-approval-workflow"></a><a name="use-the-approval-workflow"></a>Hyväksymistyönkulun käyttäminen
...
### <a name="to-request-approval-of-a-purchase-order-as-alicia"></a><a name="to-request-approval-of-a-purchase-order-as-alicia"></a>Pyydä hyväksyntä ostotilaukseen, Aliciana
...
### <a name="to-approve-the-purchase-order-as-sean"></a><a name="to-approve-the-purchase-order-as-sean"></a>Hyväksy ostotilaus, Seanina
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Lue aiheeseen liittyen [Microsoftin koulutukset](/training/modules/use-approval-workflows/)
