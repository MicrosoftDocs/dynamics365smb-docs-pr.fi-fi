...
ms.author: edupont
---
# <a name="walkthrough-setting-up-and-using-a-purchase-approval-workflow" />Vaihekuvaus: Ostojen hyväksyntä -työnkulun määrittäminen ja käyttäminen
...
### <a name="setting-up-approval-users" />Hyväksyjäkäyttäjien määrittäminen
...
#### <a name="to-set-up-yourself-and-alicia-as-approval-users" />Määritä itsesi ja Alicia hyväksyjäkäyttäjiksi
...
### <a name="setting-up-notifications" />Ilmoitusten määrittäminen
...
#### <a name="to-set-up-how-and-when-you-are-notified" />Voit määrittää, miten ja milloin saat ilmoituksen
...
## <a name="creating-the-approval-workflow" />Hyväksymistyönkulun luominen
...
### <a name="to-create-and-enable-a-purchase-order-approval-workflow" />Ostotilauksen hyväksymisen työnkulun luominen ja lähettäminen
...
## <a name="use-the-approval-workflow" />Hyväksymistyönkulun käyttäminen
...
### <a name="to-request-approval-of-a-purchase-order-as-alicia" />Pyydä hyväksyntä ostotilaukseen, Aliciana
...
### <a name="to-approve-the-purchase-order-as-sean" />Hyväksy ostotilaus, Seanina
