...
---
# <a name="walkthrough-set-up-and-use-a-purchase-approval-workflow"></a>Vaihekuvaus: ostojen hyväksynnän työnkulun määrittäminen ja käyttäminen
...
#### <a name="to-set-up-how-and-when-youre-notified"></a>Ilmoituksen saantitavan ja -ajan määrittäminen
...
## <a name="create-the-approval-workflow"></a>Hyväksymistyönkulun luominen
