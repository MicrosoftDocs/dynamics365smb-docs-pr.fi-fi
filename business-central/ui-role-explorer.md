...
# <a name="finding-pages-with-the-role-explorer" />Sivujen etsiminen roolienhallinnan avulla
...
## <a name="open-the-role-explorer" />Avaa roolien hallinta
...
## <a name="navigate-features" />Navigoi ominaisuuksia
...
## <a name="search-for-features" />Etsi ominaisuuksia
...
## <a name="explore-other-roles" />Tutki muita rooleja
...
## <a name="expand-and-collapse-nodes-on-the-role-explorer" />Solmujen laajentaminen ja tiivistäminen roolienhallinnassa
