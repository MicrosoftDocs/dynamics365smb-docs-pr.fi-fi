...
# <a name="define-an-invoice-posting-policy-for-users" />Laskun kirjauskäytännön määrittäminen käyttäjille
...
## <a name="to-specify-a-posting-policy" />Kirjauskäytännön määrittäminen
...
## <a name="effect-on-documents" />Vaikutus asiakirjoihin
