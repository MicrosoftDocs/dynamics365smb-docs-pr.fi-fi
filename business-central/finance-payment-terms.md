...
ms.author: edupont
---
# <a name="set-up-payment-terms"></a><a name="set-up-payment-terms"></a>Maksuehtojen määrittäminen
...
## <a name="to-set-up-payment-terms"></a><a name="to-set-up-payment-terms"></a>Maksuehtojen määrittäminen
