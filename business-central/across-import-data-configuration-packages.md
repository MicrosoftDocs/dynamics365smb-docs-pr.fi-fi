...
ms.author: edupont
---
# <a name="import-business-data-from-other-finance-systems" />Liiketoimintatietojen tuominen muista rahoitusjärjestelmistä
...
## <a name="work-with-data-in-excel" />Tietojen käyttäminen Excelissä
...
## <a name="import-data-from-configuration-packages" />Tietojen tuominen määrityspaketeista
...
### <a name="tables-in-the-default-configuration-package" />Oletusmäärityspaketin taulukot
