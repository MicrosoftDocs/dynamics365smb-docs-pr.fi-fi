...
ms.author: edupont
---
# <a name="set-up-work-hours-and-service-hours" />Työ- ja huoltotuntien määrittäminen
...
## <a name="to-set-up-default-service-hours" />Oletushuoltotuntien määrittäminen
...
## <a name="to-set-up-work-hour-templates" />Työtuntimallien määrittäminen
...
## <a name="to-set-up-contract-specific-service-hours" />Sopimuskohtaisten huoltotuntien määrittäminen
