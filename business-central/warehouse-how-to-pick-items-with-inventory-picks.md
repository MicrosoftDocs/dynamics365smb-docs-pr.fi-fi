...
---
# <a name="pick-items-with-inventory-picks" />Nimikkeiden poiminta varastopoiminnalla
...
## <a name="to-create-multiple-inventory-picks-with-a-batch-job" />Useiden varaston poimintojen luominen eräajon avulla
...
## <a name="to-create-the-pick-in-two-steps" />Poiminnan luominen kahdessa vaiheessa

### <a name="to-request-an-inventory-pick-by-releasing-the-source-document" />Pyydä varastopoiminta vapauttamalla lähdeasiakirja
...
### <a name="to-create-an-inventory-pick-based-on-the-source-document" />Lähdeasiakirjaan perustuvan varaston poiminnan luominen
...
## <a name="to-record-inventory-picks" />Varaston poimintojen kirjaaminen
...
## <a name="handling-assemble-to-order-items-with-inventory-picks" />Tilausta varten kokoonpantavien nimikkeiden käsitteleminen varaston poimintojen avulla
