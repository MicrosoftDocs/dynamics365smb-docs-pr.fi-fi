...
ms.author: jswymer
---
# <a name="power-bi-integration-component-and-architecture-overview-for-"></a><a name="power-bi-integration-component-and-architecture-overview-for-"></a><a name="power-bi-integration-component-and-architecture-overview-for-"></a>[!INCLUDE[prod_short](includes/prod_short.md)]in Power BI -integrointiosa ja arkkitehtuurin yleiskatsaus
...
## <a name="components"></a><a name="components"></a><a name="components"></a>Komponentit
...
## <a name="whats-available-from-the-start"></a><a name="whats-available-from-the-start"></a><a name="whats-available-from-the-start"></a>Käytettävissä heti
...
## <a name="architecture"></a><a name="architecture"></a><a name="architecture"></a>Arkkitehtuuri
...
## <a name="general-flow"></a><a name="general-flow"></a><a name="general-flow"></a>Yleinen työnkulku
