...
---
# <a name="power-bi-integration-component-and-architecture-overview"></a>Power BI -integrointiosa ja -arkkitehtuurin yleiskatsaus
...
:::image type="content" source="./media/power-bi-architecture.svg" alt-text="Kuvan vaihtoehtoinen teksti." lightbox="./media/power-bi-architecture.svg":::
...
![Power BI:n ja Business Centralin integroinnin työnkulku.](./media/power-bi-flow-v2.svg)
