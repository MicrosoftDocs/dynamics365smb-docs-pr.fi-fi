...
---
# <a name="setting-up-banking"></a><a name="setting-up-banking"></a><a name="setting-up-banking"></a>Pankkitoiminnan määrittäminen
...
| Määritä ulkoinen palvelu, jonka avulla voit viedä pankin maksut käsittelyyn ja tuoda pankin tiliotteet pankkitiedostoista maksun kohdistusta ja pankin täsmäytystä varten. |[Käytä AMC Banking 365 Fundamentals -laajennusta](ui-extensions-amc-banking.md) |
