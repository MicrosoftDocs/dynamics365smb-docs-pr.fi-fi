...
# <a name="setting-up-troubleshooting-for-service-items"></a><a name="setting-up-troubleshooting-for-service-items"></a><a name="setting-up-troubleshooting-for-service-items"></a>Huoltonimikkeiden vianmäärityksen määrittäminen
...
## <a name="to-set-up-troubleshooting-guidelines"></a><a name="to-set-up-troubleshooting-guidelines"></a><a name="to-set-up-troubleshooting-guidelines"></a>Vianetsinnän suuntaviivojen määrittäminen
...
## <a name="to-assign-troubleshooting-guidelines-to-items-service-items-or-service-item-groups"></a><a name="to-assign-troubleshooting-guidelines-to-items-service-items-or-service-item-groups"></a><a name="to-assign-troubleshooting-guidelines-to-items-service-items-or-service-item-groups"></a>Vianmääritysohjeiden määrittäminen nimikkeille, huoltonimikkeille tai huoltonimikeryhmille
