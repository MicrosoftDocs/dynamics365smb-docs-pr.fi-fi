...
# <a name="setting-up-troubleshooting-for-service-items" />Huoltonimikkeiden vianmäärityksen määrittäminen
...
## <a name="to-set-up-troubleshooting-guidelines" />Vianetsinnän suuntaviivojen määrittäminen
...
## <a name="to-assign-troubleshooting-guidelines-to-items-service-items-or-service-item-groups" />Vianmääritysohjeiden määrittäminen nimikkeille, huoltonimikkeille tai huoltonimikeryhmille
