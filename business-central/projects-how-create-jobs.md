...
ms.author: edupont
---
# <a name="create-jobs"></a><a name="create-jobs"></a>Projektien luominen
...
## <a name="to-create-a-job-card"></a><a name="to-create-a-job-card"></a>Projektikortin luominen
...
## <a name="to-create-tasks-for-a-job"></a><a name="to-create-tasks-for-a-job"></a>Luo projektille tehtäviä
...
## <a name="to-create-planning-lines-for-a-job"></a><a name="to-create-planning-lines-for-a-job"></a>Projektin suunnittelurivien luominen
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Lue aiheeseen liittyen [Microsoftin koulutukset](/training/modules/create-new-job/)
