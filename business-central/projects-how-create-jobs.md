...
ms.author: edupont
---
# <a name="create-jobs" />Projektien luominen
...
## <a name="to-create-a-job-card" />Projektikortin luominen
...
## <a name="to-create-tasks-for-a-job" />Luo projektille tehtäviä
...
## <a name="to-create-planning-lines-for-a-job" />Projektin suunnittelurivien luominen
