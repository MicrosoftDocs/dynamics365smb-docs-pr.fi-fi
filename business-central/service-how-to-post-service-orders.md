...
ms.author: edupont
---
# <a name="post-service-orders-and-credit-memos"></a><a name="post-service-orders-and-credit-memos"></a>Huoltotilausten ja hyvityslaskujen kirjaaminen
...
## <a name="to-post-a-service-order"></a><a name="to-post-a-service-order"></a>Huoltotilauksien kirjaaminen
...
## <a name="to-batch-post-service-orders"></a><a name="to-batch-post-service-orders"></a>Huoltotilauksien eräkirjaaminen
1. Valitse ![Lamppu, joka avaa Kerro-ominaisuuden.](media/ui-search/search_small.png "Kerro, mitä haluat tehdä") -kuvake, syötä **Huoltotilaukset** ja valitse sitten vastaava linkki.  
...
## <a name="to-post-a-service-credit-memo"></a><a name="to-post-a-service-credit-memo"></a>Huollon hyvityslaskujen kirjaaminen
...
## <a name="to-post-consumption-from-a-service-order"></a><a name="to-post-consumption-from-a-service-order"></a>Kulutuksen kirjaaminen huoltotilauksesta
...
## <a name="to-post-shipments-from-service-orders"></a><a name="to-post-shipments-from-service-orders"></a>Toimitusten kirjaaminen huoltotilauksista
...
## <a name="to-undo-posted-consumption"></a><a name="to-undo-posted-consumption"></a>Kirjatun kulutuksen kumoaminen
...
## <a name="to-post-service-lines"></a><a name="to-post-service-lines"></a>Huoltorivien kirjaaminen
