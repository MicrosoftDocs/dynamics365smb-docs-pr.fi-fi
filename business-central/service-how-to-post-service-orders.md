...
Seuraavassa ohjeessa neuvotaan, miten kirjataan nimikkeet, resurssitunnit ja/tai kulut, joita käytetään huoltotoimenpiteessä, jota ei laskuteta asiakkaalta. Voit kirjata kulutetut nimikkeet, tunnit tai kustannukset vain sellaista kirjattua toimitusta, jolla ei ole kirjattuja laskuja tai kulutusta.  
...
Jos haluat lisätietoja huoltopalvelurivituotteista kehittyneissä varastokokoonpanoissa, siirry kohtaan Kohteiden kerääminen varastolähetystä varten](warehouse-how-to-pick-items-for-warehouse-shipment.md).  
