...
ms.author: bholtorf
---
# <a name="design-details-average-cost" />Rakennetiedot: Keskimääräinen kustannus
...
## <a name="setting-up-average-cost-calculation" />Määritetään keskimääräiskustannuslaskelma
...
## <a name="calculating-average-cost" />Keskimääräisen kustannuksen laskeminen
...
### <a name="example-average-cost-period--day" />Esimerkki: keskimääräisen kustannusjakso = päivä
...
### <a name="example-average-cost-period--month" />Esimerkki: keskimääräinen kustannusjakso = kuukausi
...
## <a name="setting-the-valuation-date" />Arvostuspäivämäärän asetus
...
## <a name="recalculating-average-cost" />Keskimääräisen kustannuksen uudelleenlaskeminen
...
### <a name="example-of-recalculated-average-cost" />Esimerkki uudelleen laskettavista keskimääräisistä kustannuksista
