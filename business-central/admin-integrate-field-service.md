...
description: Tietoja Business Centralin ja Field Servicen integroinnista.
ms.date: 02/21/2024
ms.topic: article
author: brentholtorf
ms.author: bholtorf
...
Huoltotyyppinen nimike voidaan lisätä **työtilauksen palveluina**, jonka jälkeen kustannukset ja hinnat saadaan [!INCLUDE [prod_short](includes/prod_short.md)]ista. Lisätietoja on kohdassa [Tuotteet ja palvelut -välilehti](/dynamics365/field-service/work-order-experience#products-and-services-tab).
...
> [!NOTE]
> Työtilauksen palvelut, joiden varaus käyttää [!INCLUDE [prod_short](includes/prod_short.md)]in resurssiin yhdistettyä varattavissa olevaa resurssia, synkronoidaan kahdelle projektipäiväkirjan riville. Toinen rivi on yhdistetyn resurssin **Budjetti**-tyyppinen rivi ja toinen huollettavan nimikkeen **Laskutettava**-tyyppinen rivi.
>
