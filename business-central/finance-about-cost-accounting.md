...
ms.author: edupont
---
# <a name="about-cost-accounting" />Tietoja kustannuslaskennasta
...
## <a name="workflow-in-cost-accounting" />Työnkulku kustannuslaskennassa
...
## <a name="cost-types-cost-centers-and-cost-objects" />Kustannustyypit, kustannuspaikat ja kustannuskohteet
...
## <a name="cost-entries-and-cost-journals" />Kustannustapahtumat ja kustannuspäiväkirjat
...
## <a name="cost-allocations" />Kustannusten kohdistukset
...
## <a name="cost-budgets" />Kustannusbudjetit
...
## <a name="cost-reporting" />Kustannusraportti
...
## <a name="see-related-microsoft-trainingtrainingpathsuse-cost-accounting-dynamics-365-business-central" />Lue aiheeseen liittyen [Microsoftin koulutukset](/training/paths/use-cost-accounting-dynamics-365-business-central/)
