...
ms.author: edupont
---
# <a name="about-cost-accounting"></a><a name="about-cost-accounting"></a>Tietoja kustannuslaskennasta
...
## <a name="workflow-in-cost-accounting"></a><a name="workflow-in-cost-accounting"></a>Työnkulku kustannuslaskennassa
...
## <a name="cost-types-cost-centers-and-cost-objects"></a><a name="cost-types-cost-centers-and-cost-objects"></a>Kustannustyypit, kustannuspaikat ja kustannuskohteet
...
## <a name="cost-entries-and-cost-journals"></a><a name="cost-entries-and-cost-journals"></a>Kustannustapahtumat ja kustannuspäiväkirjat
...
## <a name="cost-allocations"></a><a name="cost-allocations"></a>Kustannusten kohdistukset
...
## <a name="cost-budgets"></a><a name="cost-budgets"></a>Kustannusbudjetit
...
## <a name="cost-reporting"></a><a name="cost-reporting"></a>Kustannusraportti
