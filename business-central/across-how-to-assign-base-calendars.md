...
ms.author: edupont
---
# <a name="set-up-base-calendars" />Peruskalenterien määrittäminen
...
## <a name="to-set-up-a-base-calendar" />Peruskalenterin määrittäminen
...
## <a name="to-customize-a-calendar" />Kalenterin räätälöiminen
...
## <a name="to-assign-a-base-calendar" />Peruskalenterin määritteleminen:
