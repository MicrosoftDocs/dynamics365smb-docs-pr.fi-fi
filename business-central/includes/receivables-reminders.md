...
### <a name="to-create-a-reminder-automatically" />Muistutusten luominen automaattisesti
...
### <a name="to-create-a-reminder-manually" />Muistutusten luominen manuaalisesti
...
### <a name="to-replace-reminder-texts" />Muistutustekstien vaihtaminen
...
### <a name="to-issue-a-reminder" />Muistutuksen lähettäminen
...
### <a name="to-cancel-an-issued-reminder" />Lähetetyn muistutuksen peruuttaminen
