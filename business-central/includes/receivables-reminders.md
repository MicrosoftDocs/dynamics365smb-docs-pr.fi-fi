...
### <a name="to-create-a-reminder-automatically"></a><a name="to-create-a-reminder-automatically"></a><a name="to-create-a-reminder-automatically"></a>Muistutusten luominen automaattisesti
...
### <a name="to-create-a-reminder-manually"></a><a name="to-create-a-reminder-manually"></a><a name="to-create-a-reminder-manually"></a>Muistutusten luominen manuaalisesti
...
### <a name="to-replace-reminder-texts"></a><a name="to-replace-reminder-texts"></a><a name="to-replace-reminder-texts"></a>Muistutustekstien vaihtaminen
...
### <a name="to-issue-a-reminder"></a><a name="to-issue-a-reminder"></a><a name="to-issue-a-reminder"></a>Muistutuksen lähettäminen
...
### <a name="to-cancel-an-issued-reminder"></a><a name="to-cancel-an-issued-reminder"></a><a name="to-cancel-an-issued-reminder"></a>Lähetetyn muistutuksen peruuttaminen
