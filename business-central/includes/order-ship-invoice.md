...
>
> Jos myynti on laskutettava ilman toimituksen rekisteröintiä [!INCLUDE[prod_short](prod_short.md)]issa, luo asiakirja **Myyntilaskut**-sivulla tai valitse **Myyntitarjous**-sivulla **Tee lasku** -toiminto. Lisätietoja on kohdassa [Laskutus myynnissä](../sales-how-invoice-sales.md).
