...
# <a name="consolidating-financial-data-from-multiple-companies"></a><a name="consolidating-financial-data-from-multiple-companies"></a>Usean yrityksen kirjanpitotietojen konsolidoiminen
...
## <a name="use-the-consolidated-trial-balance-report"></a><a name="use-the-consolidated-trial-balance-report"></a>Käytä Konsolidoitu alustava saldo -raporttia
...
## <a name="consolidate-data"></a><a name="consolidate-data"></a>Tietojen konsolidointi
...
### <a name="to-test-the-data-before-you-consolidate"></a><a name="to-test-the-data-before-you-consolidate"></a>Tietojen testaus ennen konsolidointia
...
### <a name="run-the-consolidation"></a><a name="run-the-consolidation"></a>Suorita konsolidointi
...
## <a name="eliminate-repeated-transactions"></a><a name="eliminate-repeated-transactions"></a>Estä toistuvat tapahtumat
...
## <a name="export-and-import-consolidated-data-between-databases"></a><a name="export-and-import-consolidated-data-between-databases"></a>Vie ja tuo konsolidoituja tietoja tietokantojen välillä
