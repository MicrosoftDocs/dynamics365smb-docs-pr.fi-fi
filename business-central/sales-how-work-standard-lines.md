...
ms.author: edupont
---
# <a name="create-recurring-sales" />Luo toistuvia myyntejä
...
## <a name="set-up-recurring-sales-lines" />Toistuvien myyntirivien määrittäminen
...
## <a name="assign-recurring-sales-lines-to-a-customer" />Toistuvien myyntirivien määrittäminen asiakkaalle
...
## <a name="insert-recurring-sales-lines-on-a-sales-invoice" />Toistuvien myyntirivien lisääminen myyntilaskuun
...
## <a name="create-multiple-sales-invoices-based-on-recurring-sales-lines" />Useiden myyntilaskujen luonti toistuvien myyntirivien perusteella
