...
ms.author: edupont
---
# <a name="set-up-time-sheets" />Aikaraporttien määrittäminen
...
## <a name="set-up-time-sheets-with-the-assisted-setup-guide" />Määritä aikaraportit tuetun asetusoppaan avulla
...
## <a name="set-up-time-sheets-manually" />Aikaraporttien määrittäminen manuaalisesti
...
### <a name="to-set-up-general-information-for-time-sheets-manually" />Aikaraporttien yleistietojen määrittäminen manuaalisesti
...
### <a name="to-assign-a-time-sheet-administrator-manually" />Aikaraportin järjestelmänvalvojan määrittäminen manuaalisesti
...
### <a name="to-assign-a-time-sheets-owner-and-approver-manually" />Aikaraportin omistajan ja hyväksyjän määrittäminen manuaalisesti
