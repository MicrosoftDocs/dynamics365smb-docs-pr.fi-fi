...
ms.author: jswymer
---
# <a name="sharing-business-data-from-business-central" />Yritystietojen jakaminen Business Centralista
...
## <a name="copying-a-link" />Linkin kopioiminen
...
### <a name="modify-the-page-link" />Muokkaa sivun linkkiä
...
### <a name="about-filtered-lists" />Tietoja suodatetuista luetteloista
...
## <a name="sharing-to-teams" />Jakaminen Teamsiin
...
## <a name="sharing-through-onedrive" />Jakaminen OneDriven kautta
...
## <a name="opening-in-excel" />Avaaminen Excelissä
...
## <a name="sharing-rows-or-tables" />Rivien tai taulukoiden jakaminen
