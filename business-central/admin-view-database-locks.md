...
ms.author: jswymer
---
# <a name="viewing-database-locks"></a><a name="viewing-database-locks"></a><a name="viewing-database-locks"></a>Tietokannan lukitusten tarkasteleminen
...
## <a name="to-view-database-locks"></a><a name="to-view-database-locks"></a><a name="to-view-database-locks"></a>Tietokannan lukitusten tarkasteleminen
