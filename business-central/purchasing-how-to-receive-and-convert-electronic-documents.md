...
ms.author: edupont
---
# <a name="receive-and-convert-electronic-documents" />Sähköisten asiakirjojen vastaanottaminen ja muuntaminen
...
### <a name="to-receive-and-convert-an-electronic-invoice-to-a-purchase-invoice" />Sähköisen laskun vastaanottaminen ja muuntaminen ostolaskuksi
...
## <a name="see-related-microsoft-trainingtrainingmoduleselectronic-documents-dynamics--business-centralindex" />Lue aiheeseen liittyen [Microsoftin koulutukset](/training/modules/electronic-documents-dynamics-365-business-central/index)
