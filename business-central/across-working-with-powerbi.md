...
### <a name="sign-up-power-bi" />Rekisteröityminen Power BI:hin
...
## <a name="work-with-power-bi-reports" />Power BI -raporttien käyttö

### <a name="show-reports-on-list-pages" />Raporttien näyttäminen luettelosivuilla
...
### <a name="switch-reports" />Raporttien vaihtaminen
...
### <a name="get-more-reports" />Lisäraporttien hakeminen
...
### <a name="manage-and-modify-reports" />Raporttien hallinta ja muokkaaminen
...
#### <a name="you-cant-see-a-report-on-the-select-report-page-on-a-list-page" />Raportti ei näy luettelosivun Valitse raportti -sivulla
