...
ms.author: jswymer
---
# <a name="work-with-power-bi-reports-in-"></a><a name="work-with-power-bi-reports-in-"></a><a name="work-with-power-bi-reports-in-"></a>Power BI -raporttien käsittely [!INCLUDE [prod_short](includes/prod_short.md)]issa
...
## <a name="get-started"></a><a name="get-started"></a><a name="get-started"></a>Aloita
...
### <a name="sign-up-power-bi"></a><a name="sign-up-power-bi"></a><a name="sign-up-power-bi"></a>Rekisteröityminen Power BI:hin
...
## <a name="connect-to-power-bi---one-time-only"></a><a name="connect-to-power-bi---one-time-only"></a><a name="connect-to-power-bi---one-time-only"></a><a name="connect"></a>Power BI -yhteyden muodostaminen – kerran
...
#### <a name="from--on-premises"></a><a name="from--on-premises"></a><a name="from--on-premises"></a>Paikallinen [!INCLUDE [prod_short](includes/prod_short.md)]
...
## <a name="work-with-power-bi-reports"></a><a name="work-with-power-bi-reports"></a><a name="work-with-power-bi-reports"></a>Power BI -raporttien käyttö

### <a name="show-reports-on-list-pages"></a><a name="show-reports-on-list-pages"></a><a name="show-reports-on-list-pages"></a>Raporttien näyttäminen luettelosivuilla
...
### <a name="switch-reports"></a><a name="switch-reports"></a><a name="switch-reports"></a>Raporttien vaihtaminen
...
### <a name="get-more-reports"></a><a name="get-more-reports"></a><a name="get-more-reports"></a>Lisäraporttien hakeminen
...
### <a name="manage-and-modify-reports"></a><a name="manage-and-modify-reports"></a><a name="manage-and-modify-reports"></a>Raporttien hallinta ja muokkaaminen
...
### <a name="upload-reports"></a><a name="upload-reports"></a><a name="upload-reports"></a><a name="upload"></a>Raporttien lataaminen palvelimeen
...
#### <a name="you-cant-see-a-report-on-the-select-report-page-on-a-list-page"></a><a name="you-cant-see-a-report-on-the-select-report-page-on-a-list-page"></a><a name="you-cant-see-a-report-on-the-select-report-page-on-a-list-page"></a>Raportti ei näy luettelosivun Valitse raportti -sivulla
