...
ms.author: edupont
---
# <a name="review-and-apply-payments-manually-after-automatic-application" />Maksujen tarkasteleminen ja kohdistaminen automaattisen kohdistuksen jälkeen
...
## <a name="to-review-or-apply-payments-after-automatic-application" />Maksujen tarkastelu tai käyttäminen automaattisen kohdistuksen jälkeen
