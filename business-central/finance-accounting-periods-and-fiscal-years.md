...
ms.author: bholtorf
---
# <a name="work-with-accounting-periods-and-fiscal-years" />Kirjanpitojaksojen ja tilikausien käyttäminen
...
## <a name="creating-a-new-fiscal-year" />Uuden tilikauden luominen

Voit luoda kirjanpitojaksoja joukkotoiminnolla käyttämällä **Luo tilikausi** -eräajoa tai voit luoda ne manuaalisesti.

### <a name="how-to-create-accounting-periods-in-bulk" />Kirjanpitojaksojen luominen joukkotoiminnolla
...
### <a name="how-to-create-accounting-periods-manually" />Kirjanpitojaksojen luominen manuaalisesti
...
## <a name="closing-a-fiscal-year" />Tilikauden sulkeminen
...
## <a name="posting-entries-to-a-closed-fiscal-year" />Tapahtumien kirjaaminen suljettuun tilikauteen
