...
> [!NOTE]
> Keskitetyn käyttöönoton määrittämistä varten Tiimien tilillä on oltava vähintään [Tiimien järjestelmänvalvojan](/entra/identity/roolipohjainen käytönvalvonta/-käyttöoikeus-viite#teams-administrator] -rooli.
