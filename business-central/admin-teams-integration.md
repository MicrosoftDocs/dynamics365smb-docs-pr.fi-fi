...
## <a name="in-microsoft-teams" />Microsoft Teamsissa
...
## <a name="installing-the-business-central-app-by-using-centralized-deployment" />Business Central -sovelluksen asentaminen keskitetyn käyttöönoton avulla
...
## <a name="managing-privacy-and-compliance" />Tietosuojan ja vaatimustenmukaisuuden hallinta
...
### <a name="restricting-sharing-of-cards" />Korttien jakamisen rajoittaminen
...
### <a name="responding-to-data-requests" />Tietopyyntöihin vastaaminen
...
## <a name="show-or-hide-record-data-on-cards" />Näytä tai Piilota korttien tietueiden tiedot
