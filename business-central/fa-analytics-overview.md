...
> [!NOTE]
> Käyttöomaisuuden analytiikka eroaa hieman muista alueista. Nykyisiä tietoja, kuten käyttöomaisuuden hankintoja, poistoja ja vakuutuksia, täytyy analysoida, mutta myös tietoja tulevista (suunnitellut) tiedoista, kuten poisnoista ja käyttöomaisuuden eläkkeelle jäämisestä. Jälkimmäistä analyysityyppiä varten [!INCLUDE[prod_short](includes/prod_short.md)] sisältää sisäänrakennettuja raportteja, jotka voivat laskea nämä numerot.
