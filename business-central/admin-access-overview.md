...
# <a name="manage-access-to-business-central" />Business Centraliin pääsyn hallinta
...
## <a name="layered-access" />Monitasoiset käyttöoikeudet
...
## <a name="licenses" />Käyttöoikeudet
...
## <a name="business-central-administrator-tasks" />Business Centralin järjestelmänvalvojan tehtävät
...
## <a name="business-central-developer-tasks" />Business Central -sovelluksen kehittäjätehtävät
