...
# <a name="inspecting-pages-in-business-central"></a><a name="inspecting-pages-in-business-central"></a>Business Centralin tarkastussivut
...
## <a name="work-with-page-inspection"></a><a name="work-with-page-inspection"></a>Sivun tarkastuksen käyttäminen
...
## <a name="controlling-access-to-page-inspection-details"></a><a name="controlling-access-to-page-inspection-details"></a>Sivun tarkastustietojen käyttöoikeuksien hallinta
