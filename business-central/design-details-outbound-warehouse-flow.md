...
---
# <a name="outbound-warehouse-processes"></a><a name="outbound-warehouse-processes"></a>Fyysisen varaston lähtevät prosessit
...
### <a name="1-release-a-source-document"></a><a name="1-release-a-source-document"></a>1: Lähdeasiakirjan vapauttaminen
...
### <a name="2-create-an-inventory-pick"></a><a name="2-create-an-inventory-pick"></a>2: Varaston poiminnan luominen
...
### <a name="3-post-an-inventory-pick"></a><a name="3-post-an-inventory-pick"></a>3: Varaston poiminnan kirjaaminen
...
### <a name="1-release-a-source-document-1"></a><a name="1-release-a-source-document-1"></a>1: Lähdeasiakirjan vapauttaminen
...
### <a name="2-create-a-warehouse-shipment"></a><a name="2-create-a-warehouse-shipment"></a>2: Fyysisen varaston toimituksen luominen
...
### <a name="3-create-a-warehouse-pick"></a><a name="3-create-a-warehouse-pick"></a>3: Fyysisen varaston poiminnan luominen
...
### <a name="4-register-a-warehouse-pick"></a><a name="4-register-a-warehouse-pick"></a>4: Fyysisen varastoinnin poiminnan rekisteröiminen
...
### <a name="5-post-the-warehouse-shipment"></a><a name="5-post-the-warehouse-shipment"></a>5: Fyysisen varastoinnin toimituksen kirjaaminen
