...
---
# <a name="set-up-vendor-bank-accounts" />Toimittajien pankkitilien määrittäminen
...
## <a name="add-or-edit-a-vendor-bank-account" />Toimittajan pankkitilin lisääminen tai muokkaaminen
...
## <a name="set-up-a-preferred-vendor-bank-account" />Ensisijaisen pankkitilin määrittäminen toimittajalle
