...
# <a name="couple-and-synchronize-records-between-dataverse-and-business-central" />Tietueiden yhdistäminen ja synkronoiminen Dataversen ja Business Centralin välillä
...
## <a name="video-example" />Esimerkkivideo
...
## <a name="to-couple-a-record" />Tietueen yhdistäminen
...
## <a name="to-synchronize-a-single-record" />Yhden tietueen synkronointi
...
## <a name="to-synchronize-a-single-record-from-includecrmmdincludescrmmdmd" />Yhden tietueen synkronointi [!INCLUDE[crm_md](includes/crm_md.md)]-sovelluksesta
...
## <a name="to-couple-multiple-records-using-match-based-coupling" />Voit yhdistää monta tietuetta vastaavuuspohjaisen yhdistämisen avulla.
...
## <a name="to-synchronize-multiple-records" />Useiden tietueiden synkronointi
...
## <a name="bulk-insert-and-couple-records" />Tietueiden joukkolisäys ja -yhdistäminen
...
## <a name="uncoupling-records" />Tietueiden yhdistämisen poistaminen
