...
ms.author: jswymer
---
# <a name="viewing-and-editing-in-excel-from-business-central"></a><a name="viewing-and-editing-in-excel-from-business-central"></a>Näyttäminen ja muokkaaminen Excelissä Business Centralista
...
## <a name="open-in-excel"></a><a name="open-in-excel"></a>Avaa Excelissä
...
## <a name="edit-in-excel"></a><a name="edit-in-excel"></a>Muokkaa Excelissä
...
### <a name="first-time-sign-in"></a><a name="first-time-sign-in"></a>Ensimmäinen sisäänkirjautuminen
...
### <a name="work-across-environments-and-companies"></a><a name="work-across-environments-and-companies"></a>Ympäristöjen ja yritysten välinen yhteistyö
...
### <a name="limits-when-using-excel-for-the-web"></a><a name="limits-when-using-excel-for-the-web"></a>Rajoituksia käytettäessä Exceliä verkossa
...
## <a name="see-the-differences-between-the-options"></a><a name="see-the-differences-between-the-options"></a>Vaihtoehtojen välisiin eroihin tutustuminen
<br><br>  
