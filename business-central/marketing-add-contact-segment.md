...
ms.author: jswymer
---
# <a name="add-contacts-to-segments"></a><a name="add-contacts-to-segments"></a>Kontaktien lisääminen segmentteihin
...
## <a name="to-add-a-contact-to-a-segment"></a><a name="to-add-a-contact-to-a-segment"></a>Kontaktin lisääminen segmenttiin:
...
## <a name="to-refine-the-number-of-contacts"></a><a name="to-refine-the-number-of-contacts"></a>Kontaktien lukumäärän määrittäminen uudelleen
...
## <a name="to-reduce-the-number-of-contacts"></a><a name="to-reduce-the-number-of-contacts"></a>Kontaktien lukumäärän vähentäminen
