...
## <a name="decide-what-type-of-layout-you-want" /><a name="decide"></a>Haluamasi asettelun tyypin valitseminen
...
## <a name="create-a-new-layout" /><a name="create"></a>Uuden asettelun luominen
...
## <a name="modify-a-layout" /><a name="modify"></a>Asettelun muokkaaminen
...
## <a name="replace-a-layout" /><a name="replace"></a>Korvaa asettelu
...
## <a name="rename-a-layout" /><a name="rename"></a>Asettelun nimeäminen uudelleen
