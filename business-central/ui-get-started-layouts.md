...
ms.author: jswymer
---
# <a name="get-started-creating-report-layouts"></a><a name="get-started-creating-report-layouts"></a>Aloita raporttiasettelujen luominen
...
## <a name="decide-what-type-of-layout-you-want"></a><a name="decide-what-type-of-layout-you-want"></a><a name="decide"></a>Haluamasi asettelun tyypin valitseminen
...
## <a name="create-a-new-layout"></a><a name="create-a-new-layout"></a><a name="create"></a>Uuden asettelun luominen
...
## <a name="modify-a-layout"></a><a name="modify-a-layout"></a><a name="modify"></a>Asettelun muokkaaminen
...
## <a name="replace-a-layout"></a><a name="replace-a-layout"></a><a name="replace"></a>Korvaa asettelu
...
## <a name="rename-a-layout"></a><a name="rename-a-layout"></a><a name="rename"></a>Asettelun nimeäminen uudelleen
