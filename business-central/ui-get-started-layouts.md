...
ms.author: jswymer
---
# <a name="get-started-creating-report-layouts" />Aloita raporttiasettelujen luominen
...
## <a name="a-namedecideadecide-what-type-of-layout-you-want" /><a name="decide"></a>Haluamasi asettelun tyypin valitseminen
...
## <a name="a-namecreateacreate-a-new-layout" /><a name="create"></a>Uuden asettelun luominen
...
## <a name="a-namemodifyamodify-a-layout" /><a name="modify"></a>Asettelun muokkaaminen
...
## <a name="a-namereplaceareplace-a-layout" /><a name="replace"></a>Korvaa asettelu
...
## <a name="a-namerenamearename-a-layout" /><a name="rename"></a>Asettelun nimeäminen uudelleen
