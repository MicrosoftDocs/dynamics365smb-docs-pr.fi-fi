...
# <a name="set-up-stockkeeping-units"></a><a name="set-up-stockkeeping-units"></a><a name="set-up-stockkeeping-units"></a>Varastointiyksiköiden määrittäminen
...
## <a name="to-set-up-a-stockkeeping-unit"></a><a name="to-set-up-a-stockkeeping-unit"></a><a name="to-set-up-a-stockkeeping-unit"></a>Varastointiyksiköiden määrittäminen
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Lue aiheeseen liittyen [Microsoftin koulutukset](/training/modules/control-inventory-multiple-locations/)
