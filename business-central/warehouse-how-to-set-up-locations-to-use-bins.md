...
ms.author: edupont
---
# <a name="set-up-locations-to-use-bins" />Sijaintien määrittäminen varastopaikkojen käyttämistä varten
...
## <a name="to-set-up-a-location-to-use-bins" />Määritä sijainti käyttääksesi varastopaikkoja
...
## <a name="fill-in-the-consumption-bin" />Kulutuksen varastopaikan täyttäminen
