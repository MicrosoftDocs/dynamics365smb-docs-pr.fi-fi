...
ms.author: jswymer
---
# <a name="work-with--data-in-power-bi"></a><a name="work-with--data-in-power-bi"></a>[!INCLUDE [prod_short](includes/prod_short.md)] -tietojen käsitteleminen Power BI:ssä
...
## <a name="get-the-latest-data"></a><a name="get-the-latest-data"></a>Viimeisten tietojen hakeminen
...
### <a name="refresh-manually"></a><a name="refresh-manually"></a>Manuaalinen päivitys

Valitse siirtymisruudussa **Tietojoukot**-kohdassa tietojoukon vieressä **Lisää vaihtoehtoja (...)** ja valitse sitten **Päivitä nyt**.

### <a name="schedule-a-refresh"></a><a name="schedule-a-refresh"></a>Päivityksen ajoittaminen
...
## <a name="upload-reports-from-files"></a><a name="upload-reports-from-files"></a><a name="upload"></a>Raporttien lataaminen tiedostoista
...
## <a name="share-reports-with-others"></a><a name="share-reports-with-others"></a><a name="share"></a>Raporttien jakaminen muiden kanssa
