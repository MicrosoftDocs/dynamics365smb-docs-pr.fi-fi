...
ms.author: bholtorf
---
# <a name="record-special-purchase-prices-and-discounts" />Erikoisostohintojen ja -alennusten kirjaaminen
...
## <a name="to-set-up-a-special-purchase-price-for-a-vendor" />Tietyn ostohinnan määrittäminen toimittajalle
...
## <a name="to-set-up-a-line-discount-for-a-vendor" />Rivialennuksen määrittäminen toimittajalle
...
## <a name="to-set-up-an-invoice-discount-for-a-vendor" />Laskualennuksen määrittäminen toimittajalle
...
## <a name="to-choose-a-principle-for-posting-purchase-discounts" />Periaatteen valitseminen ostoalennusten kirjaukselle
...
## <a name="purchase-invoice-discounts-and-service-charges" />Ostolaskualennukset ja palvelumaksut
...
## <a name="see-related-microsoft-trainingtrainingmodulesset-up-prices-discounts-dynamics-365-business-centralindex" />Lue aiheeseen liittyen [Microsoftin koulutukset](/training/modules/set-up-prices-discounts-dynamics-365-business-central/index)
