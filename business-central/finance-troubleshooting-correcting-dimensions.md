...
# <a name="troubleshooting-and-correcting-dimensions"></a><a name="troubleshooting-and-correcting-dimensions"></a><a name="troubleshooting-and-correcting-dimensions"></a>Vianmääritys ja dimensioiden korjaaminen
...
## <a name="troubleshooting-dimensions-errors"></a><a name="troubleshooting-dimensions-errors"></a><a name="troubleshooting-dimensions-errors"></a>Dimensiovirheiden vianmääritys
...
## <a name="changing-dimension-assignments-after-posting"></a><a name="changing-dimension-assignments-after-posting"></a><a name="changing-dimension-assignments-after-posting"></a>Dimensiomääritysten muuttaminen kirjauksen jälkeen
...
### <a name="setting-up-dimension-corrections"></a><a name="setting-up-dimension-corrections"></a><a name="setting-up-dimension-corrections"></a>Dimension korjausten määrittäminen
...
### <a name="correcting-a-dimension"></a><a name="correcting-a-dimension"></a><a name="correcting-a-dimension"></a>Dimension korjaaminen
...
### <a name="validating-dimension-corrections"></a><a name="validating-dimension-corrections"></a><a name="validating-dimension-corrections"></a>Dimension korjausten vahvistaminen
...
### <a name="undoing-a-correction"></a><a name="undoing-a-correction"></a><a name="undoing-a-correction"></a>Korjauksen kumoaminen
...
### <a name="dimension-corrections-on-large-data-sets"></a><a name="dimension-corrections-on-large-data-sets"></a><a name="dimension-corrections-on-large-data-sets"></a>Suurten tietojoukkojen dimension korjaukset
...
### <a name="use-analysis-views-with-dimension-corrections"></a><a name="use-analysis-views-with-dimension-corrections"></a><a name="use-analysis-views-with-dimension-corrections"></a>Analyysinäkymien käyttäminen dimension korjausten kanssa
...
### <a name="viewing-historical-dimension-corrections"></a><a name="viewing-historical-dimension-corrections"></a><a name="viewing-historical-dimension-corrections"></a>Historiallisten dimension korjausten näyttäminen

Jos kirjapitotapahtuma on korjattu, muutosta voi tarkastella **Dimension korjaushistoria** -toiminnolla.

### <a name="handling-incomplete-corrections"></a><a name="handling-incomplete-corrections"></a><a name="handling-incomplete-corrections"></a>Keskeneräisten korjausten käsitteleminen
...
### <a name="use-cost-accounting-with-corrected-gl-entries"></a><a name="use-cost-accounting-with-corrected-gl-entries"></a><a name="use-cost-accounting-with-corrected-gl-entries"></a>Kustannuslaskennan käyttäminen korjatuissa KP-tapahtumissa
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Lue aiheeseen liittyen [Microsoftin koulutukset](/training/modules/dimensions-dynamics-365-business-central/)
