...
# <a name="troubleshooting-and-correcting-dimensions" />Vianmääritys ja dimensioiden korjaaminen
...
## <a name="troubleshooting-dimensions-errors" />Dimensiovirheiden vianmääritys
...
## <a name="changing-dimension-assignments-after-posting" />Dimensiomääritysten muuttaminen kirjauksen jälkeen
...
### <a name="setting-up-dimension-corrections" />Dimension korjausten määrittäminen
...
### <a name="correcting-a-dimension" />Dimension korjaaminen
...
### <a name="validating-dimension-corrections" />Dimension korjausten vahvistaminen
...
### <a name="undoing-a-correction" />Korjauksen kumoaminen
...
### <a name="dimension-corrections-on-large-data-sets" />Suurten tietojoukkojen dimension korjaukset
...
### <a name="use-analysis-views-with-dimension-corrections" />Analyysinäkymien käyttäminen dimension korjausten kanssa
...
### <a name="viewing-historical-dimension-corrections" />Historiallisten dimension korjausten näyttäminen

Jos kirjapitotapahtuma on korjattu, muutosta voi tarkastella **Dimension korjaushistoria** -toiminnolla.

### <a name="handling-incomplete-corrections" />Keskeneräisten korjausten käsitteleminen
...
### <a name="use-cost-accounting-with-corrected-gl-entries" />Kustannuslaskennan käyttäminen korjatuissa KP-tapahtumissa
...
## <a name="see-related-microsoft-trainingtrainingmodulesdimensions-dynamics-365-business-central" />Lue aiheeseen liittyen [Microsoftin koulutukset](/training/modules/dimensions-dynamics-365-business-central/)
