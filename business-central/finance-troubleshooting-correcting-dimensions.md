...
### <a name="validate-dimension-corrections"></a>Dimension korjausten tarkistaminen
...
### <a name="view-historical-dimension-corrections"></a>Aiempien dimensioiden korjausten tarkasteleminen

Jos kirjapitotapahtuma on korjattu, muutosta voi tarkastella **Dimension korjaushistoria** -toiminnolla.

### <a name="handle-incomplete-corrections"></a>Käsittele epätäydellisiä korjauksia.
