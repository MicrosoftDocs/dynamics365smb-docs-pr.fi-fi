...
# <a name="configure-api-templates" />API-mallien määritys
...
## <a name="setting-up-the-entity-template" />Objektimallin määrittäminen
...
## <a name="assign-the-template-to-an-api" />Mallin liittäminen APIin
