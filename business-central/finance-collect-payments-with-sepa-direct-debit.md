...
ms.author: edupont
---
# <a name="collect-payments-with-sepa-direct-debit" />Maksujen kerääminen SEPA-suoraveloitusperintänä.
...
## <a name="setting-up-sepa-direct-debit" />SEPA-suoraveloituksen määrittäminen
...
### <a name="to-set-up-your-bank-account-for-sepa-direct-debit" />SEPA-suoraveloituksen pankkitilin määrittäminen
...
### <a name="to-set-up-the-customers-payment-method-for-sepa-direct-debit" />SEPA-suoraveloituksen asiakkaan maksutavan määrittäminen
...
#### <a name="to-set-up-the-direct-debit-mandate-that-represents-the-customer-agreement" />Suoraveloitusvaltakirjan määrittäminen, joka vastaa asiakkaan sopimusta
...
## <a name="creating-sepa-direct-debit-collection-entries-and-export-to-a-bank-file" />SEPA-suoraveloitusperintätapahtumien luominen ja vieminen pankkitiedostoon
...
### <a name="to-create-a-direct-debit-collection" />Suoraveloitusperinnän luominen
...
### <a name="to-export-a-direct-debit-collection-entry-to-a-bank-file" />Suoraveloitusperintätapahtuman vieminen pankkitiedostoon
...
### <a name="to-reject-a-direct-debit-collection-entry" />Suoraveloitusperintätapahtuman hylkääminen
...
### <a name="to-close-a-direct-debit-collection" />Suoraveloitusperinnän sulkeminen
...
## <a name="posting-sepa-direct-debit-payment-receipts" />SEPA-suoraveloitusmaksujen kirjaaminen
...
### <a name="to-post-a-direct-debit-payment-receipt-from-the-direct-debit-collections-page" />Suoraveloitusmaksukuitin kirjaaminen suoraveloitusperinnän sivulta
