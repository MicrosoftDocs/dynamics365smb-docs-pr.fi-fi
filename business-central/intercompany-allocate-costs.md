...
ms.author: bholtorf
---
# <a name="allocate-costs-to-intercompany-partners" />Kustannusten kohdistaminen konsernikumppaneille
...
## <a name="to-allocate-costs-using-an-intercompany-general-journal" />Kustannusten kohdistaminen konsernin yleisen päiväkirjan avulla
...
## <a name="to-allocate-costs-using-a-purchase-document" />Kustannusten kohdistaminen ostoasiakirjan avulla
...
## <a name="to-send-the-allocated-costs-to-intercompany-partners" />Kohdistettujen kustannusten lähettäminen konsernikumppaneille
...
## <a name="calculating-vat-for-cost-distributions" />ALV:n laskeminen kustannusten jaoille
