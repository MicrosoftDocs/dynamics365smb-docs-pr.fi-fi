...
ms.author: edupont
---
# <a name="create-special-orders"></a><a name="create-special-orders"></a>Erikoistilausten luominen
...
## <a name="to-create-a-special-order"></a><a name="to-create-a-special-order"></a>Erikoistilausten luominen
