...
ms.author: edupont
---
# <a name="register-consumption-and-output-for-one-released-production-order-line" />Yhden vapautetun tuotantotilausrivin kulutuksen ja tuotoksen rekisteröiminen
...
## <a name="to-register-consumption-and-output" />Kulutuksen ja tuotoksen rekisteröiminen
