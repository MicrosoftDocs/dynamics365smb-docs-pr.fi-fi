...
description: Jos käytät RapidStart Servicesia, voit käyttää määritysmalleja nykyisten asiakastietojen jäsentämiseen ennen päätietojen siirtämistä uuteen yrityksessä Business Centralissa.
author: SorenGP
ms.topic: conceptual
ms.devlang: na
ms.tgt_pltfrm: na
