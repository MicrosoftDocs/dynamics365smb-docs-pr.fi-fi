...
# <a name="set-up-pricing-and-additional-costs-for-services"></a><a name="set-up-pricing-and-additional-costs-for-services"></a>Huollon hintojen ja lisäkustannusten määrittäminen
...
## <a name="to-set-up-a-service-price-group"></a><a name="to-set-up-a-service-price-group"></a>Huoltohintaryhmien määrittäminen
...
## <a name="to-set-up-a-service-price-adjustment-group"></a><a name="to-set-up-a-service-price-adjustment-group"></a>Huoltohintamuutoksen ryhmien määrittäminen
...
## <a name="to-set-up-additional-costs-for-services"></a><a name="to-set-up-additional-costs-for-services"></a>Huollon lisäkustannusten määrittäminen
...
### <a name="to-set-up-service-costs"></a><a name="to-set-up-service-costs"></a>Huoltokustannusten määrittäminen
...
### <a name="to-specify-a-default-cost-for-service-orders"></a><a name="to-specify-a-default-cost-for-service-orders"></a>Huoltotilausten oletuskustannusten määrittäminen
