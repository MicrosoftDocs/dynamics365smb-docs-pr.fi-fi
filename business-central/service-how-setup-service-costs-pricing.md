...
# <a name="set-up-pricing-and-additional-costs-for-services" />Huollon hintojen ja lisäkustannusten määrittäminen
...
## <a name="to-set-up-a-service-price-group" />Huoltohintaryhmien määrittäminen
...
## <a name="to-set-up-a-service-price-adjustment-group" />Huoltohintamuutoksen ryhmien määrittäminen
...
## <a name="to-set-up-additional-costs-for-services" />Huollon lisäkustannusten määrittäminen
...
### <a name="to-set-up-service-costs" />Huoltokustannusten määrittäminen
...
### <a name="to-specify-a-default-cost-for-service-orders" />Huoltotilausten oletuskustannusten määrittäminen
