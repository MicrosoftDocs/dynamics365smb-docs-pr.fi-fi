...
ms.author: edupont
---
# <a name="walkthrough-planning-supplies-manually" />Vaihekuvaus: Toimitusten manuaalinen suunnittelu
...
## <a name="setting-up-the-sample-data" />Esimerkkitietojen määrittäminen
...
## <a name="use-the-order-planning-page" />Tilauksen suunnittelu -sivun käyttäminen
...
### <a name="to-use-the-order-planning-page" />Tilauksen suunnittelu -sivun käyttäminen
...
## <a name="planning-a-purchase-order-to-fulfill-component-demand" />Ostotilauksen suunnitteleminen komponenttien kysynnän täyttämiseksi
 Näissä toimintaohjeissa luodaan ostotilaus tarvittavia valmistuskomponentteja varten.  

### <a name="to-plan-a-purchase-order-to-fulfill-component-need-in-production" />Ostotilauksen suunnitteleminen täyttämään tuotannon komponenttitarve
...
## <a name="planning-a-transfer-order-to-fulfill-sales-demand" />Siirtotilauksen suunnitteleminen myyntikysynnän täyttämiseksi
...
### <a name="to-plan-a-transfer-order-to-fulfill-sales-demand" />Siirtotilauksen suunnitteleminen myyntikysynnän täyttämiseksi
...
## <a name="planning-a-multilevel-production-order-to-fulfill-sales-demand" />Monitasoisen tuotantotilauksen suunnitteleminen myyntikysynnän täyttämiseksi
...
### <a name="to-plan-multilevel-production-to-fulfill-sales-demand" />Monitasoisen tuotannon suunnitteleminen myyntikysynnän täyttämiseksi
...
### <a name="to-plan-a-specific-production-order" />Tietyn tuotantotilauksen suunnitteleminen
