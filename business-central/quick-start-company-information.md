...
# <a name="company-information-quick-start"></a><a name="company-information-quick-start"></a>Yritystietojen pika-aloitus
...
## <a name="to-set-up-company-information"></a><a name="to-set-up-company-information"></a>Yrityksen tietojen määrittäminen
