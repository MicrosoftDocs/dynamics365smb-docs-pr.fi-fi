...
ms.author: edupont
---
# <a name="record-purchases-with-purchase-invoices-and-orders"></a><a name="record-purchases-with-purchase-invoices-and-orders"></a>Ostojen kirjaaminen ostolaskujen ja tilausten avulla
...
## <a name="record-purchases-with-purchase-invoices"></a><a name="record-purchases-with-purchase-invoices"></a>Ostojen kirjaaminen ostolaskujen avulla
...
### <a name="create-a-and-post-purchase-invoice"></a><a name="create-a-and-post-purchase-invoice"></a>Ostolaskun luominen ja kirjaaminen
...
## <a name="purchasing-non-inventory-items"></a><a name="purchasing-non-inventory-items"></a>Muiden kuin varastonimikkeiden osto
...
## <a name="when-to-use-purchase-orders"></a><a name="when-to-use-purchase-orders"></a>Ostotilausten käyttö
...
## <a name="receive-items-with-a-purchase-order"></a><a name="receive-items-with-a-purchase-order"></a>Nimikkeiden vastaanottaminen ostotilauksella
...
## <a name="receive-more-items-than-ordered"></a><a name="receive-more-items-than-ordered"></a>Tilattua määrää useamman nimikkeen vastaanottaminen
...
### <a name="set-up-over-receipts"></a><a name="set-up-over-receipts"></a>Vastaanoton ylittävän määrän määrittäminen
...
### <a name="assign-the-over-receipt-code-to-an-item"></a><a name="assign-the-over-receipt-code-to-an-item"></a>Vastaanoton ylittävän määrän koodin määrittäminen nimikkeelle
...
### <a name="over-receive-an-order"></a><a name="over-receive-an-order"></a>Tilauksen vastaanoton ylitys
...
## <a name="posting-purchases"></a><a name="posting-purchases"></a>Ostojen kirjaaminen
...
## <a name="see-related-microsoft-training-1"></a><a name="see-related-microsoft-training-1"></a>Lue aiheeseen liittyen [Microsoftin koulutukset](/training/modules/processing-invoices-dynamics-365-business-central/index)
