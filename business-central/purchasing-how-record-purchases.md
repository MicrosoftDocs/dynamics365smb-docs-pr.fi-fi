...
ms.author: edupont
---
# <a name="record-purchases-with-purchase-invoices-and-orders" />Ostojen kirjaaminen ostolaskujen ja tilausten avulla
...
## <a name="record-purchases-with-purchase-invoices" />Ostojen kirjaaminen ostolaskujen avulla
...
### <a name="create-a-and-post-purchase-invoice" />Ostolaskun luominen ja kirjaaminen
...
## <a name="posted-invoices" />Kirjatut laskut
...
## <a name="purchasing-non-inventory-items" />Muiden kuin varastonimikkeiden osto
...
## <a name="when-to-use-purchase-orders" />Ostotilausten käyttö
...
## <a name="receive-items-with-a-purchase-order" />Nimikkeiden vastaanottaminen ostotilauksella
...
## <a name="receive-more-items-than-ordered" />Tilattua määrää useamman nimikkeen vastaanottaminen
...
### <a name="set-up-over-receipts" />Vastaanoton ylittävän määrän määrittäminen
...
### <a name="assign-the-over-receipt-code-to-an-item" />Vastaanoton ylittävän määrän koodin määrittäminen nimikkeelle
...
### <a name="over-receive-an-order" />Tilauksen vastaanoton ylitys
...
## <a name="posting-purchases" />Ostojen kirjaaminen
...
## <a name="viewing-ledger-entries" />Kirjaustapahtuminen katselu
...
## <a name="editing-ledger-entries" />Kirjaustapahtuminen muokkaus
...
## <a name="see-related-microsoft-training" />Lue aiheeseen liittyen [Microsoftin koulutukset](/training/modules/receive-invoice-dynamics-d365-business-central/index).

## <a name="see-related-microsoft-training-1" />Lue aiheeseen liittyen [Microsoftin koulutukset](/training/modules/processing-invoices-dynamics-365-business-central/index)
