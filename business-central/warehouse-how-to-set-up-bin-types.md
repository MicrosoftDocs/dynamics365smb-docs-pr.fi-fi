...
ms.author: edupont
---
# <a name="set-up-bin-types" />Varastopaikkatyyppien määrittäminen
...
## <a name="to-set-up-the-bin-types-you-want-to-use" />Haluamiesi varastopaikan tyyppien määrittäminen
