...
3. Luo käyttäjät, joita ALV-ryhmän jäsenet käyttävät tunnistautumiseen, kun he luovat yhteyden ALV-ryhmän edustajan [!INCLUDE[prod_short](includes/prod_short.md)]en. Käyttäjillä on oltava täydet käyttöoikeudet [!INCLUDE[prod_short](includes/prod_short.md)]en.
...
### <a name="microsoft-entra-id-setup-for-group-members"></a>Microsoft Entra ID -asetukset ryhmän jäsenille
...
## <a name="issue-with-enabling-multifactor-authentication-mfa"></a>Ongelma monivaiheisen todennuksen (MFA) käyttöönotossa
