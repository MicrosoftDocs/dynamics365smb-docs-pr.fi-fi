...
4. Valitse **Ryhmän maksutili** -kentästä maksutili, jota käytetään ryhmän jäsenten ALV-summille.
5. Määritä **ALV-maksutili**-kentässä tili, jota käytät ALV-maksuihin.
