...
# <a name="the-vat-group-management-extension-for-the-united-kingdom" />Yhdistyneen kuningaskunnan ALV-ryhmän hallinnan laajennus
...
## <a name="forming-a-vat-group" />ALV-ryhmän muodostaminen
...
### <a name="license-requirements" />Lisenssivaatimukset
...
## <a name="set-up-a-vat-group" />Määritä ALV-ryhmä
...
### <a name="azure-active-directory-setup-for-group-members" />Azure Active Directory -asetukset ryhmän jäsenille
...
### <a name="group-api-setup" />Ryhmän ohjelmointirajapinnan asetukset
...
## <a name="set-up-vat-group-members" />Määritä ALV-ryhmän jäsenet
...
### <a name="vat-group-representative-uses-business-central-online" />ALV-ryhmän edustaja käyttää Business Central Online -versiota
...
### <a name="vat-group-representative-uses-business-central-on-premises" />ALV-ryhmän edustaja käyttää Business Central On-Premises -versiota
...
## <a name="set-up-the-vat-group-representative" />Määritä ALV-ryhmän edustaja
...
## <a name="use-the-vat-group-management-features" />ALV-ryhmän hallintaominaisuuksien käyttäminen
...
### <a name="review-vat-member-submissions" />Tarkasta ALV-ryhmän jäsenten lähetykset
...
### <a name="create-a-group-vat-return" />Luo ryhmän ALV-palautus
