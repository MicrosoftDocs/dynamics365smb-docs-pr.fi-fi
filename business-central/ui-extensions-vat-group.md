...
# <a name="the-vat-group-management-extension-for-the-united-kingdom"></a><a name="the-vat-group-management-extension-for-the-united-kingdom"></a>Yhdistyneen kuningaskunnan ALV-ryhmän hallinnan laajennus
...
## <a name="forming-a-vat-group"></a><a name="forming-a-vat-group"></a>ALV-ryhmän muodostaminen
...
### <a name="license-requirements"></a><a name="license-requirements"></a>Lisenssivaatimukset
...
## <a name="set-up-a-vat-group"></a><a name="set-up-a-vat-group"></a>Määritä ALV-ryhmä
...
### <a name="azure-active-directory-setup-for-group-members"></a><a name="azure-active-directory-setup-for-group-members"></a>Azure Active Directory -asetukset ryhmän jäsenille
...
### <a name="group-api-setup"></a><a name="group-api-setup"></a>Ryhmän ohjelmointirajapinnan asetukset
...
## <a name="set-up-vat-group-members"></a><a name="set-up-vat-group-members"></a>Määritä ALV-ryhmän jäsenet
...
### <a name="vat-group-representative-uses-business-central-online"></a><a name="vat-group-representative-uses-business-central-online"></a>ALV-ryhmän edustaja käyttää Business Central Online -versiota
...
### <a name="vat-group-representative-uses-business-central-on-premises"></a><a name="vat-group-representative-uses-business-central-on-premises"></a>ALV-ryhmän edustaja käyttää Business Central On-Premises -versiota
...
## <a name="set-up-the-vat-group-representative"></a><a name="set-up-the-vat-group-representative"></a>Määritä ALV-ryhmän edustaja
...
## <a name="use-the-vat-group-management-features"></a><a name="use-the-vat-group-management-features"></a>ALV-ryhmän hallintaominaisuuksien käyttäminen
...
### <a name="review-vat-member-submissions"></a><a name="review-vat-member-submissions"></a>Tarkasta ALV-ryhmän jäsenten lähetykset
...
### <a name="create-a-group-vat-return"></a><a name="create-a-group-vat-return"></a>Luo ryhmän ALV-palautus
