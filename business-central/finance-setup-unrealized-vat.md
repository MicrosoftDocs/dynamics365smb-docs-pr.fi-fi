...
# <a name="set-up-unrealized-vat-for-cash-based-accounting" />Ei-realisoituneen arvonlisäveron määrittäminen kassaperusteista kirjanpitoa varten
...
## <a name="to-use-general-ledger-accounts-for-unrealized-vat" />Pääkirjanpidon tilien käyttäminen ei-realisoitunutta arvonlisäveroa varten
