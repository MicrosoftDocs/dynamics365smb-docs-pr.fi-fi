...
ms.author: edupont
---
# <a name="set-up-statuses-for-service-orders-and-repairs" />Huoltotilausten ja -korjausten tilan määrittäminen
...
## <a name="to-set-up-service-status-priorities" />Huoltotilan prioriteettien määrittäminen
...
## <a name="to-set-up-a-repair-status" />Korjauksen tilan määrittäminen
