...
ms.author: edupont
---
# <a name="set-up-statuses-for-service-orders-and-repairs"></a><a name="set-up-statuses-for-service-orders-and-repairs"></a><a name="set-up-statuses-for-service-orders-and-repairs"></a>Huoltotilausten ja -korjausten tilan määrittäminen
...
## <a name="to-set-up-service-status-priorities"></a><a name="to-set-up-service-status-priorities"></a><a name="to-set-up-service-status-priorities"></a>Huoltotilan prioriteettien määrittäminen
...
## <a name="to-set-up-a-repair-status"></a><a name="to-set-up-a-repair-status"></a><a name="to-set-up-a-repair-status"></a>Korjauksen tilan määrittäminen
