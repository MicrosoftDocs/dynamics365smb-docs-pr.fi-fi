...
# <a name="business-central-and-onedrive-for-business-integration" />Business Centralin ja OneDrive for Businessin integrointi
...
## <a name="get-started-with-onedrive-features" />Aloita OneDrive-ominaisuuksien käyttö
...
### <a name="open-and-share-in-onedrive" />Avaa ja jaa OneDrivessä
...
### <a name="save-excel-workbooks-and-report-files-in-onedrive" />Tallenna Excel-työkirjat ja raporttitiedostot OneDriveen
