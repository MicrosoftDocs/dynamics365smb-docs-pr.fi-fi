...
---
# <a name="transfer-inventory-between-locations" />Varastonimikkeiden siirtäminen sijaintien välillä
...
## <a name="transfer-orders" />Siirtotilaukset
...
## <a name="item-reclassification-journals" />Nimikkeen uudelleenluokituspäiväkirjat
...
## <a name="to-transfer-items-with-a-transfer-order" />Nimikkeiden siirtäminen siirtotilauksella
...
### <a name="post-multiple-transfer-orders-in-a-batch" />Kirjaa useita siirtotilauksia erässä
...
### <a name="schedule-a-job-queue-entry-to-post-multiple-documents-in-a-batch" />Työjonotapahtuman ajoittaminen useiden asiakirjojen kirjaamiseksi erässä
...
## <a name="to-transfer-items-with-the-item-reclassification-journal" />Siirrä nimikkeet nimikkeiden uudelleenluokituspäiväkirjan avulla
...
## <a name="undo-a-transfer-shipment" />Peruuta siirtotoimitus
