...
---
# <a name="transfer-inventory-between-locations"></a><a name="transfer-inventory-between-locations"></a><a name="transfer-inventory-between-locations"></a>Varastonimikkeiden siirtäminen sijaintien välillä
...
## <a name="transfer-orders"></a><a name="transfer-orders"></a><a name="transfer-orders"></a>Siirtotilaukset
...
## <a name="item-reclassification-journals"></a><a name="item-reclassification-journals"></a><a name="item-reclassification-journals"></a>Nimikkeen uudelleenluokituspäiväkirjat
...
## <a name="to-transfer-items-with-a-transfer-order"></a><a name="to-transfer-items-with-a-transfer-order"></a><a name="to-transfer-items-with-a-transfer-order"></a>Nimikkeiden siirtäminen siirtotilauksella
...
### <a name="post-multiple-transfer-orders-in-a-batch"></a><a name="post-multiple-transfer-orders-in-a-batch"></a><a name="post-multiple-transfer-orders-in-a-batch"></a>Kirjaa useita siirtotilauksia erässä
...
### <a name="schedule-a-job-queue-entry-to-post-multiple-documents-in-a-batch"></a><a name="schedule-a-job-queue-entry-to-post-multiple-documents-in-a-batch"></a><a name="schedule-a-job-queue-entry-to-post-multiple-documents-in-a-batch"></a>Työjonotapahtuman ajoittaminen useiden asiakirjojen kirjaamiseksi erässä
...
## <a name="to-transfer-items-with-the-item-reclassification-journal"></a><a name="to-transfer-items-with-the-item-reclassification-journal"></a><a name="to-transfer-items-with-the-item-reclassification-journal"></a>Siirrä nimikkeet nimikkeiden uudelleenluokituspäiväkirjan avulla
...
## <a name="undo-a-transfer-shipment"></a><a name="undo-a-transfer-shipment"></a><a name="undo-a-transfer-shipment"></a>Peruuta siirtotoimitus
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Lue aiheeseen liittyen [Microsoftin koulutukset](/training/modules/transfer-items/)
