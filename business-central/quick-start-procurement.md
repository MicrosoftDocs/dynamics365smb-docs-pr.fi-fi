...
# <a name="procurement-quick-start"></a><a name="procurement-quick-start"></a><a name="procurement-quick-start"></a>Hankinnan pika-aloitus
...
## <a name="set-up-vendors"></a><a name="set-up-vendors"></a><a name="set-up-vendors"></a>Toimittajien määrittäminen
...
### <a name="set-up-a-new-vendor"></a><a name="set-up-a-new-vendor"></a><a name="set-up-a-new-vendor"></a>Uuden toimittajan määrittäminen
...
## <a name="create-new-purchase-orders"></a><a name="create-new-purchase-orders"></a><a name="create-new-purchase-orders"></a>Luo uusia ostotilauksia
...
### <a name="to-create-a-purchase-order"></a><a name="to-create-a-purchase-order"></a><a name="to-create-a-purchase-order"></a>Ostotilauksen luominen
...
## <a name="create-a-purchase-invoice"></a><a name="create-a-purchase-invoice"></a><a name="create-a-purchase-invoice"></a>Luo ostolasku
...
### <a name="how-to-create-and-post-a-purchase-invoice"></a><a name="how-to-create-and-post-a-purchase-invoice"></a><a name="how-to-create-and-post-a-purchase-invoice"></a>Ostolaskun luominen ja kirjaaminen
