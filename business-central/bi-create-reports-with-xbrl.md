...
ms.author: edupont
---
# <a name="create-reports-with-xbrl" />Luo raportteja XBRL-linkityksellä.
...
## <a name="extensible-business-reporting-language" />XBRL (eXtensible Business Reporting Language)
...
## <a name="xbrl-comprises-the-following-components" />XBRL koostuu seuraavista komponenteista
...
## <a name="layered-taxonomies" />Kerrostetut taksonomiat
...
## <a name="set-up-xbrl-lines" />Määritä XBRL-rivit
...
## <a name="import-an-xbrl-taxonomy" />XBRL-taksonomian tuominen
...
## <a name="update-an-xbrl-taxonomy" />XBRL-taksonomian päivittäminen
...
## <a name="see-related-training-at-microsoft-learnlearnmodulesxbrl-reports-dynamics--business-centralindex" />Lisätietoja aiheeseen liittyvistä kursseista on [Microsoft Learnissa](/learn/modules/xbrl-reports-dynamics-365-business-central/index).
