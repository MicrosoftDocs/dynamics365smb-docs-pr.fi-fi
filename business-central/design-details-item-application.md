...
ms.author: edupont
---
# <a name="design-details-item-application"></a><a name="design-details-item-application"></a><a name="design-details-item-application"></a>Rakennetiedot: Nimikkeen kohdistus
...
## <a name="inventory-increase"></a><a name="inventory-increase"></a><a name="inventory-increase"></a>Varastoarvon nousu
...
## <a name="inventory-decrease"></a><a name="inventory-decrease"></a><a name="inventory-decrease"></a>Varastoarvon lasku
...
## <a name="fixed-application"></a><a name="fixed-application"></a><a name="fixed-application"></a>Kiinteä kohdistus
...
### <a name="example--fixed-application-in-purchase-return"></a><a name="example--fixed-application-in-purchase-return"></a><a name="example--fixed-application-in-purchase-return"></a>Esimerkki – kiinteä kohdistus ostopalautuksessa
...
### <a name="example--fixed-application-with-average-cost"></a><a name="example--fixed-application-with-average-cost"></a><a name="example--fixed-application-with-average-cost"></a>Esimerkki – kiinteä kohdistus keskimääräisen kustannuksen kanssa
...
### <a name="example--fixed-application-in-sales-return"></a><a name="example--fixed-application-in-sales-return"></a><a name="example--fixed-application-in-sales-return"></a>Esimerkki – kiinteä kohdistus myyntipalautuksessa
...
## <a name="transfer-application"></a><a name="transfer-application"></a><a name="transfer-application"></a>Sovelluksen siirtäminen
...
### <a name="example--average-costing-method"></a><a name="example--average-costing-method"></a><a name="example--average-costing-method"></a>Esimerkki – keskiarvo-arvostusmenetelmä
...
### <a name="example--standard-costing-method"></a><a name="example--standard-costing-method"></a><a name="example--standard-costing-method"></a>Esimerkki – Arvostusmenetelmä Vakio
...
## <a name="reapplication"></a><a name="reapplication"></a><a name="reapplication"></a>Uudelleenkohdistus
