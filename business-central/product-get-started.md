...
Aina kun kirjaudut sovellukseen kokeilujakson aikana, jäljellä oleva aika näkyy yläreunassa olevassa sinisessä palkissa. Jos päätät tilata, sinun täytyy ottaa yhteyttä Dynamics 365 -jälleenmyyjäkumppaniin. Lisätietoja on kohdassa [Miten löydän jälleenmyyjäpartnerin?](across-faq.md#findpartner) ja [[!INCLUDE[d365fin_long](includes/d365fin_long_md.md)] – kokeilut ja tilaukset](across-preview.md).  
