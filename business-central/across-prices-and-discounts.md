...
ms.author: bholtorf
---
# <a name="set-up-prices-and-discounts" />Hintojen ja alennusten määrittäminen
...
## <a name="setting-up-prices-and-discounts" />Hintojen ja alennusten määrittäminen
...
## <a name="about-price-lists" />Tietoja hinnastoista
...
## <a name="set-up-prices" />Määritä hinnat
...
## <a name="work-with-invoice-discounts-and-service-charges" />Laskualennusten ja palvelumaksujen käyttäminen
...
## <a name="calculating-the-best-price" />Parhaan hinnan laskenta
...
## <a name="see-related-microsoft-training" />Lue aiheeseen liittyen [Microsoftin koulutukset](/training/modules/customer-discounts-dynamics-365-business-central/)
