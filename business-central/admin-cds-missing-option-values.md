...
# <a name="handling-missing-option-values"></a><a name="handling-missing-option-values"></a><a name="handling-missing-option-values"></a>Puuttuvien asetusarvojen käsitteleminen
> [!NOTE]
...
### <a name="extending-option-sets-in-"></a><a name="extending-option-sets-in-"></a><a name="extending-option-sets-in-"></a>[!INCLUDE[prod_short](includes/prod_short.md)] -sovelluksen asetusjoukkojen laajentaminen
...
### <a name="update--option-mapping"></a><a name="update--option-mapping"></a><a name="update--option-mapping"></a>[!INCLUDE[prod_short](includes/cds_long_md.md)] -sovelluksen asetusten yhdistämisen päivittäminen
