...
ms.author: bholtorf
---
# <a name="define-retention-policies" />Määritä säilytyskäytännöt
...
## <a name="required-setups-and-permissions" />Pakolliset määritykset ja käyttöoikeudet
...
### <a name="to-create-retention-periods" />Säilytyskausien luominen
...
### <a name="set-up-a-retention-policy" />Säilytyskäytännön määrittäminen
...
## <a name="applying-retention-policies" />Säilytyskäytäntöjen ottaminen käyttöön
...
## <a name="viewing-retention-policy-log-entries" />Säilytyskäytäntölokin tapahtumien tarkasteleminen
...
## <a name="including-your-extension-in-a-retention-policy-requires-help-from-a-developer" />Laajennuksen käyttäminen säilytyskäytännön mukaan (edellyttää kehittäjän apua)
