...
---
# <a name="set-up-intrastat-reporting" />Intrastat-raportoinnin määrittäminen
...
## <a name="enable-the-new-intrastat-experience" />Ota käyttöön uusi Intrastat-käyttökokemus
...
## <a name="intrastat-configuration" />Intrastatin määritys

Ennen kuin Intrastat-raportteja voi käyttää, on määritettävä useita konfiguraatioita.

### <a name="intrastat-reporting-setup" />Intrastat-raportoinnin määrittäminen
...
### <a name="set-up-a-reporting-file" />Määritä raportointitiedosto
...
### <a name="set-mandatory-fields-with-the-intrastat-report-checklist" />Pakollisten kenttien määrittäminen Intrastat-raportin tarkistusluettelon avulla
...
## <a name="use-custom-codeunits-in-intrastat-reporting" />Käytä mukautettuja codeunitseja Intrastat-raporteissa
...
## <a name="other-intrastat-configurations" />Muut Intrastatin määritykset
...
#### <a name="set-up-transport-methods" />Kuljetusmuotojen määrittäminen
...
#### <a name="set-up-transaction-nature-codes" />Kauppatapahtuman luonteen koodien määrittäminen
...
### <a name="other-related-configurations" />Muut asiaan liittyvät määritykset
...
#### <a name="item-cards" />Nimikekortit
...
#### <a name="set-up-fixed-assets-for-intrastat" />Määritä käyttöomaisuus Intrastatia varten
...
#### <a name="set-up-vendors-for-intrastat" />Toimittajien määrittäminen Intrastatia varten
...
#### <a name="set-up-customers-for-intrastat" />Asiakkaiden määritys Intrastatia varten
...
#### <a name="exclude-items-and-fixed-assets-from-intrastat-reporting" />Nimikkeiden ja käyttöomaisuuden jättäminen pois Intrastat-raportoinnista

Jos tietty nimike tai käyttöomaisuus jätetään pois Intrastat-raportoinnista, muuta kortissa olevaa asetusta.

##### <a name="exclude-an-item-from-intrastat-reporting" />Sulje nimike pois Intrastat-raportoinnista
...
##### <a name="exclude-a-fixed-asset-from-intrastat-reporting" />Käyttöomaisuuden jättäminen pois Intrastat-raportoinnista

1. Valitse ![Lamppu, joka avaa Kerro-ominaisuuden.](media/ui-search/search_small.png "Kerro, mitä haluat tehdä") -kuvake, syötä **Käyttöomaisuus** ja valitse sitten vastaava linkki.
2. Valitse käyttöomaisuus, jota haluat määrittää.
3. Valitse **Intrastat**-pikavälilehdellä **Jätä pois Intrastat-raportista** -valintaruutu.

#### <a name="set-up-tariff-numbers" />Tavaranimikkeiden määrittäminen
...
## <a name="enter-country-specific-intrastat-settings" />Määritä maa-/aluekohtaiset Intrastat-asetukset
...
### <a name="czech-republic" />Tšekin tasavalta
...
## <a name="see-related-training-at-microsoft-learn" />Lisätietoja aiheeseen liittyvästä koulutuksesta on [Microsoft Learnissa](/learn/modules/process-intrastat-dynamics-365-business-central/index).
