...
---
# <a name="set-up-intrastat-reporting"></a><a name="set-up-intrastat-reporting"></a>Intrastat-raportoinnin määrittäminen
...
## <a name="enable-the-new-intrastat-experience"></a><a name="enable-the-new-intrastat-experience"></a>Ota käyttöön uusi Intrastat-käyttökokemus
...
## <a name="intrastat-configuration"></a><a name="intrastat-configuration"></a>Intrastatin määritys

Ennen kuin Intrastat-raportteja voi käyttää, on määritettävä useita konfiguraatioita.

### <a name="intrastat-reporting-setup"></a><a name="intrastat-reporting-setup"></a>Intrastat-raportoinnin määrittäminen
...
### <a name="set-up-a-reporting-file"></a><a name="set-up-a-reporting-file"></a>Määritä raportointitiedosto
...
### <a name="set-mandatory-fields-with-the-intrastat-report-checklist"></a><a name="set-mandatory-fields-with-the-intrastat-report-checklist"></a>Pakollisten kenttien määrittäminen Intrastat-raportin tarkistusluettelon avulla
...
## <a name="use-custom-codeunits-in-intrastat-reporting"></a><a name="use-custom-codeunits-in-intrastat-reporting"></a>Käytä mukautettuja codeunitseja Intrastat-raporteissa
...
## <a name="other-intrastat-configurations"></a><a name="other-intrastat-configurations"></a>Muut Intrastatin määritykset
...
#### <a name="set-up-transport-methods"></a><a name="set-up-transport-methods"></a>Kuljetusmuotojen määrittäminen
...
#### <a name="set-up-transaction-nature-codes"></a><a name="set-up-transaction-nature-codes"></a>Kauppatapahtuman luonteen koodien määrittäminen
...
### <a name="other-related-configurations"></a><a name="other-related-configurations"></a>Muut asiaan liittyvät määritykset
...
#### <a name="item-cards"></a><a name="item-cards"></a>Nimikekortit
...
#### <a name="set-up-fixed-assets-for-intrastat"></a><a name="set-up-fixed-assets-for-intrastat"></a>Määritä käyttöomaisuus Intrastatia varten
...
#### <a name="set-up-vendors-for-intrastat"></a><a name="set-up-vendors-for-intrastat"></a>Toimittajien määrittäminen Intrastatia varten
...
#### <a name="set-up-customers-for-intrastat"></a><a name="set-up-customers-for-intrastat"></a>Asiakkaiden määritys Intrastatia varten
...
#### <a name="exclude-items-and-fixed-assets-from-intrastat-reporting"></a><a name="exclude-items-and-fixed-assets-from-intrastat-reporting"></a>Nimikkeiden ja käyttöomaisuuden jättäminen pois Intrastat-raportoinnista

Jos tietty nimike tai käyttöomaisuus jätetään pois Intrastat-raportoinnista, muuta kortissa olevaa asetusta.

##### <a name="exclude-an-item-from-intrastat-reporting"></a><a name="exclude-an-item-from-intrastat-reporting"></a>Sulje nimike pois Intrastat-raportoinnista
...
##### <a name="exclude-a-fixed-asset-from-intrastat-reporting"></a><a name="exclude-a-fixed-asset-from-intrastat-reporting"></a>Käyttöomaisuuden jättäminen pois Intrastat-raportoinnista

1. Valitse ![Lamppu, joka avaa Kerro-ominaisuuden.](media/ui-search/search_small.png "Kerro, mitä haluat tehdä") -kuvake, syötä **Käyttöomaisuus** ja valitse sitten vastaava linkki.
2. Valitse käyttöomaisuus, jota haluat määrittää.
3. Valitse **Intrastat**-pikavälilehdellä **Jätä pois Intrastat-raportista** -valintaruutu.

#### <a name="set-up-tariff-numbers"></a><a name="set-up-tariff-numbers"></a>Tavaranimikkeiden määrittäminen
...
## <a name="enter-country-specific-intrastat-settings"></a><a name="enter-country-specific-intrastat-settings"></a>Määritä maa-/aluekohtaiset Intrastat-asetukset
...
### <a name="austria"></a><a name="austria"></a>Itävalta
...
### <a name="czech-republic"></a><a name="czech-republic"></a>Tšekin tasavalta
...
### <a name="finland"></a><a name="finland"></a>Suomi
...
### <a name="sweden"></a><a name="sweden"></a>Ruotsi
