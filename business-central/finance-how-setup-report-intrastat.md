...
>
> Ole varovainen määrittäessäsi kelpoisuussääntöjä. Ne voivat vaihdella maittain.
...
5. Sen jälkeen voit lisätä koodiyksiköt seuraaville vaihtoehdoille: a. Määrittele **Ehdota rivejä codeunit-tunnukseen** -kentässä uusi codeunit Intrastat-raporttirivien ehdottamista varten.
   b. Määritä **Sisällön codeunitin tunnus** -kentässä uusi codeunit tietojen viemistä varten tiedonsiirtomääritystä käyttämällä.
...
3. Täytä **Kustannukset ja kirjaus** -pikavälilehdessä **Tavaranimike**-, **Lisämittayksikkö**- ja **Alkuperämaan/-alueen koodi** -kentät.
...
1. Valitse ![Lamppu, joka avaa Kerro-ominaisuuden.](media/ui-search/search_small.png "Kerro, mitä haluat tehdä") -kuvake, syötä **Nimikkeet**, valitse sitten vastaava linkki.
2. Valitse kohde, jonka haluat määrittää.
3. Valitse **Kustannus ja kirjaus** -pikavälilehdessä **Jätä pois Intrastat-raportista** -kenttä.

##### Käyttöomaisuuden jättäminen pois Intrastat-raportoinnista

1. Valitse ![Lamppu, joka avaa Kerro-ominaisuuden.](media/ui-search/search_small.png "Kerro, mitä haluat tehdä") -kuvake, syötä **Käyttöomaisuus**, valitse sitten vastaava linkki.
2. Valitse käyttöomaisuus, jota haluat määrittää.
3. Valitse **Intrastat**-pikavälilehdellä **Jätä pois Intrastat-raportista** -kenttä.

## Maakohtaiset Intrastat-asetukset

Intrastat-vaatimukset ovat samanlaiset kaikissa EU:n jäsenvaltioissa, joskin tärkeitä poikkeuksia on olemassa. Teoriassa sääntöjä olisi sovellettava yhdenmukaisesti kaikissa jäsenvaltioissa. Täytäntöönpanossa on kuitenkin eroja, koska jotkin jäsenvaltiot antavat suuntaviivoja siitä, miten asetuksen yleisiä periaatteita tulee soveltaa erityistilanteissa. Esimerkiksi kaupalliset näytteet, tavaroiden palautus ja niin edelleen. Nämä suuntaviivat voivat johtaa erilaisiin tuloksiin eri tilanteissa EU:n jäsenvaltioissa. Tämän vuoksi joissakin maissa on erillisiä erityistietoja, jotka eroavat muista maista. Ne käyttävät myös eri tiedostomuotoa raportointia varten.
...
1. Valitse ![Lamppu, joka avaa Kerro-ominaisuuden.](media/ui-search/search_small.png "Kerro, mitä haluat tehdä") -kuvake, syötä **Intrastat-raportoinnin asetukset** ja valitse sitten vastaava linkki.  
2. Tarkista **Raportointi**-pikavälilehdellä onko **jaettujen vastaanottojen/toimitusten tiedostot** valittuna. Siihen liittyen löydät kaksi erillistä **Tiedonsiirtomääritys, koodit** määritettynä. Myös **zip-tiedosto(-t)** -kenttä on valittuna sen varmistamiseksi, että raporttitiedostot lisätään zip-tiedostoon.
...
Uusi Intrastat-raporttikokemus Tšekin tasavallalle on saatavilla 2023 julkaisuaalto 1 -versiosta. Tällä välin voit jatkaa **Intrastat-ilmoitus**-ominaisuuden käyttöä.

### Suomi

Intrastatin määrittämisessä on Suomessa muutamia lisävaiheita. Suomen Intrastat-raportointiin tarvitaan kaksi eri tiedostoa vastaanotoille ja toimituksille. Siihen liittyen löydät kaksi erillistä **Tiedonsiirtomääritys, koodit** määritettynä.
...
Italian uusi Intrastat-raporttikokemus on saatavilla helmikuusta 2023. Tällä välin voit jatkaa **Intrastat-ilmoitus**-ominaisuuden käyttöä.
...
1. Valitse ![Lamppu, joka avaa Kerro-ominaisuuden.](media/ui-search/search_small.png "Kerro, mitä haluat tehdä") -kuvake, syötä **Intrastat-raportoinnin asetukset** ja valitse sitten vastaava linkki.  
2. Tarkista **Raportointi**-pikavälilehdellä onko **jaettujen vastaanottojen/toimitusten tiedostot** valittuna. Siihen liittyen löydät kaksi erillistä **Tiedonsiirtomääritys, koodit** määritettynä.
