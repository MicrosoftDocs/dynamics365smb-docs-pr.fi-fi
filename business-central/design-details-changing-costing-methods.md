...
# <a name="design-details-change-the-costing-method-for-items"></a><a name="design-details-change-the-costing-method-for-items"></a><a name="design-details-change-the-costing-method-for-items"></a>Rakennetiedot: nimikkeiden arvostusmenetelmän muuttaminen
...
## <a name="about-costing-methods"></a><a name="about-costing-methods"></a><a name="about-costing-methods"></a>Tietoja arvostusmenetelmistä
...
## <a name="use-assembly-orders-to-change-costing-method-assignments"></a><a name="use-assembly-orders-to-change-costing-method-assignments"></a><a name="use-assembly-orders-to-change-costing-method-assignments"></a>Arvostusmenetelmämääritysten muuttaminen kokoonpanotilauksia käyttämällä
...
### <a name="define-a-default-costing-method"></a><a name="define-a-default-costing-method"></a><a name="define-a-default-costing-method"></a>Arvostuksen oletusmenetelmän määrittäminen
...
### <a name="manually-copy-related-master-data-from-the-original-item-to-the-new-item"></a><a name="manually-copy-related-master-data-from-the-original-item-to-the-new-item"></a><a name="manually-copy-related-master-data-from-the-original-item-to-the-new-item"></a>Liittyvien päätietojen manuaalinen kopiointi alkuperäisestä nimikkeestä uuteen nimikkeeseen
...
### <a name="transfer-the-inventory-to-the-new-item"></a><a name="transfer-the-inventory-to-the-new-item"></a><a name="transfer-the-inventory-to-the-new-item"></a>Varaston siirtäminen uuteen nimikkeeseen
...
#### <a name="header"></a><a name="header"></a><a name="header"></a>Otsikko
...
#### <a name="lines"></a><a name="lines"></a><a name="lines"></a>Rivit
...
### <a name="handle-inventory-quantities-that-are-allocated-to-demand"></a><a name="handle-inventory-quantities-that-are-allocated-to-demand"></a><a name="handle-inventory-quantities-that-are-allocated-to-demand"></a>Kysyntään kohdistettujen varastomäärien käsitteleminen
...
### <a name="block-the-original-item-from-further-use"></a><a name="block-the-original-item-from-further-use"></a><a name="block-the-original-item-from-further-use"></a>Alkuperäisen nimikkeen käytön estäminen
...
## <a name="summary"></a><a name="summary"></a><a name="summary"></a>Yhteenveto
