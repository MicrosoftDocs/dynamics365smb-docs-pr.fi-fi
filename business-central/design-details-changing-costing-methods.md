...
# <a name="design-details-change-the-costing-method-for-items" />Rakennetiedot: nimikkeiden arvostusmenetelmän muuttaminen
...
## <a name="about-costing-methods" />Tietoja arvostusmenetelmistä
...
## <a name="use-assembly-orders-to-change-costing-method-assignments" />Arvostusmenetelmämääritysten muuttaminen kokoonpanotilauksia käyttämällä
...
### <a name="define-a-default-costing-method" />Arvostuksen oletusmenetelmän määrittäminen
...
### <a name="identify-the-items-to-change-the-costing-method-for-and-renumber-them" />Niiden nimikkeiden määrittäminen, joiden kustannusmenetelmä muutetaan ja nimikkeiden uudelleenumerointi
...
### <a name="create-new-items-with-the-old-numbering-scheme-and-copy-the-master-data-in-a-batch" />Uusien nimikkeiden luonti vanhalla numerointimallilla ja päätietojen kopiointi eränä
...
### <a name="manually-copy-related-master-data-from-the-original-item-to-the-new-item" />Liittyvien päätietojen manuaalinen kopiointi alkuperäisestä nimikkeestä uuteen nimikkeeseen
...
### <a name="determine-the-inventory-quantity-to-convert-from-the-original-item-to-the-new-item" />Alkuperäisestä nimikkeestä uuteen nimikkeeseen muunnettavan varastomäärän määrittäminen
...
### <a name="transfer-the-inventory-to-the-new-item" />Varaston siirtäminen uuteen nimikkeeseen
...
### <a name="handle-inventory-quantities-that-are-allocated-to-demand" />Kysyntään kohdistettujen varastomäärien käsitteleminen
...
### <a name="block-the-original-item-from-further-use" />Alkuperäisen nimikkeen käytön estäminen
