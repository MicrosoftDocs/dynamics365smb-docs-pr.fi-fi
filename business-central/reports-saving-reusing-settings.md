...
ms.author: edupont
---
# <a name="manage-saved-settings-for-reports-and-batch-jobs"></a><a name="manage-saved-settings-for-reports-and-batch-jobs"></a>Raporttien ja erätöiden tallennettujen asetusten hallinta
...
## <a name="manage-saved-settings"></a><a name="manage-saved-settings"></a>Tallennettujen asetusten hallinta
...
## <a name="create-or-modify-saved-settings-for-all-users"></a><a name="create-or-modify-saved-settings-for-all-users"></a>Kaikkien käyttäjien tallennettujen asetusten luominen tai muokkaaminen
