...
ms.author: jswymer
---
# <a name="overview-of-tasks-to-close-accounting-periods"></a><a name="overview-of-tasks-to-close-accounting-periods"></a>Kirjanpitojaksojen sulkemistehtävien yleiskatsaus
...
## <a name="general-ledger"></a><a name="general-ledger"></a>Pääkirjanpito
...
## <a name="sales-and-receivables"></a><a name="sales-and-receivables"></a>Myynnit ja myyntisaamiset
...
## <a name="purchases-and-payables"></a><a name="purchases-and-payables"></a>Ostot ja ostovelat
...
## <a name="fixed-assets"></a><a name="fixed-assets"></a>Käyttöomaisuus
...
## <a name="intercompany"></a><a name="intercompany"></a>Konserni

* Käsittele konsernin tapahtumat.

## <a name="calculate-and-process-sales-tax"></a><a name="calculate-and-process-sales-tax"></a>Arvonlisäveron laskeminen ja käsitteleminen

* Täytä ALV-ilmoitukset.  

## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Lue aiheeseen liittyen [Microsoftin koulutukset](/training/modules/close-fiscal-year-dynamics-365-business-central/)
