...
ms.author: bholtorf
---
# <a name="setting-up-user-accounts-for-integrating-with-microsoft-dataverse"></a><a name="setting-up-user-accounts-for-integrating-with-microsoft-dataverse"></a>Microsoft Dataverse -integroinnissa käytettävien käyttäjätilien määrittäminen
...
## <a name="set-up-the-administrator-user-account"></a><a name="set-up-the-administrator-user-account"></a>Järjestelmänvalvojan käyttäjätilin määrittäminen
...
## <a name="permissions-and-security-roles-for-user-accounts-in-"></a><a name="permissions-and-security-roles-for-user-accounts-in-"></a>[!INCLUDE[prod_short](includes/cds_long_md.md)] -sovelluksen käyttäjätilien käyttöoikeudet ja ja käyttöoikeusroolit
