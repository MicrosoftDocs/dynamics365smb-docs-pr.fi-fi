...
## <a name="permissions-and-security-roles-for-user-accounts-in-" />[!INCLUDE[prod_short](includes/cds_long_md.md)] -sovelluksen käyttäjätilien käyttöoikeudet ja ja käyttöoikeusroolit
