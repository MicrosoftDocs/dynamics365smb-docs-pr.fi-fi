...
> [!NOTE]  
> Paikalliset määräykset tai tavat saattavat edellyttää, että laskujen summat pyöristetään tietyllä tavalla. Voit esimerkiksi arvoon, joka on jaollinen 0,05:llä.  
