...
ms.author: edupont
---
# <a name="why-a-page-is-locked-from-personalization" />Sivun mukauttamisen estäminen lukitsemalla
...
## <a name="locked-from-personalizing" />Mukauttaminen estetty lukitsemalla
...
### <a name="unlocking-the-page" />Sivun lukituksen poistaminen
...
## <a name="blocked-from-personalizing" />Mukauttaminen estetty
