...
# <a name="add-marketing-text-to-items" />Markkinointitekstin lisääminen nimikkeille
...
### <a name="create-first-draft-with-copilot" />Luo ensimmäinen luonnos Copilotin avulla
...
### <a name="review-edit-and-save-text" />Tarkista, muokkaa ja tallenna teksti
...
### <a name="improve-and-tailor-text-suggestions" />Tekstiehdotusten parantaminen ja mukauttaminen
...
## <a name="create-marketing-text-from-scratch" />Luo markkinointiteksti tyhjästä
