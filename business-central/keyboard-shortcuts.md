...
|Oikea nuoli|Siirry saman rivin seuraavaan oikealla olevaan toiminnalliseen kenttään.| Siirry saman rivin seuraavaan oikealla olevaan ruutuun. |Tämä ei koske muokattavaa luetteloa.|
|Vasen nuoli|Siirry saman rivin edelliseen vasemmalla olevaan kenttään. | Siirry saman rivin edelliseen vasemmalla olevaan ruutuun. |Tämä ei koske muokattavaa luetteloa.|
|Kotitalous<br />(Fn+vasen nuoli)|Siirry rivin ensimmäiseen kenttään.|Siirry rivin ensimmäiseen ruutuun.||
|End<br />(Fn+oikea nuoli)|Siirry rivin viimeiseen toiminnalliseen kenttään.|Siirry rivin viimeiseen ruutuun.||
|Sivu ylös<br />(Fn+ylänuoli)|Siirry saman sarakkeen ylimpänä näkyvään riviin.|Siirry saman sarakkeen ylimpänä näkyvään riviin.||
|Sivu alas<br />(Fn+alanuoli)|Siirry saman sarakkeen alimpana näkyvään riviin.|Siirry saman sarakkeen alimpana näkyvään riviin.||
...
|Ctrl+Home<br />(Fn+vasen nuoli)|Valitse luettelon ensimmäinen rivi, kohdistus siirtyy rivin ensimmäiseen toiminnalliseen kenttään|Siirry luettelon ensimmäisen rivin ruutuun||
|Ctrl+End<br />(Fn+Ctrl+oikea nuoli)|Valitse luettelon viimeinen rivi, kohdistus siirtyy rivin ensimmäiseen toiminnalliseen kenttään|Siirry luettelon viimeisen rivin ensimmäiseen ruutuun||
