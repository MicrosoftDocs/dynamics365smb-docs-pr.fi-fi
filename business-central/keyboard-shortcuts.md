...
# <a name="keyboard-shortcuts"></a><a name="keyboard-shortcuts"></a>Pikanäppäimet
...
## <a name="general-keyboard-shortcuts"></a><a name="general-keyboard-shortcuts"></a><a name="Keyboard"></a> Yleiset pikanäppäimet
...
## <a name="keyboard-shortcuts-in-lists"></a><a name="keyboard-shortcuts-in-lists"></a>Luettelon pikanäppäimet
...
### <a name="navigating-between-rows-and-columns"></a><a name="navigating-between-rows-and-columns"></a><a name="navigateshortcuts"></a>Rivien ja sarakkeiden välillä siirtyminen
...
### <a name="selecting-copying-and-pasting"></a><a name="selecting-copying-and-pasting"></a><a name="CopyRows"></a>Valitseminen, kopioiminen ja liittäminen
...
### <a name="searching-and-filtering-lists"></a><a name="searching-and-filtering-lists"></a><a name="KeyboardFilter"></a>Luetteloiden lajitteleminen ja luetteloista hakeminen
...
## <a name="keyboard-shortcuts-in-cards-and-documents"></a><a name="keyboard-shortcuts-in-cards-and-documents"></a>Korttien ja asiakirjojen pikanäppäimet
...
## <a name="quick-entry-shortcuts-for-fields"></a><a name="quick-entry-shortcuts-for-fields"></a><a name="QuickEntry"></a>Kenttien pikatapahtuman pikanäppäimet
...
## <a name="keyboard-shortcuts-in-the-calendar-date-picker"></a><a name="keyboard-shortcuts-in-the-calendar-date-picker"></a><a name="calendarshortcuts"></a> Kalenterin pikanäppäimet (päivämäärän valitsin)
...
## <a name="keyboard-shortcuts-in-date-fields"></a><a name="keyboard-shortcuts-in-date-fields"></a>Päivämääräkenttien pikanäppäimet
...
## <a name="keyboard-shortcuts-in-the-report-preview"></a><a name="keyboard-shortcuts-in-the-report-preview"></a><a name="reportpreviewshortcuts"></a>Raportin esikatselun pikanäppäimet
...
## <a name="keyboard-shortcuts-for-zooming-in-and-out"></a><a name="keyboard-shortcuts-for-zooming-in-and-out"></a><a name="zoomshortcuts"></a>Lähentämisen ja loitontamisen pikanäppäimet
...
## <a name="keyboard-shortcuts-for-role-explorer"></a><a name="keyboard-shortcuts-for-role-explorer"></a><a name="roleexplorer"></a>Roolien hallinnan pikanäppäimet
...
## <a name="numeric-keypad-shortcuts"></a><a name="numeric-keypad-shortcuts"></a><a name="keypad"></a> Numeronäppäimistön pikanäppäimet
...
## <a name="access-keys-for-action-bar-and-navigation-menu"></a><a name="access-keys-for-action-bar-and-navigation-menu"></a>Toimintopalkin ja siirtymisvalikon käyttöoikeusavaimet
