...
# <a name="keyboard-shortcuts" />Pikanäppäimet
...
## <a name="keyboard-shortcuts-in-lists" />Luettelon pikanäppäimet
...
## <a name="keyboard-shortcuts-in-cards-and-documents" />Korttien ja asiakirjojen pikanäppäimet
...
## <a name="keyboard-shortcuts-in-date-fields" />Päivämääräkenttien pikanäppäimet
...
## <a name="access-keys-for-action-bar-and-navigation-menu" />Toimintopalkin ja siirtymisvalikon käyttöoikeusavaimet
