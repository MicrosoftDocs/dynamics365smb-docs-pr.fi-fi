...
ms.author: edupont
---
# <a name="design-details-revaluation"></a><a name="design-details-revaluation"></a>Rakennetiedot: uudelleenarvostus
...
## <a name="calculating-the-revaluable-quantity"></a><a name="calculating-the-revaluable-quantity"></a>Lasketaan uudelleenarvotettavaa määrää
...
## <a name="expected-cost-in-revaluation"></a><a name="expected-cost-in-revaluation"></a>Oletettu kustannus uudelleenarvostuksessa
...
## <a name="determining-whether-an-inventory-decrease-is-affected-by-revaluation"></a><a name="determining-whether-an-inventory-decrease-is-affected-by-revaluation"></a>Määritetään vaikuttaako uudelleenarvostus varaston vähennykseen
...
## <a name="wip-inventory-revaluation"></a><a name="wip-inventory-revaluation"></a>KET-varaston uudelleenarvostus
