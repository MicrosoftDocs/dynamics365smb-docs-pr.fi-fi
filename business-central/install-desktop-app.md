...
## <a name="install-the-app-for--online"></a>Asenna [!INCLUDE [prod_short](includes/prod_short.md)] online -sovellus
...
## <a name="install-the-app-for--on-premises"></a>Sovelluksen asentaminen paikallista [!INCLUDE [prod_short](includes/prod_short.md)] -ohjelmaa varten
