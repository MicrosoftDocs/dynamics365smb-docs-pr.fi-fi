...
ms.author: jswymer
---
# <a name="get-business-central-desktop-app" />Business Central -työpöytäsovelluksen hankkiminen
...
## <a name="why-use-the-app" />Miksi käyttää sovellusta?
...
## <a name="install-the-app-for-business-central-online" />Sovelluksen asentaminen Business Central Onlinea varten
...
### <a name="from-microsoft-store" />Microsoft Storesta
...
### <a name="from-the-browser" />Selaimesta
...
## <a name="install-the-app-for-business-central-on-premises" />Sovelluksen asentaminen paikallista Business Centralia varten
