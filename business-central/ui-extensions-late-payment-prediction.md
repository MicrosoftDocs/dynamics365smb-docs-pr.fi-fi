...
ms.author: bholtorf
---
# <a name="the-late-payment-prediction-extension"></a><a name="the-late-payment-prediction-extension"></a>Myöhästyneen maksun ennusteen laajennus
...
## <a name="viewing-all-payment-predictions"></a><a name="viewing-all-payment-predictions"></a>Kaikkien maksujen ennusteiden tarkasteleminen
...
## <a name="viewing-a-payment-prediction-for-a-specific-sales-document"></a><a name="viewing-a-payment-prediction-for-a-specific-sales-document"></a>Tietyn myyntiasiakirjan maksun ennusteen tarkasteleminen
...
### <a name="data-required-to-train-and-evaluate-the-model"></a><a name="data-required-to-train-and-evaluate-the-model"></a>Tiedot, jotka vaaditaan mallin kouluttamista ja arvioimista varten
...
### <a name="standard-model-and-my-model"></a><a name="standard-model-and-my-model"></a>Vakiomalli ja oma malli
...
#### <a name="to-train-and-use-your-model"></a><a name="to-train-and-use-your-model"></a>Mallin kouluttaminen ja käyttäminen
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Lue aiheeseen liittyen [Microsoftin koulutukset](/training/modules/predict-late-payments-sales-documents/)
