...
# <a name="the-image-analyzer-extension"></a><a name="the-image-analyzer-extension"></a>Kuvan analysointilaajennus
...
## <a name="switch-on-the-image-analyzer-extension"></a><a name="switch-on-the-image-analyzer-extension"></a>Ota käyttöön Kuvan analysointilaajennus
...
## <a name="analyze-an-item-image"></a><a name="analyze-an-item-image"></a>Analysoi nimikkeen kuvaa
...
## <a name="analyze-a-contact-person-picture"></a><a name="analyze-a-contact-person-picture"></a>Analysoi kontaktihenkilön kuva
...
## <a name="use-your-own-computer-vision-api-account"></a><a name="use-your-own-computer-vision-api-account"></a>Käytä omaa konenäön ohjelmointirajapintatiliäsi
...
## <a name="see-how-many-analyses-you-have-left-in-the-current-period"></a><a name="see-how-many-analyses-you-have-left-in-the-current-period"></a>Kuluvan jakson jäljellä olevien analyysien näyttäminen
...
## <a name="stop-using-the-image-analyzer-extension"></a><a name="stop-using-the-image-analyzer-extension"></a>Kuvan analysointilaajennuksen käytön lopettaminen
