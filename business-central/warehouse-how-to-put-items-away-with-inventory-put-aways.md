...
---
# <a name="put-items-away-with-inventory-put-aways" />Nimikkeiden hyllyttäminen varastohyllytyksen avulla
...
## <a name="to-create-an-inventory-put-away-from-the-source-document" />Varastohyllytyksen lähdeasiakirjasta luominen
...
## <a name="to-create-multiple-inventory-put-aways-with-a-batch-job" />Useiden varastohyllytysten luominen eräajon avulla
...
## <a name="to-create-the-put-away-in-two-steps" />Hyllytyksen luominen kahdessa vaiheessa

### <a name="to-request-an-inventory-put-away-by-releasing-the-source-document" />Pyydä varaston hyllytys vapauttamalla lähdeasiakirja
...
### <a name="to-create-an-inventory-put-away-based-on-the-source-document" />Varastohyllytyksen lähdeasiakirjasta luominen
...
## <a name="to-record-the-inventory-put-away" />Varastohyllytyksen kirjaaminen
