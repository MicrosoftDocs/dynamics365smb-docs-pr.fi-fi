...
ms.author: edupont
---
# <a name="understanding-the-general-ledger-and-chart-of-accounts"></a><a name="understanding-the-general-ledger-and-chart-of-accounts"></a>Tietoja pääkirjanpidosta ja tilikartasta
...
## <a name="general-ledger-setup-and-general-posting-setup"></a><a name="general-ledger-setup-and-general-posting-setup"></a>Pääkirjanpidon asetukset ja yleiset kirjausasetukset
...
## <a name="the-chart-of-accounts"></a><a name="the-chart-of-accounts"></a>Tilikartta
...
## <a name="account-categories"></a><a name="account-categories"></a>Tililuokat
...
## <a name="get-a-quick-overview"></a><a name="get-a-quick-overview"></a>Nopean yleiskuvauksen saaminen
...
## <a name="access-to-create-and-edit-accounts-and-account-categories"></a><a name="access-to-create-and-edit-accounts-and-account-categories"></a>Luo ja muokkaa tilejä ja tililuokkia
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Lue aiheeseen liittyen [Microsoftin koulutukset](/training/modules/business-central-configure-general-ledger-setup/)
