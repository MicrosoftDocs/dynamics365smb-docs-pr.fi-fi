...
ms.author: edupont
---
# <a name="walkthrough-setting-up-and-invoicing-sales-prepayments" />Vaihekuvaus: Myynnin ennakkomaksujen määrittäminen ja laskuttaminen
...
### <a name="to-set-up-number-series-for-prepayments" />Ennakkomaksujen numerosarjojen määrittäminen
...
### <a name="to-block-shipments-for-unpaid-prepayment" />Toimitusten estäminen tilanteissa, joissa ennakkomaksuja on jätetty maksamatta
...
### <a name="to-assign-default-prepayment-percentages-to-customers-and-items" />Ennakkomaksujen oletusprosenttien määrittäminen asiakkaille ja nimikkeille
...
### <a name="to-specify-an-account-for-sales-prepayments-in-general-posting-setup" />Määritä tili myynnin ennakkomaksuille yleisissä kirjausasetuksissa
...
## <a name="create-an-order-that-requires-a-prepayment" />Ennakkomaksua edellyttävän tilauksen luominen
...
### <a name="to-create-a-sales-order-with-a-prepayment" />Ennakkomaksun sisältävän myyntitilauksen luominen
...
## <a name="create-a-prepayment-invoice" />Ennakkomaksulaskun luominen
...
## <a name="create-an-additional-prepayment-invoice" />Ylimääräisen ennakkolaskumaksun luominen
...
### <a name="to-create-an-additional-prepayment-invoice" />Ylimääräisen ennakkolaskumaksun luominen
...
## <a name="apply-the-prepayments" />Ennakkomaksujen kohdistaminen

Asiakas maksaa ennakkomaksusumman. Kirjanpito-osaston Arnie rekisteröi maksun ja kohdistaa sen ennakkomaksulaskuihin.  

### <a name="to-apply-a-payment-to-the-prepayment-invoices" />Maksun kohdistaminen ennakkomaksulaskuihin
...
## <a name="invoice-the-remaining-amount" />Jäljellä olevan summan laskuttaminen
...
### <a name="to-invoice-the-remaining-amount" />Jäljellä olevan summan laskuttaminen
...
## <a name="see-related-microsoft-trainingtrainingmodulesprepayment-invoices-dynamics-365-business-central" />Lue aiheeseen liittyen [Microsoftin koulutukset](/training/modules/prepayment-invoices-dynamics-365-business-central/)
