...
ms.author: edupont
---
# <a name="available-fonts" />Käytettävissä olevat fontit
...
## <a name="document-fonts" />Asiakirjafontit
...
## <a name="fonts-for-checks" />Sekkien fontit
...
## <a name="fonts-for-barcodes" />Viivakoodien fontit
