...
ms.author: edupont
---
# <a name="available-fonts"></a><a name="available-fonts"></a>Käytettävissä olevat fontit
...
## <a name="document-fonts"></a><a name="document-fonts"></a>Asiakirjafontit
...
## <a name="fonts-for-checks"></a><a name="fonts-for-checks"></a>Sekkien fontit
...
## <a name="fonts-for-barcodes"></a><a name="fonts-for-barcodes"></a>Viivakoodien fontit
