...
### Voinko määrittää ennakoivasti erilaisia alustavia käyttöoikeuksia eri käyttäjäryhmille?
...
### Voinko määrittää käyttöoikeuksia, profiileja ja asetuksia ennakoivasti yksittäisille käyttäjille ennen kuin he kirjautuvat sisään?
...
### Kun käyttäjä on kirjautunut sisään, voinko muuttaa objekteja, joiden käyttöoikeus hänellä on?
...
### Miten estän pääsyn luottamuksellisiin taulukoihin?
...
### Voinko mukauttaa käyttäjäryhmää käyttöoikeuden määrityksen mukauttamisen sijaan?
...
### Jos määritän kirjoitusoikeuksia sisältäviä käyttöoikeuksia, voivatko käyttäjät kirjoittaa Teamsissa?
...
### Miksi asetus, joka ottaa käyttöoikeuden käyttöön, ei ole käytettävissä ympäristössäni?
...
### Voinko käyttää Business Central on-premises -versiota Microsoft 365 -käyttöoikeuksilla?
...
### Mikä on Teams-käyttäjät-käyttäjäryhmä?
...
### Näytetäänkö Business Centralin Käyttäjät-luettelossa käyttäjät, joilla on vain Microsoft 365 -käyttöoikeus?
...
### Toimiiko tämä ominaisuus upotettujen ISV-ratkaisujen kanssa?
...
### Voiko asiakas käyttää tätä ominaisuutta ilman Business Centralia?
...
### Miten tämä auttaa minua hallitsemaan organisaationi tilausten kustannuksia?
...
### Business Centralin käyttöoikeuksien luettelossa näkyy Microsoft 365 -käyttöoikeus. Mikä se on?
...
### Täytyykö minun hankkia uudentyyppinen Microsoft 365 -käyttöoikeus, jotta tämä ominaisuus toimisi?  
...
### Miten saan selville, kenellä käyttäjistä on vain Microsoft 365 -käyttöoikeus?
...
### Miten suodatan Business Centralin Käyttäjät-luetteloa nähdäkseni käyttäjät, joilla on vain Microsoft 365 -käyttöoikeus?
...
### Entä käyttäjät, joilla on sekä Microsoft 365- että Business Central -käyttöoikeus?
...
### Liittyykö tämän käyttöoikeus Business Central Team Member -käyttöoikeuteen?
...
### Onko Business Centralissa voimassa rajoituksia?
...
### Voinko käyttää tietueita Teamsin iOS- ja Android-sovelluksissa? 
...
### Miten käyttäjät muuttavat henkilökohtaisia asetuksiaan Omat asetukset -sivulta? 
...
### Miten valittu kieli määritetään, kun kirjaudut sisään ensimmäisen kerran? 
...
### Miksi en voi aktivoida joitakin väritettyjä linkkejä välilehdissä ja kortin tiedoissa?
...
### Miksi en voi aktivoida sivun ilmoitustoimintoja?
...
### Voivatko Microsoft 365 -käyttäjät poistaa välilehtiä?
...
### Jos en voi suodattaa, näenkö silti muiden luoman suodatetun luettelon?
