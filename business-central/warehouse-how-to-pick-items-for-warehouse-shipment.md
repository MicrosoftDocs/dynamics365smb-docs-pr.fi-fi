...
---
# <a name="pick-items-for-warehouse-shipment" />Nimikkeiden poiminta fyysisen varastoinnin toimitusta varten
...
## <a name="to-pick-items-for-a-warehouse-shipment" />Fyysisen varastoinnin toimituksen nimikkeiden poimiminen
...
## <a name="see-related-microsoft-trainingtrainingmodulespick-ship-items-warehouse" />Lue aiheeseen liittyen [Microsoftin koulutukset](/training/modules/pick-ship-items-warehouse/)
