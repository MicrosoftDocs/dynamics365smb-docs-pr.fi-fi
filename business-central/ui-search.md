...
ms.author: bholtorf
---
# <a name="finding-pages-and-information-with-tell-me"></a><a name="finding-pages-and-information-with-tell-me"></a>Sivujen ja tietojen etsiminen Kerro, mitä haluat tehdä -toiminnolla
...
## <a name="find-an-action-on-the-current-page"></a><a name="find-an-action-on-the-current-page"></a>Toiminnon etsiminen nykyiseltä sivulta
...
## <a name="find-a-page-or-a-task"></a><a name="find-a-page-or-a-task"></a>Sivun tai tehtävän etsiminen
...
## <a name="find-a-report-or-archived-information"></a><a name="find-a-report-or-archived-information"></a>Raportin tai arkistoitujen tietojen etsiminen
...
## <a name="find-information-in-the-help"></a><a name="find-information-in-the-help"></a>Tietojen etsiminen ohjeesta
...
## <a name="get-more-functionality-from-apps"></a><a name="get-more-functionality-from-apps"></a>Sovellusten toimintojen tehostaminen
...
## <a name="search-for-data"></a><a name="search-for-data"></a>Tietojen haku
...
## <a name="questions"></a><a name="questions"></a>Kysyttävää?
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Lue aiheeseen liittyen [Microsoftin koulutukset](/training/modules/user-interface-dynamics-365-business-central/index)
