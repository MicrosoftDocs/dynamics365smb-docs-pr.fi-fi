...
ms.author: edupont
---
# <a name="batch-post-production-consumption" />Tuotannon kulutuksen eräkirjaus
...
## <a name="to-post-consumption-for-one-or-more-production-order-lines" />Vähintään yhden tuotantotilausrivin kulutuksen kirjaaminen
