...
Kun haluat löytää tietyn tietueen tai arvon, käytä ![Kerro, mitä haluat tehdä](media/ui-search/search.png "Etsi sivua tai raporttia") -toimintoa. **Haku**-kuvake hakua varten. Lisätietoja hakemisesta kohteessa [!INCLUDE [prod_short](includes/prod_short.md)] on kohdassa [Sivujen ja tietojen etsiminen Kerro, mitä haluat tehdä -toiminnolla](ui-search.md).
