...
# <a name="work-with-word-layouts" />Wordin asettelujen käyttö
...
## <a name="embedding-fonts-in-word-layouts-for-consistency" />Fonttien upottaminen Word-asetteluihin yhdenmukaisuuden vuoksi
...
## <a name="adding-data-fields" />Tietokenttien lisääminen
...
### <a name="to-add-a-label-or-data-field" />Selitteen tai tietokentän lisääminen
...
### <a name="to-add-repeating-rows-of-data-fields-to-create-a-list" />Tietokenttien toistuvien rivien lisääminen luettelon luomiseksi
...
## <a name="adding-image-fields" />Kuvakenttien lisääminen
...
### <a name="to-add-an-image" />Kuvan lisääminen
...
### <a name="to-remove-a-label-or-data-field" />Selitteen tai tietokentän poistaminen
...
## <a name="custom-xml-part-overview" />Mukautetun XML-osan yleiskatsaus
...
### <a name="xml-structure-of-custom-xml-part" />Mukautetun XML-osan XML-rakenne
...
### <a name="custom-xml-part-in-word" />Mukautettu XML-osa Wordissa
