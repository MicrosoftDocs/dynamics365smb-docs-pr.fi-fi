...
ms.author: edupont
---
# <a name="make-drop-shipments" />Suoratoimitusten tekeminen
...
## <a name="to-create-a-sales-order-for-drop-shipment" />Myyntitilauksen luominen suoratoimitusta varten
...
## <a name="to-create-the-purchase-order-for-drop-shipment" />Ostotilauksen luominen suoratoimitukselle
...
## <a name="to-create-multiple-purchase-orders-for-drop-shipments" />Useiden ostotilausten luominen suoratoimituksille
...
## <a name="to-view-the-linked-purchase-order-from-the-sales-order" />Myyntitilauksesta linkitetyn ostotilauksen tarkasteleminen
...
## <a name="to-post-a-drop-shipment" />Kirjaa suoratoimitus
