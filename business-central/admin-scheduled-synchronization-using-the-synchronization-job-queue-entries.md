...
# <a name="scheduling-a-synchronization-between-business-central-and-dataverse" />Business Centralin ja Dataversein synkronoinnin ajoittaminen
...
## <a name="synchronization-process" />Synkronointiprosessi
...
## <a name="about-inactivity-timeouts" />Tietoja käyttämättömyyden aikakatkaisusta
...
## <a name="to-view-the-synchronization-job-log" />Synkronointityön lokin tarkasteleminen
...
## <a name="to-view-the-synchronization-job-log-from-the-table-mappings" />Synkronointityölokin tarkasteleminen taulukon yhdistämismäärityksistä
...
## <a name="to-view-the-synchronization-error-log" />Synkronoinnin virhelokin tarkasteleminen
