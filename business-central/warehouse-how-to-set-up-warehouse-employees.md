...
---
# <a name="set-up-warehouse-employees"></a><a name="set-up-warehouse-employees"></a>Varastotyöntekijöiden määrittäminen
...
## <a name="to-set-up-warehouse-employees"></a><a name="to-set-up-warehouse-employees"></a>Varastotyöntekijöiden määrittäminen
