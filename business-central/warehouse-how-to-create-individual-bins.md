...
ms.author: edupont
---
# <a name="create-bins" />Varastopaikkojen luominen
...
## <a name="to-create-a-bin-from-the-location-card" />Varastopaikan luonti sijaintikortista
...
### <a name="the-dedicated-field" />Erityinen-kenttä
...
## <a name="to-create-bins-individually-in-the-bin-creation-worksheet" />Varastopaikkojen luominen yksittäin varastopaikan luontityökirjassa
...
## <a name="to-make-bins-automatically-in-the-bin-creation-worksheet" />Varastopaikkojen muodostaminen automaattisesti varastopaikkojen luontityökirjassa
...
## <a name="see-related-microsoft-trainingtrainingmodulescreate-new-bins" />Lue aiheeseen liittyen [Microsoftin koulutukset](/training/modules/create-new-bins/)
