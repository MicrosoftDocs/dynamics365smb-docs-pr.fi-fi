...
ms.author: edupont
---
# <a name="create-bins"></a><a name="create-bins"></a>Varastopaikkojen luominen
...
## <a name="to-create-a-bin-from-the-location-card"></a><a name="to-create-a-bin-from-the-location-card"></a>Varastopaikan luonti sijaintikortista
...
### <a name="the-dedicated-field"></a><a name="the-dedicated-field"></a>Erityinen-kenttä
...
## <a name="to-create-bins-individually-in-the-bin-creation-worksheet"></a><a name="to-create-bins-individually-in-the-bin-creation-worksheet"></a>Varastopaikkojen luominen yksittäin varastopaikan luontityökirjassa
...
## <a name="to-make-bins-automatically-in-the-bin-creation-worksheet"></a><a name="to-make-bins-automatically-in-the-bin-creation-worksheet"></a>Varastopaikkojen muodostaminen automaattisesti varastopaikkojen luontityökirjassa
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Lue aiheeseen liittyen [Microsoftin koulutukset](/training/modules/create-new-bins/)
