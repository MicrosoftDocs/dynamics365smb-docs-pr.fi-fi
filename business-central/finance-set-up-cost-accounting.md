...
ms.author: edupont
---
# <a name="setting-up-cost-accounting" />Kustannuslaskennan määrittäminen

Ennen kuin alat käsitellä kustannuslaskentaa, sinun täytyy suorittaa asetustehtävät.

## <a name="balances-between-cost-type-cost-center-and-cost-object" />Kustannustyypin, kustannuspaikan ja kustannusobjektin saldot
...
## <a name="setting-up-cost-types" />Kustannustyyppien määrittäminen
...
### <a name="to-transfer-the-general-ledger-chart-of-accounts-to-the-chart-of-cost-types" />Siirrä pääkirjanpidon tilikartta kustannustyyppikaavioon
...
### <a name="to-set-up-new-cost-types-in-the-chart-of-cost-types-page" />Uuden kustannustyypin määrittäminen Kustannustyyppikartta-sivulla
...
### <a name="to-update-cost-types" />Päivitä kustannustyypit
...
## <a name="defining-the-relationship-between-cost-types-and-general-ledger-accounts" />Pääkirjanpitotilien ja kustannustyyppien välisen suhteen määrittäminen
...
### <a name="relationship-between-general-ledger-accounts-and-cost-types" />Pääkirjanpitotilien ja kustannustyyppien välinen suhde.
...
### <a name="cost-types-without-a-relationship-to-the-general-ledger" />Kustannustyypit ilman suhdetta pääkirjanpitoon
...
## <a name="setting-up-cost-centers" />Kustannuspaikkojen määrittäminen
...
### <a name="to-transfer-dimension-values-in-the-general-ledger-to-the-chart-of-cost-centers" />Dimensioarvojen siirtäminen pääkirjanpidosta kustannuspaikkakaavioon
...
### <a name="to-create-new-cost-centers-in-the-chart-of-cost-centers-page" />Uuden kustannuspaikan luominen Kustannuspaikkakartta-sivulla
...
## <a name="setting-up-cost-objects" />Kustannuskohteiden määrittäminen
...
### <a name="to-transfer-dimension-values-from-the-general-ledger-to-the-chart-of-cost-objects" />Dimensioarvojen siirtäminen pääkirjanpidosta kustannuskohdekaavioon
...
### <a name="to-create-new-cost-objects-in-the-chart-of-cost-objects-page" />Uuden kustannuskohteen luominen Kustannuskohdekartta-sivulla
...
## <a name="defining-cost-centers-and-cost-objects-for-chart-of-accounts" />Kustannuspaikkojen ja kustannuskohteiden määrittäminen tilikarttaan
...
### <a name="defining-default-dimension-values-for-general-ledger-accounts" />Dimension oletusarvojen määrittäminen pääkirjanpitotilejä varten
...
### <a name="defining-dimension-values-for-overhead-costs-and-direct-costs" />Dimensioarvojen määrittäminen yleiskustannuksille ja suorille kustannuksille
...
## <a name="see-related-microsoft-trainingtrainingmodulescost-accounting-dynamics-365-business-central" />Lue aiheeseen liittyen [Microsoftin koulutukset](/training/modules/cost-accounting-dynamics-365-business-central/)
