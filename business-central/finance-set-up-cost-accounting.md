...
# <a name="set-up-cost-accounting"></a>Määritä kustannuslaskenta

Ennen kuin alat käsitellä kustannuslaskentaa, sinun täytyy suorittaa asetustehtävät.

## <a name="balances-between-cost-type-cost-center-and-cost-object"></a>Kustannustyypin, Kustannuspaikan ja Kustannuskohteen väliset saldot
