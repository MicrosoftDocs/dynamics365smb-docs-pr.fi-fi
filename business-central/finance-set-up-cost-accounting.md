...
ms.author: edupont
---
# <a name="setting-up-cost-accounting"></a><a name="setting-up-cost-accounting"></a>Kustannuslaskennan määrittäminen

Ennen kuin alat käsitellä kustannuslaskentaa, sinun täytyy suorittaa asetustehtävät.

## <a name="balances-between-cost-type-cost-center-and-cost-object"></a><a name="balances-between-cost-type-cost-center-and-cost-object"></a>Kustannustyypin, kustannuspaikan ja kustannusobjektin saldot
...
## <a name="setting-up-cost-types"></a><a name="setting-up-cost-types"></a>Kustannustyyppien määrittäminen
...
### <a name="to-transfer-the-general-ledger-chart-of-accounts-to-the-chart-of-cost-types"></a><a name="to-transfer-the-general-ledger-chart-of-accounts-to-the-chart-of-cost-types"></a>Siirrä pääkirjanpidon tilikartta kustannustyyppikaavioon
...
### <a name="to-set-up-new-cost-types-in-the-chart-of-cost-types-page"></a><a name="to-set-up-new-cost-types-in-the-chart-of-cost-types-page"></a>Uuden kustannustyypin määrittäminen Kustannustyyppikartta-sivulla
...
### <a name="to-update-cost-types"></a><a name="to-update-cost-types"></a>Päivitä kustannustyypit
...
## <a name="defining-the-relationship-between-cost-types-and-general-ledger-accounts"></a><a name="defining-the-relationship-between-cost-types-and-general-ledger-accounts"></a>Pääkirjanpitotilien ja kustannustyyppien välisen suhteen määrittäminen
...
### <a name="relationship-between-general-ledger-accounts-and-cost-types"></a><a name="relationship-between-general-ledger-accounts-and-cost-types"></a>Pääkirjanpitotilien ja kustannustyyppien välinen suhde.
...
### <a name="cost-types-without-a-relationship-to-the-general-ledger"></a><a name="cost-types-without-a-relationship-to-the-general-ledger"></a>Kustannustyypit ilman suhdetta pääkirjanpitoon
...
## <a name="setting-up-cost-centers"></a><a name="setting-up-cost-centers"></a>Kustannuspaikkojen määrittäminen
...
### <a name="to-transfer-dimension-values-in-the-general-ledger-to-the-chart-of-cost-centers"></a><a name="to-transfer-dimension-values-in-the-general-ledger-to-the-chart-of-cost-centers"></a>Dimensioarvojen siirtäminen pääkirjanpidosta kustannuspaikkakaavioon
...
### <a name="to-create-new-cost-centers-in-the-chart-of-cost-centers-page"></a><a name="to-create-new-cost-centers-in-the-chart-of-cost-centers-page"></a>Uuden kustannuspaikan luominen Kustannuspaikkakartta-sivulla
...
## <a name="setting-up-cost-objects"></a><a name="setting-up-cost-objects"></a>Kustannuskohteiden määrittäminen
...
### <a name="to-transfer-dimension-values-from-the-general-ledger-to-the-chart-of-cost-objects"></a><a name="to-transfer-dimension-values-from-the-general-ledger-to-the-chart-of-cost-objects"></a>Dimensioarvojen siirtäminen pääkirjanpidosta kustannuskohdekaavioon
...
### <a name="to-create-new-cost-objects-in-the-chart-of-cost-objects-page"></a><a name="to-create-new-cost-objects-in-the-chart-of-cost-objects-page"></a>Uuden kustannuskohteen luominen Kustannuskohdekartta-sivulla
...
## <a name="defining-cost-centers-and-cost-objects-for-chart-of-accounts"></a><a name="defining-cost-centers-and-cost-objects-for-chart-of-accounts"></a>Kustannuspaikkojen ja kustannuskohteiden määrittäminen tilikarttaan
...
### <a name="defining-default-dimension-values-for-general-ledger-accounts"></a><a name="defining-default-dimension-values-for-general-ledger-accounts"></a>Dimension oletusarvojen määrittäminen pääkirjanpitotilejä varten
...
### <a name="defining-dimension-values-for-overhead-costs-and-direct-costs"></a><a name="defining-dimension-values-for-overhead-costs-and-direct-costs"></a>Dimensioarvojen määrittäminen yleiskustannuksille ja suorille kustannuksille
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Lue aiheeseen liittyen [Microsoftin koulutukset](/training/modules/cost-accounting-dynamics-365-business-central/)
