...
---
# <a name="introduction-to--and-power-bi"></a><a name="introduction-to--and-power-bi"></a>[!INCLUDE[prod_short](includes/prod_short.md)]-sovelluksen ja Power BI:n esittely
...
## <a name="what-you-can-do-with-power-bi-and-"></a><a name="what-you-can-do-with-power-bi-and-"></a>Power BI:n ja [!INCLUDE[prod_short](includes/prod_short.md)]in käyttötapoja
...
## <a name="get-ready-to-use-power-bi"></a><a name="get-ready-to-use-power-bi"></a>Power BI:n valmistelu käyttöä varten
...
## <a name="track-your-business-kpis-with-power-bi-metrics"></a><a name="track-your-business-kpis-with-power-bi-metrics"></a>Liiketoiminnan KPI:iden seuraaminen Power BI -mittareiden avulla
