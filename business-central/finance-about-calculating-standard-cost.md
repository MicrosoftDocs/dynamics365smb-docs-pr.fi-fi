...
ms.author: edupont
---
# <a name="about-calculating-standard-cost"></a><a name="about-calculating-standard-cost"></a>Tietoja standardikustannuksen laskemisesta
...
## <a name="setting-up-standard-costs"></a><a name="setting-up-standard-costs"></a>Vakiokustannusten määrittäminen
...
### <a name="material-costs"></a><a name="material-costs"></a>Materiaalikulut
...
### <a name="capacity-costs"></a><a name="capacity-costs"></a>Kapasiteettikustannukset
...
### <a name="subcontractor-costs"></a><a name="subcontractor-costs"></a>Alihankkijan kustannukset
...
## <a name="updating-standard-costs"></a><a name="updating-standard-costs"></a>Vakiokustannusten päivittäminen
