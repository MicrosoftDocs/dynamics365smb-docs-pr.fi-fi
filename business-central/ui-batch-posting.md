...
ms.author: edupont
---
# <a name="post-multiple-documents-at-the-same-time" />Useiden asiakirjojen kirjaaminen samanaikaisesti
...
## <a name="to-post-multiple-purchase-orders-immediately" />Useiden ostotilausten kirjaaminen heti
...
## <a name="to-batch-post-multiple-purchase-orders" />Useiden ostotilausten eräkirjaaminen
...
## <a name="to-set-up-background-posting-with-job-queues" />Taustakirjauksen määrittäminen työjonojen avulla
...
### <a name="to-view-status-from-a-sales-or-purchase-document" />Myynti- tai ostoasiakirjan tilan näyttäminen
...
## <a name="to-create-a-job-queue-entry-for-batch-posting-of-sales-orders" />Työjonotapahtuman luonti myyntitilausten eräkirjausta varten
...
## <a name="monitor-the-job-queue" />Valvo työjonoa
