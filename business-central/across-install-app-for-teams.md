...
# <a name="install-the--app-for-microsoft-teams"></a><a name="install-the--app-for-microsoft-teams"></a>Asenna [!INCLUDE [prod_short](includes/prod_short.md)] -sovellus Microsoft Teamsiin
...
## <a name="add-the-business-central-app-to-teams"></a><a name="add-the-business-central-app-to-teams"></a>Lisää Business Central -sovellus Teamsiin
...
## <a name="next-step"></a><a name="next-step"></a>Seuraava vaihe
