...
# <a name="install-the-include-prodshortincludesprodshortmd-app-for-microsoft-teams" />Asenna [!INCLUDE [prod_short](includes/prod_short.md)] -sovellus Microsoft Teamsiin
