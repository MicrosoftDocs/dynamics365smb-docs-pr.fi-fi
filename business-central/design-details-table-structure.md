...
ms.author: edupont
---
# <a name="design-details-table-structure"></a><a name="design-details-table-structure"></a>Rakennetiedot: taulukkorakenne
Dimensiotapahtumien tallennuksen ja kirjauksen ymmärtäminen edellyttää taulukkorakenteen ymmärtämistä.  

## <a name="table-480-dimension-set-entry"></a><a name="table-480-dimension-set-entry"></a>Taulukko 480, Dimensioyhdistelmän tapahtuma
...
## <a name="table-481-dimension-set-tree-node"></a><a name="table-481-dimension-set-tree-node"></a>Taulukko 481, Dimensioyhdistelmän puusolmu
...
## <a name="table-482-reclas-dimension-set-buffer"></a><a name="table-482-reclas-dimension-set-buffer"></a>Taulukko 482 Uudelleenluokita dimensioyhdistelmän puskuri
...
## <a name="transaction-and-budget-tables"></a><a name="transaction-and-budget-tables"></a>Tapahtuma- ja budjettitaulukot
...
### <a name="table-83-item-journal-line"></a><a name="table-83-item-journal-line"></a>Taulukko 83, Nimikepäiväkirjan rivi
...
### <a name="table-349-dimension-value"></a><a name="table-349-dimension-value"></a>Taulukko 349, Dimensioarvo
Muiden taulukon dimensiokenttien lisäksi nämä kentät ovat tärkeitä.  
...
### <a name="tables-that-contain-the-dimension-set-id-field"></a><a name="tables-that-contain-the-dimension-set-id-field"></a>Taulukot, jotka sisältävät Dimensionasetustunnus-kentän
