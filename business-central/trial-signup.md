...
# <a name="sign-up-for-a-free-dynamics-365-business-central-trial" />Rekisteröidy maksuttoman Dynamics 365 Business Central -kokeiluversion käyttäjäksi
...
## <a name="to-sign-up-for-the-trial" />Rekisteröityminen kokeiluversion käyttäjäksi

[!INCLUDE [trial-get](includes/trial-get.md)]

## <a name="what-to-try" />Kokeiltavissa
...
## <a name="get-started-with-a-subscription" />Tilauksen käytön aloittaminen
...
## <a name="see-related-microsoft-training" />Lue aiheeseen liittyen [Microsoftin koulutukset](/training/modules/trial-dynamics-365-business-central/)

## <a name="additional-resources" />Lisäresurssit
