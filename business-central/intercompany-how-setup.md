...
### <a name="connect-with-partners-in-another-tenant-or-environment"></a>Yhteyden muodostaminen toisen vuokralaisen tai ympäristön kumppaneiden kanssa

Jos yhden tai usean kumppanin [!INCLUDE [prod_short](includes/prod_short.md)] on toisessa vuokraajassa tai ympäristössä, yhteyden luomisessa vaaditaan muutama lisävaihe. Vaiheet koskevat kaikkia toisessa vuokraajassa tai ympäristössä olevia kumppaneita.

* Määritä [!INCLUDE [prod_short](includes/prod_short.md)] rekisteröitynä sovelluksena Azure-portaaliin.
* Lisää sovelluksen rekisteröinti ja ota se käyttöön sovelluksessa [!INCLUDE [prod_short](includes/prod_short.md)].
* Voit vaihtaa tietoja konsernin asetuksista. Kukin kumppani saa nämä tiedot avustetusta **Konsernikumppanin ympäristöjen välinen määritys** -määritysoppaasta.
...
* Vaihda seuraavat todennusasetukset, jotta [!INCLUDE [prod_short](includes/prod_short.md)] voi tehdä todennuksen yhteyden muodostamisen aikana. Kukin kumppani voi saada nämä tiedot rekisteröidystä sovelluksestaan. Saat lisätietoja rekisteröidyn sovelluksen luomisesta siirtymällä kohtaan [Rekisteröidyn sovelluksen luominen Azure-portaalissa](#create-a-registered-app-in-azure-portal).  
...
Suorita ohjattu **Konsernikumppanin ympäristöjen välinen määritys** -määritysopas kaikissa yrityksissä tietojen määrittämiseksi. Aloita opas **Konsernikumppani**-sivulla käyttämällä **Yhdistä ulkoisesti -määritys** -toimintoa.

#### <a name="create-a-registered-app-in-azure-portal"></a>Rekisteröidyn sovelluksen luominen Azure-portaalissa

Tämä prosessi on tarpeellinen vain, jos haluat muodostaa yhteyden kumppaneihin, joiden [!INCLUDE [prod_short](includes/prod_short.md)] on eri vuokraajassa tai ympäristössä.

> [!TIP]
> Tekstieditori, kuten Muistio, kannattaa pitää avoinna rekisteröidyn sovelluksen luomisen yhteydessä. Tarvitset tietoja, kun suoritat ohjatun **Konsernikumppanin ympäristöjen välinen määritys** -määritysoppaan, joten on mukava pitää tiedot helposti käytettävissä.

1. Siirry [Azure-portaaliin](https://portal.azure.com/#home).
...
7. Valitse Uudelleenohjauksen URI-osoitteelle **Valitse ympäristö** -kentässä **Verkko**-vaihtoehto ja anna sitten URI-osoite. Se voi olla esimerkiksi \**https://businesscentral.dynamics.com/OAuthLanding.htm**.

  Jos käytössä on upotettu ISV, näkyvissä voi olla eri URI.

8. Rekisteröi sovellus.
9. Valitse **Konsernin sisäinen sovellus** -sivulla **Ohjelmointirajapinnan oikeudet**.
10. Valitse **Lisää oikeus** -toiminto.
11. Valitse **Microsoftin ohjelmointirajapinta** -välilehdessä **Dynamics 365 Business Central**.
12. Valitse **Pyydä ohjelmointirajapinnan oikeudet** -ruudussa **Sovelluksen oikeudet** valitse sitten **API.ReadWrite.All**-oikeus.
13. Valitse **Konsernin sisäinen sovellus | ohjelmointirajapinnan oikeudet** -sivulla **Anna Contosolle järjestelmänvalvojan suostumus** -toiminto ja anna suostumus.
14. Valitse siirtymisruudussa **Sertifikaatit ja salasanat**.
15. Valitse **Asiakasohjelman salasanat** -välilehti ja valitse sitten **Uusi asiakasohjelman salasana**.
16. Anna **Lisää asiakasohjelman salasana** -ruutuun salasanan nimi ja määritä sen vanhentumisajankohta.
...
17. Valitse siirtymisruudussa **Yleiskatsaus**.
18. Kopioi arvo **Sovelluksen (asiakasohjelman) tunnus** -kenttään. Voit esimerkiksi liittää arvon tekstieditoriin.
19. Valitse **Päätepisteet**-toiminto ja kopioi arvo **OAuth 2.0 -tunnuksen päätepiste (v2)** -kenttään. Voit esimerkiksi liittää arvon tekstieditoriin.
20. Kopioi arvo **Hakemiston (vuokraajan) tunnus** -kenttään. Voit esimerkiksi liittää arvon tekstieditoriin.
21. Kun tunnuksen arvo on kopioitu, korvaa **organisaatiot** edellisessä vaiheessa **Hakemiston (vuokraajan) tunnus** -kentästä kopioidulla arvolla.

#### <a name="add-and-enable-your-registered-app-in-business-central"></a>Rekisteröidyn sovelluksen lisääminen ja sen käyttöönotto Business Centralissa

1. Valitse ![Lamppu, joka avaa Kerro-ominaisuuden.](media/ui-search/search_small.png "Kerro, mitä haluat tehdä") -kuvake, anna **Microsoft Entra -sovelluksen kortti** ja valitse liittyvä linkki.  
...
5. Valitse **Käyttöoikeuksien joukko** -kentässä käyttöoikeuksien joukoksi **Ohjelmointirajapinta – ympäristöjen välinen konserni**.
