...
---
# <a name="set-up-intercompany-transactions"></a><a name="set-up-intercompany-transactions"></a>Konsernitapahtumien määrittäminen
...
## <a name="overview-of-the-steps-to-get-started"></a><a name="overview-of-the-steps-to-get-started"></a>Yleistä aloitusvaiheista
...
## <a name="set-up-a-synchronization-partner"></a><a name="set-up-a-synchronization-partner"></a>Synkronointikumppanien määrittäminen
...
## <a name="set-up-the-intercompany-charts-of-accounts"></a><a name="set-up-the-intercompany-charts-of-accounts"></a>Konsernin tilikartan määrittäminen
...
### <a name="import-or-export-an-intercompany-chart-of-accounts"></a><a name="import-or-export-an-intercompany-chart-of-accounts"></a>Konsernin tilikartan tuominen tai vieminen
...
## <a name="map-the-intercompany-chart-of-accounts-to-your-companys-chart-of-accounts"></a><a name="map-the-intercompany-chart-of-accounts-to-your-companys-chart-of-accounts"></a>Konsernin tilikartan linkittäminen yrityksen tilikarttaan
...
## <a name="set-up-intercompany-dimensions"></a><a name="set-up-intercompany-dimensions"></a>Konsernin dimensioiden määrittäminen
...
### <a name="import-or-export-intercompany-dimensions"></a><a name="import-or-export-intercompany-dimensions"></a>Konsernin dimensioiden tuonti tai vienti
...
### <a name="map-intercompany-dimensions-to-your-companys-dimensions"></a><a name="map-intercompany-dimensions-to-your-companys-dimensions"></a>Konsernin dimensioiden linkittäminen oman yrityksen dimensioihin
...
## <a name="set-up-intercompany-general-journal-templates-and-batches"></a><a name="set-up-intercompany-general-journal-templates-and-batches"></a>Konsernin yleisen päiväkirjan mallien ja erien määrittäminen
...
## <a name="set-up-a-company-for-intercompany-transactions"></a><a name="set-up-a-company-for-intercompany-transactions"></a>Konsernitapahtumien yrityksen määrittäminen
...
## <a name="set-up-intercompany-partners"></a><a name="set-up-intercompany-partners"></a>Määritä konsernikumppanit
...
### <a name="set-up-intercompany-partners-as-customers-and-vendors"></a><a name="set-up-intercompany-partners-as-customers-and-vendors"></a>Konsernikumppanien määrittäminen asiakkaiksi ja toimittajiksi
...
### <a name="set-up-default-intercompany-partner-general-ledger-accounts"></a><a name="set-up-default-intercompany-partner-general-ledger-accounts"></a>Oletuskonsernikumppanin kirjanpitotilien määrittäminen
...
### <a name="auto-accept-transactions-from-intercompany-partners"></a><a name="auto-accept-transactions-from-intercompany-partners"></a>Hyväksy tapahtumia automaattisesti konsernikumppaneilta
...
### <a name="specify-the-bank-accounts-to-use-for-intercompany-partners"></a><a name="specify-the-bank-accounts-to-use-for-intercompany-partners"></a>Konsernikumppanien käyttöön tarkoitettujen pankkitilien määrittäminen
...
## <a name="troubleshoot-your-intercompany-setup"></a><a name="troubleshoot-your-intercompany-setup"></a>Konsernin määritysten vianmääritys
