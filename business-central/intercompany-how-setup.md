...
---
# <a name="set-up-intercompany-transactions" />Konsernitapahtumien määrittäminen
...
## <a name="overview-of-the-steps-to-get-started" />Yleistä aloitusvaiheista
...
## <a name="set-up-a-synchronization-partner" />Synkronointikumppanien määrittäminen
...
## <a name="set-up-the-intercompany-charts-of-accounts" />Konsernin tilikartan määrittäminen
...
### <a name="import-or-export-an-intercompany-chart-of-accounts" />Konsernin tilikartan tuominen tai vieminen
...
## <a name="map-the-intercompany-chart-of-accounts-to-your-companys-chart-of-accounts" />Konsernin tilikartan linkittäminen yrityksen tilikarttaan
...
## <a name="set-up-intercompany-dimensions" />Konsernin dimensioiden määrittäminen
...
### <a name="import-or-export-intercompany-dimensions" />Konsernin dimensioiden tuonti tai vienti
...
### <a name="map-intercompany-dimensions-to-your-companys-dimensions" />Konsernin dimensioiden linkittäminen oman yrityksen dimensioihin
...
## <a name="set-up-intercompany-general-journal-templates-and-batches" />Konsernin yleisen päiväkirjan mallien ja erien määrittäminen
...
## <a name="set-up-a-company-for-intercompany-transactions" />Konsernitapahtumien yrityksen määrittäminen
...
## <a name="set-up-intercompany-partners" />Määritä konsernikumppanit
...
### <a name="set-up-intercompany-partners-as-customers-and-vendors" />Konsernikumppanien määrittäminen asiakkaiksi ja toimittajiksi
...
### <a name="set-up-default-intercompany-partner-general-ledger-accounts" />Oletuskonsernikumppanin kirjanpitotilien määrittäminen
...
### <a name="auto-accept-transactions-from-intercompany-partners" />Hyväksy tapahtumia automaattisesti konsernikumppaneilta
...
### <a name="specify-the-bank-accounts-to-use-for-intercompany-partners" />Konsernikumppanien käyttöön tarkoitettujen pankkitilien määrittäminen
...
## <a name="troubleshoot-your-intercompany-setup" />Konsernin määritysten vianmääritys
