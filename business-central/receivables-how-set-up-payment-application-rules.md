...
ms.author: edupont
---
# <a name="set-up-rules-for-automatic-application-of-payments" />Automaattinen maksujen soveltamisen sääntöjen määrittäminen
...
## <a name="to-set-up-a-payment-application-rule" />Maksun sovellussäännön asettaminen
...
## <a name="see-related-microsoft-trainingtrainingmodulesreconciliation-journals-dynamics--business-centralindex" />Lue aiheeseen liittyen [Microsoftin koulutukset](/training/modules/reconciliation-journals-dynamics-365-business-central/index)
