...
---
# <a name="assemble-items"></a><a name="assemble-items"></a>Kokoa nimikkeet
...
## <a name="to-assemble-an-item-to-stock"></a><a name="to-assemble-an-item-to-stock"></a>Nimikkeen kokoaminen varastoon
