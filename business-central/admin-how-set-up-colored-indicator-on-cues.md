...
ms.author: jswymer
---
# <a name="set-up-a-colored-indicator-on-cues-for-the-company-or-individual-users" />Pinojen värillisen ilmaisimen määrittäminen yrityskäyttäjille tai yksittäisille käyttäjille
...
### <a name="to-set-up-colored-indicators-on-cues" />Värillisten ilmaisinten määrittäminen pinoissa
