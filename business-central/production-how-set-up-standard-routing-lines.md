...
ms.author: edupont
---
# <a name="set-up-standard-routing-lines" />Vakioreititysrivien määrittäminen
...
## <a name="to-set-up-a-standard-task" />Vakiotehtävän määrittäminen
...
## <a name="to-add-a-standard-task-to-an-operation" />Vakiotehtävän lisääminen toimintoon
