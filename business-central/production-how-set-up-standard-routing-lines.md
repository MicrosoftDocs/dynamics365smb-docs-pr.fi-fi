...
description: Tietoja vakiotehtävien määrittämisestä ja vakiotehtävien lisäämisestä toimintoihin reititysten ylläpidon helpottamiseksi.
author: SorenGP
ms.topic: conceptual
ms.devlang: na
ms.tgt_pltfrm: na
...
ms.author: edupont
---
# <a name="set-up-standard-routing-lines"></a><a name="set-up-standard-routing-lines"></a><a name="set-up-standard-routing-lines"></a>Vakioreititysrivien määrittäminen
...
## <a name="to-set-up-a-standard-task"></a><a name="to-set-up-a-standard-task"></a><a name="to-set-up-a-standard-task"></a>Vakiotehtävän määrittäminen
...
## <a name="to-add-a-standard-task-to-an-operation"></a><a name="to-add-a-standard-task-to-an-operation"></a><a name="to-add-a-standard-task-to-an-operation"></a>Vakiotehtävän lisääminen toimintoon
