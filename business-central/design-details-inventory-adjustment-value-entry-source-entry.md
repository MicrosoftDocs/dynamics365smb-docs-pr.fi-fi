...
# <a name="posting-date-on-adjustment-value-entry-compared-to-the-source-entry" />Oikaisun arvon tapahtuman kirjauspäivämäärä verrattuna lähdetapahtumaan
...
## <a name="revaluation-scenario" />Uudelleenarvostusskenaario
