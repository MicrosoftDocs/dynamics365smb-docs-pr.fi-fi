...
ms.author: edupont
---
# <a name="assign-default-bins-to-items" />Oletusvarastopaikkojen määrittäminen nimikkeille
...
## <a name="to-assign-a-default-bin-to-an-item" />Oletusvarastopaikan määrittäminen nimikkeelle
...
## <a name="to-change-the-default-bin-for-an-item" />Nimikkeen oletusvarastopaikan muuttaminen
