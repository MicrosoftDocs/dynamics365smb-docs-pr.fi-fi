...
ms.author: edupont
---
# <a name="assign-default-bins-to-items"></a><a name="assign-default-bins-to-items"></a><a name="assign-default-bins-to-items"></a>Oletusvarastopaikkojen määrittäminen nimikkeille
...
## <a name="to-assign-a-default-bin-to-an-item"></a><a name="to-assign-a-default-bin-to-an-item"></a><a name="to-assign-a-default-bin-to-an-item"></a>Oletusvarastopaikan määrittäminen nimikkeelle
...
## <a name="to-change-the-default-bin-for-an-item"></a><a name="to-change-the-default-bin-for-an-item"></a><a name="to-change-the-default-bin-for-an-item"></a>Nimikkeen oletusvarastopaikan muuttaminen
