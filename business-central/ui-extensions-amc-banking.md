...
# <a name="use-the-amc-banking-365-fundamentals-extension"></a><a name="use-the-amc-banking-365-fundamentals-extension"></a><a name="use-the-amc-banking-365-fundamentals-extension"></a>Käytä AMC Banking 365 Fundamentals -laajennusta
...
## <a name="use-our-demonstration-account"></a><a name="use-our-demonstration-account"></a><a name="use-our-demonstration-account"></a>Esittelytilin käyttäminen
...
## <a name="setting-up-the-extension"></a><a name="setting-up-the-extension"></a><a name="setting-up-the-extension"></a>Laajennuksen määrittäminen
...
### <a name="to-set-up-the-required-permission-sets"></a><a name="to-set-up-the-required-permission-sets"></a><a name="to-set-up-the-required-permission-sets"></a>Tarvittavien käyttöoikeusjoukkojen määrittäminen
...
### <a name="to-connect-the-extension-to-amc-banking"></a><a name="to-connect-the-extension-to-amc-banking"></a><a name="to-connect-the-extension-to-amc-banking"></a>Voit liittää laajennuksen AMC Bankingiin
...
### <a name="to-connect-bank-accounts-to-the-extension"></a><a name="to-connect-bank-accounts-to-the-extension"></a><a name="to-connect-bank-accounts-to-the-extension"></a>Pankkitilit voidaan liittää laajennuksen
...
## <a name="use-the-extension"></a><a name="use-the-extension"></a><a name="use-the-extension"></a>Käytä laajennusta
...
### <a name="to-export-data-and-submit-it-to-your-bank"></a><a name="to-export-data-and-submit-it-to-your-bank"></a><a name="to-export-data-and-submit-it-to-your-bank"></a>Tietojen vieminen ja lähettäminen pankkiin
...
### <a name="to-import-and-apply-the-converted-file"></a><a name="to-import-and-apply-the-converted-file"></a><a name="to-import-and-apply-the-converted-file"></a>Muunnetun tiedoston tuominen ja käyttäminen
