...
## <a name="use-our-demonstration-account" />Esittelytilin käyttäminen
...
## <a name="setting-up-the-extension" />Laajennuksen määrittäminen
...
### <a name="to-set-up-the-required-permission-sets" />Tarvittavien käyttöoikeusjoukkojen määrittäminen
...
### <a name="to-connect-the-extension-to-amc-banking" />Voit liittää laajennuksen AMC Bankingiin
...
### <a name="to-connect-bank-accounts-to-the-extension" />Pankkitilit voidaan liittää laajennuksen
...
## <a name="use-the-extension" />Käytä laajennusta
...
### <a name="to-export-data-and-submit-it-to-your-bank" />Tietojen vieminen ja lähettäminen pankkiin
...
### <a name="to-import-and-apply-the-converted-file" />Muunnetun tiedoston tuominen ja käyttäminen
