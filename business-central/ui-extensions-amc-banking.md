...
# <a name="use-the-amc-banking-365-fundamentals-extension"></a>Käytä AMC pankki 365 fundamentals -laajennusta
...
Laajennuksen käytön aloittaminen edellyttää vain muutamia helppoja vaiheita, ja avustettu asennusopas muodostaa yhteyden ja käynnistää laajennuksen. Oppaasta on hyötyä esimerkiksi pankin tiliotteen vienti-/tuontiasetusten tietojen vaihdon määritysten asentamisessa sekä hyvitysten siirtoviestien numerosarjojen aloittamisessa.  
...
3. Valitse Nimi-kentässä **pankin** vaatimaa muotoa.  
