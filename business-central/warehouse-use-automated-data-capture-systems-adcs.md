...
---
# <a name="use-automated-data-capture-systems-adcs"></a><a name="use-automated-data-capture-systems-adcs"></a><a name="use-automated-data-capture-systems-adcs"></a>Käytä ADCS (Automated Data Capture System) -järjestelmää
...
## <a name="to-enable-web-services-for-adcs"></a><a name="to-enable-web-services-for-adcs"></a><a name="to-enable-web-services-for-adcs"></a>Voit ottaa ADCS-verkkopalvelut käyttöön

Jotta voisit käyttää automaattista tiedonkeruujärjestelmää, sinun on otettava ADCS-verkkopalvelu käyttöön.  

## <a name="to-enable-and-publish-the-adcs-web-service"></a><a name="to-enable-and-publish-the-adcs-web-service"></a><a name="to-enable-and-publish-the-adcs-web-service"></a>ADCS-verkkopalvelun käyttöönotto ja julkaiseminen
...
## <a name="to-set-up-a-warehouse-to-use-adcs"></a><a name="to-set-up-a-warehouse-to-use-adcs"></a><a name="to-set-up-a-warehouse-to-use-adcs"></a>Fyysisen varaston määrittäminen ADCS-järjestelmän käyttämistä varten
...
## <a name="to-specify-an-item-to-use-adcs"></a><a name="to-specify-an-item-to-use-adcs"></a><a name="to-specify-an-item-to-use-adcs"></a>Nimikkeen määrittäminen käyttämään ADCS-järjestelmää
...
## <a name="to-add-an-adcs-user"></a><a name="to-add-an-adcs-user"></a><a name="to-add-an-adcs-user"></a>ADCS-käyttäjän lisääminen
...
### <a name="to-specify-that-a-warehouse-employee-is-an-adcs-user"></a><a name="to-specify-that-a-warehouse-employee-is-an-adcs-user"></a><a name="to-specify-that-a-warehouse-employee-is-an-adcs-user"></a>Varastotyöntekijän määrittäminen ADCS-käyttäjäksi
...
## <a name="to-create-and-customize-miniforms"></a><a name="to-create-and-customize-miniforms"></a><a name="to-create-and-customize-miniforms"></a>Pienoislomakkeiden luominen ja mukauttaminen
...
### <a name="to-create-a-miniform-for-adcs"></a><a name="to-create-a-miniform-for-adcs"></a><a name="to-create-a-miniform-for-adcs"></a>Luo ADCS-pienoislomake
...
### <a name="to-customize-miniform-functions"></a><a name="to-customize-miniform-functions"></a><a name="to-customize-miniform-functions"></a>Mukauta pienoislomakkeen toiminnot
