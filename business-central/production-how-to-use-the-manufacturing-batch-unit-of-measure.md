...
ms.author: edupont
---
# <a name="work-with-manufacturing-batch-units-of-measure" />Tuotantoerän mittayksiköiden käyttäminen
...
## <a name="to-create-a-production-bom-using-a-batch-unit-of-measure" />Tuotannon tuoterakenteen luominen erän mittayksikköä käyttäen
...
## <a name="to-calculate-a-manufacturing-batch-unit-of-measure-on-a-production-order" />Tuotantotilauksen tuotantoerän mittayksikön laskeminen
