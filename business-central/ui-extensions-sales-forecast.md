...
# <a name="the-sales-and-inventory-forecast-extension" />Myynti- ja varastoennustelaajennus
...
## <a name="setting-up-forecasting" />Ennusteiden määrittäminen
...
## <a name="use-the-forecasts" />Ennusteiden käyttäminen
...
## <a name="a-nameanchortext-acreate-and-use-your-own-predictive-web-service-for-sales-and-inventory-forecasts" /><a name="AnchorText"> </a>Myynnin ja varaston ennusteiden ennakoivan verkkopalvelun luominen ja käyttäminen
