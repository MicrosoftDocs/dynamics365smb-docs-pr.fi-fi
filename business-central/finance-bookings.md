...
ms.author: edupont
---
# <a name="bulk-invoicing-for-microsoft-bookings-in-"></a><a name="bulk-invoicing-for-microsoft-bookings-in-"></a><a name="bulk-invoicing-for-microsoft-bookings-in-"></a>Microsoft Bookingsin massalaskutus [!INCLUDE[prod_short](includes/prod_short.md)]issa
...
## <a name="connect-to-bookings"></a><a name="connect-to-bookings"></a><a name="connect-to-bookings"></a>Yhdistäminen Bookings-sovellukseen
...
## <a name="invoice-appointments"></a><a name="invoice-appointments"></a><a name="invoice-appointments"></a>Laskuta tapaamiset
