...
ms.author: edupont
---
# <a name="depreciation-methods-for-fixed-assets" />Käyttöomaisuuden poistomenetelmät
...
## <a name="straight-line-depreciation" />Tasapoisto
...
### <a name="depreciation-period" />Poistojakso
...
### <a name="fixed-yearly-percentage" />Kiinteä vuosittainen prosentti
...
### <a name="fixed-yearly-amount" />Kiinteä vuosittainen summa
...
### <a name="example---straight-line-depreciation" />Esimerkki - Tasapoisto
...
## <a name="half-year-convention-depreciation" />Poisto puolivuotissopimusta käyttämällä
...
### <a name="example---half-year-convention-depreciation" />Esimerkki – Poisto puolivuotissopimusta käyttämällä
...
## <a name="duplicating-entries-to-more-depreciation-books" />Tapahtumien monistaminen lisäpoistokirjoihin
