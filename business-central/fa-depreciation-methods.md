...
ms.author: edupont
---
# <a name="depreciation-methods-for-fixed-assets"></a><a name="depreciation-methods-for-fixed-assets"></a>Käyttöomaisuuden poistomenetelmät
...
## <a name="straight-line-depreciation"></a><a name="straight-line-depreciation"></a>Tasapoisto
...
### <a name="depreciation-period"></a><a name="depreciation-period"></a>Poistojakso
...
### <a name="fixed-yearly-percentage"></a><a name="fixed-yearly-percentage"></a>Kiinteä vuosittainen prosentti
...
### <a name="fixed-yearly-amount"></a><a name="fixed-yearly-amount"></a>Kiinteä vuosittainen summa
...
### <a name="example---straight-line-depreciation"></a><a name="example---straight-line-depreciation"></a>Esimerkki - Tasapoisto
...
## <a name="declining-balance-1-depreciation"></a><a name="declining-balance-1-depreciation"></a>Menojäännöspoisto 1 -poisto
...
### <a name="example---declining-balance-1-depreciation"></a><a name="example---declining-balance-1-depreciation"></a>Esimerkki - Menojäännöspoisto 1 -poisto
...
## <a name="declining-balance-2-depreciation"></a><a name="declining-balance-2-depreciation"></a>Menojäännöspoisto 2 -poisto
...
### <a name="example---declining-balance-2-depreciation"></a><a name="example---declining-balance-2-depreciation"></a>Esimerkki - Menojäännöspoisto 2 -poisto
...
## <a name="db1sl-depreciation"></a><a name="db1sl-depreciation"></a>MJP1/TP-poisto
...
### <a name="example---db1-sl-depreciation"></a><a name="example---db1-sl-depreciation"></a>Esimerkki - MJP1/TP-poisto
...
## <a name="half-year-convention-depreciation"></a><a name="half-year-convention-depreciation"></a>Poisto puolivuotissopimusta käyttämällä
...
### <a name="example---half-year-convention-depreciation"></a><a name="example---half-year-convention-depreciation"></a>Esimerkki – Poisto puolivuotissopimusta käyttämällä
...
## <a name="example---db1sl-depreciation-using-half-year-convention"></a><a name="example---db1sl-depreciation-using-half-year-convention"></a>Esimerkki – MJP1/TP-poisto puolivuotissopimusta käyttämällä
...
## <a name="duplicating-entries-to-more-depreciation-books"></a><a name="duplicating-entries-to-more-depreciation-books"></a>Tapahtumien monistaminen lisäpoistokirjoihin
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Lue aiheeseen liittyen [Microsoftin koulutukset](/training/modules/configure-depreciation-books/)
