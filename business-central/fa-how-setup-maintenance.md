...
ms.author: edupont
---
# <a name="set-up-fixed-asset-maintenance" />Käyttöomaisuuden huollon määrittäminen
...
## <a name="to-set-up-general-maintenance-information" />Yleisten kunnossapitotietojen määrittäminen
...
## <a name="to-set-up-maintenance-codes" />Kunnossapitokoodien määrittäminen
...
## <a name="to-set-up-maintenance-expense-accounts" />Kunnossapitokustannusten tilien määrittäminen
