...
ms.author: edupont
---
# <a name="set-up-fixed-asset-maintenance"></a><a name="set-up-fixed-asset-maintenance"></a>Käyttöomaisuuden huollon määrittäminen
...
## <a name="to-set-up-general-maintenance-information"></a><a name="to-set-up-general-maintenance-information"></a>Yleisten kunnossapitotietojen määrittäminen
...
## <a name="to-set-up-maintenance-codes"></a><a name="to-set-up-maintenance-codes"></a>Kunnossapitokoodien määrittäminen
...
## <a name="to-set-up-maintenance-expense-accounts"></a><a name="to-set-up-maintenance-expense-accounts"></a>Kunnossapitokustannusten tilien määrittäminen
