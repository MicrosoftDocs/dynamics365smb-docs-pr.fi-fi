...
ms.author: edupont
---
# <a name="subcontract-manufacturing" />Tuotanto alihankintana
...
## <a name="subcontract-work-centers" />Alihankinnan tuotantosolut
...
### <a name="subcontract-work-center-fields" />Alihankinnan tuotantosolukentät
...
### <a name="routings-that-use-subcontract-work-centers" />Alihankinnan tuotantokeskuksia käyttävät reititykset
...
## <a name="calculate-subcontracting-worksheets-and-create-subcontract-purchase-orders" />Alihankintatyökirjan laskeminen ja alihankkijan ostotilausten luominen
...
### <a name="to-calculate-the-subcontracting-worksheet" />Alihankintatyökirjan laskeminen
...
### <a name="to-create-the-subcontract-purchase-order" />Luo alihankkijan ostotilaus
1.  Valitse ![Lamppu, joka avaa Kerro-ominaisuuden.](media/ui-search/search_small.png "Kerro, mitä haluat tehdä") -kuvake, syötä **Alihankintatyökirja** ja valitse sitten vastaava linkki.  
...
## <a name="posting-subcontract-purchase-orders" />Alihankkijan ostotilauksen kirjaaminen
...
## <a name="to-post-a-subcontract-purchase-order" />Alihankkijan ostotilauksen kirjaaminen
