...
# <a name="data-ownership-models" />Tietojen omistusmallit
...
## <a name="team-ownership" />Tiimin omistus
...
## <a name="choosing-a-different-business-unit" />Toisen liiketoimintayksikön valitseminen
...
## <a name="person-ownership" />Henkilön omistus
