...
ms.author: edupont
---
# <a name="set-up-shipment-methods"></a><a name="set-up-shipment-methods"></a>Toimitusehtojen määrittäminen
...
## <a name="to-set-up-a-shipment-method"></a><a name="to-set-up-a-shipment-method"></a>Toimitustapojen määrittäminen
