...
ms.author: bholtorf
---
# <a name="manage-notifications"></a><a name="manage-notifications"></a><a name="manage-notifications"></a>Ilmoitusten hallinta
...
## <a name="to-turn-notifications-on-or-off-and-control-when-they-are-sent"></a><a name="to-turn-notifications-on-or-off-and-control-when-they-are-sent"></a><a name="to-turn-notifications-on-or-off-and-control-when-they-are-sent"></a>Ilmoitusten ottaminen käyttöön ja käytöstä poistaminen sekä lähetystilanteiden hallinta
