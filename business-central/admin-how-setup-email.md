...
Kun olet rekisteröinyt sovelluksen Azure-portaalissa, voit [!INCLUDE[prod_short](includes/prod_short.md)]issa käyttää **Sähköpostisovelluksen AAD-rekisteröinti** -sivua yhdistääksesi [!INCLUDE[prod_short](includes/prod_short.md)]in siihen.
