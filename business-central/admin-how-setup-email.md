...
# <a name="set-up-email"></a><a name="set-up-email"></a>Määritä sähköposti
...
## <a name="requirements"></a><a name="requirements"></a>Tarpeet
...
## <a name="adding-email-accounts"></a><a name="adding-email-accounts"></a>Sähköpostitilien lisääminen
...
## <a name="using-smtp"></a><a name="using-smtp"></a>SMTP:n käyttö
...
## <a name="add-email-accounts"></a><a name="add-email-accounts"></a>Sähköpostitilien lisääminen
...
is this still true?-->
## <a name="assign-email-scenarios-to-email-accounts"></a><a name="assign-email-scenarios-to-email-accounts"></a>Sähköpostiskenaarioiden määritys sähköpostitileille
...
## <a name="set-up-view-policies"></a><a name="set-up-view-policies"></a>Näkymäkäytäntöjen määrittäminen
...
## <a name="specify-how-many-messages-an-account-can-send-per-minute"></a><a name="specify-how-many-messages-an-account-can-send-per-minute"></a>Määritä, montako viestiä tili voi lähettää minuutissa
...
## <a name="set-up-reusable-email-texts-and-layouts"></a><a name="set-up-reusable-email-texts-and-layouts"></a>Uudelleenkäytettävien sähköpostitekstien ja -asettelujen määrittäminen
...
## <a name="use-a-substitute-sender-address-on-outbound-email-messages"></a><a name="use-a-substitute-sender-address-on-outbound-email-messages"></a>Korvaavan lähettäjän osoitteen käyttäminen lähtevissä sähköpostiviesteissä
...
## <a name="set-up-document-sending-profiles"></a><a name="set-up-document-sending-profiles"></a>Asiakirjan lähetysprofiilien määrittäminen
...
## <a name="optional-set-up-email-logging-in-exchange-online"></a><a name="optional-set-up-email-logging-in-exchange-online"></a>Valinnainen: Sähköpostin lokiinkirjauksen määrittäminen Exchange Onlinessa
...
## <a name="setting-up-email-for-business-central-on-premises"></a><a name="setting-up-email-for-business-central-on-premises"></a>Sähköpostin määrittäminen Business Central On-Premises -versiossa
...
### <a name="create-an-app-registration-for-business-central-in-azure-portal"></a><a name="create-an-app-registration-for-business-central-in-azure-portal"></a>Business Centralin sovelluksen rekisteröinnin luonti Azure-portaalissa
...
### <a name="connect--to-your-app-registration"></a><a name="connect--to-your-app-registration"></a>Yhdistä [!INCLUDE[prod_short](includes/prod_short.md)] sovellusrekisteröintiisi
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Lue aiheeseen liittyen [Microsoftin koulutukset](/training/modules/set-up-email/)
