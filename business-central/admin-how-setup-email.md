...
> [!NOTE]
> Jos käytät S2S (Service-to-service) -todennusta, Microsoft 365 ja nykyiset käyttäjäyhdistimet eivät voi todentaa käyttäjää, kun hän lähettää myynti- tai ostoasiakirjan sähköpostitse. Kun joku lähettää asiakirjan, näyttöön tulee seuraava virhesanoma:
>
> "Sinulla ei ole lupaa käyttää tätä resurssia: https:\//graph.microsoft.com/.default. Ota yhteys järjestelmänvalvojaan."
>
> Ongelman aiheuttivat sähköpostin lähettävien asiakirjojen ohjelmointirajapinta-asiakirjoissa olevat sidotut toiminnot. Lisätietoja sidotuista toiminnoista on kohdassa [Sidotut toiminnot](/dynamics365/business-central/dev-itpro/api-reference/v2.0/resources/dynamics_salesinvoice#bound-actions). 
>
> Jos haluat käyttää S2S-todennusta ja sähköpostitoimintoja, käytä SMTP-yhdistinasetusta.
<br><br>
...
|Microsoft Graph / Mail.Send.Shared|Delegoitu|Jaettu postilaatikko|
