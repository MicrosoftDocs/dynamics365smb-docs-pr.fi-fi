...
# <a name="basic-reports-and-documents-output-quick-start" />Perusraporttien ja asiakirjojen tulostuksen pika-aloitus
...
## <a name="add-your-company-logo-to-documents" />Lisää yrityksesi logo asiakirjoihin
...
## <a name="run-reports" />Raporttien suorittaminen
...
## <a name="save-reports-as-pdf-excel-or-word-documents" />Tallentaminen PDF-, Excel- tai Word-tiedostoina
...
### <a name="change-report-and-document-layouts" />Muutosraportti ja asiakirjojen asettelu
