...
ms.author: edupont
---
# <a name="work-with-item-attributes" />Nimikkeen määritteiden käsitteleminen
...
## <a name="create-item-attributes" />Nimikkeen määritteiden luominen
...
## <a name="create-values-for-item-attributes-of-type-option" />Arvojen luominen nimikkeen määritteille, joiden tyyppi on Asetus
...
## <a name="assign-item-attributes-to-items" />Nimikkeen määritteiden määrittäminen nimikkeille
...
## <a name="assign-item-attributes-to-item-categories" />Nimikkeen määritteiden määrittäminen nimikeluokille
...
## <a name="filter-by-item-attributes" />Suodattaminen nimikkeen määritteiden mukaan
