...
ms.author: edupont
---
# <a name="setup-best-practices-reordering-policies" />Asetukset - parhaat käytännöt: uusintatilaustavat
...
## <a name="see-related-microsoft-trainingtrainingpathsreplenish-items-dynamics-365-business-central" />Lue aiheeseen liittyen [Microsoftin koulutukset](/training/paths/replenish-items-dynamics-365-business-central/)
