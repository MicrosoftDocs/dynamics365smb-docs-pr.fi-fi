...
# <a name="intelligent-insights-and-cloud-migration-on-premises-only"></a>[!INCLUDE[prod_short](includes/prod_short.md)] Onlinen älykkäät tiedot
...
## <a name="viewing-insights-in--online"></a>[!INCLUDE[prod_short](includes/prod_short.md)] Onlinen merkityksellisten tietojen näyttäminen
