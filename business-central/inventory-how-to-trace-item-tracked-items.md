...
description: 'Voit nähdä, missä nimikeseurannassa olevaa nimikettä on käytetty. Voit esimerkiksi tarkastella sitä, miten ja milloin se vastaanotettiin, tuotettiin tai palautettiin Nimikkeen jäljitys- ja Etsi tapahtumat -toimintojen avulla.'
author: brentholtorf
ms.topic: conceptual
ms.devlang: al
...
Näistä ominaisuuksista voi olla hyötyä laaduntarkastuksessa, kun haluat tietää, kuka asiakas vastaanotti tietyllä eränumerolla varustettuja tuotteita, tai kun on selvitettävä, mistä erästä viallinen komponentti on peräisin.  
  ...
  **Etsi tapahtumat -** sivulla ei näy tapahtumien järjestystä, mutta voit tarkastella sarja- tai eränumeron kaikkia tietueita, sekä kirjattuja tapahtumia että avoimia tietueita.  
...
2. Valitse **Etsi nimikeviittauksia**.
