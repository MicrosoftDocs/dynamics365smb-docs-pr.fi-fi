...
ms.author: edupont
---
# <a name="trace-item-tracked-items"></a><a name="trace-item-tracked-items"></a>Nimikeseurannan nimikkeiden jäljittäminen
...
## <a name="to-trace-item-tracked-items"></a><a name="to-trace-item-tracked-items"></a>Nimikeseurannan nimikkeiden jäljittäminen
...
## <a name="to-find-item-tracked-items-with-find-entries"></a><a name="to-find-item-tracked-items-with-find-entries"></a>Voit etsiä nimikeseurannassa olevia nimikkeitä Etsi tapahtumat -toiminnolla
