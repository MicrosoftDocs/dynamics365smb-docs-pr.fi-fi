...
---
# <a name="work-with-dimensions"></a><a name="work-with-dimensions"></a><a name="work-with-dimensions"></a>Dimensioiden käyttäminen
...
## <a name="analyzing-by-dimensions"></a><a name="analyzing-by-dimensions"></a><a name="analyzing-by-dimensions"></a>Analyysi dimensioittain
...
## <a name="dimension-sets"></a><a name="dimension-sets"></a><a name="dimension-sets"></a>Dimensioyhdistelmät
...
## <a name="setting-up-dimensions"></a><a name="setting-up-dimensions"></a><a name="setting-up-dimensions"></a>Dimensioiden luominen
...
### <a name="to-set-up-default-dimension-priorities"></a><a name="to-set-up-default-dimension-priorities"></a><a name="to-set-up-default-dimension-priorities"></a>Oletus dimensioprioriteettien luominen
...
### <a name="to-set-up-dimension-combinations"></a><a name="to-set-up-dimension-combinations"></a><a name="to-set-up-dimension-combinations"></a>Dimensioiden kombinaatioiden luominen
...
### <a name="to-set-up-global-and-shortcut-dimensions"></a><a name="to-set-up-global-and-shortcut-dimensions"></a><a name="to-set-up-global-and-shortcut-dimensions"></a>Globaalien dimensioiden ja pikadimensioiden määrittäminen
...
#### <a name="to-change-global-dimensions"></a><a name="to-change-global-dimensions"></a><a name="to-change-global-dimensions"></a>Globaalien dimensioiden muuttaminen
...
### <a name="example-of-dimension-setup"></a><a name="example-of-dimension-setup"></a><a name="example-of-dimension-setup"></a>Esimerkki dimension asetuksista
...
## <a name="getting-an-overview-of-dimensions-used-multiple-times"></a><a name="getting-an-overview-of-dimensions-used-multiple-times"></a><a name="getting-an-overview-of-dimensions-used-multiple-times"></a>Useita kertoja käytettyjen dimensioiden yhteenvedon hakeminen
...
## <a name="use-dimensions"></a><a name="use-dimensions"></a><a name="use-dimensions"></a>Dimensioiden käyttö
...
### <a name="to-view-global-dimensions-in-ledger-entry-pages"></a><a name="to-view-global-dimensions-in-ledger-entry-pages"></a><a name="to-view-global-dimensions-in-ledger-entry-pages"></a>Globaalien dimensioiden tarkastelu tapahtumasivuilla
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Lue aiheeseen liittyen [Microsoftin koulutukset](/training/modules/dimensions-dynamics-365-business-central/index)
