...
ms.author: edupont
---
# <a name="register-new-items"></a><a name="register-new-items"></a>Uusien nimikkeiden rekisteröiminen
...
## <a name="to-create-a-new-item-card"></a><a name="to-create-a-new-item-card"></a>Uuden nimikekortin luominen
...
### <a name="to-save-the-item-card-as-a-template"></a><a name="to-save-the-item-card-as-a-template"></a>Nimikekortin tallentaminen mallina
...
### <a name="items-used-in-production-orders"></a><a name="items-used-in-production-orders"></a>Tuotantotilauksissa käytetyt nimikkeet
...
## <a name="to-set-up-multiple-vendors-for-an-item"></a><a name="to-set-up-multiple-vendors-for-an-item"></a>Useiden toimittajien määrittäminen nimikkeille
...
## <a name="set-up-item-substitutions"></a><a name="set-up-item-substitutions"></a>Määritä nimikekorvaukset
...
### <a name="to-make-an-item-substitution"></a><a name="to-make-an-item-substitution"></a>Nimikkeen korvaamisen toteuttaminen
...
## <a name="deleting-item-cards"></a><a name="deleting-item-cards"></a>Nimikekorttien poistaminen
...
## <a name="manage-inventory-in-warehouses"></a><a name="manage-inventory-in-warehouses"></a>Hallitse varastoa fyysisessä varastossa
...
## <a name="planning"></a><a name="planning"></a>Suunnitt.
