...
## <a name="set-a-printer-as-a-default-printer-for-all-print-jobs" />Tulostimen määrittäminen kaikkien tulostustöiden oletustulostimeksi
...
## <a name="set-a-default-printer-for-specific-reports" />Oletustulostimen määrittäminen tietyille raporteille
...
## <a name="choosing-the-printer-when-running-a-report" />Tulostimen valitseminen raporttia suoritettaessa
...
## <a name="sizing-print-jobs" />Tulostustöiden mitoitus
