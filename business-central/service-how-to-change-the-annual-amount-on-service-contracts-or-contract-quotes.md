...
ms.author: bholtorf
---
# <a name="change-the-annual-amount-on-service-contracts-or-contract-quotes"></a><a name="change-the-annual-amount-on-service-contracts-or-contract-quotes"></a><a name="change-the-annual-amount-on-service-contracts-or-contract-quotes"></a>Huoltosopimuksen tai sopimustarjouksen vuosittaisen summan muuttaminen
...
## <a name="to-change-the-annual-amount-of-the-service-contract-or-contract-quote"></a><a name="to-change-the-annual-amount-of-the-service-contract-or-contract-quote"></a><a name="to-change-the-annual-amount-of-the-service-contract-or-contract-quote"></a>Huoltosopimuksen tai sopimustarjouksen vuosittaisen summan muuttaminen
...
## <a name="distributing-differences-between-new-and-calculated-annual-amounts"></a><a name="distributing-differences-between-new-and-calculated-annual-amounts"></a><a name="distributing-differences-between-new-and-calculated-annual-amounts"></a>Uuden ja lasketun vuosittaisen summan eron jakaminen
...
### <a name="even-distribution"></a><a name="even-distribution"></a><a name="even-distribution"></a>Tasainen jako
...
### <a name="distribution-based-on-line-amount"></a><a name="distribution-based-on-line-amount"></a><a name="distribution-based-on-line-amount"></a>Jako rivisumman perusteella
...
### <a name="distribution-based-on-profit"></a><a name="distribution-based-on-profit"></a><a name="distribution-based-on-profit"></a>Tuottoon perustuva jako
...
#### <a name="example-2"></a><a name="example-2"></a><a name="example-2"></a>Esimerkki
