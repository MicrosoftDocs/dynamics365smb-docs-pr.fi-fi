...
ms.author: bholtorf
---
# <a name="change-the-annual-amount-on-service-contracts-or-contract-quotes" />Huoltosopimuksen tai sopimustarjouksen vuosittaisen summan muuttaminen
...
## <a name="to-change-the-annual-amount-of-the-service-contract-or-contract-quote" />Huoltosopimuksen tai sopimustarjouksen vuosittaisen summan muuttaminen
...
## <a name="distributing-differences-between-new-and-calculated-annual-amounts" />Uuden ja lasketun vuosittaisen summan eron jakaminen
...
### <a name="even-distribution" />Tasainen jako
...
### <a name="distribution-based-on-line-amount" />Jako rivisumman perusteella
...
### <a name="distribution-based-on-profit" />Tuottoon perustuva jako
