...
ms.author: edupont
---
# <a name="remove-and-reapply-item-ledger-entries" />Nimiketapahtumien poistaminen ja uudelleenkohdistaminen
...
## <a name="to-remove-an-item-application-by-using-the-application-worksheet" />Nimikkeen kohdistuksen ja kohdistustyökirjan poistaminen
...
## <a name="to-reapply-an-item-application-by-using-the-application-worksheet" />Nimikkeen kohdistuksen ja kohdistustyökirjan luominen
