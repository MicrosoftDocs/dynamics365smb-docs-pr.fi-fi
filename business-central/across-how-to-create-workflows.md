...
---
# <a name="create-workflows-to-connect-tasks-in-business-processes" />Työnkulkujen luominen liiketoimintaprosessin yhdistämistehtäviä varten
...
## <a name="to-create-a-workflow" />Työnkulun luominen
...
## <a name="example-of-creating-a-new-workflow-using-existing-events" />Esimerkki uuden työnkulun luomisesta aiemmin luotujen tapahtumien avulla
