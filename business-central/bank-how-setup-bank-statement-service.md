...
Envestnet Yodlee Bank Feeds -palvelu on asennettu [!INCLUDE[prod_short](includes/prod_short.md)]in online-versioon laajennuksena. Se on valmis käyttöönottoa varten tuetuissa maissa ja tuetuilla alueilla. Lisätietoja on kohdassa [[!INCLUDE[prod_short](includes/prod_short.md)] -ohjelman mukauttaminen laajennusten avulla](ui-extensions.md).
