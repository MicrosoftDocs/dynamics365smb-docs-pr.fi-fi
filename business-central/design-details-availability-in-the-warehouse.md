...
---
# <a name="design-details-availability-in-the-warehouse" />Rakennetiedot: saatavuus varastossa
...
## <a name="bin-content-and-reservations" />Varastopaikan sisältö ja varaukset
...
## <a name="quantity-available-to-pick" />Saatavilla oleva poimintamäärä
...
### <a name="calculating-the-quantity-available-to-pick" />Poimittavissa olevan määrän laskeminen
...
## <a name="quantity-available-to-reserve" />Varattavissa oleva määrä
...
### <a name="calculating-the-quantity-available-to-reserve" />Varattavissa olevaan määrän laskeminen
