...
1. Varastopaikkoja käytettäessä on määritettävä ainakin yksi laiturointivarastopaikka. Laiturointialue määritetään, jos käytössä on ohjattu hyllytys ja poiminta.  
    ...
    Laiturointivarastopaikalle on valittu **Laiturointivarastopaikka**-kenttä. Jos haluat lisätietoja varastopaikoista, siirry [Luo varastopaikat](warehouse-how-to-create-individual-bins.md) -kenttään.  

    Jos käytät alueita, luo alue laiturointivarastopaikoille ja valitse **Laiturointivar.paikan alue** -kenttä. Jos käytät ohjattua hyllytystä ja poimintaa, valitse varastopaikan tyyppi **poiminta** valittuna. Voit käyttää esimerkiksi *POIMINTAA* tai *HYLLYTYSPOIMINTAA*. Jos haluat lisätietoja alueista ja varastopaikan tyypeistä, siirry kohtiin [Sijaintien määrittäminen varastopaikkojen käyttöä varten](warehouse-how-to-set-up-locations-to-use-bins.md) ja [varastopaikan tyyppien määrittäminen](warehouse-how-to-set-up-bin-types.md).  
...
4. Ota **Käytä laiturointia** vaihtopainikkeella käyttöön **Fyysinen varasto** -pikavälilehdessä ja täytä **Laituroinnin eräpvm lask.** -kenttään jakso, jonka ajalta laiturointimahdollisuuksia etsitään.
    ...
    **Käytä laiturointia** -vaihtoehto on käytettävissä vain, jos **Vaadi kuittaus**-, **Vaadi toimitus**-, **Vaadi poiminta**- ja **Vaadi hyllytys** -kenttiin on asetettu valintamerkki.  
