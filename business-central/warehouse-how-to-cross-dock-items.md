...
---
# <a name="cross-dock-items" />Nimikkeiden laiturointi
...
## <a name="cross-dock-bins-and-zones" />Laituroinnin varastopaikat ja vyöhykkeet
...
## <a name="cross-dock-select-lines-for-a-receipt" />Vastaanoton laituroinnin valintarivit
...
## <a name="about-the-put-away-worksheet-page" />Tietoja hyllytystyökirjasta -sivu
...
## <a name="to-set-up-the-warehouse-for-cross-docking" />Fyysisen varastoinnin määrittäminen laiturointia varten
...
## <a name="to-cross-dock-items-without-viewing-the-opportunities" />Nimikkeiden laituroiminen ilman mahdollisuuksien tarkastelua
...
## <a name="to-cross-dock-items-after-viewing-the-opportunities" />Nimikkeiden laiturointi mahdollisuuksien tarkastelemisen jälkeen
...
## <a name="to-view-cross-docked-items-in-a-shipment-or-pick-worksheet" />Laituroitujen nimikkeiden tarkasteleminen toimituksissa tai poimintatyökirjassa
