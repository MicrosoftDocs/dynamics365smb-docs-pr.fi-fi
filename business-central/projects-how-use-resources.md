...
ms.author: edupont
---
# <a name="use-resources-for-jobs" />Resurssien käyttäminen projekteissa
...
## <a name="to-assign-resources-to-jobs" />Resurssien määrittäminen projekteihin:
...
## <a name="to-record-resource-usage-for-a-job" />Projektin resurssin käytön kirjaaminen
...
## <a name="to-adjust-resource-prices" />Resurssihintojen muuttaminen
...
## <a name="to-get-resource-price-change-suggestions-based-on-existing-alternate-prices" />Resurssihintojen muutosehdotusten saaminen olemassa olevien vaihtoehtoisten hintojen perusteella
...
## <a name="to-get-resource-price-change-suggestions-based-on-standard-prices" />Resurssihintojen muutosehdotusten saaminen vakiohintojen perusteella
...
## <a name="to-get-resource-price-change-suggestions-based-on-alternate-prices" />Resurssihintojen muutosehdotusten saaminen vakiohintojen perusteella
