...
ms.author: jswymer
---
# <a name="create-sales-opportunities"></a><a name="create-sales-opportunities"></a>Myyntimahdollisuuksien luominen
...
## <a name="to-create-an-opportunity-from-a-salesperson"></a><a name="to-create-an-opportunity-from-a-salesperson"></a>Mahdollisuuden luominen myyjästä
...
## <a name="to-create-an-opportunity-from-a-contact"></a><a name="to-create-an-opportunity-from-a-contact"></a>Mahdollisuuden luominen kontaktista
