...
ms.author: edupont
---
# <a name="create-analysis-reports" />Analyysiraporttien luominen
...
## <a name="setting-up-line-and-column-layouts" />Rivi- ja sarakeasettelujen määrittäminen
...
## <a name="set-up-analysis-column-templates" />Analyysisarakkeen mallien määrittäminen
...
## <a name="set-up-analysis-line-templates" />Analyysirivimallien määrittäminen
...
## <a name="create-a-new-sales-analysis-report" />Uusien myynnin analyysiraporttien luominen
