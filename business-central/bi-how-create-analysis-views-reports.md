...
ms.author: edupont
---
# <a name="create-analysis-reports"></a><a name="create-analysis-reports"></a>Analyysiraporttien luominen
...
## <a name="setting-up-line-and-column-layouts"></a><a name="setting-up-line-and-column-layouts"></a>Rivi- ja sarakeasettelujen määrittäminen
...
## <a name="set-up-analysis-column-templates"></a><a name="set-up-analysis-column-templates"></a>Analyysisarakkeen mallien määrittäminen
...
## <a name="set-up-analysis-line-templates"></a><a name="set-up-analysis-line-templates"></a>Analyysirivimallien määrittäminen
...
## <a name="create-a-new-sales-analysis-report"></a><a name="create-a-new-sales-analysis-report"></a>Uusien myynnin analyysiraporttien luominen
