...
ms.author: edupont
---
# <a name="process-sales-returns-or-cancellations" />Myynnin palautusten tai peruutusten käsittely
...
## <a name="to-create-a-sales-credit-memo-from-a-posted-sales-invoice" />Myyntihyvityslaskun luominen kirjatusta myyntilaskusta
...
## <a name="to-create-a-sales-credit-memo-by-copying-a-posted-sales-invoice" />Myyntihyvityslaskun luominen kopioimalla kirjattu myyntilasku
...
## <a name="to-create-a-sales-allowance" />Myyntialennuksen luominen
...
## <a name="to-combine-return-receipts" />Palautusvastaanottojen yhdistäminen
...
### <a name="to-manually-combine-return-receipts" />Palautusvastaanottojen yhdistäminen manuaalisesti
...
### <a name="to-automatically-combine-return-receipts" />Palautusvastaanottojen yhdistäminen automaattisesti
...
### <a name="to-remove-a-received-and-invoiced-return-order" />Vastaanotettujen ja laskutettujen palautustilausten poistaminen
