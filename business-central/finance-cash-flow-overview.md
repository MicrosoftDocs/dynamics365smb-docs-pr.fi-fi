...
# <a name="cash-flow-overview"></a><a name="cash-flow-overview"></a>Kassavirta – yleistä
...
## <a name="definition-of-cash-flow"></a><a name="definition-of-cash-flow"></a>Kassavirran määritelmä
...
## <a name="work-with-cash-flow"></a><a name="work-with-cash-flow"></a>Kassavirtojen käsittely
...
## <a name="making-a-cash-flow-forecast"></a><a name="making-a-cash-flow-forecast"></a>Kassavirtaennusteen tekeminen
