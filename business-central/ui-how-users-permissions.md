...
ms.reviewer: jswymer
---
# <a name="create-users-according-to-licenses"></a><a name="create-users-according-to-licenses"></a>Luo käyttäjät käyttöoikeuksien mukaan
...
## <a name="manage-users-and-licenses-in-online-tenants"></a><a name="manage-users-and-licenses-in-online-tenants"></a>Käyttäjien ja lisenssien hallinta online-vuokraajissa
...
### <a name="configure-permissions-based-on-licenses"></a><a name="configure-permissions-based-on-licenses"></a><a name="licensespermissions"></a>Käyttöoikeuksien määrittäminen oikeuksien perusteella
...
### <a name="to-add-users-or-update-user-information-and-license-assignments-in-business-central"></a><a name="to-add-users-or-update-user-information-and-license-assignments-in-business-central"></a><a name="adduser"></a>Käyttäjien lisääminen tai käyttäjätietojen ja käyttöoikeuksien delegoinnin päivittäminen Business Centralissa
...
### <a name="to-remove-a-users-access-to-the-system"></a><a name="to-remove-a-users-access-to-the-system"></a>Järjestelmän käyttöoikeuden poistaminen käyttäjältä
...
### <a name="synchronization-with-microsoft-365"></a><a name="synchronization-with-microsoft-365"></a><a name="m365"></a>Synkronointi Microsoft 365:n kanssa
...
## <a name="manage-users-and-licenses-in-on-premises-deployments"></a><a name="manage-users-and-licenses-in-on-premises-deployments"></a>Käyttäjien ja lisenssien hallinta on-premises-käyttöönotoissa
...
### <a name="to-edit-or-delete-a-user-in-an-on-premises-deployment"></a><a name="to-edit-or-delete-a-user-in-an-on-premises-deployment"></a>Käyttäjän muokkaaminen tai poistaminen paikallisesta käyttöoikeudesta
