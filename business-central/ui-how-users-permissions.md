...
---
# <a name="create-users-according-to-licenses"></a>Käyttäjien luominen käyttöoikeuksien mukaan
...
> [!NOTE]
>  **Päivitä käyttäjät -oppaassa Microsoft 365** ei päivitetä käyttäjiä, joille ei ole määritetty käyttöoikeutta, kuten Dynamics 365 -järjestelmänvalvojaa [...](/entra/identity/role-based-access-control/permissions-reference#dynamics-365-administrator). Käyttäjät päivittyvät, kun he seuraavan kerran kirjautuvat ympäristöön.
...
## <a name="analyze-user-status-by-license-type"></a>Käyttäjän tilan analysointi käyttöoikeustyypin mukaan
...
### <a name="user-analysis-scenarios"></a>Käyttäjäanalyysiskenaariot
...
### <a name="example-users-by-status"></a>Esimerkki: Käyttäjät tilan mukaan
...
### <a name="example-users-by-license-type"></a>Esimerkki: Käyttäjät käyttöoikeustyypin mukaan
