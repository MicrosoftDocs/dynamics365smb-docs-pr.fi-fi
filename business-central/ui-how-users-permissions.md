...
Täsäs ohjeaiheessa kuvataan, miten järjestelmänvalvojat luovat käyttäjiä ja määrittävät, ketkä voivat kirjautua sisään [!INCLUDE[d365fin](includes/d365fin_md.md)] -sovellukseen ja mitkä käyttöoikeudet eri käyttäjätyypeille annetaan käyttöoikeuksien mukaan.
...
> [!NOTE]
> Käyttäjien ja käyttöoikeuksien hallintaprosessi vaihtelee sen mukaan, onko [!INCLUDE[d365fin](includes/d365fin_md.md)] käytössä online-tilassa vai paikallisesti. Esimerkiksi online-käyttöoikeuksien kohdalla voit hallinnoida käyttäjiä vasta sitten, kun nämä on lisätty [!INCLUDE[d365fin](includes/d365fin_md.md)] -sovellukseen Office 365:stä. Paikallisissa käyttöönotoissa voit luoda, muokata ja poistaa käyttäjiä suoraan.  

## <a name="managing-users-and-licenses-in-online-deployments"></a>Käyttäjien ja lisenssien hallinta online-käyttöönotoissa
[!INCLUDE[d365fin](includes/d365fin_md.md)] -sovelluksen online-versiossa tilaus määrittää käyttäjien lukumäärän. Se lisätään vuokraajalle Microsoft Partner Centerissä. Tämän tekee tavallisesti Microsoft-kumppanisi. Lisätietoja on kohdassa [Uuden asiakkaan lisääminen](https://docs.microsoft.com/partner-center/add-a-new-customer) sekä [Asiakastilausten luominen, keskeyttäminen ja peruuttaminen](https://docs.microsoft.com/partner-center/create-a-new-subscription) Microsoft Partner Center -ohjeessa.
...
Lisätietoja on kehittäjän ja IT-ammattilaisten ohjeen kohdassa [Business Central Onlinen hallinta](/dynamics365/business-central/dev-itpro/administration/tenant-administration).
...
2. Valitse **Hae uudet käyttäjät Office 365:stä**- tai **Päivitä käyttäjät Office 365:stä** -toiminto.

Office 365 -tilauksen uudet käyttäjät ja käyttäjätiedot lisätään **Käyttäjät**-sivulle [!INCLUDE[d365fin](includes/d365fin_md.md)] -sovelluksessa. Lisätietoja käyttäjätietojen synkronoimisesta Office 365:n kanssa on kohdassa [Synkronoiminen Office 365:n kanssa](ui-how-users-permissions.md#synchronization-with-office-365).
...
> [!NOTE]
> Kaikille käyttäjille on määritettävä sama käyttöoikeus. Se voi olla joko Essential tai Premium. Lisätietoja on Microsoft Dynamics 365 Business Centralin käyttöoikeusoppaassa. Opas on ladattavissa [Business Centralin](https://dynamics.microsoft.com/en-us/business-central/overview/) verkkosivulla.
...
* Järjestelmänvalvoja voi lisätä käyttäjän valitsemalla **Päivitä käyttäjät Office 365:stä** -toiminnon **Käyttäjät**-sivulla.
...
> [!NOTE]
> Järjestelmänvalvoja voi määrittää paikallisissa käyttöönotoissa, miten käyttäjän tunnistetiedot todennetaan [!INCLUDE[server](includes/server.md)] -ilmentymässä. Kun luot käyttäjän, anna käyttämäsi tunnistetietotyyppi.<br /><br />
> Lisätietoja on [!INCLUDE[d365fin](includes/d365fin_md.md)] -sovelluksen kehittäjän ja IT-ammattilaisen sisällön järjestelmänvalvojan osan [Todennus ja tunnistetietotyypit](/dynamics365/business-central/dev-itpro/administration/users-credential-types) -kohdassa.
