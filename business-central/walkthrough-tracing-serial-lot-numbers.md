...
ms.author: bholtorf
---
# <a name="walkthrough-tracing-seriallot-numbers" />Vaihekuvaus: Sarja-/eränumeroiden jäljitys
...
### <a name="to-create-the-items" />Nimikkeiden luominen
...
### <a name="to-purchase-components" />Osta osia
...
### <a name="to-produce-end-items" />Tuota lopullisia nimikkeitä
...
### <a name="to-sell-the-end-items" />Myy lopullisia nimikkeitä
...
## <a name="tracing-from-usage-to-origin" />Jäljittäminen käytöstä alkuperään
...
### <a name="to-determine-which-lot-included-the-faulty-frame-and-who-supplied-it" />Virheellisen rungon erän ja toimittajan määrittäminen
...
## <a name="tracing-from-origin-to-usage" />Jäljittäminen alkuperästä käyttöön
...
### <a name="to-find-all-usage-of-the-faulty-lot" />Virheellisen erän kaikkien käyttökohteiden etsiminen
...
## <a name="finding-all-records-of-a-seriallot-number" />Sarja-/eränumeron kaikkien tietueiden etsiminen
...
## <a name="see-related-microsoft-trainingtrainingpathsuse-serial-lot-numbers" />Lue aiheeseen liittyen [Microsoftin koulutukset](/training/paths/use-serial-lot-numbers/)
