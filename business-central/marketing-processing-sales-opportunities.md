...
ms.author: jswymer
---
# <a name="process-sales-opportunities" />Myyntimahdollisuuksien käsitteleminen
Mahdollisuuden luomisen jälkeen sen hallinnassa ja valmistumisprosessissa voidaan käyttää useita toimintoja.

## <a name="to-view-opportunities" />Mahdollisuuksien tarkasteleminen
...
## <a name="to-close-opportunities" />Mahdollisuuksien sulkeminen
...
## <a name="to-create-quotes-for-opportunities" />Tarjousten luominen mahdollisuuksille
> [!NOTE]
...
## <a name="to-create-sales-orders-for-opportunities" />Mahdollisuuksien myyntitilausten luominen
...
## <a name="to-delete-opportunities" />Mahdollisuuksien poistaminen
...
## <a name="to-move-an-opportunity-through-sales-cycle-stages" />Mahdollisuuden siirtäminen myyntisyklin vaiheiden läpi
