...
ms.author: edupont
---
# <a name="customizing-business-central-online-with-apps"></a><a name="customizing-business-central-online-with-apps"></a>Business Central Onlinen mukauttaminen sovellusten avulla
...
## <a name="manage-apps"></a><a name="manage-apps"></a>Sovellusten hallinta
...
## <a name="apps-and-data-transfer"></a><a name="apps-and-data-transfer"></a>Sovellukset ja tietojen siirto
...
## <a name="connect-your-business"></a><a name="connect-your-business"></a>Yhdistä yrityksesi
...
## <a name="recommended-apps"></a><a name="recommended-apps"></a>Suositellut sovellukset
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Lue aiheeseen liittyen [Microsoftin koulutukset](/training/modules/customize-dynamics-365-business-central/)
