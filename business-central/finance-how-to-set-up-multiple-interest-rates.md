...
ms.author: edupont
---
# <a name="set-up-multiple-interest-rates-for-delayed-payment"></a><a name="set-up-multiple-interest-rates-for-delayed-payment"></a><a name="set-up-multiple-interest-rates-for-delayed-payment"></a>Useiden korkoprosenttien määrittäminen viivästynyttä maksua varten
...
## <a name="to-set-up-multiple-interest-rates"></a><a name="to-set-up-multiple-interest-rates"></a><a name="to-set-up-multiple-interest-rates"></a>Useiden korkoprosenttien määrittäminen
