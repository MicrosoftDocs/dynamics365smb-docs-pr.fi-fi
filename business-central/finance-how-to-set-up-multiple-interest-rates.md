...
ms.author: edupont
---
# <a name="set-up-multiple-interest-rates-for-delayed-payment" />Useiden korkoprosenttien määrittäminen viivästynyttä maksua varten
...
## <a name="to-set-up-multiple-interest-rates" />Useiden korkoprosenttien määrittäminen
