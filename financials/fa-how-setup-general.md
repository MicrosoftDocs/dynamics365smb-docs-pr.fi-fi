---
title: "Toimintaohje: Käyttöomaisuuden yleisten tietojen määrittäminen| Microsoft Docs"
description: "Tässä artikkelissa kerrotaan, miten järjestelmä määritetään käyttöomaisuuden hallintaa varten."
...
1. Valitse oikeassa yläkulmassa **Etsi sivua tai raporttia** -kuvake ![Etsi sivua tai raporttia](media/ui-search/search_small.png "Etsi sivua tai raporttia -kuvake"), kirjoita **Käyttöomaisuuden asetukset** ja valitse sitten liittyvä linkki.  
...
1. Valitse oikeassa yläkulmassa **Etsi sivua tai raporttia** -kuvake ![Etsi sivua tai raporttia](media/ui-search/search_small.png "Etsi sivua tai raporttia -kuvake"), kirjoita **KO:n päiväkirjan mallit** ja valitse sitten liittyvä linkki.  
...
1. Valitse oikeassa yläkulmassa **Etsi sivua tai raporttia** -kuvake ![Etsi sivua tai raporttia](media/ui-search/search_small.png "Etsi sivua tai raporttia -kuvake"), kirjoita **KO:n uud.luok.pvk:n mallit** ja valitse sitten liittyvä linkki.  
2. Täytä tarvittavat kentät.
...
1. Valitse oikeassa yläkulmassa **Etsi sivua tai raporttia** -kuvake ![Etsi sivua tai raporttia](media/ui-search/search_small.png "Etsi sivua tai raporttia -kuvake"), kirjoita **KO:n luokat** ja valitse sitten liittyvä linkki.
...
1. Valitse oikeassa yläkulmassa **Etsi sivua tai raporttia** -kuvake ![Etsi sivua tai raporttia](media/ui-search/search_small.png "Etsi sivua tai raporttia -kuvake"), kirjoita **KO:n alaluokat** ja valitse sitten liittyvä linkki.
2. Syötä koodit ja nimet niiden luokkien osalta, jotka haluat luoda.
...
1. Valitse oikeassa yläkulmassa **Etsi sivua tai raporttia** -kuvake ![Etsi sivua tai raporttia](media/ui-search/search_small.png "Etsi sivua tai raporttia -kuvake"), kirjoita **KO:n sijainnit** ja valitse sitten liittyvä linkki.
