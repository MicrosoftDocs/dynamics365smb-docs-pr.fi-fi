---
title: Yleiset liiketoimintatoiminnot | Microsoft Docs
description: "Lisätietoja Dynamics 365 for Financialsin liiketoiminta-alueiden yleisistä toiminnoista"
...
[!INCLUDE[d365fin](includes/d365fin_md.md)] sisältää omat toiminnot tavallisille liiketoiminta-alueille, kuten rahoitus ja myynti. Liiketoiminta-aluekohtaisia tehtäviä varten käytettävissä on useita yleisen liiketoiminnan toimintoja, kuten **Numerosarjat** ja **Laajennukset**, jotka ovat käytettävissä kaikilla alueilla.
...
| Muuta [!INCLUDE[d365fin](includes/d365fin_md.md)]ia asentamalla laajennuksia, jotka sisältävät lisätoimintoja, muuttavat toimintaa tai mahdollistavat uusien verkkopalveluiden käyttämisen. |[[!INCLUDE[d365fin](includes/d365fin_md.md)]in mukauttaminen laajennuksilla](ui-extensions.md) |
...
| Kirjaa ulkoiset asiakirjat [!INCLUDE[d365fin](includes/d365fin_md.md)]issa liitteineen ja luo sitten manuaalisesti liittyvät asiakirjat tai muunna tiedostot automaattisesti sähköisiksi asiakirjoiksi. |[Saapuvien asiakirjojen hallinta](across-income-documents.md) |
