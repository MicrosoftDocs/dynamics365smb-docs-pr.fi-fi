 ...
 **Tilauksen suunnittelu** -ikkunaa voi käyttää siirtymisruudun **Osastot**-valikosta useasta eri sijainnista:  

-   Tuotanto, Suunnittelu  
-   Myynti ja markkinointi, Tilauksen käsitteleminen  
-   Osto, Suunnittelu  
-   Lisäksi voit avata tämän tietyn tuotantotilauksen ikkunan valitsemalla **Suunnittelu**-kohdan **Navigoi**-välilehdessä **Tilaus**-ryhmässä.  
