...
description: "Tutustu yleisimpiin syihin, minkä vuoksi Finance and Operations, Business editioniin rekisteröityminen ei onnistu ja miten nämä ongelmat voidaan ratkaista."
...
## <a name="what-email-address-can-i-use-with-finance-and-operations-business-edition"></a>Mitä sähköpostiosoitetta käytetään Finance and Operations, Business editionissa?
