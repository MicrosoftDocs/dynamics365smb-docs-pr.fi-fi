---
title: 'Toimintaohje: Projektien laskuttaminen| Microsoft Docs'
description: "Artikkelissa kerrotaan, miten projektin kustannukset laskutetaan asiakkailta projektin edetessä."
...
**Huomautus**: Jos valitset projektiin liittyvien ostojen ostoasiakirjojen **Projektin rivityyppi** -kentän **Laskutettava**-kohdan, projektin suunnittelurivit, jotka ovat valmiita asiakkaalta laskutusta varten, luodaan. Lisätietoja on kohdassa [Toimintaohje: Projektin tarvikkeiden hallinta](projects-how-manage-project-supplies.md).
...
1. Valitse oikeassa yläkulmassa **Etsi sivua tai raporttia** -kuvake ![Etsi sivua tai raporttia](media/ui-search/search_small.png "Etsi sivua tai raporttia -kuvake"), kirjoita **Luo projektin myyntilasku** ja valitse sitten liittyvä linkki.  
...
**Huomautus**: Projektiin liittyvän myyntihyvityslaskun luominen, tarkistaminen ja kirjaaminen tapahtuu edellä esitetyllä tavalla.
