...
## [QuickBooks-sovelluksen vaihtaminen Microsoft Finance and Operations, Business editioniin](across-quickbooks-to-business-edition.md)
...
## [Finance and Operations, Business editionin käyttäminen ilman Outlookia](madeira-no-outlook.md)
## [Yritystietojen ottaminen käyttöön Power BI:tä varten](madeira-powerbi.md)
## [Power BI:n yhdistäminen Finance and Operations, Business editionin sisältöpaketteihin](across-how-to-connect-powerbi-dynamics-365-content-packs-help.md)
## [Finance and Operations, Business editionin käyttäminen automaattisessa työkalussa](across-how-use-financials-data-source-flow.md)
## [Finance and Operations, Business editionin käyttäminen Power BI:n tietolähteenä](across-how-use-financials-data-source-powerbi.md)
## [Liiketoimintasovellusten luominen PowerAppsin avulla luomalla liiketoimintasovelluksia yhdistettyjen Finance and Operations, Business editionin tietojen avulla](across-how-use-financials-data-source-powerapps.md)
...
### [Ulkoisen kirjanpitäjän kutsuminen Finance and Operations, Business editioniin](finance-invite-external-accountant.md)  
...
## [Raporttien luonti XBRL-linkityksellä.](bi-create-reports-with-xbrl.md)

# [Myynti](sales-manage-sales.md)
## [Tarjousten tekeminen](sales-how-make-offers.md)
...
## [Finance and Operations, Business editionin arvoehdotusten salliminen](ui-let-system-suggest-values.md)
