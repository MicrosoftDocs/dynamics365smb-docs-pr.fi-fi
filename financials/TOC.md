...
### [Käyttöomaisuuden ylläpidon määrittäminen](fa-how-setup-maintenance.md)
...
## [Laajennetun nimiketekstin määrittäminen](ui-how-define-ext-text.md)
...
## [Muutosten kirjaaminen Finance and Operations, Business editionissa](across-log-changes.md)
## [Käyttäjien ja käyttöoikeuksien hallinta](ui-how-users-permissions.md)
