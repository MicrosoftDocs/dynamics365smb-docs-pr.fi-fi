...
---
# <a name="setup-and-administration-in-dynamics-365-for-financials"></a>Dynamics 365 for Financialsin määrittäminen ja hallinta
...
|**Tehtävä**|**Katso**|  
|------------|-------------|  
|Lisää käyttäjiä, hallitse tietojen käyttöoikeuksia ja määritä rooleja.|[Dynamics 365 for Financialsin käyttäjät, profiilit ja roolikeskukset](admin-users-profiles-roles.md)|  
|Seuraa kaikkia suoria muutoksia, joita käyttäjät tekevät tietokannan tietoihin. Muutoksia seuraamalla voidaan tunnistaa virheiden alkuperä ja tietojen muutokset.|[Muutosten kirjaaminen Dynamics 365 for Financialsissa](across-log-changes.md)|  
...
|Dynamics 365 for Financialsin sähköpostiviestinnän mahdollistavan SMTP-palvelimen määrittäminen| [Toimintaohje: Sähköpostin määrittäminen manuaalisesti tai asetusten ohjatun määrityksen käyttäminen](madeira-how-setup-email.md)|  
...
[Yritystoimintojen yleiskatsaus](madeira-business-functionality.md)  
